    ...
    public static void initSpawns() {	
        for (Biome biome : ForgeRegistries.BIOMES.getValues())
            if (biome.equals(ModBiomes.Iceika)) {
                ...
                EntityRegistry.addSpawn(AcidHag.class, 2, 1, 4, EnumCreatureType.MONSTER, biome);
                EntityRegistry.addSpawn(Biphron.class, 2, 1, 4, EnumCreatureType.MONSTER, biome);
                EntityRegistry.addSpawn(Bohemite.class, 2, 1, 4, EnumCreatureType.MONSTER, biome);
                EntityRegistry.addSpawn(Cymesoid.class, 2, 1, 4, EnumCreatureType.MONSTER, biome);
                //EntityRegistry.addSpawn(Dissiment.class, 2, 1, 4, EnumCreatureType.MONSTER, biome);
                EntityRegistry.addSpawn(Dreamwrecker.class, 2, 1, 4, EnumCreatureType.MONSTER, biome);
                EntityRegistry.addSpawn(Duo.class, 2, 1, 4, EnumCreatureType.MONSTER, biome);
                EntityRegistry.addSpawn(Galroid.class, 2, 1, 4, EnumCreatureType.MONSTER, biome);
