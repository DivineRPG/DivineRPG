...
public class RenderRegistry {
    ...
    public static void registerRenders(ModelRegistryEvent event) {
        ...
        // Vanilla
        registerRender(EntityAncientEntity.class, manager -> new RenderDivineMob(manager, new ModelAncientEntity(), 5.F, new ResourceLocation(DivineRPG.MODID, "textures/entity/ancient_entity.png")));
