...
public class MaterialRegistry {
    ...
    //Armor materials
    public static final ArmorMaterial ANGELIC_ARMOR = EnumHelper.addArmorMaterial("drpg_angelic_armor", DivineRPG.MODID + ":angelic", 20, new int[] {3, 4, 4, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0F);
    public static final ArmorMaterial APALACHIA_ARMOR = EnumHelper.addArmorMaterial("drpg_apalachia_armor", DivineRPG.MODID + ":apalachia", 38, new int[] {5, 5, 7, 5}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F).setRepairItem(makeRepairStack("apalachia_chunk"));
    public static final ArmorMaterial AQUASTRIVE_ARMOR = EnumHelper.addArmorMaterial("drpg_aquastrive_armor", DivineRPG.MODID + ":aquastrive", 30, new int[] {4, 5, 6, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F).setRepairItem(makeRepairStack("aquatic_ingot"));
    public static final ArmorMaterial ARLEMITE_ARMOR = EnumHelper.addArmorMaterial("drpg_arlemite_armor", DivineRPG.MODID + ":arlemite", 31, new int[] {3, 5, 7, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4F).setRepairItem(makeRepairStack("arlemite_ingot"));
    public static final ArmorMaterial AWAKENED_HALITE_ARMOR = EnumHelper.addArmorMaterial("drpg_awakened_halite_armor", DivineRPG.MODID + ":awakened_halite", 44, new int[] {5, 7, 8, 5}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4F);
    public static final ArmorMaterial BEDROCK_ARMOR = EnumHelper.addArmorMaterial("drpg_bedrock_armor", DivineRPG.MODID + ":bedrock", 47, new int[] {5, 6, 8, 5}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 5F).setRepairItem(makeRepairStack("bedrock_chunk"));
    public static final ArmorMaterial CORRUPTED_ARMOR = EnumHelper.addArmorMaterial("drpg_corrupted_armor", DivineRPG.MODID + ":corrupted", 42, new int[] {4, 6, 8, 5}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F).setRepairItem(makeRepairStack("corrupted_stone"));
    public static final ArmorMaterial DIVINE_ARMOR = EnumHelper.addArmorMaterial("drpg_divine_armor", DivineRPG.MODID + ":divine", 42, new int[] {5, 6, 8, 4}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4F).setRepairItem(makeRepairStack("divine_stone"));
    public static final ArmorMaterial EDEN_ARMOR = EnumHelper.addArmorMaterial("drpg_eden_armor", DivineRPG.MODID + ":eden", 34, new int[] {3, 5, 7, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F).setRepairItem(makeRepairStack("eden_chunk"));
    public static final ArmorMaterial ELITE_REALMITE_ARMOR = EnumHelper.addArmorMaterial("drpg_elite_realmite_armor", DivineRPG.MODID + ":elite_realmite", 40, new int[] {4, 6, 7, 4}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F).setRepairItem(makeRepairStack("realmite_block"));
    public static final ArmorMaterial ENDER_ARMOR = EnumHelper.addArmorMaterial("drpg_ender_armor", DivineRPG.MODID + ":ender", 38, new int[] {5, 6, 7, 5}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F).setRepairItem(makeRepairStack("ender_stone"));
    public static final ArmorMaterial RED_ENDER_ARMOR = EnumHelper.addArmorMaterial("drpg_red_ender_armor", DivineRPG.MODID + ":red_ender", 38, new int[] {5, 6, 7, 5}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F).setRepairItem(makeRepairStack("ender_stone"));
    public static final ArmorMaterial YELLOW_ENDER_ARMOR = EnumHelper.addArmorMaterial("drpg_yellow_ender_armor", DivineRPG.MODID + ":yellow_ender", 38, new int[] {5, 6, 7, 5}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F).setRepairItem(makeRepairStack("ender_stone"));
    public static final ArmorMaterial GREEN_ENDER_ARMOR = EnumHelper.addArmorMaterial("drpg_green_ender_armor", DivineRPG.MODID + ":green_ender", 38, new int[] {5, 6, 7, 5}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F).setRepairItem(makeRepairStack("ender_stone"));
    public static final ArmorMaterial GRAY_ENDER_ARMOR = EnumHelper.addArmorMaterial("drpg_gray_ender_armor", DivineRPG.MODID + ":gray_ender", 38, new int[] {5, 6, 7, 5}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F).setRepairItem(makeRepairStack("ender_stone"));
    public static final ArmorMaterial BLUE_ENDER_ARMOR = EnumHelper.addArmorMaterial("drpg_blue_ender_armor", DivineRPG.MODID + ":blue_ender", 38, new int[] {5, 6, 7, 5}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F).setRepairItem(makeRepairStack("ender_stone"));
    public static final ArmorMaterial FROZEN_ARMOR = EnumHelper.addArmorMaterial("drpg_frozen_armor", DivineRPG.MODID + ":frozen", 31, new int[] {3, 5, 7, 4}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1F).setRepairItem(makeRepairStack("ice_stone"));
    public static final ArmorMaterial HALITE_ARMOR = EnumHelper.addArmorMaterial("drpg_halite_armor", DivineRPG.MODID + ":halite", 44, new int[] {5, 7, 8, 5}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4F).setRepairItem(makeRepairStack("mortum_chunk"));
    public static final ArmorMaterial INFERNO_ARMOR = EnumHelper.addArmorMaterial("drpg_inferno_armor", DivineRPG.MODID + ":inferno", 22, new int[] {4, 7, 7, 4}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1F).setRepairItem(makeRepairStack("molten_stone"));
    public static final ArmorMaterial JACK_O_MAN_ARMOR = EnumHelper.addArmorMaterial("drpg_jack_o_man_armor", DivineRPG.MODID + ":jack_o_man", 26, new int[] {3, 6, 8, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial JUNGLE_ARMOR = EnumHelper.addArmorMaterial("drpg_jungle_armor", DivineRPG.MODID + ":jungle", 31, new int[] {3, 5, 7, 4}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1F).setRepairItem(makeRepairStack("jungle_stone"));
    public static final ArmorMaterial KORMA_ARMOR = EnumHelper.addArmorMaterial("drpg_korma_armor", DivineRPG.MODID + ":korma", 38, new int[] {4, 7, 8, 4}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4F);
    public static final ArmorMaterial KRAKEN_ARMOR = EnumHelper.addArmorMaterial("drpg_kraken_armor", DivineRPG.MODID + ":kraken", 28, new int[] {3, 5, 6, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1F).setRepairItem(makeRepairStack("kraken_skin"));
    public static final ArmorMaterial MORTUM_ARMOR = EnumHelper.addArmorMaterial("drpg_mortum_armor", DivineRPG.MODID + ":mortum", 40, new int[] {4, 6, 9, 5}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4F).setRepairItem(makeRepairStack("mortum_chunk"));
    public static final ArmorMaterial NETHERITE_ARMOR = EnumHelper.addArmorMaterial("drpg_netherite_armor", DivineRPG.MODID + ":netherite", 36, new int[] {4, 5, 6, 4}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F).setRepairItem(makeRepairStack("netherite_ingot"));
    public static final ArmorMaterial REALMITE_ARMOR = EnumHelper.addArmorMaterial("drpg_realmite_armor", DivineRPG.MODID + ":realmite", 24, new int[] {2, 5, 6, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0F).setRepairItem(makeRepairStack("realmite_ingot"));
    ...
    public static final ArmorMaterial SANTA_ARMOR = EnumHelper.addArmorMaterial("drpg_santa_armor", DivineRPG.MODID + ":santa", 20, new int[] {3, 4, 5, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0F);
    public static final ArmorMaterial SHADOW_ARMOR = EnumHelper.addArmorMaterial("drpg_shadow_armor", DivineRPG.MODID + ":shadow", 28, new int[] {4, 6, 8, 4}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F).setRepairItem(makeRepairStack("shadow_bar"));
    ...
    public static final ArmorMaterial SKYTHERN_ARMOR = EnumHelper.addArmorMaterial("drpg_skythern_armor", DivineRPG.MODID + ":skythern", 38, new int[] {4, 6, 8, 5}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F).setRepairItem(makeRepairStack("skythern_chunk"));
    public static final ArmorMaterial TERRAN_ARMOR = EnumHelper.addArmorMaterial("drpg_terran_armor", DivineRPG.MODID + ":terran", 31, new int[] {3, 5, 7, 4}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1F).setRepairItem(makeRepairStack("terran_stone"));
    public static final ArmorMaterial VEMOS_ARMOR = EnumHelper.addArmorMaterial("drpg_vemos_armor", DivineRPG.MODID + ":vemos", 30, new int[] {4, 5, 6, 5}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F);
    public static final ArmorMaterial WILDWOOD_ARMOR = EnumHelper.addArmorMaterial("drpg_wildwood_armor", DivineRPG.MODID + ":wildwood", 36, new int[] {4, 5, 7, 4}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F).setRepairItem(makeRepairStack("wildwood_chunk"));
    public static final ArmorMaterial WITHER_REAPER_ARMOR = EnumHelper.addArmorMaterial("drpg_wither_reaper_armor", DivineRPG.MODID + ":wither_reaper", 36, new int[] {3, 6, 8, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
