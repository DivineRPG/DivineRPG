...
/**
 * Registers most items for the mod, except for tools and weapons which go in ModTools and ModItems respectively.
...
/*    public static final Item diamondHelmet = new ItemDivineArmor(EnumArmor.DIAMOND, EntityEquipmentSlot.HEAD);
    ...
    /**
     * Items map used for render
     */
    public static HashMap<String, Item> itemMap = new HashMap<>();
    /**
     * List of items blocks. Should register at first
     */
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        ...
        while (!itemBlockList.isEmpty()) {
            register(registry, itemBlockList.get(0));
            itemBlockList.remove(0);
        }
        ...
        registerDependends(registry);
    }

    /**
     * Register dependent items.
     * <p>
     * Now it's armor and tools
     */
    private static void registerDependends(IForgeRegistry<Item> registry) {

        DivineRPG.logger.info("Forcing Object Holders population");

        // forced population of previousely registered items
        ...
        DivineRPG.logger.info("Registering DivineRPG armors");
