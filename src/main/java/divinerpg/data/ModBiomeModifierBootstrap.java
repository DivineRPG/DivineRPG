...
public class ModBiomeModifierBootstrap {
    ...
    public static void bootstrap(BootstrapContext<BiomeModifier> ctx) {
        ...
        ResourceKey<BiomeModifier> KOBBLIN_HILL = ResourceKey.create(NeoForgeRegistries.Keys.BIOME_MODIFIERS, Identifier.fromNamespaceAndPath(MODID, "kobblin_hill"));
