...
@OnlyIn(Dist.CLIENT)
public class TwilightArcherLayer extends LayerRenderer<EntityTwilightArcher, ModelTwilightArcher<EntityTwilightArcher>> {

    public TwilightArcherLayer(IEntityRenderer<EntityTwilightArcher, ModelTwilightArcher<EntityTwilightArcher>> p_i50926_1_) {
        super(p_i50926_1_);
    }

    public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, EntityTwilightArcher entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
