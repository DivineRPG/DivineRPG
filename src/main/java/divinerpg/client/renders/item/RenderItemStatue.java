...
public class RenderItemStatue extends BlockEntityWithoutLevelRenderer {
    ...
    private Model getModel(ItemStack stack){
        ...
        if(item == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "ancient_entity_statue")).asItem()){
            return new ModelAncientEntity(context.bakeLayer(ModelAncientEntity.LAYER_LOCATION));
        } else if(item == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "densos_statue")).asItem()){
            return new ModelDensos<>(context.bakeLayer(ModelDensos.LAYER_LOCATION));
        } else if(item == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "dramix_statue")).asItem()){
            return new ModelDramix<>(context.bakeLayer(ModelDramix.LAYER_LOCATION));
        } else if(item == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "eternal_archer_statue")).asItem()){
            return new ModelEternalArcher<>(context.bakeLayer(ModelEternalArcher.LAYER_LOCATION));
        } else if(item == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "karot_statue")).asItem()){
            return new ModelKarot(context.bakeLayer(ModelKarot.LAYER_LOCATION));
        } else if(item == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "king_of_scorchers_statue")).asItem()){
            return new ModelKingOfScorchers(context.bakeLayer(ModelKingOfScorchers.LAYER_LOCATION));
        } else if(item == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "parasecta_statue")).asItem()){
            return new ModelParasecta(context.bakeLayer(ModelParasecta.LAYER_LOCATION));
        } else if(item == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "reyvor_statue")).asItem()){
            return new ModelDensos<>(context.bakeLayer(ModelDensos.LAYER_LOCATION));
        } else if(item == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "soul_fiend_statue")).asItem()){
            return new ModelSoulFiend(context.bakeLayer(ModelSoulFiend.LAYER_LOCATION));
        } else if(item == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "the_watcher_statue")).asItem()){
            return new ModelWatcher(context.bakeLayer(ModelWatcher.LAYER_LOCATION));
        } else if(item == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "twilight_demon_statue")).asItem()){
            return new ModelTwilightDemon(context.bakeLayer(ModelTwilightDemon.LAYER_LOCATION));
        } else if(item == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "vamacheron_statue")).asItem()){
            return new ModelVamacheron(context.bakeLayer(ModelVamacheron.LAYER_LOCATION));
        }

        else if(item == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "ayeraco_statue")).asItem()) {
            return new ModelAyeraco(context.bakeLayer(ModelAyeraco.LAYER_LOCATION));
        }

        else if(item == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "termasect_statue")).asItem()){
            return new ModelTermasect<>(context.bakeLayer(ModelTermasect.LAYER_LOCATION));
        } else if(item == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "sunstorm_statue")).asItem()){
            return new ModelSunstorm<>(context.bakeLayer(ModelSunstorm.LAYER_LOCATION));
        } else if(item == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "experienced_cori_statue")).asItem()){
            return new ModelExperiencedCori(context.bakeLayer(ModelExperiencedCori.LAYER_LOCATION));
        } else if(item == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "kitra_statue")).asItem()){
