...
public class RenderDisk<T extends ThrowableEntity> extends EntityRenderer<T> {
    public RenderDisk(final EntityRendererManager renderManager) {
        super(renderManager);
    }
    ...
    public void render(T entity, float yaw, float partialTicks, MatrixStack matrix, IRenderTypeBuffer buffer, int packedLight) {
        ...
        IVertexBuilder vertexBuilder = buffer.getBuffer(RenderType.entityCutout(((EntityDisk)entity).getTexture()));
    ...
    public ResourceLocation getTextureLocation(T entity) {
        return ((EntityDisk)entity).getTexture();
    }
}