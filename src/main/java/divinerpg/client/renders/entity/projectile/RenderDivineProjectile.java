...
public class RenderDivineProjectile<T extends ThrowableEntity> extends EntityRenderer<T> {
    private final ResourceLocation texture;
    private final RenderType renderType;

    public RenderDivineProjectile(final EntityRendererManager renderManager, final ResourceLocation texture) {
        super(renderManager);
