...
public class RenderGlinthop extends MobRenderer<EntityGlinthop, ModelGlinthop> {
    private static final ResourceLocation
        TEXTURE = ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "textures/entity/glinthop.png"),
        TEXTURE_ALT = ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "textures/entity/glinthop_alt.png");
