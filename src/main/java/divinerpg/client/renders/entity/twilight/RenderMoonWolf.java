...
public class RenderMoonWolf extends MobRenderer<EntityMoonWolf, ModelMoonWolf> {
    private static final ResourceLocation
        WOLF_LOCATION = ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "textures/entity/moon_wolf/moon_wolf_default.png"),
        WOLF_TAME_LOCATION = ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "textures/entity/moon_wolf/moon_wolf_default.png"),
        WOLF_ANGRY_LOCATION = ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "textures/entity/moon_wolf/moon_wolf_agro.png");
