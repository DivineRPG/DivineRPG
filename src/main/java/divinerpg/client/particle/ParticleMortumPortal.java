...
@OnlyIn(Dist.CLIENT)
public class ParticleMortumPortal extends TextureSheetParticle
{
    SpriteSet animatedSprite;
    private final float portalParticleScale;
    private final double portalPosX, portalPosY, portalPosZ;

    public ParticleMortumPortal(ClientLevel worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeed, double ySpeed, double zSpeed, SpriteSet sprite)
    {
        this(worldIn, xCoordIn, yCoordIn, zCoordIn, xSpeed, ySpeed, zSpeed, 1.0F, sprite);
    }

    public ParticleMortumPortal(ClientLevel worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeed, double ySpeed, double zSpeed, float scale, SpriteSet sprite)
    {
        ...
        float f = worldIn.random.nextFloat() * 0.4F + 0.1F;
        this.bCol = f;
        this.gCol = f;
        this.rCol = f;
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel world, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeed, double ySpeed, double zSpeed) {
            ParticleMortumPortal particle = new ParticleMortumPortal(world, xCoordIn, yCoordIn, zCoordIn, xSpeed, ySpeed, zSpeed, sprites);
