...
public class FrostedChestMenu extends AbstractContainerMenu {
    private static final int SLOTS_PER_ROW = 9;
    private final Container container;
    private final int containerRows;

    private FrostedChestMenu(int p_39225_, Inventory p_39226_, int p_39227_) {
    ...
    public static FrostedChestMenu threeRows(int p_39238_, Inventory p_39239_, Container p_39240_) {
        return new FrostedChestMenu(p_39238_, p_39239_, p_39240_, 3);
    }

    public FrostedChestMenu(int p_39230_, Inventory p_39231_, Container p_39232_, int p_39233_) {
        super(MenuTypeRegistry.FROSTED_CHEST.get(), p_39230_);
