...
public class ModelGalroid<T extends Entity> extends EntityModel<T> {
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		...
		rightarm9.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		...
		leftarm9.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarm10.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarm11.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarm12.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarm13.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarm14.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarm15.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarm16.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarm17.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarm18.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarm10.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarm11.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarm12.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarm13.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarm14.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarm15.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarm16.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarm17.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarm18.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarm19.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarm20.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarm21.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarm22.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarm23.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarm24.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarm25.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarm26.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarm19.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarm20.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarm22.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarm21.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarm23.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarm24.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarm25.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarm26.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		...
		body13.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		body14.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		head.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		horn2.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		horn3.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		horn4.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarm27.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarm27.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
	}
}