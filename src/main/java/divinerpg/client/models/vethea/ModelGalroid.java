...
public class ModelGalroid extends EntityModel<GalroidRenderState> {
    ...
    @Override
    public void setupAnim(GalroidRenderState state) {
        float limbSwing = state.limbSwing;
        float limbSwingAmount = state.limbSwingAmount;
        ModelPart[] leftLegs = {this.leftleg1, this.leftleg2, this.leftleg3, this.leftleg4, this.leftleg5};
        float leftLegAngle = Mth.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
        for (ModelPart leg : leftLegs) {
            leg.xRot = leftLegAngle;
        }

        ModelPart[] rightLegs = {this.rightleg1, this.rightleg2, this.rightleg3, this.rightleg4, this.rightleg5};
        float rightLegAngle = Mth.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount;
        for (ModelPart leg : rightLegs) {
            leg.xRot = rightLegAngle;
        }

        ModelPart[] rightArmsWithOffset = {
                this.rightarm1, this.rightarm7, this.rightarm8, this.rightarm9,
                this.rightarm10, this.rightarm11, this.rightarm12, this.rightarm13,
                this.rightarm14, this.rightarm17, this.rightarm18, this.rightarm19,
                this.rightarm20, this.rightarm22, this.rightarm27
        };
        float baseRightArmAngle = Mth.cos(limbSwing * 0.6662F + (float) Math.PI) * 2.0F * limbSwingAmount * 0.5F;

        for (ModelPart arm : rightArmsWithOffset) {
            arm.xRot = baseRightArmAngle - 1.22173F;
        }

        ModelPart[] rightArmsStandard = {
                this.rightarm2, this.rightarm3, this.rightarm4, this.rightarm5,
                this.rightarm6, this.rightarm15, this.rightarm16, this.rightarm21,
                this.rightarm23, this.rightarm24, this.rightarm25, this.rightarm26
        };
        for (ModelPart arm : rightArmsStandard) {
            arm.xRot = baseRightArmAngle;
        }

        ModelPart[] leftArmsWithOffset = {
                this.leftarm1, this.leftarm7, this.leftarm8, this.leftarm9,
                this.leftarm10, this.leftarm11, this.leftarm12, this.leftarm18,
                this.leftarm19, this.leftarm21, this.leftarm23, this.leftarm24
        };
        float baseLeftArmAngle = Mth.cos(limbSwing * 0.6662F) * 2.0F * limbSwingAmount * 0.5F;

        for (ModelPart arm : leftArmsWithOffset) {
            arm.xRot = baseLeftArmAngle - 1.22173F;
        }

        ModelPart[] leftArmsStandard = {
                this.leftarm2, this.leftarm3, this.leftarm4, this.leftarm5,
                this.leftarm6, this.leftarm13, this.leftarm14, this.leftarm15,
                this.leftarm16, this.leftarm17, this.leftarm20, this.leftarm22,
                this.leftarm25, this.leftarm26, this.leftarm27
        };
        for (ModelPart arm : leftArmsStandard) {
            arm.xRot = baseLeftArmAngle;
        }
    }
