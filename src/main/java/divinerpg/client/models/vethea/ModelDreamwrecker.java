...
public class ModelDreamwrecker<T extends Entity> extends EntityModel<T> {
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		...
		bodyt1.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarmb.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarmb.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightlegb.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftlegb.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		bodyt2.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		...
		bodyb1.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		bodyb2.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarmt.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarmt.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		...
		seg4.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		seg5.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		seg6.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		seg7.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		seg8.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		seg9.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		seg10.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		seg11.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		seg12.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		seg13.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarmm.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarmm.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		...
		leftarmspike3.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarmspike3.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		rightarmspike4.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		leftarmspike4.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		seg14.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		seg15.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		seg16.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		seg17.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		seg18.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
	}
}