...
public class ModelTwins<S extends TwinsRenderState> extends EntityModel<S> {
    ...
    public ModelTwins(ModelPart root) {
        super(root);
    ...
    public void setupAnim(S state) {
        ...
        if(state.abilityCoolDown < 11) {
            float f = (float)((state.isFast ? 1 : -1) * (Math.PI / 20.));
