...
public class ModelLadyLuna<S extends LivingEntityRenderState> extends EntityModel<S> {
    ...
    public ModelLadyLuna(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition rightleg = root.addOrReplaceChild("rightleg", CubeListBuilder.create().texOffs(132, 22).mirror().addBox(1.0F, 18.0F, -7.0F, 2.0F, 2.0F, 8.0F, cubedef).mirror(false)
        ...
        PartDefinition leftleg = root.addOrReplaceChild("leftleg", CubeListBuilder.create().texOffs(172, 1).mirror().addBox(-2.0F, -2.0681F, -2.4824F, 4.0F, 4.0F, 4.0F, cubedef).mirror(false)
        ...
        root.addOrReplaceChild("leftarm", CubeListBuilder.create().texOffs(111, 3).mirror().addBox(-1.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, cubedef).mirror(false)
        ...
        root.addOrReplaceChild("rightarm", CubeListBuilder.create().texOffs(236, 9).mirror().addBox(-1.0F, 10.0F, -1.0F, 2.0F, 8.0F, 2.0F, cubedef).mirror(false)
        ...
        PartDefinition body1 = root.addOrReplaceChild("body1", CubeListBuilder.create().texOffs(116, 13).mirror().addBox(-5.0F, 3.0F, 7.0F, 1.0F, 9.0F, 4.0F, cubedef).mirror(false)
        ...
        PartDefinition body = root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(100, 12).mirror().addBox(-2.0F, -4.0F, -1.0F, 6.0F, 9.0F, 2.0F, cubedef).mirror(false)
        ...
        PartDefinition head = root.addOrReplaceChild("head", CubeListBuilder.create().texOffs(3, 8).mirror().addBox(-2.0F, -3.9136F, -1.8389F, 4.0F, 5.0F, 2.0F, cubedef).mirror(false)
    ...
    public void setupAnim(S state) {
        ...
        this.leftarm.xRot = Mth.cos(state.walkAnimationPos * 0.6662F) * 2.0F * state.walkAnimationSpeed * 0.5F + 0.1047198F;
