...
public class ModelWreckForm1<T extends Entity> extends SegmentedModel<T>
{
    //fields
    ModelRenderer part1;
    ModelRenderer part2;
    ...
    public void setupAnim(T entity, float f, float f1, float f2, float f3, float f4) {
        ...
        this.leftarm4.xRot = MathHelper.cos(f * 0.6662F) * 2.0F * f1 * 0.5F-1.308997F;
        this.leftarm5.xRot = MathHelper.cos(f * 0.6662F) * 2.0F * f1 * 0.5F-1.308997F;
        this.leftarm6.xRot = MathHelper.cos(f * 0.6662F) * 2.0F * f1 * 0.5F + 0.4363323F;
        this.leftarm7.xRot = MathHelper.cos(f * 0.6662F) * 2.0F * f1 * 0.5F + 0.4363323F;
    }

    @Override
    public Iterable<ModelRenderer> parts() {
        return ImmutableList.of(part1, part2, leftarm1, leftarm2, rightleg1, leftleg1, rightarm1, rightarm2, rightarm3, rightarm4,
                rightarm5, rightarm6, leftarm3, leftarm4, leftarm5, leftarm6, leftarm7, rightarm7, rightarm8, rightarm9, part3,
                part4, part5, rightleg2, rightleg3, leftleg2, rightleg4, leftleg3, rightleg5, leftleg4, leftleg5, rightleg6,
                leftleg6, rightleg7, leftleg7, rightleg8, leftleg8, part6, part7);
    }
