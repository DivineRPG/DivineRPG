...
public class ModelExperiencedCori extends EntityModel<EntityExperiencedCori> {
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		...
		Tentacle23.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle24.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle25.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle26.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle27.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle28.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle29.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle30.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		...
		Tentacle33.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle34.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle35.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle36.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle37.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle38.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle39.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle40.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle41.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle42.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle43.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle44.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle45.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle46.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle47.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		Tentacle48.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
	}
}