...
public class ModelDensos<E extends EntityDensos> extends EntityModel<EntityDensos> {
	...
	public ModelDensos(Context context) {
	...
	@Override
	public void setupAnim(EntityDensos entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
