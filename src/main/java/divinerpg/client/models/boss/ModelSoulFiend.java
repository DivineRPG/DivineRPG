...
public class ModelSoulFiend extends EntityModel<EntitySoulFiend> {
	...
	public ModelSoulFiend(Context context) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(16, 16).mirror().addBox(4.0F, -2.0F, -2.0F, 8.0F, 12.0F, 4.0F, cubedef).mirror(false)
		...
		partdefinition.addOrReplaceChild("rightleg", CubeListBuilder.create().texOffs(0, 16).mirror().addBox(-3.0F, 9.0F, -3.0F, 6.0F, 3.0F, 6.0F, cubedef).mirror(false)
		...
		partdefinition.addOrReplaceChild("leftleg", CubeListBuilder.create().texOffs(0, 16).mirror().addBox(-3.0F, 9.0F, -3.0F, 6.0F, 3.0F, 6.0F, cubedef).mirror(false)
		.texOffs(0, 16).mirror().addBox(-2.0F, -0.2F, -2.0F, 4.0F, 12.0F, 4.0F, cubedef).mirror(false)
		.texOffs(0, 16).mirror().addBox(-3.0F, -4.0F, -3.0F, 6.0F, 5.0F, 6.0F, cubedef).mirror(false), PartPose.offset(4.0F, 12.0F, 0.0F));

		partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(8, 0).mirror().addBox(-8.0F, -3.0F, -9.0F, 2.0F, 2.0F, 5.0F, cubedef).mirror(false)
		...
		partdefinition.addOrReplaceChild("leftarm", CubeListBuilder.create().texOffs(40, 3).mirror().addBox(-1.0F, -2.0F, -2.0F, 4.0F, 20.0F, 4.0F, cubedef).mirror(false), PartPose.offset(8.0F, 2.0F, 0.0F));

		partdefinition.addOrReplaceChild("rightarm", CubeListBuilder.create().texOffs(40, 3).mirror().addBox(-3.0F, -2.0F, -2.0F, 4.0F, 20.0F, 4.0F, cubedef).mirror(false), PartPose.offset(-8.0F, 2.0F, 0.0F));

		PartDefinition back = partdefinition.addOrReplaceChild("back", CubeListBuilder.create().texOffs(8, 0).mirror().addBox(-5.0F, 0.0F, 3.0F, 5.0F, 2.0F, 2.0F, cubedef).mirror(false)
