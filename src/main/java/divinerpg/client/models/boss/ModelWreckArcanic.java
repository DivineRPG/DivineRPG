...
public class ModelWreckArcanic extends EntityModel<EntityWreck> {
	public static final ModelLayerLocation LAYER_LOCATION = createLocation("wreck_arcanic");
	private final ModelPart head, rightleg, body, leftleg, rightarm, leftarm;
	public ModelWreckArcanic(Context context) {
