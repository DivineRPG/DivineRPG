...
public class ModelDungeonConstructor<E extends EntityDivineMonster> extends EntityModel<EntityDungeonConstructor> {
    ...
    @Override
    public void setupAnim(EntityDungeonConstructor entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
