...
public class ModelDungeonDemon<T extends Entity> extends SegmentedModel<T> 
{
    ...
    public ModelDungeonDemon()
    {
        ...
        backplate.setPos(0F, 5F, 0F);
        backplate.setTexSize(64, 32);
	...
	public void setupAnim(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks,
        ...
        this.rightarm.yRot += MathHelper.cos(ageInTicks * 0.09F) * 0.05F + 0.05F;
        this.leftarm.yRot -= MathHelper.cos(ageInTicks * 0.09F) * 0.05F + 0.05F;
