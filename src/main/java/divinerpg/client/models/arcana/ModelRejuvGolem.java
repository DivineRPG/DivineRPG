...
public class ModelRejuvGolem<T extends Entity> extends SegmentedModel<T> 
{
	...
	public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks,
        ...
        this.rightarm.rotateAngleX = this.rightshoulder.rotateAngleX = MathHelper.cos(limbSwing)*limbSwingAmount*0.75f - 0.6981317F;
        this.leftarm.rotateAngleX = this.leftshoulder.rotateAngleX = MathHelper.cos(limbSwing + (float)Math.PI)*limbSwingAmount*0.75f - 0.6981317F;
	}
}
