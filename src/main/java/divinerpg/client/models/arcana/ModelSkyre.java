...
public class ModelSkyre<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(24, 28).addBox(1.0F, 1.0F, -8.0F, 0.0F, 11.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(5.0F, 12.0F, -1.0F));

		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(0, 47).addBox(-1.0F, 1.0F, -8.0F, 0.0F, 11.0F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(10, 35).addBox(-2.0F, -2.0F, -2.0F, 2.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 12.0F, -1.0F));
