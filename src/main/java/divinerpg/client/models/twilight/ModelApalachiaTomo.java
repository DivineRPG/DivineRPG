...
public class ModelApalachiaTomo extends EntityModel<EntityApalachiaTomo> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		Torso.addOrReplaceChild("RightAntenna", CubeListBuilder.create().texOffs(37, 37).addBox(-1.5F, -6.5F, -3, 3, 3, 3, new CubeDeformation(0))
		.texOffs(28, 32).addBox(-1.5F, -5, -1.5F, 3, 5, 3, new CubeDeformation(0))
		.texOffs(38, 20).addBox(-2, -7, -2.5F, 4, 4, 2, new CubeDeformation(0)), PartPose.offsetAndRotation(-2.5F, -6, 0, .0873F, .1745F, 0));
		Torso.addOrReplaceChild("LeftAntenna", CubeListBuilder.create().texOffs(37, 29).addBox(-1.5F, -6.5F, -3, 3, 3, 3, new CubeDeformation(0))
		.texOffs(16, 32).addBox(-1.5F, -5, -1.5F, 3, 5, 3, new CubeDeformation(0))
		.texOffs(0, 36).addBox(-2, -7, -2.5F, 4, 4, 2, new CubeDeformation(0)), PartPose.offsetAndRotation(2.5F, -6, 0, .0873F, -.1745F, 0));
	...
	@Override public void setupAnim(EntityApalachiaTomo entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
