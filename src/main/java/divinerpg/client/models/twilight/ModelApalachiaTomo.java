...
public class ModelApalachiaTomo<T extends Entity> extends EntityModel<T> {
	...
	public ModelApalachiaTomo(Context context) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		Torso.addOrReplaceChild("RightAntenna", CubeListBuilder.create().texOffs(37, 37).addBox(-1.5F, -6.5F, -3.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(28, 32).addBox(-1.5F, -5.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(38, 20).addBox(-2.0F, -7.0F, -2.5F, 4.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.5F, -6.0F, 0.0F, 0.0873F, 0.1745F, 0.0F));

		Torso.addOrReplaceChild("LeftAntenna", CubeListBuilder.create().texOffs(37, 29).addBox(-1.5F, -6.5F, -3.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(16, 32).addBox(-1.5F, -5.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(0, 36).addBox(-2.0F, -7.0F, -2.5F, 4.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5F, -6.0F, 0.0F, 0.0873F, -0.1745F, 0.0F));
