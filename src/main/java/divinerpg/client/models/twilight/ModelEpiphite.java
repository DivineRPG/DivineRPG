...
public class ModelEpiphite<T extends Entity> extends EntityModel<T> {
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
		...
		foot4.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		body.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		neck.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike1.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike2.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike3.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike4.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike5.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike6.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike7.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike8.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike9.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike10.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		head.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike11.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike12.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike13.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike14.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike15.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike16.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike17.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike18.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		...
		spike19.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike20.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		spike21.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		...
		side5.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		side6.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		side7.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
		side8.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
