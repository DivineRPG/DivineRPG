...
public class ModelGlinthop extends EntityModel<EntityGlinthop> {
	...
	private final ModelPart Spine, LeftWhisker, RightWhisker, FrontRightLeg, BackRightLeg, FrontLeftLeg, BackLeftLeg, Head;

	public ModelGlinthop(EntityRendererProvider.Context context) {
		ModelPart root = context.bakeLayer(LAYER_LOCATION);
		this.Spine = root.getChild("Spine");
		this.LeftWhisker = root.getChild("LeftWhisker");
		this.RightWhisker = root.getChild("RightWhisker");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition FrontRightLeg = partdefinition.addOrReplaceChild("FrontRightLeg", CubeListBuilder.create().texOffs(31, 6).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, 18.25F, -2.0F));
		...
		.texOffs(14, 31).addBox(-2.0F, 2.0F, 0.5F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 16.25F, 4.0F));

		PartDefinition FrontLeftLeg = partdefinition.addOrReplaceChild("FrontLeftLeg", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, 18.25F, -2.0F));
		...
		.texOffs(33, 0).addBox(0.0F, 2.0F, 0.5F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(1.0F, 16.25F, 4.0F));
		...
		.texOffs(20, 23).addBox(-2.5F, -2.0F, -4.0F, 5.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 14.75F, -6.0F));
		...
		PartDefinition LeftWhisker = partdefinition.addOrReplaceChild("LeftWhisker", CubeListBuilder.create().texOffs(9, 27).addBox(0.5F, -2.0F, 0.0F, 3.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(1.5F, 15.0F, -7.0F));

		PartDefinition RightWhisker = partdefinition.addOrReplaceChild("RightWhisker", CubeListBuilder.create().texOffs(24, 19).addBox(-3.5F, -2.0F, 0.0F, 3.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.5F, 15.0F, -7.0F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		...
		LeftWhisker.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
		RightWhisker.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
