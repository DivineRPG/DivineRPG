...
public class ModelMoonWolf<T extends Entity> extends SegmentedModel<T> {
    ...
    public void setLivingAnimations(LivingEntity entity, float var2, float var3, float var4) {
        //TODO - Moonwolf amination
...
//        }
//
//        this.WolfHead.rotateAngleZ = moonWolf.getShakeAngle(var4, 0.0F);
//        this.Mane.rotateAngleZ = moonWolf.getShakeAngle(var4, -0.08F);
//        this.Body.rotateAngleZ = moonWolf.getShakeAngle(var4, -0.16F);
//
//        if (moonWolf.getWolfShaking()) {
//            float var6 = moonWolf.getBrightness() * moonWolf.getShadingWhileShaking(var4);
