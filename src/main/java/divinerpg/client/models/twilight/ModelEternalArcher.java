...
public class ModelEternalArcher<T extends Entity> extends SegmentedModel<T> {
    ...
    public ModelEternalArcher() {
        ...
        armRight1.setRotationPoint(-21F, -1F, 0F);
        armRight1.setTextureSize(128, 32);
        ...
        armLeft1.setRotationPoint(21F, -1F, 0F);
        armLeft1.setTextureSize(128, 32);
        ...
        armRight2.setRotationPoint(-7F, 5F, 0F);
        armRight2.setTextureSize(128, 32);
        ...
        armLeft2.setRotationPoint(7F, 5F, 0F);
        armLeft2.setTextureSize(128, 32);
        ...
        armLeft3.setRotationPoint(14F, 2F, 0F);
        armLeft3.setTextureSize(128, 32);
        ...
        armRight3.setRotationPoint(-14F, 2F, 0F);
        armRight3.setTextureSize(128, 32);
    ...
    public void setRotationAngles(T entity, float f, float f1, float f2, float f3, float f4) {
        ...
        armRight1.rotateAngleX = 0;
        armRight2.rotateAngleX = 0;
        armRight3.rotateAngleX = 0;

        armLeft1.rotateAngleX = 0;
        armLeft2.rotateAngleX = 0;
        armLeft3.rotateAngleX = 0;
