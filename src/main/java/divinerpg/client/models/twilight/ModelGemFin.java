...
public class ModelGemFin extends EntityModel<EntityGemFin> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition TailFin = partdefinition.addOrReplaceChild("TailFin", CubeListBuilder.create().texOffs(0, 15).addBox(0.0F, -4.0F, 0.0F, 0.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 20.0F, 4.0F));
