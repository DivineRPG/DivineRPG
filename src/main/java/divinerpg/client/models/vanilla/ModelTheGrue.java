...
public class ModelTheGrue extends EntityModel<EntityTheGrue> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition legRight = partdefinition.addOrReplaceChild("legRight", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(4.0F, 4.0F, 6.0F, 3.0F, 10.0F, 3.0F, cubedef).mirror(false), PartPose.offsetAndRotation(-5.0F, 6.0F, 4.0F, -0.3718F, 0.0F, 0.2231F));
		...
		PartDefinition legLeft = partdefinition.addOrReplaceChild("legLeft", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-6.0F, 4.0F, 7.0F, 3.0F, 10.0F, 3.0F, cubedef).mirror(false), PartPose.offsetAndRotation(8.0F, 6.0F, 4.0F, -0.409F, 0.0F, -0.2231F));
		...
		partdefinition.addOrReplaceChild("thighRight", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 11.0F, 4.0F, cubedef).mirror(false), PartPose.offsetAndRotation(-5.0F, 6.0F, 4.0F, 0.6146F, 0.0F, -0.409F));

		partdefinition.addOrReplaceChild("thighLeft", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 11.0F, 4.0F, cubedef).mirror(false), PartPose.offsetAndRotation(8.0F, 6.0F, 4.0F, 0.6146F, 0.0F, 0.409F));

		partdefinition.addOrReplaceChild("torso", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(0.0F, 0.0F, 0.0F, 12.0F, 6.0F, 4.0F, cubedef).mirror(false), PartPose.offsetAndRotation(-5.0F, 1.0F, 3.0F, -0.2231F, 0.0F, 0.0F));

		partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(0.0F, 0.0F, 0.0F, 8.0F, 9.0F, 10.0F, cubedef).mirror(false), PartPose.offsetAndRotation(-3.0F, -5.3333F, 0.0F, -0.0744F, 0.0F, 0.0F));

		partdefinition.addOrReplaceChild("Shape6", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(0.0F, 0.0F, 0.0F, 6.0F, 8.0F, 8.0F, cubedef).mirror(false), PartPose.offsetAndRotation(-2.0F, -2.0F, -7.0F, 0.3718F, 0.0F, 0.0F));
		...
		partdefinition.addOrReplaceChild("tail3", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(0.0F, 0.0F, 0.0F, 2.0F, 2.0F, 2.0F, cubedef).mirror(false), PartPose.offsetAndRotation(0.0F, 1.0F, 17.0F, 0.7808F, 0.0F, 0.0F));

		partdefinition.addOrReplaceChild("tail2", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(0.0F, 0.0F, 0.0F, 4.0F, 4.0F, 4.0F, cubedef).mirror(false), PartPose.offsetAndRotation(-1.0F, 1.0F, 13.0F, 1.041F, 0.0F, 0.0F));

		partdefinition.addOrReplaceChild("mouth", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(0.0F, 0.0F, 0.0F, 8.0F, 2.0F, 6.0F, cubedef).mirror(false), PartPose.offsetAndRotation(-3.0F, 8.0F, -9.4667F, 0.6692F, 0.0F, 0.0F));

		partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(0.0F, 0.0F, 0.0F, 8.0F, 7.0F, 11.0F, cubedef).mirror(false), PartPose.offsetAndRotation(-3.0F, 1.0F, -17.0F, 0.3346F, 0.0F, 0.0F));
