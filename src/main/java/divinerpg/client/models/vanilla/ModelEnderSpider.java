...
import net.minecraft.client.model.EntityModel; // Changed from SpiderModel
...
public class ModelEnderSpider extends EntityModel<LivingEntityRenderState> {
    public static final ModelLayerLocation LAYER_LOCATION = createLocation("ender_spider");
    public final ModelPart body, head, rightMandible, leftMandible, thorax, rightFrontLeg, leftFrontLeg, rightMiddleFrontLeg, leftMiddleFrontLeg, rightMiddleHindLeg, leftMiddleHindLeg, rightHindLeg, leftHindLeg;
    ...
    public ModelEnderSpider(ModelPart root) {
        ...
        this.rightMiddleFrontLeg = body.getChild("right_middle_front_leg");
        this.leftMiddleFrontLeg = body.getChild("left_middle_front_leg");
        this.rightMiddleHindLeg = body.getChild("right_middle_hind_leg");
        this.leftMiddleHindLeg = body.getChild("left_middle_hind_leg");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-3, 12, -3, 6, 6, 6, new CubeDeformation(.01F)), PartPose.ZERO);
        PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(32, 4).addBox(-4, -4, -8, 8, 8, 8, cubeDef), PartPose.offset(0, 15, -3));
        head.addOrReplaceChild("right_mandible", CubeListBuilder.create().texOffs(24, 7).addBox(-1, -1, -1, 2, 4, 1, cubeDef), PartPose.offset(-2, 3, -8));
        ...
        body.addOrReplaceChild("thorax", CubeListBuilder.create().texOffs(0, 12).addBox(-5, -4, 0, 10, 8, 12, cubeDef)
                .texOffs(8, 40).addBox(-4, -7, 2, 8, 3, 8, cubeDef), PartPose.offset(0, 15, 3));

        PartDefinition rightFrontLeg = body.addOrReplaceChild("right_front_leg", CubeListBuilder.create(), PartPose.offset(-4, 15, -1));
        ...
        PartDefinition leftFrontLeg = body.addOrReplaceChild("left_front_leg", CubeListBuilder.create(), PartPose.offset(4, 15, -1));
        ...
        PartDefinition rightMiddleFrontLeg = body.addOrReplaceChild("right_middle_front_leg", CubeListBuilder.create(), PartPose.offset(-4, 15, 0));
        ...
        PartDefinition leftMiddleFrontLeg = body.addOrReplaceChild("left_middle_front_leg", CubeListBuilder.create(), PartPose.offset(4, 15, 0));
        ...
        PartDefinition rightMiddleHindLeg = body.addOrReplaceChild("right_middle_hind_leg", CubeListBuilder.create(), PartPose.offset(-4, 15, 1));
        ...
        PartDefinition leftMiddleHindLeg = body.addOrReplaceChild("left_middle_hind_leg", CubeListBuilder.create(), PartPose.offset(4, 15, 1));
        ...
        PartDefinition rightHindLeg = body.addOrReplaceChild("right_hind_leg", CubeListBuilder.create(), PartPose.offset(-4, 15, 2));
        ...
        PartDefinition leftHindLeg = body.addOrReplaceChild("left_hind_leg", CubeListBuilder.create(), PartPose.offset(4, 15, 2));
    ...
    public void setupAnim(LivingEntityRenderState state) {
        ...
        float f1 = -Mth.cos(f * 2.0F) * 0.4F * limbSwingAmount;
        float f2 = Mth.sin(f * 2.0F) * 0.4F * limbSwingAmount;
        float f3 = Math.abs(Mth.sin(f) * 0.4F) * limbSwingAmount;
        float f4 = Math.abs(Mth.cos(f) * 0.4F) * limbSwingAmount;

        thorax.xRot = Mth.cos(limbSwing * 0.6662F) * 0.25F * limbSwingAmount;
        ...
        // Hind legs
        rightHindLeg.yRot = f1 + Mth.PI / 4.0F;
        leftHindLeg.yRot = -rightHindLeg.yRot;
        rightHindLeg.zRot = f3 - Mth.PI / 4.0F;
