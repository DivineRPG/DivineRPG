...
@OnlyIn(Dist.CLIENT)
public class ModelJungleBat extends SegmentedModel<EntityJungleBat> {
    ...
    public void setRotationAngles(EntityJungleBat entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
