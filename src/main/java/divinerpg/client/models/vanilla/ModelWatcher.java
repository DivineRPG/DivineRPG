...
public class ModelWatcher extends EntityModel<Mob> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Jaw = partdefinition.addOrReplaceChild("Jaw", CubeListBuilder.create(), PartPose.offset(0.0F, 21.7F, 4.0F));
		...
		Tentacle11.addOrReplaceChild("Tentacle11_r1", CubeListBuilder.create().texOffs(40, 0).mirror().addBox(8.0F, -9.0F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-5.0F, 8.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		Tentacle12.addOrReplaceChild("Tentacle12_r1", CubeListBuilder.create().texOffs(40, 6).mirror().addBox(5.0F, -9.0F, -1.0F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-9.0F, 8.0F, 0.0F, 0.0F, 0.0F, 0.0F));
		...
		Tentacle21.addOrReplaceChild("Tentacle21_r1", CubeListBuilder.create().texOffs(40, 0).mirror().addBox(-10.0F, -9.0F, 0.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(5.0F, 8.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		Tentacle22.addOrReplaceChild("Tentacle22_r1", CubeListBuilder.create().texOffs(40, 6).mirror().addBox(-10.0F, -9.0F, -1.0F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(9.0F, 8.0F, 0.0F, 0.0F, 0.0F, 0.0F));
