...
public class ModelPumpkinSpider<T extends EntityPumpkinSpider> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition.addOrReplaceChild("Thorax", CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -11.0F, 2.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
