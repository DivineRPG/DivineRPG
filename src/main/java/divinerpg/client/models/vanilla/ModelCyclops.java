...
public class ModelCyclops<T extends LivingEntity> extends AgeableModel<T> implements IHasArm, IHasHead {
    ...
    public ModelCyclops(float p_i1148_1_) {
        this(RenderType::entityCutoutNoCull, p_i1148_1_, 0.0F, 64, 32);
    }

    protected ModelCyclops(float p_i1149_1_, float p_i1149_2_, int p_i1149_3_, int p_i1149_4_) {
        this(RenderType::entityCutoutNoCull, p_i1149_1_, p_i1149_2_, p_i1149_3_, p_i1149_4_);
    }

    public ModelCyclops(Function<ResourceLocation, RenderType> p_i225946_1_, float p_i225946_2_, float p_i225946_3_, int p_i225946_4_, int p_i225946_5_) {
