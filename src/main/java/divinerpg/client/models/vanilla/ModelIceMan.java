...
@OnlyIn(Dist.CLIENT)
public class ModelIceMan<T extends Entity> extends SegmentedModel<T> {
    ModelRenderer head;
    ModelRenderer body;
    ...
    public void setupAnim(T entityIn, float var1, float var2, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.legLB.xRot = MathHelper.cos(var1 * 0.6662F + (float) Math.PI) * 1.4F * var2;
        this.legLBT.xRot = MathHelper.cos(var1 * 0.6662F + (float) Math.PI) * 1.4F * var2;
        this.legLM.xRot = MathHelper.cos(var1 * 0.6662F + (float) Math.PI) * 1.4F * var2;
        this.legLMT.xRot = MathHelper.cos(var1 * 0.6662F + (float) Math.PI) * 1.4F * var2;
        this.legLF.xRot = MathHelper.cos(var1 * 0.6662F + (float) Math.PI) * 1.4F * var2;
        this.legLFT.xRot = MathHelper.cos(var1 * 0.6662F + (float) Math.PI) * 1.4F * var2;
    }

    @Override
    public Iterable<ModelRenderer> parts() {
        return ImmutableList.of(head, body, legRBT, legLBT, legRFT, legLFT, udders, legRMT, legLMT, legLF, legRF, legLM, legLB, legRM, legRB, body1,
                body2, body3, body4, body5, body7, body6, body8, body9, body10, body11, body12, body13, body14, body15, body16, body17, body18, body19,
                body20, body21, body22, body23, body24, body25, body26);
    }
