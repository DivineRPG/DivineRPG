...
public class ModelRotatick<T extends Entity> extends SegmentedModel<T> {
    ...
    public Iterable<ModelRenderer> getParts() {
        return ImmutableList.of(Box8, Body, LegRBT, LegLBT, LegRFT, LegLFT, LegRMT, LegLMT, LegRF, LegLF, LegLM, LegLB, LegRM, LegRB, LegRFB, LegLFB, LegRMB, LegRBB,
                LegLMB, LegLBB, LegLFC, LegLMC, LegLBC, LegRBC, LegRMC, LegRFC, Box1, Box2, Box3, Box4, Box5, Box6, Box7, Box9, Head, Box10);
    }
