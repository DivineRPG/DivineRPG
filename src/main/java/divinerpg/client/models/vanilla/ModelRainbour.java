...
public class ModelRainbour extends EntityModel<EntityRainbour> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition.addOrReplaceChild("lwing1", CubeListBuilder.create().texOffs(0, 18).mirror().addBox(0.0F, 0.0F, -2.0F, 9.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.0F, 12.0F, -3.0F, 0.0F, -0.3665F, 0.0F));
		...
		.texOffs(0, 27).mirror().addBox(-3.0F, -2.0F, -5.0F, 6.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 13.0F, -5.0F));
		...
		partdefinition.addOrReplaceChild("lwing2", CubeListBuilder.create().texOffs(0, 39).mirror().addBox(4.0F, 0.0F, 0.0F, 8.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.0F, 12.0F, -3.0F, 0.0F, 0.192F, 0.0F));

		partdefinition.addOrReplaceChild("lwing3", CubeListBuilder.create().texOffs(0, 50).mirror().addBox(11.0F, 0.0F, -5.0F, 14.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.0F, 12.0F, -3.0F, 0.0F, -0.2618F, 0.0F));

		partdefinition.addOrReplaceChild("rwing1", CubeListBuilder.create().texOffs(33, 18).mirror().addBox(-9.0F, 0.0F, -2.0F, 9.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.0F, 12.0F, -3.0F, 0.0F, 0.3665F, 0.0F));

		partdefinition.addOrReplaceChild("rwing2", CubeListBuilder.create().texOffs(38, 28).mirror().addBox(-12.0F, 0.0F, 0.0F, 8.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.0F, 12.0F, -3.0F, 0.0F, -0.192F, 0.0F));

		partdefinition.addOrReplaceChild("rwing3", CubeListBuilder.create().texOffs(66, 15).mirror().addBox(-25.0F, 0.0F, -5.0F, 14.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.0F, 12.0F, -3.0F, 0.0F, 0.2618F, 0.0F));

		PartDefinition lhip = partdefinition.addOrReplaceChild("lhip", CubeListBuilder.create().texOffs(73, 28).mirror().addBox(-1.5F, 0.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.0F, 15.0F, 2.0F, -0.2269F, 0.0F, 0.0F));
		...
		PartDefinition rhip = partdefinition.addOrReplaceChild("rhip", CubeListBuilder.create().texOffs(86, 28).mirror().addBox(-1.5F, 0.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.0F, 15.0F, 2.0F, -0.2269F, 0.0F, 0.0F));
