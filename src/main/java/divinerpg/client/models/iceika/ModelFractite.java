...
public class ModelFractite<T extends Entity> extends SegmentedModel<T> {
    ...
    public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.shard1.rotateAngleX = MathHelper.cos(netHeadYaw * 0.1F) * (float)Math.PI;
        this.shard2.rotateAngleX = MathHelper.cos(netHeadYaw * 0.1F) * (float)Math.PI;
        this.shard3.rotateAngleX = MathHelper.cos(netHeadYaw * 0.1F) * (float)Math.PI;
        this.shard4.rotateAngleX = MathHelper.cos(netHeadYaw * 0.1F) * (float)Math.PI;
        this.shard5.rotateAngleX = MathHelper.cos(netHeadYaw * 0.1F) * (float)Math.PI;
        this.shard6.rotateAngleX = MathHelper.cos(netHeadYaw * 0.1F) * (float)Math.PI;
        this.shard7.rotateAngleX = MathHelper.cos(netHeadYaw * 0.1F) * (float)Math.PI;
        this.shard8.rotateAngleX = MathHelper.cos(netHeadYaw * 0.1F) * (float)Math.PI;
    }
