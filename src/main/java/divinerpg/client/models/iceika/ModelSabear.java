...
public class ModelSabear<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition FrontLeftLeg = partdefinition.addOrReplaceChild("FrontLeftLeg", CubeListBuilder.create().texOffs(22, 49).addBox(-2.0F, -1.0F, -4.0F, 5.0F, 11.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, 14.0F, -4.0F));

		PartDefinition RearLeftLeg = partdefinition.addOrReplaceChild("RearLeftLeg", CubeListBuilder.create().texOffs(48, 18).addBox(-2.5F, 0.5F, -4.0F, 5.0F, 11.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(4.5F, 12.5F, 12.0F));

		PartDefinition RearRightLeg = partdefinition.addOrReplaceChild("RearRightLeg", CubeListBuilder.create().texOffs(44, 41).addBox(-2.5F, 0.5F, -4.0F, 5.0F, 11.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.5F, 12.5F, 12.0F));

		PartDefinition FrontRightLeg = partdefinition.addOrReplaceChild("FrontRightLeg", CubeListBuilder.create().texOffs(0, 49).addBox(-2.5F, -1.5F, -3.0F, 5.0F, 11.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.5F, 14.5F, -5.0F));

		PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 67).addBox(-3.0F, 3.25F, -13.8333F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 26).addBox(-7.0F, -22.0F, -8.0F, 14.0F, 11.0F, 12.0F, new CubeDeformation(0.0F))
