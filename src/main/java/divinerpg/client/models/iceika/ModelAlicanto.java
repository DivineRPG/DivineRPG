...
public class ModelAlicanto<T extends Entity> extends SegmentedModel<T> {
    ...
    public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        wing1.rotateAngleZ = MathHelper.cos(f) * 16.0F * ((float)Math.PI / 180F);
        wing1slide1.rotateAngleZ = MathHelper.cos(f) * 16.0F * ((float)Math.PI / 180F);
        wing1slide2.rotateAngleZ = MathHelper.cos(f) * 16.0F * ((float)Math.PI / 180F);
        wing1slide3.rotateAngleZ = MathHelper.cos(f) * 16.0F * ((float)Math.PI / 180F);

        wing2.rotateAngleZ = -wing1.rotateAngleZ;
        wing2slide1.rotateAngleZ = -wing1.rotateAngleZ;
        wing2slide2.rotateAngleZ = -wing1.rotateAngleZ;
        wing2slide3.rotateAngleZ = -wing1.rotateAngleZ;
    }
