...
public class ModelWorkshop<T extends Entity> extends EntityModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = createLocation("workshop");
	...
	public ModelWorkshop(EntityRendererProvider.Context context) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, -7.0F, 0.0F));
		...
		partdefinition.addOrReplaceChild("rightarmtop", CubeListBuilder.create().texOffs(37, 16).mirror().addBox(-6.0F, -3.0F, -2.0F, 8.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-6.0F, -5.0F, -1.0F));
