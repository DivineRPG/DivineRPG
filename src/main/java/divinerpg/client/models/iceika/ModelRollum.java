...
@OnlyIn(Dist.CLIENT)
public class ModelRollum<T extends Entity> extends SegmentedModel<T> {
    //fields
    ModelRenderer head;
    ...
    public void setupAnim(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.rightarmext.xRot = MathHelper.cos(-(limbSwing * 0.6662F + (float)Math.PI)) * 2.0F * limbSwingAmount * 0.5F;
        this.leftarmext.xRot = MathHelper.cos(-(limbSwing * 0.6662F)) * 2.0F * limbSwingAmount * 0.5F;
    ...
    public Iterable<ModelRenderer> parts() {
        return ImmutableList.of(head, connector, rightarmtop, rightlegbottom, rightleg, leftlegbottom, leftleg, rightarm, rightarmext, leftarmtop, leftarm, leftarmext, body);
    }
