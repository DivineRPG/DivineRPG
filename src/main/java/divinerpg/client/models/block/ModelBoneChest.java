...
public class ModelBoneChest<T extends Entity> extends Model {
	public static final ModelLayerLocation LAYER_LOCATION = createLocation("bone_chest");
	private final ModelPart storage;
	public final ModelPart lid;
	public final ModelPart handle;

	public ModelBoneChest(ModelPart root) {
