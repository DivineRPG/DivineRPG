...
import divinerpg.client.containers.slot.FuelSlot;
...
public abstract class DivineFurnaceContainer extends RecipeBookMenu<Container> {
...
//    private static final int USE_ROW_SLOT_END = 39;
    ...
    protected DivineFurnaceContainer(MenuType<?> p_38960_, RecipeType<? extends AbstractCookingRecipe> p_38961_, RecipeBookType p_38962_, int p_38963_, Inventory p_38964_) {
        this(p_38960_, p_38961_, p_38962_, p_38963_, p_38964_, new SimpleContainer(3), new SimpleContainerData(4));
    }

    protected DivineFurnaceContainer(MenuType<?> p_38966_, RecipeType<? extends AbstractCookingRecipe> p_38967_, RecipeBookType p_38968_, int p_38969_, Inventory inventory, Container container, ContainerData p_38972_) {
        ...
        addSlot(new FurnaceResultSlot(inventory.player, DivineFurnaceContainer.this.container, 2, 116, 35){
            @Override
