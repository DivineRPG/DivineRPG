...
public class MoltenFurnaceScreen extends AbstractFurnaceScreen<MoltenFurnaceContainer> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(DivineRPG.MODID, "textures/gui/molten_furnace.png");

    public MoltenFurnaceScreen(MoltenFurnaceContainer p_i51089_1_, PlayerInventory p_i51089_2_, ITextComponent p_i51089_3_) {
