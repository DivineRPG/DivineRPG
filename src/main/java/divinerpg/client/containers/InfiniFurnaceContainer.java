...
public class InfiniFurnaceContainer extends RecipeBookMenu<Container> {
	private final Container container;
	private final ContainerData data;
	protected final Level level;
	public InfiniFurnaceContainer(MenuType<?> type, int i, Inventory inv) {
		this(type, i, inv, new SimpleContainer(2), new SimpleContainerData(2));
	}
	public InfiniFurnaceContainer(MenuType<?> type, int num, Inventory inv, Container container, ContainerData data) {
		super(type, num);
