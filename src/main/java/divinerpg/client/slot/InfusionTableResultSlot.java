...
public class InfusionTableResultSlot extends Slot {
    ...
    public InfusionTableResultSlot(Player player, InfusionTableMenu.InfusionInventory craftSlots, ResultContainer inventory, int p_i45790_4_, int p_i45790_5_, int p_i45790_6_) {
