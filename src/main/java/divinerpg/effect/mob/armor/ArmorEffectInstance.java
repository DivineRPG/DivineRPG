...
public class ArmorEffectInstance extends MobEffectInstance {
	public ArmorEffectInstance(Holder<MobEffect> effect, int amplifier) {super(effect, -1, amplifier, false, false);}
	...
	@Override public Set<EffectCure> getCures() {return noCures;}
