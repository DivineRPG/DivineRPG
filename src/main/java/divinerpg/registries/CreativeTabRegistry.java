...
public class CreativeTabRegistry {
    ...
    public static void creativeTab(BuildCreativeModeTabContentsEvent event) {
        ...
        if (event.getTab() == TOOLS.get()) {
            for (RegistryObject<Item> item : ItemRegistry.ITEMS.getEntries()) {
                if (item.get() instanceof ItemMeriksMissile || item.getId().toLanguageKey().contains("bullet") || item.getId().toLanguageKey().contains("bucket") || item.getId().toLanguageKey().contains("serenade") || item.get() instanceof ItemEnderScepter || item.get() instanceof ItemDivineAccumulator || item.get() instanceof ItemGhostbane || item.get() instanceof ItemStaffEnrichment || item.get() instanceof ItemGrenade || item.getId().toLanguageKey().contains("arrow") || item.get() instanceof ItemModThrowable || item.get() instanceof DivineShield || item.get() instanceof ItemDivineArmor || item.get() instanceof ItemModAxe || item.get() instanceof ItemModBow || item.get() instanceof ItemModHoe || item.get() instanceof ItemModPickaxe || item.get() instanceof ItemModRanged || item.get() instanceof ItemModShotgun || item.get() instanceof ItemModShovel || item.get() instanceof ItemModSword || item.get() instanceof ItemShickaxe || item.get() instanceof ItemArmorPouch || item.get() instanceof ItemVetheanDisk) {
                    event.accept(item.get());
                }
            }
        }
        if (event.getTab() == MISC.get()) {
            for (RegistryObject<Item> item : ItemRegistry.ITEMS.getEntries()) {
                if (!(item.get() instanceof ItemMeriksMissile || item.getId().toLanguageKey().contains("bullet") || item.getId().toLanguageKey().contains("bucket") || item.getId().toLanguageKey().contains("serenade") || item.get() instanceof ItemEnderScepter || item.get() instanceof ItemDivineAccumulator || item.get() instanceof ItemGhostbane || item.get() instanceof ItemStaffEnrichment || item.get() instanceof ItemGrenade || item.getId().toLanguageKey().contains("arrow") || item.get() instanceof ItemModThrowable || item.get() instanceof ItemNightmareBed || item.get() instanceof StandingAndWallBlockItem || item.get() instanceof DivineShield || item.get() instanceof ItemDivineArmor || item.get() instanceof ItemModAxe || item.get() instanceof ItemModBow || item.get() instanceof ItemModHoe || item.get() instanceof ItemModPickaxe || item.get() instanceof ItemModRanged || item.get() instanceof ItemModShotgun || item.get() instanceof ItemModShovel || item.get() instanceof ItemModSword || item.get() instanceof ItemShickaxe || item.get() instanceof ItemArmorPouch || item.get() instanceof ItemVetheanDisk)) {
                    event.accept(item.get());
                }
            }
        }
