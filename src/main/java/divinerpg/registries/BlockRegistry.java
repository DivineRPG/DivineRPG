...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block>
            ...
            cobaltitePressurePlate = registerBlock("cobaltite_pressure_plate", () -> new BlockModPressurePlate(Blocks.STONE_PRESSURE_PLATE, GLOW_LICHEN, BlockSetType.STONE)),
            ...
            streamleafLog = registerBlock("streamleaf_log", () -> new BlockModLog(COLOR_MAGENTA, SoundType.NETHER_WOOD)),
            streamleafWood = registerBlock("streamleaf_wood", () -> new BlockModLog(COLOR_MAGENTA, SoundType.NETHER_WOOD)),
            strippedStreamleafLog = registerBlock("stripped_streamleaf_log", () -> new BlockModLog(COLOR_MAGENTA, SoundType.NETHER_WOOD)),
            strippedStreamleafWood = registerBlock("stripped_streamleaf_wood", () -> new BlockModLog(COLOR_MAGENTA, SoundType.NETHER_WOOD)),
            streamleafPlanks = registerBlock("streamleaf_planks", () -> new BlockModPlanks(COLOR_MAGENTA, SoundType.NETHER_WOOD)),
            ...
            streamleafFence = registerBlock("streamleaf_fence", () -> new BlockModFence(COLOR_MAGENTA, SoundType.NETHER_WOOD)),
            ...
            polishedCobaltitePressurePlate = registerBlock("polished_cobaltite_pressure_plate", () -> new BlockModPressurePlate(Blocks.STONE_PRESSURE_PLATE, TERRACOTTA_LIGHT_BLUE, BlockSetType.STONE)),
            ...
            cutOxdritePressurePlate = registerBlock("cut_oxdrite_pressure_plate", () -> new BlockModPressurePlate(Blocks.STONE_PRESSURE_PLATE, TERRACOTTA_BROWN, BlockSetType.IRON)),
