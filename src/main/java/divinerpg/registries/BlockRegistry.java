...
public class BlockRegistry {
        ...
        //Grass Blocks
        frozenGrass = registerBlock("frozen_grass", () -> new BlockModGrass( () -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "frozen_dirt")), DIAMOND)),
        ...
        //Gravel
        frozenGravel = registerBlock("frozen_gravel", () -> new ColoredFallingBlock(new ColorRGBA(-8356741), Properties.ofFullCopy(Blocks.GRAVEL).mapColor(GLOW_LICHEN))),

        //Sand
        arcaniteSand = registerBlock("arcanite_sand", () -> new ColoredFallingBlock(new ColorRGBA(14406560), Properties.ofFullCopy(Blocks.SAND).mapColor(COLOR_LIGHT_BLUE))),
                arcanicSand = registerBlock("arcanic_sand", () -> new ColoredFallingBlock(new ColorRGBA(14406560), Properties.ofFullCopy(Blocks.SAND).mapColor(COLOR_CYAN))),
                arcanium_rich_sand = registerBlock("arcanium_rich_sand", () -> new ColoredFallingBlock(new ColorRGBA(14406560), Properties.ofFullCopy(Blocks.SAND).mapColor(COLOR_BLUE))),
                soulSludge = registerBlock("soul_sludge", () -> new BlockModUnbreakable(Properties.ofFullCopy(Blocks.SOUL_SAND).strength(-1F, 3600000F).mapColor(COLOR_GRAY))),
        ...
        //Ice
        glaciline = registerBlock("glaciline", () -> new BlockMod(Properties.ofFullCopy(Blocks.BLUE_ICE).mapColor(COLOR_LIGHT_BLUE).friction(0.992F))),
        ...
        milkStone = registerBlock("milk_stone", () -> new BlockMod(WOOL, 1.5F, 6F)),
                ...
                frozenStairs = registerBlock("frozen_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "frozen_stone")), 0, 0)),
                frozenSlab = registerBlock("frozen_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "frozen_stone")), 0, 0)),
                ...
                cobbledFrozenStone = registerBlock("cobbled_frozen_stone", () -> new BlockMod(GLOW_LICHEN, 2F, 6F)),
                cobbledFrozenStairs = registerBlock("cobbled_frozen_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "cobbled_frozen_stone")), 0, 0)),
                cobbledFrozenSlab = registerBlock("cobbled_frozen_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "cobbled_frozen_stone")), 0, 0)),
                cobbledFrozenWall = registerBlock("cobbled_frozen_wall", () -> new BlockModWall(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "cobbled_frozen_stone")))),
                ...
                cobaltite = registerBlock("cobaltite", () -> new BlockMod(COLOR_LIGHT_BLUE, 1.5F, 6F)),
                cobaltiteStairs = registerBlock("cobaltite_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "cobaltite")), 0, 0)),
                cobaltiteSlab = registerBlock("cobaltite_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "cobaltite")), 0, 0)),
                cobaltiteWall = registerBlock("cobaltite_wall", () -> new BlockModWall(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "cobaltite")))),
                ...
                coalstoneStairs = registerBlock("coalstone_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "coalstone")), 0, 0)),
                coalstoneSlab = registerBlock("coalstone_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "coalstone")), 0, 0)),
                coalstoneWall = registerBlock("coalstone_wall", () -> new BlockModWall(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "coalstone")))),
        ...
        arlemiteOre			 = registerBlock("arlemite_ore",			() -> new BlockMod(STONE, 3F, 3F)),
                ...
                anthraciteOre = registerBlock("anthracite_ore", () -> new BlockMod(GLOW_LICHEN, 3F, 3F)),
                oxdriteOre = registerBlock("oxdrite_ore", () -> new BlockMod(GLOW_LICHEN, 3F, 3F)),
        ...
        rawArlemiteBlock= registerBlock("raw_arlemite_block",() -> new BlockMod(COLOR_LIGHT_GREEN, 5F, 6F)),
                ...
                rawOxdriteBlock = registerBlock("raw_oxdrite_block", () -> new BlockMod(COLOR_BROWN, 5F, 6F)),
                oxdriteBlock = registerBlock("oxdrite_block", () -> new BlockMod(COLOR_BROWN, 5F, 6F, SoundType.COPPER, NoteBlockInstrument.HARP)),
        ...
        //Divine Tree
        divineSapling = registerBlock("divine_sapling", () -> new BlockModSapling(GOLD, () -> Blocks.GRASS_BLOCK, () -> Blocks.DIRT, new DivineTreeGrower())),
                ...
                divineStairs = registerBlock("divine_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "divine_planks")), 20, 5)),
                divineSlab = registerBlock("divine_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "divine_planks")), 20, 5)),
        ...
        //Shiverspine
        shiverspineSapling = registerBlock("shiverspine_sapling", () -> new BlockModSapling(GLOW_LICHEN, () -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "frozen_grass")), () -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "frozen_dirt")), new ShiverspineTreeGrower())),
                ...
                shiverspineStairs = registerBlock("shiverspine_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "shiverspine_planks")), 20, 5)),
                shiverspineSlab = registerBlock("shiverspine_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "shiverspine_planks")), 20, 5)),
        ...
        //Auroraoak
        auroraoakSapling = registerBlock("auroraoak_sapling", () -> new BlockModSapling(COLOR_PURPLE, () -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "frozen_grass")), () -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "frozen_dirt")), new AuroraoakTreeGrower())),
                ...
                auroraoakStairs = registerBlock("auroraoak_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "auroraoak_planks")), 20, 5)),
                auroraoakSlab = registerBlock("auroraoak_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "auroraoak_planks")), 20, 5)),
        ...
        //Cozybark
        cozybarkSapling = registerBlock("cozybark_sapling", () -> new BlockModSapling(CRIMSON_STEM, () -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "frozen_grass")), () -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "frozen_dirt")), new CozybarkTreeGrower())),
                ...
                cozybarkStairs = registerBlock("cozybark_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "cozybark_planks")), 20, 5)),
                cozybarkSlab = registerBlock("cozybark_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "cozybark_planks")), 20, 5)),
        ...
        //Streamleaf
        streamleafSapling = registerBlock("streamleaf_sapling", () -> new BlockModSapling(GLOW_LICHEN, () -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "frozen_grass")), () -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "frozen_dirt")), new StreamleafTreeGrower())),
                ...
                streamleafStairs = registerBlock("streamleaf_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "streamleaf_planks")), 20, 5)),
                streamleafSlab = registerBlock("streamleaf_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "streamleaf_planks")), 20, 5)),
        ...
        //Glowsprout
        glowsprout = registerBlock("glowsprout", () -> new FungusBlock(ConfiguredFeatureKeys.GLOWSPROUT, BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "gelidite")), Properties.ofFullCopy(Blocks.WARPED_FUNGUS).mapColor(COLOR_CYAN))),
        ...
        //Lowsprout
        lowsprout = registerBlock("lowsprout", () -> new FungusBlock(ConfiguredFeatureKeys.LOWSPROUT, BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "gelidite")), Properties.ofFullCopy(Blocks.WARPED_FUNGUS).mapColor(COLOR_GREEN))),
        ...
        //Slowsprout
        slowsprout = registerBlock("slowsprout", () -> new FungusBlock(ConfiguredFeatureKeys.SLOWSPROUT, BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "gelidite")), Properties.ofFullCopy(Blocks.WARPED_FUNGUS).mapColor(COLOR_MAGENTA))),
        ...
        eucalyptusLog = registerBlock("eucalyptus_log", () -> new BlockModLog(TERRACOTTA_WHITE, SoundType.WOOD)),
                ...
                eucalyptusStairs = registerBlock("eucalyptus_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "eucalyptus_planks")), 20, 5)),
                eucalyptusSlab = registerBlock("eucalyptus_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "eucalyptus_planks")), 20, 5)),
        ...
        //Eden Tree
        edenSapling = registerBlock("eden_sapling", () -> new BlockModSapling(GOLD, () -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "eden_grass")), () -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "eden_dirt")), new EdenTreeGrower())),
                ...
                edenStairs = registerBlock("eden_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "eden_planks")), 20, 5)),
                edenSlab = registerBlock("eden_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "eden_planks")), 20, 5)),
        ...
        //Wildwood Tree
        wildwoodSapling = registerBlock("wildwood_sapling", () -> new BlockModSapling(COLOR_LIGHT_BLUE, () -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "wildwood_grass")), () -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "wildwood_dirt")), new WildwoodTreeGrower())),
                ...
                wildwoodStairs = registerBlock("wildwood_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "wildwood_planks")), 20, 5)),
                wildwoodSlab = registerBlock("wildwood_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "wildwood_planks")), 20, 5)),
        ...
        //Apalachia Tree
        apalachiaSapling = registerBlock("apalachia_sapling", () -> new BlockModSapling(COLOR_MAGENTA, () -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "apalachia_grass")), () -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "apalachia_dirt")), new ApalachiaTreeGrower())),
                ...
                apalachiaStairs = registerBlock("apalachia_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "apalachia_planks")), 20, 5)),
                apalachiaSlab = registerBlock("apalachia_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "apalachia_planks")), 20, 5)),
        ...
        //Skythern Tree
        skythernSapling = registerBlock("skythern_sapling", () -> new BlockModSapling(WOOL, () -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "skythern_grass")), () -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "skythern_dirt")), new SkythernTreeGrower())),
                ...
                skythernStairs = registerBlock("skythern_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "skythern_planks")), 20, 5)),
                skythernSlab = registerBlock("skythern_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "skythern_planks")), 20, 5)),
        ...
        //Mortum Tree
        mortumSapling = registerBlock("mortum_sapling", () -> new BlockModSapling(COLOR_GRAY, () -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "mortum_grass")), () -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "mortum_dirt")), new MortumTreeGrower())),
                ...
                mortumStairs = registerBlock("mortum_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "mortum_planks")), 20, 5)),
                mortumSlab = registerBlock("mortum_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "mortum_planks")), 20, 5)),
        ...
        asphalt = registerBlock("asphalt", () -> new BlockMod(COLOR_BLACK, 1.5F, 6F)),
                asphaltStairs = registerBlock("asphalt_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "asphalt")), 0, 0)),
                asphaltSlab = registerBlock("asphalt_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "asphalt")), 0, 0)),
        ...
        milkStoneBricks = registerBlock("milk_stone_bricks", () -> new BlockMod(WOOL, 2F, 6F, SoundType.NETHER_BRICKS, NoteBlockInstrument.BASEDRUM)),
                ironBricks = registerBlock("iron_bricks", () -> new BlockMod(METAL, 2F, 6F, SoundType.NETHER_BRICKS, NoteBlockInstrument.BASEDRUM)),
                torriditeBricks = registerFireResistantBlock("torridite_bricks", () -> new BlockMod(CRIMSON_NYLIUM, 2F, 6F, SoundType.NETHER_BRICKS, NoteBlockInstrument.BASEDRUM), Rarity.COMMON),
                lavaBricks = registerBlock("lava_bricks", () -> new BlockMod(Block.Properties.of().mapColor(FIRE).requiresCorrectToolForDrops().strength(2F, 6F).sound(SoundType.NETHER_BRICKS).instrument(NoteBlockInstrument.BASEDRUM).lightLevel((state) -> 6))),
                realmiteBricks = registerBlock("realmite_bricks", () -> new BlockMod(COLOR_ORANGE, 2F, 6F, SoundType.NETHER_BRICKS, NoteBlockInstrument.BASEDRUM)),
                goldBricks = registerBlock("gold_bricks", () -> new BlockMod(GOLD, 2F, 6F, SoundType.NETHER_BRICKS, NoteBlockInstrument.BASEDRUM)),
                arlemiteBricks = registerBlock("arlemite_bricks", () -> new BlockMod(COLOR_LIGHT_GREEN, 2F, 6F, SoundType.NETHER_BRICKS, NoteBlockInstrument.BASEDRUM)),
                greenBricks = registerBlock("green_bricks", () -> new BlockMod(COLOR_GREEN, 2F, 6F, SoundType.NETHER_BRICKS, NoteBlockInstrument.BASEDRUM)),
                darkstoneBricks = registerBlock("darkstone_bricks", () -> new BlockMod(Block.Properties.ofFullCopy(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "darkstone"))).strength(6F, 1200F).sound(SoundType.NETHER_BRICKS))),
                ...
                lapisLazuliBricks = registerBlock("lapis_lazuli_bricks", () -> new BlockMod(LAPIS, 2F, 6F, SoundType.NETHER_BRICKS, NoteBlockInstrument.BASEDRUM)),
                purpleBricks = registerBlock("purple_bricks", () -> new BlockMod(COLOR_PURPLE, 2F, 6F, SoundType.NETHER_BRICKS, NoteBlockInstrument.BASEDRUM)),
                magentaBricks = registerBlock("magenta_bricks", () -> new BlockMod(COLOR_MAGENTA, 2F, 6F, SoundType.NETHER_BRICKS, NoteBlockInstrument.BASEDRUM)),
                bloodgemBricks = registerBlock("bloodgem_bricks", () -> new BlockMod(CRIMSON_STEM, 2F, 6F, SoundType.NETHER_BRICKS, NoteBlockInstrument.BASEDRUM)),
        ...
        frozenBricks = registerBlock("frozen_bricks", () -> new BlockMod(GLOW_LICHEN, 1.5F, 6F)),
                frozenBrickStairs = registerBlock("frozen_brick_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "frozen_bricks")), 0, 0)),
                frozenBrickSlab = registerBlock("frozen_brick_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "frozen_bricks")), 0, 0)),
                frozenBrickWall = registerBlock("frozen_brick_wall", () -> new BlockModWall(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "frozen_bricks")))),
                ...
                coalstoneBrickStairs = registerBlock("coalstone_brick_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "coalstone_bricks")), 0, 0)),
                coalstoneBrickSlab = registerBlock("coalstone_brick_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "coalstone_bricks")), 0, 0)),
                coalstoneBrickWall = registerBlock("coalstone_brick_wall", () -> new BlockModWall(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "coalstone_bricks")))),
                ...
                polishedCoalstoneStairs = registerBlock("polished_coalstone_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "polished_coalstone")), 0, 0)),
                polishedCoalstoneSlab = registerBlock("polished_coalstone_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "polished_coalstone")), 0, 0)),
                polishedCoalstoneWall = registerBlock("polished_coalstone_wall", () -> new BlockModWall(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "polished_coalstone")))),
                ...
                polishedCobaltite = registerBlock("polished_cobaltite", () -> new BlockMod(COLOR_LIGHT_BLUE, 1.5F, 6F)),
                polishedCobaltiteStairs = registerBlock("polished_cobaltite_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "polished_cobaltite")), 0, 0)),
                polishedCobaltiteSlab = registerBlock("polished_cobaltite_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "polished_cobaltite")), 0, 0)),
                polishedCobaltiteWall = registerBlock("polished_cobaltite_wall", () -> new BlockModWall(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "polished_cobaltite")))),
                ...
                cutOxdrite = registerBlock("cut_oxdrite", () -> new BlockMod(Properties.of().mapColor(COLOR_BROWN).requiresCorrectToolForDrops().strength(5F, 6F).sound(SoundType.COPPER).noOcclusion())),
                cutOxdriteStairs = registerBlock("cut_oxdrite_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "cut_oxdrite")), 0, 0)),
                cutOxdriteSlab = registerBlock("cut_oxdrite_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "cut_oxdrite")), 0, 0)),
                cutOxdriteWall = registerBlock("cut_oxdrite_wall", () -> new BlockModWall(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "cut_oxdrite")))),
        ...
        ancientBricks = registerBlock("ancient_bricks", () -> new BlockModUnbreakable(WARPED_NYLIUM)),
                ancientBrickStairs = registerBlock("ancient_brick_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "ancient_bricks")), 0, 0)),
                ancientBrickSlab = registerBlock("ancient_brick_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "ancient_bricks")), 0, 0)),
                ancientBrickWall = registerBlock("ancient_brick_wall", () -> new BlockModWall(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "ancient_bricks")))),
                degradedBricks = registerBlock("degraded_bricks", () -> new BlockModUnbreakable(COLOR_BLUE)),
                degradedBrickStairs = registerBlock("degraded_brick_stairs", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "degraded_bricks")), 0, 0)),
                degradedBrickSlab = registerBlock("degraded_brick_slab", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "degraded_bricks")), 0, 0)),
                degradedBrickWall = registerBlock("degraded_brick_wall", () -> new BlockModWall(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "degraded_bricks")))),
                ...
                ancientBrickStairsBreakable = registerBlock("ancient_brick_stairs_breakable", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "ancient_bricks_breakable")), 0, 0)),
                ancientBrickSlabBreakable = registerBlock("ancient_brick_slab_breakable", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "ancient_bricks_breakable")), 0, 0)),
                ancientBrickWallBreakable = registerBlock("ancient_brick_wall_breakable", () -> new BlockModWall(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "ancient_bricks_breakable")))),
                degradedBricksBreakable = registerBlock("degraded_bricks_breakable", () -> new BlockMod(COLOR_BLUE, 1.5F, 6F)),
                degradedBrickStairsBreakable = registerBlock("degraded_brick_stairs_breakable", () -> new BlockModStairs(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "degraded_bricks_breakable")), 0, 0)),
                degradedBrickSlabBreakable = registerBlock("degraded_brick_slab_breakable", () -> new BlockModSlab(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "degraded_bricks_breakable")), 0, 0)),
                degradedBrickWallBreakable = registerBlock("degraded_brick_wall_breakable", () -> new BlockModWall(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "degraded_bricks_breakable")))),
        ...
        brittleGrass = registerBlock("brittle_grass", () -> new BlockBrittleGrass()),
                ...
                globebrush = registerBlock("globebrush", () -> new BlockModDoublePlant(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "frozen_grass")), SNOW)),
                thermoliage = registerBlock("thermoliage", () -> new BlockModDoublePlant(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "frozen_grass")), COLOR_PINK)),
                arcanaBrush = registerBlock("arcana_brush", () -> new BlockTwilightGrass(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "arcanite_sand")), ICE)),
                arcanaBush = registerBlock("arcana_bush", () -> new BlockTwilightGrass(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "arcanite_sand")), TERRACOTTA_BLUE)),
                gemOfTheDunes = registerBlock("gem_of_the_dunes", () -> new BlockTwilightFlower(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "arcanite_sand")), COLOR_MAGENTA), Rarity.EPIC),
                ...
                edenBrush = registerBlock("eden_brush", () -> new BlockTwilightGrass(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "eden_grass")), COLOR_YELLOW)),
                sunBlossom = registerBlock("sun_blossom", () -> new BlockTwilightFlower(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "eden_grass")), 0.9, 0.6, PLANT)),
                sunbloom = registerBlock("sunbloom", () -> new BlockTwilightFlower(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "eden_grass")), TERRACOTTA_YELLOW)),
                moonlightFern = registerBlock("moonlight_fern", () -> new BlockTwilightGrass(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "wildwood_grass")), ICE)),
                moonBud = registerBlock("moon_bud", () -> new BlockTwilightFlower(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "wildwood_grass")), 0.8, 0.7, QUARTZ)),
                wildwoodTallgrass = registerBlock("wildwood_tallgrass", () -> new BlockModDoublePlant(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "wildwood_grass")), COLOR_BLUE, SoundType.GRASS)),
                ...
                apalachiaTallgrass = registerBlock("apalachia_tallgrass", () -> new BlockTwilightGrass(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "apalachia_grass")), COLOR_PURPLE)),
                duskBloom = registerBlock("dusk_bloom", () -> new BlockTwilightFlower(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "apalachia_grass")), 0.5, 0.5, COLOR_PURPLE)),
                duskFlower = registerBlock("dusk_flower", () -> new BlockModDoublePlant(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "apalachia_grass")), COLOR_PURPLE)),
                skythernBrush = registerBlock("skythern_brush", () -> new BlockTwilightGrass(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "skythern_grass")), WOOL)),
                dustLily = registerBlock("dust_lily", () -> new BlockTwilightFlower(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "skythern_grass")), WOOL)),
                dustBrambles = registerBlock("dust_brambles", () -> new BlockBrambles(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "skythern_grass")), WOOL)),
                mortumBrush = registerBlock("mortum_brush", () -> new BlockTwilightGrass(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "mortum_grass")), COLOR_GRAY)),
                eyePlant = registerBlock("eye_plant", () -> new BlockTwilightFlower(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "mortum_grass")), 0.5, 0.5, COLOR_GRAY)),
                demonBrambles = registerBlock("demon_brambles", () -> new BlockBrambles(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "mortum_grass")), COLOR_GRAY)),
                shineGrass = registerBlock("shine_grass", () -> new BlockTwilightFlower(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "dream_grass")), COLOR_CYAN)),
                cracklespike = registerBlock("cracklespike", () -> new BlockTwilightFlower(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "dream_grass")), COLOR_CYAN)),
                fernite = registerBlock("fernite", () -> new BlockTwilightFlower(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "dream_grass")), COLOR_CYAN)),
                dreamglow = registerBlock("dreamglow", () -> new BlockTwilightFlower(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "dream_grass")), COLOR_CYAN)),
                bulbatobe = registerBlock("bulbatobe", () -> new BlockTwilightFlower(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "dream_grass")), COLOR_CYAN)),
                shimmer = registerBlock("shimmer", () -> new BlockTwilightFlower(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "dream_grass")), COLOR_CYAN)),
                yellowDulah = registerBlock("yellow_dulah", () -> new BlockTwilightFlower(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "dream_grass")), COLOR_CYAN)),
                greenDulah = registerBlock("green_dulah", () -> new BlockTwilightFlower(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "dream_grass")), COLOR_CYAN)),
                greenGemtop = registerBlock("green_gemtop", () -> new BlockTwilightFlower(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "dream_grass")), COLOR_CYAN)),
                purpleGemtop = registerBlock("purple_gemtop", () -> new BlockTwilightFlower(() -> BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "dream_grass")), COLOR_CYAN)),
        ...
        arcanaPortal = registerBlock("arcana_portal", () -> new BlockArcanaPortal()),
                ...
                edenPortal = registerBlock("eden_portal", () -> new BlockModPortal(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "divine_rock")))),
                wildwoodPortal = registerBlock("wildwood_portal", () -> new BlockModPortal(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "eden_block")))),
                apalachiaPortal = registerBlock("apalachia_portal", () -> new BlockModPortal(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "wildwood_block")))),
                skythernPortal = registerBlock("skythern_portal", () -> new BlockModPortal(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "apalachia_block")))),
                mortumPortal = registerBlock("mortum_portal", () -> new BlockModPortal(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "skythern_block")))),
                vetheaPortal = registerBlock("vethea_portal", () -> new BlockModPortal(BuiltInRegistries.BLOCK.get(new ResourceLocation(MODID, "mortum_block")))),
        ...
        private static <T extends Block> DeferredBlock<T> registerFireResistantBlock(String registryName, Supplier<T> block, Rarity rarity) {
                DeferredBlock<T> registeredBlock = BLOCKS.register(registryName, block);
