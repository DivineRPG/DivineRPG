...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block>
            ...
            shiverspineLog = registerBlock("shiverspine_log", () -> new BlockModLog(ICE)),
            strippedShiverspineLog = registerBlock("stripped_shiverspine_log", () -> new BlockModLog(ICE)),
            shiverspineWood = registerBlock("shiverspine_wood", () -> new BlockModLog(COLOR_LIGHT_GRAY)),
            strippedShiverspineWood = registerBlock("stripped_shiverspine_wood", () -> new BlockModLog(ICE)),
            shiverspinePlanks = registerBlock("shiverspine_planks", () -> new BlockModPlanks(ICE)),
            ...
            shiverspineFence = registerBlock("shiverspine_fence", () -> new BlockModFence(ICE)),
            shiverspineFenceGate = registerBlock("shiverspine_fence_gate", () -> new BlockModGate(ICE)),
            shiverspineDoor = registerBlock("shiverspine_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(DivineRPG.MODID, "shiverspine_planks"))).strength(2.0F, 1.0F).noOcclusion(), BlockSetType.OAK)),
            shiverspineTrapdoor = registerBlock("shiverspine_trapdoor", () -> new BlockModTrapdoor(ICE)),
            shiverspinePressurePlate = registerBlock("shiverspine_pressure_plate", () -> new BlockModPressurePlate(ICE)),
            shiverspineButton = registerBlock("shiverspine_button", () -> new BlockModButton()),
            ...
            //Doors
            steelDoor = registerBlock("steel_door", () -> new DoorBlock(BlockBehaviour.Properties.of().mapColor(METAL).requiresCorrectToolForDrops().strength(5F).noOcclusion(), BlockSetType.STONE)),
            ...
            barredDoor = registerBlock("barred_door", () -> new DoorBlock(BlockBehaviour.Properties.of().mapColor(PLANT).requiresCorrectToolForDrops().strength(5F).noOcclusion(), BlockSetType.STONE)),
