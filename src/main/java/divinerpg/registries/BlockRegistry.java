...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block>// Compressed ore blocks
	    ...
	    torriditeBlock  = registerFireResistantBlock("torridite_block",() -> new BlockMod(Properties.copy(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "arlemite_block")))), tabs.blocks, Rarity.COMMON),
    ...
    public static final RegistryObject<Block>// Boss spawners
	    ...
	    termasectSpawner		= registerBlock("termasect_spawner",		() -> new BlockModMobCage(new ResourceLocation(MODID, "termasect"), new ResourceLocation(MODID, "wildwood_chunk"), new BlockPos(0, 12, 0))),
	    ...
	    experiencedCoriSpawner  = registerBlock("experienced_cori_spawner", () -> new BlockModMobCage(new ResourceLocation(MODID, "experienced_cori"), new ResourceLocation(MODID, "skythern_chunk"), new BlockPos(0, 12, 0)));
    ...
    public static final RegistryObject<Block>// Bricks
        ...
        torriditeBricks = registerFireResistantBlock("torridite_bricks", () -> new BlockMod(Properties.of(Material.STONE).strength(3F, 30F).requiresCorrectToolForDrops()), tabs.blocks, Rarity.COMMON),
    ...
    public static final RegistryObject<Block>// Minibricks
        ...
        bedrockMinibricks = registerFireResistantBlock("bedrock_minibricks", () -> new BlockMod(Properties.of(Material.STONE).strength(3F, 30F).requiresCorrectToolForDrops()), tabs.blocks, Rarity.COMMON),
        torriditeMinibricks = registerFireResistantBlock("torridite_minibricks", () -> new BlockMod(Properties.of(Material.STONE).strength(3F, 30F).requiresCorrectToolForDrops()), tabs.blocks, Rarity.COMMON),
    ...
    public static final RegistryObject<Block>// Utility blocks
    	...
    	boneChest = registerWithRender("bone_chest", () -> new BlockBoneChest(), tabs.utilities, Rarity.COMMON),
    ...
    public static final RegistryObject<Block>// Boss statues
    	ancientEntityStatue = registerWithRender("ancient_entity_statue", () -> new BlockStatue(() -> IRON_GOLEM_DEATH), tabs.blocks, Rarity.RARE),
        ayeracoStatue = registerWithRender("ayeraco_statue", () -> new BlockStatue(() -> AYERACO.get()), tabs.blocks, Rarity.RARE),
        densosStatue = registerWithRender("densos_statue", () -> new BlockStatue(() -> DENSOS.get()), tabs.blocks, Rarity.RARE),
        dramixStatue = registerWithRender("dramix_statue", () -> new BlockStatue(() -> DRAMIX.get()), tabs.blocks, Rarity.RARE),
        eternalArcherStatue = registerWithRender("eternal_archer_statue", () -> new BlockStatue(() -> ARCHER.get()), tabs.blocks, Rarity.RARE),
        karotStatue = registerWithRender("karot_statue", () -> new BlockStatue(null), tabs.blocks, Rarity.RARE),
        kingOfScorchersStatue = registerWithRender("king_of_scorchers_statue", () -> new BlockStatue(() -> KING_OF_SCORCHERS.get()), tabs.blocks, Rarity.RARE),
        parasectaStatue = registerWithRender("parasecta_statue", () -> new BlockStatue(() -> PARASECTA.get()), tabs.blocks, Rarity.RARE),
        reyvorStatue = registerWithRender("reyvor_statue", () -> new BlockStatue(() -> REYVOR.get()), tabs.blocks, Rarity.RARE),
        soulFiendStatue = registerWithRender("soul_fiend_statue", () -> new BlockStatue(null), tabs.blocks, Rarity.RARE),
        theWatcherStatue = registerWithRender("the_watcher_statue", () -> new BlockStatue(() -> ROAR.get()), tabs.blocks, Rarity.RARE),
        twilightDemonStatue = registerWithRender("twilight_demon_statue", () -> new BlockStatue(() -> INSECT.get()), tabs.blocks, Rarity.RARE),
        vamacheronStatue = registerWithRender("vamacheron_statue", () -> new BlockStatue(null), tabs.blocks, Rarity.RARE),
        termasectStatue = registerWithRender("termasect_statue", () -> new BlockStatue(() -> WOOD_STEP), tabs.blocks, Rarity.RARE),
        sunstormStatue = registerWithRender("sunstorm_statue", () -> new BlockStatue(() -> SPARKLER.get()), tabs.blocks, Rarity.RARE),
        experiencedCoriStatue = registerWithRender("experienced_cori_statue", () -> new BlockStatue(() -> CORI.get()), tabs.blocks, Rarity.RARE);
    ...
    public static final RegistryObject<Block>// Structure blocks
        ...
        frostedChest = registerWithRender("frosted_chest", () -> new BlockFrostedChest(), tabs.utilities, Rarity.COMMON),
    ...
    // Chest
    public static final RegistryObject<Block> presentBox = registerWithRender("present_box", () -> new BlockPresentBox(), tabs.utilities, Rarity.COMMON);
    ...
    public static final RegistryObject<Block>// Other
            soulFire = registerBlock("soul_fire", () -> new BlockModFire()),
        ...
        edenChest = registerWithRender("eden_chest", () -> new BlockEdenChest(), tabs.utilities, Rarity.COMMON),
    ...
    // Utility
    public static final RegistryObject<Block> arcaniumExtractor = registerWithRender("arcanium_extractor", () -> new BlockArcaniumExtractor(), tabs.utilities, Rarity.RARE);

    public static final RegistryObject<Block>// Boss altars
        dramixAltar = registerWithRender("dramix_altar", () -> new BlockModAltar(), tabs.blocks, Rarity.COMMON),
        parasectaAltar = registerWithRender("parasecta_altar", () -> new BlockModAltar(), tabs.blocks, Rarity.COMMON);
    ...
    public static final RegistryObject<Block>// Furnace
        greenlightFurnace = registerBlock("greenlight_furnace", () -> new BlockModFurnace(() -> BlockEntityRegistry.GREENLIGHT_FURNACE.get()), tabs.utilities, Rarity.COMMON),
        oceanfireFurnace = registerBlock("oceanfire_furnace", () -> new BlockModInfiniFurnace(() -> BlockEntityRegistry.OCEANFIRE_FURNACE.get()), tabs.utilities, Rarity.COMMON),
        moltenFurnace = registerBlock("molten_furnace", () -> new BlockModInfiniFurnace(() -> BlockEntityRegistry.MOLTEN_FURNACE.get()), tabs.utilities, Rarity.COMMON),
        whitefireFurnace = registerBlock("whitefire_furnace", () -> new BlockModInfiniFurnace(() -> BlockEntityRegistry.WHITEFIRE_FURNACE.get()), tabs.utilities, Rarity.COMMON),
        moonlightFurnace = registerBlock("moonlight_furnace", () -> new BlockModFurnace(() -> BlockEntityRegistry.MOONLIGHT_FURNACE.get()), tabs.utilities, Rarity.COMMON),
        demonFurnace = registerWithRender("demon_furnace", () -> new BlockDemonFurnace(), tabs.utilities, Rarity.COMMON);

    public static final RegistryObject<Block>// Miscellaneous utility
        acceleron = registerBlock("acceleron", () -> new BlockAcceleron(), tabs.utilities, Rarity.UNCOMMON),
        ...
        elevantium = registerBlock("elevantium", () -> new BlockElevantium(), tabs.utilities, Rarity.UNCOMMON),
    ...
    public static final RegistryObject<Block>// Terrain
        dreamDirt = registerBlock("dream_dirt", () -> new BlockModDirt(0.5F, COLOR_LIGHT_GREEN), tabs.vethea),
        dreamGrass = registerBlock("dream_grass", () -> new BlockDreamGrass(0.6F), tabs.vethea),
        dreamStone = registerBlock("dream_stone", () -> new BlockMod(1.5F), tabs.vethea),
        evergrass = registerBlock("evergrass", () -> new BlockDreamGrass(0.6F, COLOR_PURPLE), tabs.vethea),
		flameGrass = registerBlock("flame_grass", () -> new BlockDreamGrass(0.6F, COLOR_RED), tabs.vethea),
		scorchedGrass = registerBlock("scorched_grass", () -> new BlockModGrass(() -> dreamStone.get(), 1.5F, COLOR_LIGHT_BLUE), tabs.vethea);

    public static final RegistryObject<Block>// Logs
        dreamwoodLog = registerBlock("dreamwood_log", () -> new BlockModLog(COLOR_LIGHT_BLUE), tabs.vethea),
        firewoodLog = registerBlock("firewood_log", () -> new BlockModLog(COLOR_RED), tabs.vethea),
        hyrewoodLog = registerBlock("hyrewood_log", () -> new BlockModLog(COLOR_BLUE), tabs.vethea),
        mintwoodLog = registerBlock("mintwood_log", () -> new BlockModLog(COLOR_LIGHT_BLUE), tabs.vethea);

    public static final RegistryObject<Block>// Stripped Logs
        strippedDreamwoodLog = registerBlock("stripped_dreamwood_log", () -> new BlockModLog(COLOR_LIGHT_BLUE), tabs.vethea),
        strippedFirewoodLog = registerBlock("stripped_firewood_log", () -> new BlockModLog(COLOR_RED), tabs.vethea),
        strippedHyrewoodLog = registerBlock("stripped_hyrewood_log", () -> new BlockModLog(COLOR_BLUE), tabs.vethea),
        strippedMintwoodLog = registerBlock("stripped_mintwood_log", () -> new BlockModLog(COLOR_LIGHT_BLUE), tabs.vethea);

    public static final RegistryObject<Block>// Leaves
        dreamwoodLeaves = registerBlock("dreamwood_leaves", () -> new LeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES, COLOR_RED).strength(0.2F, 0.1F).randomTicks().sound(SoundType.GRASS).noOcclusion().isSuffocating((state, getter, pos) -> false).isViewBlocking((state, getter, pos) -> false)), tabs.vethea),
        firewoodLeaves = registerBlock("firewood_leaves", () -> new LeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES, COLOR_RED).strength(0.2F, 0.1F).randomTicks().sound(SoundType.GRASS).noOcclusion().isSuffocating((state, getter, pos) -> false).isViewBlocking((state, getter, pos) -> false)), tabs.vethea),
        hyrewoodLeaves = registerBlock("hyrewood_leaves", () -> new LeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES, COLOR_RED).strength(0.2F, 0.1F).randomTicks().sound(SoundType.GRASS).noOcclusion().isSuffocating((state, getter, pos) -> false).isViewBlocking((state, getter, pos) -> false)), tabs.vethea),
        mintwoodLeaves = registerBlock("mintwood_leaves", () -> new LeavesBlock(BlockBehaviour.Properties.of(Material.LEAVES, COLOR_RED).strength(0.2F, 0.1F).randomTicks().sound(SoundType.GRASS).noOcclusion().isSuffocating((state, getter, pos) -> false).isViewBlocking((state, getter, pos) -> false)), tabs.vethea);

    public static final RegistryObject<Block>// Ground foliage
        bulbatobe = registerBlock("bulbatobe", () -> new BlockTwilightFlower(() -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "dream_grass")), COLOR_GREEN), tabs.vethea),
        cracklespike = registerBlock("cracklespike", () -> new BlockTwilightFlower(() -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "dream_grass")), COLOR_GREEN), tabs.vethea),
        dreamglow = registerBlock("dreamglow", () -> new BlockTwilightFlower(() -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "dream_grass")), COLOR_GREEN), tabs.vethea),
        fernite = registerBlock("fernite", () -> new BlockTwilightFlower(() -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "dream_grass")), COLOR_GREEN), tabs.vethea),
        greenDulah = registerBlock("green_dulah", () -> new BlockTwilightFlower(() -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "dream_grass")), COLOR_GREEN), tabs.vethea),
        greenGemtop = registerBlock("green_gemtop", () -> new BlockTwilightFlower(() -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "dream_grass")), COLOR_GREEN), tabs.vethea),
        purpleGemtop = registerBlock("purple_gemtop", () -> new BlockTwilightFlower(() -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "dream_grass")), COLOR_GREEN), tabs.vethea),
        shimmer = registerBlock("shimmer", () -> new BlockTwilightFlower(() -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "dream_grass")), COLOR_GREEN), tabs.vethea),
        shineGrass = registerBlock("shine_grass", () -> new BlockTwilightFlower(() -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "dream_grass")), COLOR_GREEN), tabs.vethea),
        yellowDulah = registerBlock("yellow_dulah", () -> new BlockTwilightFlower(() -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "dream_grass")), COLOR_GREEN), tabs.vethea);

    public static final RegistryObject<Block>// Vines
        weedwoodVine = registerBlock("weedwood_vine", () -> new BlockModVine(), tabs.vethea),
        blossomedWeedwoodVine = registerBlock("blossomed_weedwood_vine", () -> new BlockModVine(), tabs.vethea);

    public static final RegistryObject<Block>// Building blocks
        darkDreamBricks = registerBlock("dark_dream_bricks", () -> new BlockMod(1F, 3F), tabs.vethea),
        lightDreamBricks = registerBlock("light_dream_bricks", () -> new BlockMod(1F, 3F), tabs.vethea),
        redDreamBricks = registerBlock("red_dream_bricks", () -> new BlockMod(1F, 3F), tabs.vethea),
        smoothGlass = registerBlock("smooth_glass", () -> new BlockModGlass(0.3F), tabs.vethea);

    // Door
    public static final RegistryObject<Block> barredDoor = registerBlock("barred_door", () -> new BlockModDoor(Material.HEAVY_METAL, 2f, 1F, SoundType.STONE), tabs.vethea);

    public static final RegistryObject<Block>// Lighting
        fireCrystal = registerBlock("fire_crystal", () -> new BlockLightCrystal(1F), tabs.vethea),
        firelight = registerBlock("firelight", () -> new BlockLightCrystal(1F), tabs.vethea);

    // Structure
    public static final RegistryObject<Block>// General
        dreamLamp = registerBlock("dream_lamp", () -> new BlockDreamLamp(), tabs.vethea),
        everstone = registerBlock("everstone", () -> new BlockModUnbreakable(), tabs.vethea),
        darkEverstone = registerBlock("dark_everstone", () -> new BlockModUnbreakable(), tabs.vethea),
        whiteEverstone = registerBlock("white_everstone", () -> new BlockModUnbreakable(), tabs.vethea);

    public static final RegistryObject<Block>// Crypt
        blackHungerstone = registerBlock("black_hungerstone", () -> new BlockModUnbreakable(), tabs.vethea),
        greenHungerstone = registerBlock("green_hungerstone", () -> new BlockModUnbreakable(), tabs.vethea),
        cryptFloor = registerBlock("crypt_floor", () -> new BlockModUnbreakable(), tabs.vethea),
        cryptWall = registerBlock("crypt_wall", () -> new BlockMod(1F, 3F), tabs.vethea),
        metalCaging = registerBlock("metal_caging", () -> new BlockModGlass(1F), tabs.vethea);

    // Village
    public static final RegistryObject<Block> villageLamp = registerBlock("village_lamp", () -> new BlockModLamp(1F, 3F, 15), tabs.vethea);

    public static final RegistryObject<Block>// Hive
        cellLamp = registerBlock("cell_lamp", () -> new BlockModLamp(1F, 3F, 15), tabs.vethea),
    ...
    public static final RegistryObject<Block>// Karos Madhouse
        blackKarosBricks = registerBlock("black_karos_bricks", () -> new BlockModUnbreakable(), tabs.vethea),
        blueKarosBricks = registerBlock("blue_karos_bricks", () -> new BlockModUnbreakable(), tabs.vethea),
        helioticBeam = registerBlock("heliotic_beam", () -> new BlockHelioticBeam(), tabs.vethea),
        karosDispenser = registerBlock("karos_dispenser", () -> new BlockKarosDispenser(), tabs.vethea),
        karosHeatTileGreen = registerBlock("karos_heat_tile_green", () -> new BlockKarosHeatTile(), tabs.vethea),
        karosHeatTileRed = registerBlock("karos_heat_tile_red", () -> new BlockKarosHeatTile(), tabs.vethea);

    public static final RegistryObject<Block>// Lunic Garden
        lunaBricks = registerBlock("luna_bricks", () -> new BlockMod(1F), tabs.vethea),
        lunaStone = registerBlock("luna_stone", () -> new BlockMod(2F), tabs.vethea);

    public static final RegistryObject<Block>// Raglok Chamber
        chamberWall = registerBlock("chamber_wall", () -> new BlockModUnbreakable(), tabs.vethea),
        shiftedChamberWall = registerBlock("shifted_chamber_wall", () -> new BlockModUnbreakable(), tabs.vethea),
        stackedChamberWall = registerBlock("stacked_chamber_wall", () -> new BlockModUnbreakable(), tabs.vethea);

    // Wreck Hall
    public static final RegistryObject<Block> hallWall = registerBlock("hall_wall", () -> new BlockModUnbreakable(), tabs.vethea);

    // Utility
    public static final RegistryObject<Block> infusionTable = registerBlock("infusion_table", () -> new BlockInfusionTable(), tabs.vethea);

    // Hive egg
    public static final RegistryObject<Block> hiveEgg = registerBlock("hive_egg", () -> new BlockHiveEgg(), tabs.vethea);

    public static final RegistryObject<Block>// Boss altars
        karosAltar = registerBlock("karos_altar", () -> new BlockKarosAltar(), tabs.vethea),
        lunicAltar = registerBlock("lunic_altar", () -> new BlockLunicAltar(), tabs.vethea),
        quadroticAltar = registerBlock("quadrotic_altar", () -> new BlockQuadroticAltar(), tabs.vethea),
        raglokAltar = registerBlock("raglok_altar", () -> new BlockRaglokAltar(), tabs.vethea),
        wreckAltar = registerBlock("wreck_altar", () -> new BlockWreckAltar(), tabs.vethea);

    public static final RegistryObject<Block>// Acid
        acidBlock = registerBlock("acid_block", () -> new BlockAcid(true), tabs.vethea),
        bacterialAcid = registerBlock("bacterial_acid", () -> new BlockAcid(false), tabs.vethea),
        lunicAcid = registerBlock("lunic_acid", () -> new BlockAcid(true), tabs.vethea);
    ...
    private static <T extends Block> RegistryObject<T> registerBlock(String name, Supplier<T> block) {
        return registerBlock(name, block, tabs.blocks, Rarity.COMMON);
    }
    private static <T extends Block> RegistryObject<T> registerBlock(String registryName, Supplier<T> block, Rarity rarity) {
        return registerBlock(registryName, block, tabs.blocks, rarity);
    }
    private static <T extends Block> RegistryObject<T> registerBlock(String registryName, Supplier<T> block, CreativeModeTab itemGroup) {
        return registerBlock(registryName, block, itemGroup, Rarity.COMMON);
    }
    ...
    private static <T extends Block> RegistryObject<T> registerFireResistantBlock(String registryName, Supplier<T> block, CreativeModeTab itemGroup, Rarity rarity) {
        RegistryObject<T> registeredBlock = BLOCKS.register(registryName, block);
        BLOCK_ITEMS.register(registryName, () -> new BlockItem(registeredBlock.get(), new Item.Properties().tab(itemGroup).rarity(rarity).fireResistant()));
        return registeredBlock;
    }

    private static <T extends Block> RegistryObject<T> registerWithRender(String registryName, Supplier<T> block, CreativeModeTab itemGroup, Rarity rarity) {
        RegistryObject<T> registeredBlock = BLOCKS.register(registryName, block);
        if(registryName == "arcanium_extractor") BLOCK_ITEMS.register(registryName, () -> new ItemArcaniumExtractor(registeredBlock.get(), new Item.Properties().tab(itemGroup).rarity(rarity)));
        else if(registryName == "bone_chest") BLOCK_ITEMS.register(registryName, () -> new ItemBoneChest(registeredBlock.get(), new Item.Properties().tab(itemGroup).rarity(rarity)));
        else if(registryName == "demon_furnace") BLOCK_ITEMS.register(registryName, () -> new ItemDemonFurnace(registeredBlock.get(), new Item.Properties().tab(itemGroup).rarity(rarity)));
        else if(registryName == "frosted_chest") BLOCK_ITEMS.register(registryName, () -> new ItemFrostedChest(registeredBlock.get(), new Item.Properties().tab(itemGroup).rarity(rarity)));
        else if(registryName == "present_box") BLOCK_ITEMS.register(registryName, () -> new ItemPresentBox(registeredBlock.get(), new Item.Properties().tab(itemGroup).rarity(rarity)));
        else if(registryName == "eden_chest") BLOCK_ITEMS.register(registryName, () -> new ItemEdenChest(registeredBlock.get(), new Item.Properties().tab(itemGroup).rarity(rarity)));
        else if(registryName == "parasecta_altar") BLOCK_ITEMS.register(registryName, () -> new ItemParasectaAltar(registeredBlock.get(), new Item.Properties().tab(itemGroup).rarity(rarity)));
        else if(registryName == "dramix_altar") BLOCK_ITEMS.register(registryName, () -> new ItemDramixAltar(registeredBlock.get(), new Item.Properties().tab(itemGroup).rarity(rarity)));
        else BLOCK_ITEMS.register(registryName, () -> new ItemStatueBlock(() -> registeredBlock.get(), new Item.Properties().tab(itemGroup).rarity(rarity).fireResistant()));
        return registeredBlock;
    }
}