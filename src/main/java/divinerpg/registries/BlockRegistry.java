...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block>
            ...
            frozenStairs = registerBlock("frozen_stairs", () -> new BlockModStairs(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "frozen_stone")), 0, 0)),
            frozenSlab = registerBlock("frozen_slab", () -> new BlockModSlab(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "frozen_stone")), 0, 0)),
            ...
            cobbledFrozenStairs = registerBlock("cobbled_frozen_stairs", () -> new BlockModStairs(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "cobbled_frozen_stone")), 0, 0)),
            cobbledFrozenSlab = registerBlock("cobbled_frozen_slab", () -> new BlockModSlab(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "cobbled_frozen_stone")), 0, 0)),
            ...
            cobaltiteStairs = registerBlock("cobaltite_stairs", () -> new BlockModStairs(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "cobaltite")), 0, 0)),
            ...
            coalstoneWall = registerBlock("coalstone_wall", () -> new BlockModWall(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "coalstone")))),
            ...
            //Shiverspine
            shiverspineSapling = registerBlock("shiverspine_sapling", () -> new BlockModSapling(GLOW_LICHEN, () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "frozen_grass")), () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "frozen_dirt")), new ShiverspineTreeGrower())),
            ...
            //Auroraoak
            auroraoakSapling = registerBlock("auroraoak_sapling", () -> new BlockModSapling(COLOR_PURPLE, () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "frozen_grass")), () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "frozen_dirt")), new AuroraoakTreeGrower())),
            ...
            //Streamleaf
            streamleafSapling = registerBlock("streamleaf_sapling", () -> new BlockModSapling(GLOW_LICHEN, () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "frozen_grass")), () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "frozen_dirt")), new StreamleafTreeGrower())),
            ...
            //Eden Tree
            edenSapling = registerBlock("eden_sapling", () -> new BlockModSapling(GOLD, () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "eden_grass")), () -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "eden_dirt")), new EdenTreeGrower())),
            ...
            darkstoneBricks = registerBlock("darkstone_bricks", () -> new BlockMod(Block.Properties.copy(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "darkstone"))).strength(6F, 1200F).sound(SoundType.NETHER_BRICKS))),
            ...
            frozenBrickWall = registerBlock("frozen_brick_wall", () -> new BlockModWall(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "frozen_bricks")))),
            ...
            apalachiaTallgrass = registerBlock("apalachia_tallgrass", () -> new BlockTwilightGrass(() -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "apalachia_grass")), TERRACOTTA_BLUE)),
            duskBloom = registerBlock("dusk_bloom", () -> new BlockTwilightFlower(() -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "apalachia_grass")), 0.5, 0.5, TERRACOTTA_BLUE)),
            duskFlower = registerBlock("dusk_flower", () -> new BlockModDoublePlant(() -> ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "apalachia_grass")), TERRACOTTA_BLUE)),
