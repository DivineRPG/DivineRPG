...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block>// Compressed ore blocks
            arlemiteBlock	= registerBlock("arlemite_block",	() -> new BlockMod(Properties.of(Material.METAL, COLOR_LIGHT_GREEN).requiresCorrectToolForDrops().strength(5F, 6F).sound(SoundType.METAL))),
            rawArlemiteBlock= registerBlock("raw_arlemite_block",() -> new BlockMod(Properties.of(Material.STONE, COLOR_LIGHT_GREEN).requiresCorrectToolForDrops().strength(5F, 6F))),
            realmiteBlock	= registerBlock("realmite_block",	() -> new BlockMod(Properties.copy(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "arlemite_block"))).color(COLOR_ORANGE))),
            rawRealmiteBlock= registerBlock("raw_realmite_block",() -> new BlockMod(Properties.copy(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "raw_arlemite_block"))).color(COLOR_ORANGE))),
            rupeeBlock		= registerBlock("rupee_block",		() -> new BlockMod(Properties.copy(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "arlemite_block"))).color(COLOR_LIGHT_BLUE))),
            rawRupeeBlock	= registerBlock("raw_rupee_block",	() -> new BlockMod(Properties.copy(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "raw_arlemite_block"))).color(COLOR_LIGHT_BLUE))),
            bloodgemBlock	= registerBlock("bloodgem_block",	() -> new BlockMod(Properties.copy(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "arlemite_block"))).color(CRIMSON_STEM))),
            torriditeBlock  = registerFireResistantBlock("torridite_block",() -> new BlockMod(Properties.copy(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "arlemite_block"))).strength(5F, 1200F).color(CRIMSON_NYLIUM)), Rarity.COMMON),
            rawTorriditeBlock= registerBlock("raw_torridite_block",() -> new BlockMod(Properties.copy(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "raw_arlemite_block"))).strength(5F, 1200F).color(CRIMSON_NYLIUM)));
    ...
    public static final RegistryObject<Block>// Steel
            blackSteel = registerBlock("black_steel", () -> new BlockMod(Properties.of(Material.METAL, COLOR_GRAY).requiresCorrectToolForDrops().strength(5F, 6F).sound(SoundType.METAL))),
            blueSteel = registerBlock("blue_steel", () -> new BlockMod(Properties.of(Material.METAL, COLOR_LIGHT_BLUE).requiresCorrectToolForDrops().strength(5F, 6F).sound(SoundType.METAL))),
            brightRedSteel = registerBlock("bright_red_steel", () -> new BlockMod(Properties.of(Material.METAL, CRIMSON_NYLIUM).requiresCorrectToolForDrops().strength(5F, 6F).sound(SoundType.METAL))),
            greenSteel = registerBlock("green_steel", () -> new BlockMod(Properties.of(Material.METAL, COLOR_GREEN).requiresCorrectToolForDrops().strength(5F, 6F).sound(SoundType.METAL))),
            orangeSteel = registerBlock("orange_steel", () -> new BlockMod(Properties.of(Material.METAL, TERRACOTTA_ORANGE).requiresCorrectToolForDrops().strength(5F, 6F).sound(SoundType.METAL))),
            purpleSteel = registerBlock("purple_steel", () -> new BlockMod(Properties.of(Material.METAL, TERRACOTTA_BLUE).requiresCorrectToolForDrops().strength(5F, 6F).sound(SoundType.METAL))),
            redSteel = registerBlock("red_steel", () -> new BlockMod(Properties.of(Material.METAL, COLOR_RED).requiresCorrectToolForDrops().strength(5F, 6F).sound(SoundType.METAL))),
            whiteSteel = registerBlock("white_steel", () -> new BlockMod(Properties.of(Material.METAL, WOOL).requiresCorrectToolForDrops().strength(5F, 6F).sound(SoundType.METAL))),
            yellowSteel = registerBlock("yellow_steel", () -> new BlockMod(Properties.of(Material.METAL, TERRACOTTA_YELLOW).requiresCorrectToolForDrops().strength(5F, 6F).sound(SoundType.METAL))),
    ...
    public static final RegistryObject<Block>// Bricks
            ...
            greenBricks = registerBlock("green_bricks", () -> new BlockMod(Properties.of(Material.STONE, PLANT).strength(2F, 6F).requiresCorrectToolForDrops().sound(SoundType.NETHER_BRICKS))),
            ironBricks = registerBlock("iron_bricks", () -> new BlockMod(Properties.of(Material.STONE, COLOR_CYAN).strength(2F, 6F).requiresCorrectToolForDrops().sound(SoundType.NETHER_BRICKS))),
            lapisLazuliBricks = registerBlock("lapis_lazuli_bricks", () -> new BlockMod(Properties.of(Material.STONE, COLOR_BLUE).strength(2F, 6F).requiresCorrectToolForDrops().sound(SoundType.NETHER_BRICKS))),
            milkStoneBricks = registerBlock("milk_stone_bricks", () -> new BlockMod(Properties.of(Material.STONE, WOOL).strength(2F, 6F).requiresCorrectToolForDrops().sound(SoundType.NETHER_BRICKS))),
            torriditeBricks = registerFireResistantBlock("torridite_bricks", () -> new BlockMod(Properties.of(Material.STONE, NETHER).strength(2F, 6F).requiresCorrectToolForDrops().sound(SoundType.NETHER_BRICKS)), Rarity.COMMON),
            pinkBricks = registerBlock("pink_bricks", () -> new BlockMod(Properties.of(Material.STONE, COLOR_PURPLE).strength(2F, 6F).requiresCorrectToolForDrops().sound(SoundType.NETHER_BRICKS))),
            purpleBricks = registerBlock("purple_bricks", () -> new BlockMod(Properties.of(Material.STONE, TERRACOTTA_BLUE).strength(2F, 6F).requiresCorrectToolForDrops().sound(SoundType.NETHER_BRICKS))),
            realmiteBricks = registerBlock("realmite_bricks", () -> new BlockMod(Properties.of(Material.STONE, TERRACOTTA_ORANGE).strength(2F, 6F).requiresCorrectToolForDrops().sound(SoundType.NETHER_BRICKS))),
            redstoneBricks = registerBlock("redstone_bricks", () -> new BlockMod(Properties.of(Material.STONE, CRIMSON_NYLIUM).strength(2F, 6F).requiresCorrectToolForDrops().sound(SoundType.NETHER_BRICKS))),
    ...
    public static final RegistryObject<Block>// Minibricks
            minibricks = registerBlock("minibricks", () -> new BlockMod(Properties.of(Material.STONE, DEEPSLATE).strength(2F, 6F).requiresCorrectToolForDrops().sound(SoundType.NETHER_BRICKS))),
    ...
    public static final RegistryObject<Block>// Lamps
            aquaLamp = registerBlock("aqua_lamp", () -> new BlockModLamp(5F, 6F, COLOR_LIGHT_BLUE, SoundType.METAL)),
            arlemiteLamp = registerBlock("arlemite_lamp", () -> new BlockModLamp(5F, 6F, EMERALD, SoundType.METAL)),
            blazeLamp = registerBlock("blaze_lamp", () -> new BlockModLamp(5F, 6F, COLOR_YELLOW, SoundType.METAL)),
            soulfireLamp = registerBlock("soulfire_lamp", () -> new BlockModLamp(0.3F, 0.3F, WATER, SoundType.GLASS)),
            diamondLamp = registerBlock("diamond_lamp", () -> new BlockModLamp(5F, 6F, DIAMOND, SoundType.METAL)),
            divineLamp = registerBlock("divine_lamp", () -> new BlockModLamp(0.3F, 0.3F, COLOR_YELLOW, SoundType.GLASS)),
            drakenLamp = registerBlock("draken_lamp", () -> new BlockModLamp(5F, 6F, COLOR_ORANGE, SoundType.METAL)),
            edenLamp = registerBlock("eden_lamp", () -> new BlockModLamp(5F, 6F, COLOR_YELLOW, SoundType.METAL)),
            enderLamp = registerBlock("ender_lamp", () -> new BlockModLamp(5F, 6F, COLOR_PURPLE, SoundType.METAL)),
            enderStoneLamp = registerBlock("ender_stone_lamp", () -> new BlockModLamp(0.3F, 0.3F, COLOR_PURPLE, SoundType.GLASS)),
            goldLamp = registerBlock("gold_lamp", () -> new BlockModLamp(5F, 6F, GOLD, SoundType.METAL)),
            iceLamp = registerBlock("ice_lamp", () -> new BlockModLamp(0.3F, 0.3F, COLOR_LIGHT_BLUE, SoundType.GLASS)),
            jungleLamp = registerBlock("jungle_lamp", () -> new BlockModLamp(0.3F, 0.3F, EMERALD, SoundType.GLASS)),
            krakenLamp = registerBlock("kraken_lamp", () -> new BlockModLamp(5F, 6F, COLOR_LIGHT_GREEN, SoundType.METAL)),
            lapisLazuliLamp = registerBlock("lapis_lazuli_lamp", () -> new BlockModLamp(5F, 6F, COLOR_BLUE, SoundType.METAL)),
            lavaLamp = registerBlock("lava_lamp", () -> new BlockModLamp(5F, 6F, TERRACOTTA_ORANGE, SoundType.METAL)),
            milkyLamp = registerBlock("milky_lamp", () -> new BlockModLamp(5F, 6F, QUARTZ, SoundType.METAL)),
            moltenLamp = registerBlock("molten_lamp", () -> new BlockModLamp(0.3F, 0.3F, CRIMSON_NYLIUM, SoundType.GLASS)),
            torriditeLamp = registerBlock("torridite_lamp", () -> new BlockModLamp(5F, 6F, CRIMSON_NYLIUM, SoundType.METAL)),
            realmiteLamp = registerBlock("realmite_lamp", () -> new BlockModLamp(5F, 6F, TERRACOTTA_YELLOW, SoundType.METAL)),
            redstoneOreLamp = registerBlock("redstone_ore_lamp", () -> new BlockModLamp(5F, 6F, CRIMSON_STEM, SoundType.METAL)),
            rupeeLamp = registerBlock("rupee_lamp", () -> new BlockModLamp(5F, 6F, COLOR_BLUE, SoundType.METAL)),
            terranLamp = registerBlock("terran_lamp", () -> new BlockModLamp(0.3F, 0.3F, TERRACOTTA_GREEN, SoundType.GLASS));
    ...
    public static final RegistryObject<Block>// Structure blocks
            ...
            workshopLamp = registerBlock("workshop_lamp", () -> new BlockModLamp(0.3F, 0.3F, COLOR_LIGHT_BLUE, SoundType.GLASS));
    ...
    // Village
    public static final RegistryObject<Block> villageLamp = registerBlock("village_lamp", () -> new BlockModLamp(0.3F, 0.3F, TERRACOTTA_RED, SoundType.GLASS));

    public static final RegistryObject<Block>// Hive
            cellLamp = registerBlock("cell_lamp", () -> new BlockModLamp(0.3F, 0.3F, COLOR_LIGHT_GREEN, SoundType.GLASS)),
    ...
    public static final RegistryObject<Block>// Slabs
            ...
            wildwoodSlab = registerBlock("wildwood_slab", () -> new BlockModSlab(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "wildwood_planks")))),
            apalachiaSlab = registerBlock("apalachia_slab", () -> new BlockModSlab(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "apalachia_planks")))),
            skythernSlab = registerBlock("skythern_slab", () -> new BlockModSlab(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "skythern_planks")))),
            mortumSlab = registerBlock("mortum_slab", () -> new BlockModSlab(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "mortum_planks")))),
            divineSlab = registerBlock("divine_slab", () -> new BlockModSlab(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "divine_planks")))),
            frozenSlab = registerBlock("frozen_slab", () -> new BlockModSlab(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "frozen_planks")))),
            eucalyptusSlab = registerBlock("eucalyptus_slab", () -> new BlockModSlab(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "eucalyptus_planks")))),
            ancientBrickSlab = registerBlock("ancient_brick_slab", () -> new BlockModSlab(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(MODID, "ancient_bricks")))),
