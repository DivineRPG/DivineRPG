...
public class BlockRegistry {
    ...
    divineFenceGate = registerBlock("divine_fence_gate", () -> new BlockModGate(TERRACOTTA_LIGHT_GREEN, WoodTypesList.DIVINE)),
    divineDoor = registerBlock("divine_door", () -> new BlockModDoor(TERRACOTTA_LIGHT_GREEN, BlockSetTypesList.DIVINE)),
    divineTrapdoor = registerBlock("divine_trapdoor", () -> new BlockModTrapdoor(TERRACOTTA_LIGHT_GREEN, BlockSetTypesList.DIVINE)),
    divinePressurePlate = registerBlock("divine_pressure_plate", () -> new BlockModPressurePlate(TERRACOTTA_LIGHT_GREEN, BlockSetTypesList.DIVINE)),
    ...
    shiverspineFenceGate = registerBlock("shiverspine_fence_gate", () -> new BlockModGate(GLOW_LICHEN, WoodTypesList.SHIVERSPINE)),
    shiverspineLadder = registerBlock("shiverspine_ladder", BlockModLadder::new),
    shiverspineDoor = registerBlock("shiverspine_door", () -> new BlockModDoor(GLOW_LICHEN, BlockSetTypesList.SHIVERSPINE)),
    shiverspineTrapdoor = registerBlock("shiverspine_trapdoor", () -> new BlockModTrapdoor(GLOW_LICHEN, BlockSetTypesList.SHIVERSPINE)),
    shiverspinePressurePlate = registerBlock("shiverspine_pressure_plate", () -> new BlockModPressurePlate(GLOW_LICHEN, BlockSetTypesList.SHIVERSPINE)),
    ...
    auroraoakLog = registerBlock("auroraoak_log", () -> new BlockModLog(ICE, SoundType.CHERRY_WOOD)),
    ...
    auroraoakFence = registerBlock("auroraoak_fence", () -> new BlockModFence(ICE, SoundType.CHERRY_WOOD)),
    auroraoakFenceGate = registerBlock("auroraoak_fence_gate", () -> new BlockModGate(ICE, WoodTypesList.AURORAOAK)),
    auroraoakDoor = registerBlock("auroraoak_door", () -> new BlockModDoor(ICE, BlockSetTypesList.AURORAOAK)),
    auroraoakTrapdoor = registerBlock("auroraoak_trapdoor", () -> new BlockModTrapdoor(ICE, BlockSetTypesList.AURORAOAK)),
    auroraoakPressurePlate = registerBlock("auroraoak_pressure_plate", () -> new BlockModPressurePlate(ICE, BlockSetTypesList.AURORAOAK)),
    ...
    cozybarkFence = registerBlock("cozybark_fence", () -> new BlockModFence(TERRACOTTA_PURPLE, SoundType.CHERRY_WOOD)),
    cozybarkFenceGate = registerBlock("cozybark_fence_gate", () -> new BlockModGate(TERRACOTTA_PURPLE, WoodTypesList.COZYBARK)),
    cozybarkDoor = registerBlock("cozybark_door", () -> new BlockModDoor(TERRACOTTA_PURPLE, BlockSetTypesList.COZYBARK)),
    cozybarkTrapdoor = registerBlock("cozybark_trapdoor", () -> new BlockModTrapdoor(TERRACOTTA_PURPLE, BlockSetTypesList.COZYBARK)),
    cozybarkPressurePlate = registerBlock("cozybark_pressure_plate", () -> new BlockModPressurePlate(TERRACOTTA_PURPLE, BlockSetTypesList.COZYBARK)),
    ...
    streamleafFenceGate = registerBlock("streamleaf_fence_gate", () -> new BlockModGate(ICE, WoodTypesList.STREAMLEAF)),
    streamleafDoor = registerBlock("streamleaf_door", () -> new BlockModDoor(ICE, BlockSetTypesList.STREAMLEAF)),
    streamleafTrapdoor = registerBlock("streamleaf_trapdoor", () -> new BlockModTrapdoor(ICE, BlockSetTypesList.STREAMLEAF)),
    streamleafPressurePlate = registerBlock("streamleaf_pressure_plate", () -> new BlockModPressurePlate(ICE, BlockSetTypesList.STREAMLEAF)),
    ...
    eucalyptusFenceGate = registerBlock("eucalyptus_fence_gate", () -> new BlockModGate(TERRACOTTA_WHITE, WoodTypesList.EUCALYPTUS)),
    eucalyptusDoor = registerBlock("eucalyptus_door", () -> new BlockModDoor(TERRACOTTA_WHITE, BlockSetTypesList.EUCALYPTUS)),
    eucalyptusTrapdoor = registerBlock("eucalyptus_trapdoor", () -> new BlockModTrapdoor(TERRACOTTA_WHITE, BlockSetTypesList.EUCALYPTUS)),
    eucalyptusPressurePlate = registerBlock("eucalyptus_pressure_plate", () -> new BlockModPressurePlate(TERRACOTTA_WHITE, BlockSetTypesList.EUCALYPTUS)),
    ...
    edenFenceGate = registerBlock("eden_fence_gate", () -> new BlockModGate(SAND, WoodTypesList.EDEN)),
    edenDoor = registerBlock("eden_door", () -> new BlockModDoor(SAND, BlockSetTypesList.EDEN)),
    edenTrapdoor = registerBlock("eden_trapdoor", () -> new BlockModTrapdoor(SAND, BlockSetTypesList.EDEN)),
    edenPressurePlate = registerBlock("eden_pressure_plate", () -> new BlockModPressurePlate(SAND, BlockSetTypesList.EDEN)),
    ...
    wildwoodFenceGate = registerBlock("wildwood_fence_gate", () -> new BlockModGate(COLOR_LIGHT_BLUE, WoodTypesList.WILDWOOD)),
    wildwoodDoor = registerBlock("wildwood_door", () -> new BlockModDoor(COLOR_LIGHT_BLUE, BlockSetTypesList.WILDWOOD)),
    wildwoodTrapdoor = registerBlock("wildwood_trapdoor", () -> new BlockModTrapdoor(COLOR_LIGHT_BLUE, BlockSetTypesList.WILDWOOD)),
    wildwoodPressurePlate = registerBlock("wildwood_pressure_plate", () -> new BlockModPressurePlate(COLOR_LIGHT_BLUE, BlockSetTypesList.WILDWOOD)),
    ...
    apalachiaFenceGate = registerBlock("apalachia_fence_gate", () -> new BlockModGate(COLOR_MAGENTA, WoodTypesList.APALACHIA)),
    apalachiaDoor = registerBlock("apalachia_door", () -> new BlockModDoor(COLOR_MAGENTA, BlockSetTypesList.APALACHIA)),
    apalachiaTrapdoor = registerBlock("apalachia_trapdoor", () -> new BlockModTrapdoor(COLOR_MAGENTA, BlockSetTypesList.APALACHIA)),
    apalachiaPressurePlate = registerBlock("apalachia_pressure_plate", () -> new BlockModPressurePlate(COLOR_MAGENTA, BlockSetTypesList.APALACHIA)),
    ...
    skythernFenceGate = registerBlock("skythern_fence_gate", () -> new BlockModGate(WOOL, WoodTypesList.SKYTHERN)),
    skythernDoor = registerBlock("skythern_door", () -> new BlockModDoor(WOOL, BlockSetTypesList.SKYTHERN)),
    skythernTrapdoor = registerBlock("skythern_trapdoor", () -> new BlockModTrapdoor(WOOL, BlockSetTypesList.SKYTHERN)),
    skythernPressurePlate = registerBlock("skythern_pressure_plate", () -> new BlockModPressurePlate(WOOL, BlockSetTypesList.SKYTHERN)),
    ...
    mortumFenceGate = registerBlock("mortum_fence_gate", () -> new BlockModGate(COLOR_GRAY, WoodTypesList.MORTUM)),
    mortumDoor = registerBlock("mortum_door", () -> new BlockModDoor(COLOR_GRAY, BlockSetTypesList.MORTUM)),
    mortumTrapdoor = registerBlock("mortum_trapdoor", () -> new BlockModTrapdoor(COLOR_GRAY, BlockSetTypesList.MORTUM)),
    mortumPressurePlate = registerBlock("mortum_pressure_plate", () -> new BlockModPressurePlate(COLOR_GRAY, BlockSetTypesList.MORTUM)),
    ...
    mintwoodLog = registerBlock("mintwood_log", () -> new BlockModLog(DIAMOND, SoundType.NETHER_WOOD)),
    mintwoodWood = registerBlock("mintwood_wood", () -> new BlockModLog(WARPED_WART_BLOCK, SoundType.NETHER_WOOD)),
    strippedMintwoodLog = registerBlock("stripped_mintwood_log", () -> new BlockModLog(DIAMOND, SoundType.NETHER_WOOD)),
    strippedMintwoodWood = registerBlock("stripped_mintwood_wood", () -> new BlockModLog(COLOR_CYAN, SoundType.NETHER_WOOD)),
