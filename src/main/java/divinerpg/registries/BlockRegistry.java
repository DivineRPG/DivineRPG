...
public class BlockRegistry {
    ...
    divineFence = registerBlock("divine_fence", () -> new BlockModFence(divinePlanks.get().defaultMapColor(), SoundType.CHERRY_WOOD)),
    divineFenceGate = registerBlock("divine_fence_gate", () -> new BlockModGate(divinePlanks.get().defaultMapColor(), DIVINE)),
    divineDoor = registerBlock("divine_door", () -> new BlockModDoor(divinePlanks.get().defaultMapColor(), BlockSetTypesList.DIVINE)),
    divineTrapdoor = registerBlock("divine_trapdoor", () -> new BlockModTrapdoor(divinePlanks.get().defaultMapColor(), BlockSetTypesList.DIVINE)),
    divinePressurePlate = registerBlock("divine_pressure_plate", () -> new BlockModPressurePlate(divinePlanks.get().defaultMapColor(), BlockSetTypesList.DIVINE)),
    divineButton = registerBlock("divine_button", () -> new BlockModButton(BlockSetTypesList.DIVINE)),
    divineSign = registerBlockWithSpecialItem("divine_sign", () -> new DivineSignStanding(divinePlanks.get().defaultMapColor(), DIVINE)),
    divineWallSign = BLOCKS.register("divine_wall_sign", () -> new DivineSignWall(divinePlanks.get().defaultMapColor(), DIVINE)),
    divineHangingSign = registerBlockWithSpecialItem("divine_hanging_sign", () -> new DivineSignHangingCeiling(divinePlanks.get().defaultMapColor(), DIVINE)),
    divineHangingWallSign = BLOCKS.register("divine_wall_hanging_sign", () -> new DivineSignHangingWall(divinePlanks.get().defaultMapColor(), DIVINE)),
    ...
    shiverspineFence = registerBlock("shiverspine_fence", () -> new BlockModFence(shiverspinePlanks.get().defaultMapColor())),
    shiverspineFenceGate = registerBlock("shiverspine_fence_gate", () -> new BlockModGate(shiverspinePlanks.get().defaultMapColor(), SHIVERSPINE)),
    shiverspineLadder = registerBlock("shiverspine_ladder", BlockModLadder::new),
    shiverspineDoor = registerBlock("shiverspine_door", () -> new BlockModDoor(shiverspinePlanks.get().defaultMapColor(), BlockSetTypesList.SHIVERSPINE)),
    shiverspineTrapdoor = registerBlock("shiverspine_trapdoor", () -> new BlockModTrapdoor(shiverspinePlanks.get().defaultMapColor(), BlockSetTypesList.SHIVERSPINE)),
    shiverspinePressurePlate = registerBlock("shiverspine_pressure_plate", () -> new BlockModPressurePlate(shiverspinePlanks.get().defaultMapColor(), BlockSetTypesList.SHIVERSPINE)),
    shiverspineButton = registerBlock("shiverspine_button", () -> new BlockModButton(BlockSetTypesList.SHIVERSPINE)),
    shiverspineSign = registerBlockWithSpecialItem("shiverspine_sign", () -> new DivineSignStanding(shiverspinePlanks.get().defaultMapColor(), SHIVERSPINE)),
    shiverspineWallSign = BLOCKS.register("shiverspine_wall_sign", () -> new DivineSignWall(shiverspinePlanks.get().defaultMapColor(), SHIVERSPINE)),
    shiverspineHangingSign = registerBlockWithSpecialItem("shiverspine_hanging_sign", () -> new DivineSignHangingCeiling(shiverspinePlanks.get().defaultMapColor(), SHIVERSPINE)),
    shiverspineHangingWallSign = BLOCKS.register("shiverspine_wall_hanging_sign", () -> new DivineSignHangingWall(shiverspinePlanks.get().defaultMapColor(), SHIVERSPINE)),
    ...
    auroraoakFence = registerBlock("auroraoak_fence", () -> new BlockModFence(auroraoakPlanks.get().defaultMapColor(), SoundType.CHERRY_WOOD)),
    auroraoakFenceGate = registerBlock("auroraoak_fence_gate", () -> new BlockModGate(auroraoakPlanks.get().defaultMapColor(), WoodTypesList.AURORAOAK)),
    auroraoakDoor = registerBlock("auroraoak_door", () -> new BlockModDoor(auroraoakPlanks.get().defaultMapColor(), BlockSetTypesList.AURORAOAK)),
    auroraoakTrapdoor = registerBlock("auroraoak_trapdoor", () -> new BlockModTrapdoor(auroraoakPlanks.get().defaultMapColor(), BlockSetTypesList.AURORAOAK)),
    auroraoakPressurePlate = registerBlock("auroraoak_pressure_plate", () -> new BlockModPressurePlate(auroraoakPlanks.get().defaultMapColor(), BlockSetTypesList.AURORAOAK)),
    auroraoakButton = registerBlock("auroraoak_button", () -> new BlockModButton(BlockSetTypesList.AURORAOAK)),
    auroraoakSign = registerBlockWithSpecialItem("auroraoak_sign", () -> new DivineSignStanding(auroraoakPlanks.get().defaultMapColor(), AURORAOAK)),
    auroraoakWallSign = BLOCKS.register("auroraoak_wall_sign", () -> new DivineSignWall(auroraoakPlanks.get().defaultMapColor(), AURORAOAK)),
    auroraoakHangingSign = registerBlockWithSpecialItem("auroraoak_hanging_sign", () -> new DivineSignHangingCeiling(auroraoakPlanks.get().defaultMapColor(), AURORAOAK)),
    auroraoakHangingWallSign = BLOCKS.register("auroraoak_wall_hanging_sign", () -> new DivineSignHangingWall(auroraoakPlanks.get().defaultMapColor(), AURORAOAK)),
    ...
    cozybarkFence = registerBlock("cozybark_fence", () -> new BlockModFence(cozybarkPlanks.get().defaultMapColor(), SoundType.CHERRY_WOOD)),
    cozybarkFenceGate = registerBlock("cozybark_fence_gate", () -> new BlockModGate(cozybarkPlanks.get().defaultMapColor(), WoodTypesList.COZYBARK)),
    cozybarkDoor = registerBlock("cozybark_door", () -> new BlockModDoor(cozybarkPlanks.get().defaultMapColor(), BlockSetTypesList.COZYBARK)),
    cozybarkTrapdoor = registerBlock("cozybark_trapdoor", () -> new BlockModTrapdoor(cozybarkPlanks.get().defaultMapColor(), BlockSetTypesList.COZYBARK)),
    cozybarkPressurePlate = registerBlock("cozybark_pressure_plate", () -> new BlockModPressurePlate(cozybarkPlanks.get().defaultMapColor(), BlockSetTypesList.COZYBARK)),
    cozybarkButton = registerBlock("cozybark_button", () -> new BlockModButton(BlockSetTypesList.COZYBARK)),
    cozybarkSign = registerBlockWithSpecialItem("cozybark_sign", () -> new DivineSignStanding(cozybarkPlanks.get().defaultMapColor(), COZYBARK)),
    cozybarkWallSign = BLOCKS.register("cozybark_wall_sign", () -> new DivineSignWall(cozybarkPlanks.get().defaultMapColor(), COZYBARK)),
    cozybarkHangingSign = registerBlockWithSpecialItem("cozybark_hanging_sign", () -> new DivineSignHangingCeiling(cozybarkPlanks.get().defaultMapColor(), COZYBARK)),
    cozybarkHangingWallSign = BLOCKS.register("cozybark_wall_hanging_sign", () -> new DivineSignHangingWall(cozybarkPlanks.get().defaultMapColor(), COZYBARK)),
    ...
    streamleafFence = registerBlock("streamleaf_fence", () -> new BlockModFence(streamleafPlanks.get().defaultMapColor(), SoundType.NETHER_WOOD)),
    streamleafFenceGate = registerBlock("streamleaf_fence_gate", () -> new BlockModGate(streamleafPlanks.get().defaultMapColor(), WoodTypesList.STREAMLEAF)),
    streamleafDoor = registerBlock("streamleaf_door", () -> new BlockModDoor(streamleafPlanks.get().defaultMapColor(), BlockSetTypesList.STREAMLEAF)),
    streamleafTrapdoor = registerBlock("streamleaf_trapdoor", () -> new BlockModTrapdoor(streamleafPlanks.get().defaultMapColor(), BlockSetTypesList.STREAMLEAF)),
    streamleafPressurePlate = registerBlock("streamleaf_pressure_plate", () -> new BlockModPressurePlate(streamleafPlanks.get().defaultMapColor(), BlockSetTypesList.STREAMLEAF)),
    streamleafButton = registerBlock("streamleaf_button", () -> new BlockModButton(BlockSetTypesList.STREAMLEAF)),
    streamleafSign = registerBlockWithSpecialItem("streamleaf_sign", () -> new DivineSignStanding(streamleafPlanks.get().defaultMapColor(), STREAMLEAF)),
    streamleafWallSign = BLOCKS.register("streamleaf_wall_sign", () -> new DivineSignWall(streamleafPlanks.get().defaultMapColor(), STREAMLEAF)),
    streamleafHangingSign = registerBlockWithSpecialItem("streamleaf_hanging_sign", () -> new DivineSignHangingCeiling(streamleafPlanks.get().defaultMapColor(), STREAMLEAF)),
    streamleafHangingWallSign = BLOCKS.register("streamleaf_wall_hanging_sign", () -> new DivineSignHangingWall(streamleafPlanks.get().defaultMapColor(), STREAMLEAF)),
    ...
    eucalyptusFence = registerBlock("eucalyptus_fence", () -> new BlockModFence(eucalyptusPlanks.get().defaultMapColor())),
    eucalyptusFenceGate = registerBlock("eucalyptus_fence_gate", () -> new BlockModGate(eucalyptusPlanks.get().defaultMapColor(), WoodTypesList.EUCALYPTUS)),
    eucalyptusDoor = registerBlock("eucalyptus_door", () -> new BlockModDoor(eucalyptusPlanks.get().defaultMapColor(), BlockSetTypesList.EUCALYPTUS)),
    eucalyptusTrapdoor = registerBlock("eucalyptus_trapdoor", () -> new BlockModTrapdoor(eucalyptusPlanks.get().defaultMapColor(), BlockSetTypesList.EUCALYPTUS)),
    eucalyptusPressurePlate = registerBlock("eucalyptus_pressure_plate", () -> new BlockModPressurePlate(eucalyptusPlanks.get().defaultMapColor(), BlockSetTypesList.EUCALYPTUS)),
    eucalyptusButton = registerBlock("eucalyptus_button", () -> new BlockModButton(BlockSetTypesList.EUCALYPTUS)),
    eucalyptusSign = registerBlockWithSpecialItem("eucalyptus_sign", () -> new DivineSignStanding(eucalyptusPlanks.get().defaultMapColor(), EUCALYPTUS)),
    eucalyptusWallSign = BLOCKS.register("eucalyptus_wall_sign", () -> new DivineSignWall(eucalyptusPlanks.get().defaultMapColor(), EUCALYPTUS)),
    eucalyptusHangingSign = registerBlockWithSpecialItem("eucalyptus_hanging_sign", () -> new DivineSignHangingCeiling(eucalyptusPlanks.get().defaultMapColor(), EUCALYPTUS)),
    eucalyptusHangingWallSign = BLOCKS.register("eucalyptus_wall_hanging_sign", () -> new DivineSignHangingWall(eucalyptusPlanks.get().defaultMapColor(), EUCALYPTUS)),
    ...
    edenFence = registerBlock("eden_fence", () -> new BlockModFence(edenPlanks.get().defaultMapColor())),
    edenFenceGate = registerBlock("eden_fence_gate", () -> new BlockModGate(edenPlanks.get().defaultMapColor(), EDEN)),
    edenDoor = registerBlock("eden_door", () -> new BlockModDoor(edenPlanks.get().defaultMapColor(), BlockSetTypesList.EDEN)),
    edenTrapdoor = registerBlock("eden_trapdoor", () -> new BlockModTrapdoor(edenPlanks.get().defaultMapColor(), BlockSetTypesList.EDEN)),
    edenPressurePlate = registerBlock("eden_pressure_plate", () -> new BlockModPressurePlate(edenPlanks.get().defaultMapColor(), BlockSetTypesList.EDEN)),
    edenButton = registerBlock("eden_button", () -> new BlockModButton(BlockSetTypesList.EDEN)),
    edenSign = registerBlockWithSpecialItem("eden_sign", () -> new DivineSignStanding(edenPlanks.get().defaultMapColor(), EDEN)),
    edenWallSign = BLOCKS.register("eden_wall_sign", () -> new DivineSignWall(edenPlanks.get().defaultMapColor(), EDEN)),
    edenHangingSign = registerBlockWithSpecialItem("eden_hanging_sign", () -> new DivineSignHangingCeiling(edenPlanks.get().defaultMapColor(), EDEN)),
    edenHangingWallSign = BLOCKS.register("eden_wall_hanging_sign", () -> new DivineSignHangingWall(edenPlanks.get().defaultMapColor(), EDEN)),
    ...
    wildwoodFence = registerBlock("wildwood_fence", () -> new BlockModFence(wildwoodPlanks.get().defaultMapColor())),
    wildwoodFenceGate = registerBlock("wildwood_fence_gate", () -> new BlockModGate(wildwoodPlanks.get().defaultMapColor(), WoodTypesList.WILDWOOD)),
    wildwoodDoor = registerBlock("wildwood_door", () -> new BlockModDoor(wildwoodPlanks.get().defaultMapColor(), BlockSetTypesList.WILDWOOD)),
    wildwoodTrapdoor = registerBlock("wildwood_trapdoor", () -> new BlockModTrapdoor(wildwoodPlanks.get().defaultMapColor(), BlockSetTypesList.WILDWOOD)),
    wildwoodPressurePlate = registerBlock("wildwood_pressure_plate", () -> new BlockModPressurePlate(wildwoodPlanks.get().defaultMapColor(), BlockSetTypesList.WILDWOOD)),
    wildwoodButton = registerBlock("wildwood_button", () -> new BlockModButton(BlockSetTypesList.WILDWOOD)),
    wildwoodSign = registerBlockWithSpecialItem("wildwood_sign", () -> new DivineSignStanding(wildwoodPlanks.get().defaultMapColor(), WILDWOOD)),
    wildwoodWallSign = BLOCKS.register("wildwood_wall_sign", () -> new DivineSignWall(wildwoodPlanks.get().defaultMapColor(), WILDWOOD)),
    wildwoodHangingSign = registerBlockWithSpecialItem("wildwood_hanging_sign", () -> new DivineSignHangingCeiling(wildwoodPlanks.get().defaultMapColor(), WILDWOOD)),
    wildwoodHangingWallSign = BLOCKS.register("wildwood_wall_hanging_sign", () -> new DivineSignHangingWall(wildwoodPlanks.get().defaultMapColor(), WILDWOOD)),
    ...
    apalachiaFence = registerBlock("apalachia_fence", () -> new BlockModFence(apalachiaPlanks.get().defaultMapColor())),
    apalachiaFenceGate = registerBlock("apalachia_fence_gate", () -> new BlockModGate(apalachiaPlanks.get().defaultMapColor(), WoodTypesList.APALACHIA)),
    apalachiaDoor = registerBlock("apalachia_door", () -> new BlockModDoor(apalachiaPlanks.get().defaultMapColor(), BlockSetTypesList.APALACHIA)),
    apalachiaTrapdoor = registerBlock("apalachia_trapdoor", () -> new BlockModTrapdoor(apalachiaPlanks.get().defaultMapColor(), BlockSetTypesList.APALACHIA)),
    apalachiaPressurePlate = registerBlock("apalachia_pressure_plate", () -> new BlockModPressurePlate(apalachiaPlanks.get().defaultMapColor(), BlockSetTypesList.APALACHIA)),
    apalachiaButton = registerBlock("apalachia_button", () -> new BlockModButton(BlockSetTypesList.APALACHIA)),
    apalachiaSign = registerBlockWithSpecialItem("apalachia_sign", () -> new DivineSignStanding(apalachiaPlanks.get().defaultMapColor(), APALACHIA)),
    apalachiaWallSign = BLOCKS.register("apalachia_wall_sign", () -> new DivineSignWall(apalachiaPlanks.get().defaultMapColor(), APALACHIA)),
    apalachiaHangingSign = registerBlockWithSpecialItem("apalachia_hanging_sign", () -> new DivineSignHangingCeiling(apalachiaPlanks.get().defaultMapColor(), APALACHIA)),
    apalachiaHangingWallSign = BLOCKS.register("apalachia_wall_hanging_sign", () -> new DivineSignHangingWall(apalachiaPlanks.get().defaultMapColor(), APALACHIA)),
    ...
    skythernFence = registerBlock("skythern_fence", () -> new BlockModFence(skythernPlanks.get().defaultMapColor(), SoundType.NETHER_WOOD)),
    skythernFenceGate = registerBlock("skythern_fence_gate", () -> new BlockModGate(skythernPlanks.get().defaultMapColor(), WoodTypesList.SKYTHERN)),
    skythernDoor = registerBlock("skythern_door", () -> new BlockModDoor(skythernPlanks.get().defaultMapColor(), BlockSetTypesList.SKYTHERN)),
    skythernTrapdoor = registerBlock("skythern_trapdoor", () -> new BlockModTrapdoor(skythernPlanks.get().defaultMapColor(), BlockSetTypesList.SKYTHERN)),
    skythernPressurePlate = registerBlock("skythern_pressure_plate", () -> new BlockModPressurePlate(skythernPlanks.get().defaultMapColor(), BlockSetTypesList.SKYTHERN)),
    skythernButton = registerBlock("skythern_button", () -> new BlockModButton(BlockSetTypesList.SKYTHERN)),
    skythernSign = registerBlockWithSpecialItem("skythern_sign", () -> new DivineSignStanding(skythernPlanks.get().defaultMapColor(), SKYTHERN)),
    skythernWallSign = BLOCKS.register("skythern_wall_sign", () -> new DivineSignWall(skythernPlanks.get().defaultMapColor(), SKYTHERN)),
    skythernHangingSign = registerBlockWithSpecialItem("skythern_hanging_sign", () -> new DivineSignHangingCeiling(skythernPlanks.get().defaultMapColor(), SKYTHERN)),
    skythernHangingWallSign = BLOCKS.register("skythern_wall_hanging_sign", () -> new DivineSignHangingWall(skythernPlanks.get().defaultMapColor(), SKYTHERN)),
    ...
    mortumFence = registerBlock("mortum_fence", () -> new BlockModFence(mortumPlanks.get().defaultMapColor())),
    mortumFenceGate = registerBlock("mortum_fence_gate", () -> new BlockModGate(mortumPlanks.get().defaultMapColor(), WoodTypesList.MORTUM)),
    mortumDoor = registerBlock("mortum_door", () -> new BlockModDoor(mortumPlanks.get().defaultMapColor(), BlockSetTypesList.MORTUM)),
    mortumTrapdoor = registerBlock("mortum_trapdoor", () -> new BlockModTrapdoor(mortumPlanks.get().defaultMapColor(), BlockSetTypesList.MORTUM)),
    mortumPressurePlate = registerBlock("mortum_pressure_plate", () -> new BlockModPressurePlate(mortumPlanks.get().defaultMapColor(), BlockSetTypesList.MORTUM)),
    mortumButton = registerBlock("mortum_button", () -> new BlockModButton(BlockSetTypesList.MORTUM)),
    mortumSign = registerBlockWithSpecialItem("mortum_sign", () -> new DivineSignStanding(mortumPlanks.get().defaultMapColor(), MORTUM)),
    mortumWallSign = BLOCKS.register("mortum_wall_sign", () -> new DivineSignWall(mortumPlanks.get().defaultMapColor(), MORTUM)),
    mortumHangingSign = registerBlockWithSpecialItem("mortum_hanging_sign", () -> new DivineSignHangingCeiling(mortumPlanks.get().defaultMapColor(), MORTUM)),
    mortumHangingWallSign = BLOCKS.register("mortum_wall_hanging_sign", () -> new DivineSignHangingWall(mortumPlanks.get().defaultMapColor(), MORTUM)),
