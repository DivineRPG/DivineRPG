...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block>
            ...
            shiverspineFenceGate = registerBlock("shiverspine_fence_gate", () -> new BlockModGate(ICE, WoodType.OAK)),
            shiverspineDoor = registerBlock("shiverspine_door", () -> new BlockModDoor(ICE, BlockSetType.OAK)),
            shiverspineTrapdoor = registerBlock("shiverspine_trapdoor", () -> new BlockModTrapdoor(ICE, BlockSetType.OAK)),
            shiverspinePressurePlate = registerBlock("shiverspine_pressure_plate", () -> new BlockModPressurePlate(ICE, BlockSetType.OAK)),
            shiverspineButton = registerBlock("shiverspine_button", () -> new BlockModButton(BlockSetType.OAK)),
