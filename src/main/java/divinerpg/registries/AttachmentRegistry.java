...
public class AttachmentRegistry {
	...
	public static final DeferredHolder<AttachmentType<?>, AttachmentType<DimensionalInventory>> DIMENSIONAL_INVENTORY = ATTACHMENT_TYPES.register("dimensional_inventory", () -> AttachmentType.serializable(() -> new DimensionalInventory()).build());
	public static final DeferredHolder<AttachmentType<?>, AttachmentType<Reputation>> REPUTATION = ATTACHMENT_TYPES.register("reputation", () -> AttachmentType.serializable(() -> new Reputation()).build());
}