...
public class BlockEntityRegistry {
    ...
    //Signs
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<DivineSign>> DIVINE_SIGN = register("divine_sign", () -> BlockEntityType.Builder.of(DivineSign::new, BlockRegistry.divineSign.get(), BlockRegistry.divineWallSign.get(), BlockRegistry.shiverspineSign.get(), BlockRegistry.shiverspineWallSign.get(), BlockRegistry.auroraoakSign.get(), BlockRegistry.auroraoakWallSign.get(), BlockRegistry.cozybarkSign.get(), BlockRegistry.cozybarkWallSign.get(), BlockRegistry.streamleafSign.get(), BlockRegistry.streamleafWallSign.get(), BlockRegistry.eucalyptusSign.get(), BlockRegistry.eucalyptusWallSign.get(), BlockRegistry.edenSign.get(), BlockRegistry.edenWallSign.get(), BlockRegistry.wildwoodSign.get(), BlockRegistry.wildwoodWallSign.get(), BlockRegistry.apalachiaSign.get(), BlockRegistry.apalachiaWallSign.get(), BlockRegistry.skythernSign.get(), BlockRegistry.skythernWallSign.get(), BlockRegistry.mortumSign.get(), BlockRegistry.mortumWallSign.get()).build(null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<DivineSignHanging>> DIVINE_HANGING_SIGN = register("divine_hanging_sign", () -> BlockEntityType.Builder.of(DivineSignHanging::new, BlockRegistry.divineHangingSign.get(), BlockRegistry.divineHangingWallSign.get(), BlockRegistry.shiverspineHangingSign.get(), BlockRegistry.shiverspineHangingWallSign.get(), BlockRegistry.auroraoakHangingSign.get(), BlockRegistry.auroraoakHangingWallSign.get(), BlockRegistry.cozybarkHangingSign.get(), BlockRegistry.cozybarkHangingWallSign.get(), BlockRegistry.streamleafHangingSign.get(), BlockRegistry.streamleafHangingWallSign.get(), BlockRegistry.eucalyptusHangingSign.get(), BlockRegistry.eucalyptusHangingWallSign.get(), BlockRegistry.edenHangingSign.get(), BlockRegistry.edenHangingWallSign.get(), BlockRegistry.wildwoodHangingSign.get(), BlockRegistry.wildwoodHangingWallSign.get(), BlockRegistry.apalachiaHangingSign.get(), BlockRegistry.apalachiaHangingWallSign.get(), BlockRegistry.skythernHangingSign.get(), BlockRegistry.skythernHangingWallSign.get(), BlockRegistry.mortumHangingSign.get(), BlockRegistry.mortumHangingWallSign.get()).build(null));
    //Chests
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<OxcrateBlockEntity>> OXCRATE = register("oxcrate", () -> BlockEntityType.Builder.of(OxcrateBlockEntity::new, BlockRegistry.oxcrate.get()).build(null));
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<InserterBlockEntity>> INSERTER = register("inserter", () -> BlockEntityType.Builder.of(InserterBlockEntity::new, BlockRegistry.inserter.get()).build(null));
