...
public class BlockEntityRegistry {
    ...
    public static final RegistryObject<BlockEntityType<NightmareBedBlockEntity>> NIGHTMARE_BED = register("nightmare_bed", () -> BlockEntityType.Builder.of(NightmareBedBlockEntity::new, ForgeRegistries.BLOCKS.getValue(new ResourceLocation(DivineRPG.MODID, "nightmare_bed"))).build(null));
