...
public class EntityRegistry {
    ...
    public static final EntityType<EntityJackOMan> JACK_O_MAN = registerEntity(EntityJackOMan::new, "jack_o_man", 0.8F, 2F, EntityClassification.AMBIENT);
    ...
    public static final EntityType<EntityLivestockMerchant> LIVESTOCK_MERCHANT = registerEntity(EntityLivestockMerchant::new, "livestock_merchant", 0.8F, 2f, SpawnEggColors.getColorsForDimension(SpawnEggColors.Dimension.OVERWORLD), EntityClassification.AMBIENT);
