...
public class EntityRegistry {
    ...
    public static final RegistryObject<EntityType<EntityShooterBullet>>			 SOUND_OF_CAROLS = registerProjectile(EntityShooterBullet::new,                     "sound_of_carols");
    public static final RegistryObject<EntityType<EntityShooterBullet>>			 SOUND_OF_MUSIC = registerProjectile(EntityShooterBullet::new,                      "sound_of_music");
    public static final RegistryObject<EntityType<EntityShooterBullet>>			 SOUND_OF_WHALES = registerProjectile(EntityShooterBullet::new,                     "sound_of_whales");
    public static final RegistryObject<EntityType<EntityShooterBullet>>			 SPARKLER = registerProjectile(EntityShooterBullet::new,                            "sparkler");
    ...
    public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        //Projectiles
        event.registerEntityRenderer(APALACHIA_SLICER.get(), 		RenderShooterBullet::new);
        ...
        event.registerEntityRenderer(EDEN_SLICER.get(), 		    RenderShooterBullet::new);
        ...
        event.registerEntityRenderer(GRENADE.get(), 				RenderShooterBullet::new);
        event.registerEntityRenderer(HALITE_SLICER.get(), 		    RenderShooterBullet::new);
        ...
        event.registerEntityRenderer(MORTUM_SLICER.get(), 		    RenderShooterBullet::new);
        ...
        event.registerEntityRenderer(SHURIKEN.get(), 				RenderShooterBullet::new);
        event.registerEntityRenderer(SKYRE_BULLET.get(), 		    (Context context) -> new RenderDivineProjectile<>(context, "skyre_bullet"));
        event.registerEntityRenderer(SKYTHERN_SLICER.get(), 		RenderShooterBullet::new);
        event.registerEntityRenderer(SNOWFLAKE_SHURIKEN.get(), 		RenderShooterBullet::new);
        event.registerEntityRenderer(SOUL_FIEND_SHOT.get(),         RenderDivineProjectile::new);
        event.registerEntityRenderer(SOUND_OF_CAROLS.get(), 		RenderShooterBullet::new);
        event.registerEntityRenderer(SOUND_OF_MUSIC.get(), 			RenderShooterBullet::new);
        event.registerEntityRenderer(SOUND_OF_WHALES.get(), 		RenderShooterBullet::new);
        event.registerEntityRenderer(SPARKLER.get(), 				RenderShooterBullet::new);
        event.registerEntityRenderer(STARLIGHT.get(), 				(Context context) -> new RenderDivineProjectile<>(context, "starlight"));
        event.registerEntityRenderer(TOMATO.get(), 			        RenderShooterBullet::new);
        ...
        event.registerEntityRenderer(VILE_STORM.get(), 				RenderShooterBullet::new);
        ...
        event.registerEntityRenderer(WILDWOOD_SLICER.get(), 		RenderShooterBullet::new);
