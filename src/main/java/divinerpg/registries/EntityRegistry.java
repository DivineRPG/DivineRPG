...
public class EntityRegistry {
    ...
    public static void registerSpawns() {
        ...
        //Vethea
        registerLandSpawn(ACID_HAG, EntityAcidHag::canSpawnOn);
        registerLandSpawn(BIPHRON, EntityBiphron::canSpawnOn);
        registerLandSpawn(BOHEMITE, EntityBohemite::canSpawnOn);
        registerLandSpawn(CRYPT_KEEPER, EntityCryptKeeper::canSpawnOn);
        registerLandSpawn(CYMESOID, EntityCymesoid::canSpawnOn);
        registerLandSpawn(DISSIMENT, EntityDissiment::canSpawnOn);
        registerLandSpawn(DREAMWRECKER, EntityDreamwrecker::canSpawnOn);
        registerLandSpawn(DUO, EntityDuo::canSpawnOn);
        registerLandSpawn(ENT, EntityEnt::canSpawnOn);
        registerLandSpawn(FAKE_VHRAAK, EntityFakeVhraak::canSpawnOn);
        registerLandSpawn(GALROID, EntityGalroid::canSpawnOn);
        registerLandSpawn(GORGOSION, EntityGorgosion::canSpawnOn);
        registerLandSpawn(HELIO, EntityHelio::canSpawnOn);
        registerLandSpawn(HIVE_SOLDIER, EntityHiveSoldier::canSpawnOn);
        registerLandSpawn(HOVER_STINGER, EntityHoverStinger::canSpawnOn);
        registerLandSpawn(KAZROTIC, EntityKazrotic::canSpawnOn);
        registerLandSpawn(LHEIVA, EntityLheiva::canSpawnOn);
        registerLandSpawn(LORGA, EntityLorga::canSpawnOn);
        registerLandSpawn(LORGA_FLIGHT, EntityLorgaflight::canSpawnOn);
        registerLandSpawn(MANDRAGORA, EntityMandragora::canSpawnOn);
        registerLandSpawn(MYSTERIOUS_MAN_LAYER1, EntityMysteriousManLayer1::canSpawnOn);
        registerLandSpawn(MYSTERIOUS_MAN_LAYER2, EntityMysteriousManLayer2::canSpawnOn);
        registerLandSpawn(MYSTERIOUS_MAN_LAYER3, EntityMysteriousManLayer3::canSpawnOn);
        registerLandSpawn(SHADAHIER, EntityShadahier::canSpawnOn);
        registerLandSpawn(TEMPLE_GUARDIAN, EntityTempleGuardian::canSpawnOn);
        registerLandSpawn(THE_HUNGER, EntityTheHunger::canSpawnOn);
        registerLandSpawn(TOCAXIN, EntityTocaxin::canSpawnOn);
        registerLandSpawn(TWINS, EntityTwins::canSpawnOn);
        registerLandSpawn(VERMENOUS, EntityVermenous::canSpawnOn);
        registerLandSpawn(VHRAAK, EntityVhraak::canSpawnOn);
        registerLandSpawn(ZONE, EntityZone::canSpawnOn);
        registerLandSpawn(ZORAGON, EntityZoragon::canSpawnOn);
    }
