...
public class EntityRegistry {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<EntitySeng>>               SENG                = registerEntity(EntitySeng::new,               "seng",                   .9F, 1, .59375F, 0xffffff, 0xffffff, MobCategory.CREATURE);
