...
public class EntityRegistry {
    ...
    public static final EntityType<EntityJackOMan> JACK_O_MAN = registerEntity(EntityJackOMan::new, "jack_o_man", 0.8F, 2F, EntityClassification.CREATURE);
    ...
    public static final EntityType<EntityWorkshopMerchant> WORKSHOP_MERCHANT = registerEntity(EntityWorkshopMerchant::new, "workshop_merchant",1.0F, 2.0F, SpawnEggColors.getColorsForDimension(SpawnEggColors.Dimension.ICEIKA), EntityClassification.CREATURE);
    public static final EntityType<EntityWorkshopTinkerer> WORKSHOP_TINKERER = registerEntity(EntityWorkshopTinkerer::new, "workshop_tinkerer",1.0F, 2.0F, SpawnEggColors.getColorsForDimension(SpawnEggColors.Dimension.ICEIKA), EntityClassification.CREATURE);
    ...
    // Arcana
    public static final EntityType<EntityCaptainMerik> CAPTAIN_MERIK = registerEntity(EntityCaptainMerik::new, "captain_merik", 0.8F, 2.0F, SpawnEggColors.getColorsForDimension(SpawnEggColors.Dimension.ARCANA), EntityClassification.CREATURE);
    public static final EntityType<EntityDatticon> DATTICON = registerEntity(EntityDatticon::new, "datticon", 0.8F, 2.0F, SpawnEggColors.getColorsForDimension(SpawnEggColors.Dimension.ARCANA), EntityClassification.CREATURE);
    ...
    public static final EntityType<? extends TameableEntity> GOLEM_OF_REJUVENATION = registerEntity(EntityGolemOfRejuvenation::new, "golem_of_rejuvenation", 1F, 2.35F, SpawnEggColors.getColorsForDimension(SpawnEggColors.Dimension.ARCANA), EntityClassification.CREATURE);
    public static final EntityType<EntityKazari> KAZARI = registerEntity(EntityKazari::new, "kazari", 0.8F, 1.8F, SpawnEggColors.getColorsForDimension(SpawnEggColors.Dimension.ARCANA), EntityClassification.CREATURE);
    public static final EntityType<EntityLeorna> LEORNA = registerEntity(EntityLeorna::new, "leorna", 0.8F, 1.8F, SpawnEggColors.getColorsForDimension(SpawnEggColors.Dimension.ARCANA), EntityClassification.CREATURE);
    ...
    public static final EntityType<EntityLordVatticus> LORD_VATTICUS = registerEntity(EntityLordVatticus::new, "lord_vatticus", 0.8F, 1.8F, SpawnEggColors.getColorsForDimension(SpawnEggColors.Dimension.ARCANA), EntityClassification.CREATURE);
    ...
    public static final EntityType<EntityWarGeneral> WAR_GENERAL = registerEntity(EntityWarGeneral::new, "war_general", 0.8F, 2.0F, SpawnEggColors.getColorsForDimension(SpawnEggColors.Dimension.ARCANA), EntityClassification.CREATURE);
    ...
    public static final EntityType<EntityZelus> ZELUS = registerEntity(EntityZelus::new, "zelus", 0.8F, 1.8F, SpawnEggColors.getColorsForDimension(SpawnEggColors.Dimension.ARCANA), EntityClassification.CREATURE);
    ...
    public static final EntityType<EntityTheHunger> THE_HUNGER = registerEntity(EntityTheHunger::new, "the_hunger", 0.8F, 2.0F, SpawnEggColors.getColorsForDimension(SpawnEggColors.Dimension.VETHEA), EntityClassification.CREATURE);
    ...
    public static void spawnStuff(BiomeLoadingEvent event) {
        ...
        if (biome == Biome.Category.THEEND) {                                                        //EntType      //Weight        //Min       //Max
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(ENDER_SPIDER,  2, 1, 4));
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(ENDER_TRIPLETS,  2, 1, 4));
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(ENDER_WATCHER,  4, 4, 4));
        }
        if (biome == Biome.Category.NETHER) {
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(HELL_BAT, 1, 1, 1));
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(HELL_PIG, 1, 5, 5));
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(HELL_SPIDER, 3, 1, 1));
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(SCORCHER, 2, 1, 4));
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(WILDFIRE, 5, 1, 1));
        }
        if (biome == Biome.Category.TAIGA || biome == Biome.Category.EXTREME_HILLS || biome == Biome.Category.JUNGLE || biome == Biome.Category.MESA || biome == Biome.Category.PLAINS || biome == Biome.Category.SAVANNA
            ...
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(ROTATICK, 15, 3, 4));
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(THE_EYE, 5, 1, 4));
            if(biome != Biome.Category.MUSHROOM) {
            	event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(CAVE_CRAWLER, 15, 2, 3));
            	event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(CAVECLOPS, 15, 1, 4));
                ...
                event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(JACK_O_MAN, 3, 1, 1));
                event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(THE_GRUE, 5, 1, 4));
            }
        }
        if (biome == Biome.Category.ICY) {
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(FROST, 15, 1, 4));
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(GLACON, 10, 1, 1));
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(GLACON, 10, 1, 1));
        }
        if (biome == Biome.Category.DESERT) {
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(ARID_WARRIOR, 10, 1, 4));
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(DESERT_CRAWLER, 15, 1, 4));
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(SAGUARO_WORM, 8, 1, 4));
        }
        if (biome == Biome.Category.BEACH || biome == Biome.Category.RIVER || biome == Biome.Category.OCEAN) {
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(CRAB, 10, 4, 4));
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(KING_CRAB, 5, 4, 4));
        }
        if (biome == Biome.Category.JUNGLE) {
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(JUNGLE_BAT, 3, 1, 4));
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(JUNGLE_DRAMCRYX, 10, 1, 4));
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(JUNGLE_SPIDER , 10, 1, 4));
        }
        ...
        if (biome == Biome.Category.FOREST || biome == Biome.Category.MUSHROOM || biome == Biome.Category.SAVANNA) {
            event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(PUMPKIN_SPIDER, 10, 1, 1));
        }
        if (biome == Biome.Category.OCEAN) {
            ...
            event.getSpawns().getSpawner(EntityClassification.WATER_CREATURE).add(new MobSpawnInfo.Spawners(AEQUOREA, 8, 1, 8));
        }
    }
    ...
    public static void render() {
        ...
        //Projectile
        manager.register(ATTRACTOR, new RenderDivineProjectile<DivineThrowable>(manager, new ResourceLocation("textures/particle/generic_0.png")));
        ...
        manager.register(MAGE_SHOT, new RenderDivineProjectile<DivineThrowable>(manager, new ResourceLocation("textures/particle/generic_0.png")));
        ...
        manager.register(SOUL_FIEND_SHOT, new RenderDivineProjectile<DivineThrowable>(manager, new ResourceLocation("textures/particle/generic_0.png")));
        ...
        manager.register(TWILIGHT_MAGE_SHOT, new RenderDivineProjectile<DivineThrowable>(manager, new ResourceLocation("textures/particle/generic_0.png")));
        ...
        manager.register(LORGA_FLIGHT, new RenderDivineMob(manager, new ModelLorgaflight<Entity>(), new ResourceLocation(DivineRPG.MODID, "textures/entity/lorgaflight.png")));
        ...
        manager.register(TEMPLE_GUARDIAN, new RenderDivineMob(manager, new BipedModel(1), new ResourceLocation(DivineRPG.MODID, "textures/entity/temple_guardian.png")));
    ...
    private static <T extends ProjectileItemEntity> EntityType<T> registerSnowballProjectile(EntityType.IFactory<T> factory, String entityName) {
        ResourceLocation location = new ResourceLocation(DivineRPG.MODID, entityName);
        boolean cache = SharedConstants.CHECK_DATA_FIXER_SCHEMA;
        SharedConstants.CHECK_DATA_FIXER_SCHEMA = false;
        EntityType<T> entity = EntityType.Builder.of(factory, EntityClassification.MISC).sized(0.25F, 0.25F).setTrackingRange(120).setUpdateInterval(20).build(location.getPath());
