...
public class ItemRegistry {
    ...
    // Iceika
    private static ArmorInfo santaInfo = new ArmorInfo(Component.translatable("tooltip.armor_info.massive_buff"),
    ...
    public static final RegistryObject<Item>
        ...
        bedrock_chunk = registerItem("bedrock_chunk", () -> new ItemMod(new Item.Properties().fireResistant().tab(DivineRPG.tabs.materials))),
        ...
        eden_arrow = registerItem("eden_arrow", () -> new ItemMod(DivineRPG.tabs.ranged)),
        ...
        fury_arrow = registerItem("fury_arrow", () -> new ItemMod(DivineRPG.tabs.ranged)),
        ...
        molten_shards = registerItem("molten_shards", () -> new ItemMod(new Item.Properties().tab(DivineRPG.tabs.materials).fireResistant())),
        molten_stone = registerItem("molten_stone", () -> new ItemMod(new Item.Properties().tab(DivineRPG.tabs.materials).fireResistant())),
        ...
        torridite_chunk = registerItem("torridite_chunk", () -> new ItemMod(new Item.Properties().tab(DivineRPG.tabs.materials).fireResistant())),
        torridite_ingot = registerItem("torridite_ingot", () -> new ItemMod(new Item.Properties().tab(DivineRPG.tabs.materials).fireResistant())),
        torridite_nugget = registerItem("torridite_nugget", () -> new ItemMod(new Item.Properties().tab(DivineRPG.tabs.materials).fireResistant())),
        ...
        wildwood_arrow = registerItem("wildwood_arrow", () -> new ItemMod(DivineRPG.tabs.ranged)),
        ...
        arcanite_blade = registerItem("arcanite_blade", () -> new ItemArcanaPoweredSword(DivineToolMaterials.ARCANITE_BLADE, 30, 6.0F)),
        arcanium_saber = registerItem("arcanium_saber", () -> new ItemArcanaPoweredSword(DivineToolMaterials.ARCANIUM_SABER, 25, 5.0F)),
        arcanite_blaster = registerItem("arcanite_blaster", () -> new ItemArcaniteBlaster()),
        flaming_fury = registerItem("flaming_fury", () -> new ItemBurningSword(DivineToolMaterials.FLAMING_FURY, 15)),
        inferno_sword = registerItem("inferno_sword", () -> new ItemBurningSword(DivineToolMaterials.INFERNO_SWORD, 12)),
        molten_sword = registerItem("molten_sword", () -> new ItemBurningSword(DivineToolMaterials.MOLTEN_SWORD, 5)),
        ...
        frossivence = registerItem("frossivence", () -> new ItemHealingSword(DivineToolMaterials.FROSSIVENCE, 1F)),
        massivence = registerItem("massivence", () -> new ItemHealingSword(DivineToolMaterials.PALAVENCE, 1F)),
        palavence = registerItem("palavence", () -> new ItemHealingSword(DivineToolMaterials.PALAVENCE, 0.5F)),
        ...
        jungle_knife = registerItem("jungle_knife", () -> new ItemPoisonousSword(DivineToolMaterials.JUNGLE_KNIFE, 2.5f)),
        jungle_rapier = registerItem("jungle_rapier", () -> new ItemPoisonousSword(DivineToolMaterials.JUNGLE_RAPIER, 4f)),
        poison_saber = registerItem("poison_saber", () -> new ItemPoisonousSword(DivineToolMaterials.POISON_SABER, 5)),
        ...
        shadow_saber = registerItem("shadow_saber", () -> new ItemShadowSaber(DivineToolMaterials.SHADOW_SABER)),
        enderice = registerItem("enderice", () -> new ItemSlowingSword(DivineToolMaterials.ENDERICE)),
        frost_sword = registerItem("frost_sword", () -> new ItemSlowingSword(DivineToolMaterials.FROST_SWORD)),
        frostking_sword = registerItem("frostking_sword", () -> new ItemSlowingSword(DivineToolMaterials.FROSTKING_SWORD)),
        frozen_maul = registerItem("frozen_maul", () -> new ItemSlowingSword(DivineToolMaterials.FROZEN_MAUL)),
        glacier_sword = registerItem("glacier_sword", () -> new ItemSlowingSword(DivineToolMaterials.GLACIER_SWORD)),
        icicle_bane = registerItem("icicle_bane", () -> new ItemSlowingSword(DivineToolMaterials.ICICLE_BANE)),
        icine_sword = registerItem("icine_sword", () -> new ItemSlowingSword(DivineToolMaterials.ICINE_SWORD)),
        snowslash = registerItem("snowslash", () -> new ItemSlowingSword(DivineToolMaterials.SNOWSLASH)),
        ...
        storm_sword = registerItem("storm_sword", () -> new ItemStormSword(DivineToolMaterials.STORM_SWORD)),
        ...
        amthirmis_backsword = registerItem("amthirmis_backsword", () -> new ItemVetheanSword(DivineToolMaterials.AMTHIRMIS_BACKSWORD)),
        amthirmis_claw = registerItem("amthirmis_claw", () -> new ItemVetheanSword(DivineToolMaterials.AMTHIRMIS_CLAW)),
        amthirmis_hammer = registerItem("amthirmis_hammer", () -> new ItemVetheanSword(DivineToolMaterials.AMTHIRMIS_HAMMER)),
        arksiane_backsword = registerItem("arksiane_backsword", () -> new ItemVetheanSword(DivineToolMaterials.ARKSIANE_BACKSWORD)),
        arksiane_claw = registerItem("arksiane_claw", () -> new ItemVetheanSword(DivineToolMaterials.ARKSIANE_CLAW)),
        arksiane_hammer = registerItem("arksiane_hammer", () -> new ItemVetheanSword(DivineToolMaterials.ARKSIANE_HAMMER)),
        cermile_backsword = registerItem("cermile_backsword", () -> new ItemVetheanSword(DivineToolMaterials.CERMILE_BACKSWORD)),
        cermile_claw = registerItem("cermile_claw", () -> new ItemVetheanSword(DivineToolMaterials.CERMILE_CLAW)),
        cermile_hammer = registerItem("cermile_hammer", () -> new ItemVetheanSword(DivineToolMaterials.CERMILE_HAMMER)),
        darven_backsword = registerItem("darven_backsword", () -> new ItemVetheanSword(DivineToolMaterials.DARVEN_BACKSWORD)),
        darven_claw = registerItem("darven_claw", () -> new ItemVetheanSword(DivineToolMaterials.DARVEN_CLAW)),
        darven_hammer = registerItem("darven_hammer", () -> new ItemVetheanSword(DivineToolMaterials.DARVEN_HAMMER)),
        everbright = registerItem("everbright", () -> new ItemVetheanSword(DivineToolMaterials.EVERBRIGHT)),
        everlight = registerItem("everlight", () -> new ItemVetheanSword(DivineToolMaterials.EVERLIGHT)),
        heliosis_backsword = registerItem("heliosis_backsword", () -> new ItemVetheanSword(DivineToolMaterials.HELIOSIS_BACKSWORD)),
        heliosis_claw = registerItem("heliosis_claw", () -> new ItemVetheanSword(DivineToolMaterials.HELIOSIS_CLAW)),
        heliosis_hammer = registerItem("heliosis_hammer", () -> new ItemVetheanSword(DivineToolMaterials.HELIOSIS_HAMMER)),
        karos_backsword = registerItem("karos_backsword", () -> new ItemVetheanSword(DivineToolMaterials.KAROS_BACKSWORD)),
        karos_claw = registerItem("karos_claw", () -> new ItemVetheanSword(DivineToolMaterials.KAROS_CLAW)),
        karos_hammer = registerItem("karos_hammer", () -> new ItemVetheanSword(DivineToolMaterials.KAROS_HAMMER)),
        karos_rockmaul = registerItem("karos_rockmaul", () -> new ItemVetheanSword(DivineToolMaterials.KAROS_ROCKMAUL)),
        pardimal_backsword = registerItem("pardimal_backsword", () -> new ItemVetheanSword(DivineToolMaterials.PARDIMAL_BACKSWORD)),
        pardimal_claw = registerItem("pardimal_claw", () -> new ItemVetheanSword(DivineToolMaterials.PARDIMAL_CLAW)),
        pardimal_hammer = registerItem("pardimal_hammer", () -> new ItemVetheanSword(DivineToolMaterials.PARDIMAL_HAMMER)),
        quadrotic_backsword = registerItem("quadrotic_backsword", () -> new ItemVetheanSword(DivineToolMaterials.QUADROTIC_BACKSWORD)),
        quadrotic_claw = registerItem("quadrotic_claw", () -> new ItemVetheanSword(DivineToolMaterials.QUADROTIC_CLAW)),
        quadrotic_hammer = registerItem("quadrotic_hammer", () -> new ItemVetheanSword(DivineToolMaterials.QUADROTIC_HAMMER)),
        teaker_backsword = registerItem("teaker_backsword", () -> new ItemVetheanSword(DivineToolMaterials.TEAKER_BACKSWORD)),
        teaker_claw = registerItem("teaker_claw", () -> new ItemVetheanSword(DivineToolMaterials.TEAKER_CLAW)),
        teaker_hammer = registerItem("teaker_hammer", () -> new ItemVetheanSword(DivineToolMaterials.TEAKER_HAMMER)),
        ...
        moonbulb = registerItem("moonbulb", () -> new ItemModFood(FoodList.MOONBULB, DivineRPG.tabs.food, true)),
        pink_glowbone = registerItem("pink_glowbone", () -> new ItemModFood(FoodList.PINK_GLOWBONE, DivineRPG.tabs.food, true)),
        purple_glowbone = registerItem("purple_glowbone", () -> new ItemModFood(FoodList.PURPLE_GLOWBONE, DivineRPG.tabs.food, true)),
        magic_meat = registerItem("magic_meat", () -> new ItemModFood(FoodList.MAGIC_MEAT, DivineRPG.tabs.food, true)),
        enriched_magic_meat = registerItem("enriched_magic_meat", () -> new ItemModFood(FoodList.ENRICHED_MAGIC_MEAT, DivineRPG.tabs.food, true)),
        ...
        white_mushroom = registerItem("white_mushroom", () -> new ItemModFood(FoodList.WHITE_MUSHROOM, DivineRPG.tabs.food)),
        honeychunk = registerItem("honeychunk", () -> new ItemModFood(FoodList.HONEYCHUNK, DivineRPG.tabs.vethea)),
        honeysuckle = registerItem("honeysuckle", () -> new ItemModFood(FoodList.HONEYSUCKLE, DivineRPG.tabs.vethea)),
        peppermints = registerItem("peppermints", () -> new ItemModFood(FoodList.PEPPERMINTS, DivineRPG.tabs.food)),
        cheese = registerItem("cheese", () -> new ItemModFood(FoodList.CHEESE, DivineRPG.tabs.food)),
        pinfly = registerItem("pinfly", () -> new ItemModFood(FoodList.PINFLY, DivineRPG.tabs.food)),
        snow_cones = registerItem("snow_cones", () -> new ItemModFood(FoodList.SNOW_CONES, DivineRPG.tabs.food)),
        bacon = registerItem("bacon", () -> new ItemModFood(FoodList.BACON, DivineRPG.tabs.food)),
        hitchak = registerItem("hitchak", () -> new ItemModFood(FoodList.HITCHAK, DivineRPG.tabs.food)),
        dream_carrot = registerItem("dream_carrot", () -> new ItemModFood(FoodList.DREAM_CARROT, DivineRPG.tabs.vethea)),
        tomato = registerItem("tomato", () -> new ItemTomato(FoodList.TOMATO)),
        boiled_egg = registerItem("boiled_egg", () -> new ItemModFood(FoodList.BOILED_EGG, DivineRPG.tabs.food)),
        dream_pie = registerItem("dream_pie", () -> new ItemModFood(FoodList.DREAM_PIE, DivineRPG.tabs.vethea)),
        chocolate_log = registerItem("chocolate_log", () -> new ItemModFood(FoodList.CHOCOLATE_LOG, DivineRPG.tabs.food)),
        winterberry = registerItem("winterberry", () -> new ItemModFood(FoodList.WINTERBERRY, DivineRPG.tabs.food)),
        raw_empowered_meat = registerItem("raw_empowered_meat", () -> new ItemModFood(FoodList.RAW_EMPOWERED_MEAT, DivineRPG.tabs.food)),
        dream_melon = registerItem("dream_melon", () -> new ItemModFood(FoodList.DREAM_MELON, DivineRPG.tabs.vethea)),
        dream_cake = registerItem("dream_cake", () -> new ItemModFood(FoodList.DREAM_CAKE, DivineRPG.tabs.vethea)),
        hot_pumpkin_pie = registerItem("hot_pumpkin_pie", () -> new ItemModFood(FoodList.HOT_PUMPKIN_PIE, DivineRPG.tabs.food)),
        advanced_mushroom_stew = registerItem("advanced_mushroom_stew", () -> new ItemModFood(FoodList.ADVANCED_MUSHROOM_STEW, DivineRPG.tabs.food)),
        empowered_meat = registerItem("empowered_meat", () -> new ItemModFood(FoodList.EMPOWERED_MEAT, DivineRPG.tabs.food)),
        fruit_cake = registerItem("fruit_cake", () -> new ItemModFood(FoodList.FRUIT_CAKE, DivineRPG.tabs.food)),
        donut = registerItem("donut", () -> new ItemModFood(FoodList.DONUT, DivineRPG.tabs.food)),
        chicken_dinner = registerItem("chicken_dinner", () -> new ItemModFood(FoodList.CHICKEN_DINNER, DivineRPG.tabs.food)),
        ...
        firestock_seeds = registerItem("firestock_seeds", () -> new ItemNameBlockItem(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(DivineRPG.MODID, "firestock_plant")), new Item.Properties().tab(DivineRPG.tabs.food))),
        ...
        pinfly_seeds = registerItem("pinfly_seeds", () -> new ItemNameBlockItem(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(DivineRPG.MODID, "pinfly_plant")), new Item.Properties().tab(DivineRPG.tabs.food))),
        ...
        sky_plant_seeds = registerItem("sky_plant_seeds", () -> new ItemNameBlockItem(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(DivineRPG.MODID, "sky_plant")), new Item.Properties().tab(DivineRPG.tabs.food))),
        ...
        brown_grizzle_egg = registerItem("brown_grizzle_spawn_egg", () -> new ForgeSpawnEggItem(() -> EntityRegistry.BROWN_GRIZZLE.get(), 0xFFFFFF, 0xFFFFFF, new Item.Properties().tab(DivineRPG.tabs.spawners))),
        ehu_egg = registerItem("ehu_spawn_egg", () -> new ForgeSpawnEggItem(() -> EntityRegistry.EHU.get(), 0xFFFFFF, 0xFFFFFF, new Item.Properties().tab(DivineRPG.tabs.spawners))),
        fyracryx_egg = registerItem("fyracryx_spawn_egg", () -> new ForgeSpawnEggItem(() -> EntityRegistry.FYRACRYX.get(), 0xFFFFFF, 0xFFFFFF, new Item.Properties().tab(DivineRPG.tabs.spawners))),
        golem_of_rejuvenation_egg = registerItem("golem_of_rejuvenation_spawn_egg", () -> new ForgeSpawnEggItem(() -> EntityRegistry.GOLEM_OF_REJUVENATION.get(), 0xFFFFFF, 0xFFFFFF, new Item.Properties().tab(DivineRPG.tabs.spawners))),
        husk_egg = registerItem("husk_spawn_egg", () -> new ForgeSpawnEggItem(() -> EntityRegistry.HUSK.get(), 0xFFFFFF, 0xFFFFFF, new Item.Properties().tab(DivineRPG.tabs.spawners))),
        paratiku_egg = registerItem("paratiku_spawn_egg", () -> new ForgeSpawnEggItem(() -> EntityRegistry.PARATIKU.get(), 0xFFFFFF, 0xFFFFFF, new Item.Properties().tab(DivineRPG.tabs.spawners))),
        seimer_egg = registerItem("seimer_spawn_egg", () -> new ForgeSpawnEggItem(() -> EntityRegistry.SEIMER.get(), 0xFFFFFF, 0xFFFFFF, new Item.Properties().tab(DivineRPG.tabs.spawners))),
        smelter_egg = registerItem("smelter_spawn_egg", () -> new ForgeSpawnEggItem(() -> EntityRegistry.SMELTER.get(), 0xFFFFFF, 0xFFFFFF, new Item.Properties().tab(DivineRPG.tabs.spawners))),
        snapper_egg = registerItem("snapper_spawn_egg", () -> new ForgeSpawnEggItem(() -> EntityRegistry.SNAPPER.get(), 0xFFFFFF, 0xFFFFFF, new Item.Properties().tab(DivineRPG.tabs.spawners))),
        stone_golem_egg = registerItem("stone_golem_spawn_egg", () -> new ForgeSpawnEggItem(() -> EntityRegistry.STONE_GOLEM.get(), 0xFFFFFF, 0xFFFFFF, new Item.Properties().tab(DivineRPG.tabs.spawners))),
        white_grizzle_egg = registerItem("white_grizzle_spawn_egg", () -> new ForgeSpawnEggItem(() -> EntityRegistry.WHITE_GRIZZLE.get(), 0xFFFFFF, 0xFFFFFF, new Item.Properties().tab(DivineRPG.tabs.spawners))),
        ...
        realmite_axe = registerItem("realmite_axe", () -> new ItemModAxe(DivineToolMaterials.REALMITE_AXE, DivineRPG.tabs.tools)),
        arlemite_axe = registerItem("arlemite_axe", () -> new ItemModAxe(DivineToolMaterials.ARLEMITE_AXE, DivineRPG.tabs.tools)),
        rupee_axe = registerItem("rupee_axe", () -> new ItemModAxe(DivineToolMaterials.RUPEE_AXE, DivineRPG.tabs.tools)),
        terran_axe = registerItem("terran_axe", () -> new ItemModAxe(DivineToolMaterials.TERRAN_AXE, DivineRPG.tabs.tools)),
        bedrock_axe = registerItem("bedrock_axe", () -> new ItemModAxe(DivineToolMaterials.BEDROCK_AXE, new Item.Properties().tab(DivineRPG.tabs.tools).fireResistant())),
        corrupted_axe = registerItem("corrupted_axe", () -> new ItemModAxe(DivineToolMaterials.CORRUPTED_AXE, DivineRPG.tabs.tools)),
        eden_axe = registerItem("eden_axe", () -> new ItemModAxe(DivineToolMaterials.EDEN_AXE, RarityList.EDEN, DivineRPG.tabs.tools)),
        wildwood_axe = registerItem("wildwood_axe", () -> new ItemModAxe(DivineToolMaterials.WILDWOOD_AXE, RarityList.WILDWOOD, DivineRPG.tabs.tools)),
        apalachia_axe = registerItem("apalachia_axe", () -> new ItemModAxe(DivineToolMaterials.APALACHIA_AXE, RarityList.APALACHIA, DivineRPG.tabs.tools)),
        skythern_axe = registerItem("skythern_axe", () -> new ItemModAxe(DivineToolMaterials.SKYTHERN_AXE, RarityList.SKYTHERN, DivineRPG.tabs.tools)),
        mortum_axe = registerItem("mortum_axe", () -> new ItemModAxe(DivineToolMaterials.MORTUM_AXE, RarityList.MORTUM, DivineRPG.tabs.tools)),
        divine_axe = registerItem("divine_axe", () -> new ItemModAxe(DivineToolMaterials.DIVINE_AXE, RarityList.DIVINE, DivineRPG.tabs.tools)),
        dream_axe = registerItem("dream_axe", () -> new ItemModAxe(DivineToolMaterials.DREAM_AXE, DivineRPG.tabs.vethea)),
        ...
        inferno_bow = registerItem("inferno_bow", () -> new ItemModBow(ArrowType.INFERNO_ARROW, 10000, ItemModBow.DEFAULT_MAX_USE_DURATION, null, new Item.Properties().tab(DivineRPG.tabs.ranged).durability(10000).fireResistant())),
        ...
        apalachia_hoe = registerItem("apalachia_hoe", () -> new ItemModHoe(DivineToolMaterials.ARLEMITE_PICKAXE)),
        realmite_hoe = registerItem("realmite_hoe", () -> new ItemModHoe(DivineToolMaterials.REALMITE_PICKAXE)),
        arlemite_hoe = registerItem("arlemite_hoe", () -> new ItemModHoe(DivineToolMaterials.ARLEMITE_PICKAXE)),
		bedrock_hoe = registerItem("bedrock_hoe", () -> new ItemModHoe(DivineToolMaterials.BEDROCK_PICKAXE, new Item.Properties().fireResistant())),
        corrupted_hoe = registerItem("corrupted_hoe", () -> new ItemModHoe(DivineToolMaterials.CORRUPTED_PICKAXE)),
        divine_hoe = registerItem("divine_hoe", () -> new ItemModHoe(DivineToolMaterials.DIVINE_PICKAXE)),
        eden_hoe = registerItem("eden_hoe", () -> new ItemModHoe(DivineToolMaterials.EDEN_PICKAXE)),
        mortum_hoe = registerItem("mortum_hoe", () -> new ItemModHoe(DivineToolMaterials.MORTUM_PICKAXE)),
		rupee_hoe = registerItem("rupee_hoe", () -> new ItemModHoe(DivineToolMaterials.RUPEE_PICKAXE)),
        skythern_hoe = registerItem("skythern_hoe", () -> new ItemModHoe(DivineToolMaterials.SKYTHERN_PICKAXE)),
        terran_hoe = registerItem("terran_hoe", () -> new ItemModHoe(DivineToolMaterials.TERRAN_PICKAXE)),
        wildwood_hoe = registerItem("wildwood_hoe", () -> new ItemModHoe(DivineToolMaterials.WILDWOOD_PICKAXE)),
        realmite_pickaxe = registerItem("realmite_pickaxe", () -> new ItemModPickaxe(DivineToolMaterials.REALMITE_PICKAXE, DivineRPG.tabs.tools)),
        arlemite_pickaxe = registerItem("arlemite_pickaxe", () -> new ItemModPickaxe(DivineToolMaterials.ARLEMITE_PICKAXE, DivineRPG.tabs.tools)),
        rupee_pickaxe = registerItem("rupee_pickaxe", () -> new ItemModPickaxe(DivineToolMaterials.RUPEE_PICKAXE, DivineRPG.tabs.tools)),
        terran_pickaxe = registerItem("terran_pickaxe", () -> new ItemModPickaxe(DivineToolMaterials.TERRAN_PICKAXE, DivineRPG.tabs.tools)),
        bedrock_pickaxe = registerItem("bedrock_pickaxe", () -> new ItemModPickaxe(DivineToolMaterials.BEDROCK_PICKAXE, new Item.Properties().tab(DivineRPG.tabs.tools).fireResistant())),
        corrupted_pickaxe = registerItem("corrupted_pickaxe", () -> new ItemModPickaxe(DivineToolMaterials.CORRUPTED_PICKAXE, DivineRPG.tabs.tools)),
        eden_pickaxe = registerItem("eden_pickaxe", () -> new ItemModPickaxe(DivineToolMaterials.EDEN_PICKAXE, RarityList.EDEN, DivineRPG.tabs.tools)),
        wildwood_pickaxe = registerItem("wildwood_pickaxe", () -> new ItemModPickaxe(DivineToolMaterials.WILDWOOD_PICKAXE, RarityList.WILDWOOD, DivineRPG.tabs.tools)),
        apalachia_pickaxe = registerItem("apalachia_pickaxe", () -> new ItemModPickaxe(DivineToolMaterials.APALACHIA_PICKAXE, RarityList.APALACHIA, DivineRPG.tabs.tools)),
        skythern_pickaxe = registerItem("skythern_pickaxe", () -> new ItemModPickaxe(DivineToolMaterials.SKYTHERN_PICKAXE, RarityList.SKYTHERN, DivineRPG.tabs.tools)),
        mortum_pickaxe = registerItem("mortum_pickaxe", () -> new ItemModPickaxe(DivineToolMaterials.MORTUM_PICKAXE, RarityList.MORTUM, DivineRPG.tabs.tools)),
        divine_pickaxe = registerItem("divine_pickaxe", () -> new ItemModPickaxe(DivineToolMaterials.DIVINE_PICKAXE, RarityList.DIVINE, DivineRPG.tabs.tools)),
        dream_pickaxe = registerItem("dream_pickaxe", () -> new ItemModPickaxe(DivineToolMaterials.DREAM_PICKAXE, DivineRPG.tabs.vethea)),
        realmite_shovel = registerItem("realmite_shovel", () -> new ItemModShovel(DivineToolMaterials.REALMITE_SHOVEL, DivineRPG.tabs.tools)),
        arlemite_shovel = registerItem("arlemite_shovel", () -> new ItemModShovel(DivineToolMaterials.ARLEMITE_SHOVEL, DivineRPG.tabs.tools)),
        rupee_shovel = registerItem("rupee_shovel", () -> new ItemModShovel(DivineToolMaterials.RUPEE_SHOVEL, DivineRPG.tabs.tools)),
        terran_shovel = registerItem("terran_shovel", () -> new ItemModShovel(DivineToolMaterials.TERRAN_SHOVEL, DivineRPG.tabs.tools)),
        bedrock_shovel = registerItem("bedrock_shovel", () -> new ItemModShovel(DivineToolMaterials.BEDROCK_SHOVEL, new Item.Properties().tab(DivineRPG.tabs.tools).fireResistant())),
        corrupted_shovel = registerItem("corrupted_shovel", () -> new ItemModShovel(DivineToolMaterials.CORRUPTED_SHOVEL, DivineRPG.tabs.tools)),
        eden_shovel = registerItem("eden_shovel", () -> new ItemModShovel(DivineToolMaterials.EDEN_SHOVEL, RarityList.EDEN, DivineRPG.tabs.tools)),
        wildwood_shovel = registerItem("wildwood_shovel", () -> new ItemModShovel(DivineToolMaterials.WILDWOOD_SHOVEL, RarityList.WILDWOOD, DivineRPG.tabs.tools)),
        apalachia_shovel = registerItem("apalachia_shovel", () -> new ItemModShovel(DivineToolMaterials.APALACHIA_SHOVEL, RarityList.APALACHIA, DivineRPG.tabs.tools)),
        skythern_shovel = registerItem("skythern_shovel", () -> new ItemModShovel(DivineToolMaterials.SKYTHERN_SHOVEL, RarityList.SKYTHERN, DivineRPG.tabs.tools)),
        mortum_shovel = registerItem("mortum_shovel", () -> new ItemModShovel(DivineToolMaterials.MORTUM_SHOVEL, RarityList.MORTUM, DivineRPG.tabs.tools)),
        divine_shovel = registerItem("divine_shovel", () -> new ItemModShovel(DivineToolMaterials.DIVINE_SHOVEL, RarityList.DIVINE, DivineRPG.tabs.tools)),
        dream_shovel = registerItem("dream_shovel", () -> new ItemModShovel(DivineToolMaterials.DREAM_SHOVEL, DivineRPG.tabs.vethea)),
        apalachia_blade = registerItem("apalachia_blade", () -> new ItemModSword(RarityList.APALACHIA, DivineToolMaterials.APALACHIA_BLADE, DivineRPG.tabs.melee)),
        aquatic_dagger = registerItem("aquatic_dagger", () -> new ItemModSword(DivineToolMaterials.AQUA_DAGGER, DivineRPG.tabs.melee)),
        aquatic_maul = registerItem("aquatic_maul", () -> new ItemModSword(DivineToolMaterials.AQUA_MAUL, DivineRPG.tabs.melee)),
        aquatic_trident = registerItem("aquatic_trident", () -> new ItemModSword(DivineToolMaterials.AQUA_TRIDENT, DivineRPG.tabs.melee)),
        aquaton = registerItem("aquaton", () -> new ItemModSword(DivineToolMaterials.AQUATON, DivineRPG.tabs.melee)),
        aquatooth_maul = registerItem("aquatooth_maul", () -> new ItemModSword(DivineToolMaterials.AQUATOOTH_MAUL, DivineRPG.tabs.melee)),
        aquatooth_sword = registerItem("aquatooth_sword", () -> new ItemModSword(DivineToolMaterials.AQUATOOTH_SWORD, DivineRPG.tabs.melee)),
        arlemite_stabber = registerItem("arlemite_stabber", () -> new ItemModSword(DivineToolMaterials.ARLEMITE_STABBER, DivineRPG.tabs.melee)),
        bedrock_maul = registerItem("bedrock_maul", () -> new ItemModSword(DivineToolMaterials.BEDROCK_MAUL, new Item.Properties().tab(DivineRPG.tabs.melee).fireResistant())),
        bedrock_sword = registerItem("bedrock_sword", () -> new ItemModSword(DivineToolMaterials.BEDROCK_SWORD, new Item.Properties().tab(DivineRPG.tabs.melee).fireResistant())),
        bloodgem_sword = registerItem("bloodgem_sword", () -> new ItemModSword(DivineToolMaterials.BLOODGEM_SWORD, DivineRPG.tabs.melee)),
        soulfire_sword = registerItem("soulfire_sword", () -> new ItemModSword(DivineToolMaterials.SOULFIRE_SWORD, DivineRPG.tabs.melee)),
        corrupted_maul = registerItem("corrupted_maul", () -> new ItemModSword(DivineToolMaterials.CORRUPTED_MAUL, DivineRPG.tabs.melee)),
        crabclaw_maul = registerItem("crabclaw_maul", () -> new ItemModSword(DivineToolMaterials.CRABCLAW_MAUL, DivineRPG.tabs.melee)),
        cyclopsian_sword = registerItem("cyclopsian_sword", () -> new ItemModSword(DivineToolMaterials.CYCLOPSIAN_SWORD, DivineRPG.tabs.melee)),
        death_bringer = registerItem("death_bringer", () -> new ItemModSword(DivineToolMaterials.DEATH_BRINGER, DivineRPG.tabs.melee)),
        blue_divine_sword = registerItem("blue_divine_sword", () -> new ItemModSword(RarityList.BLUE, DivineToolMaterials.DIVINE_SWORD, DivineRPG.tabs.melee)),
        divine_sword = registerItem("divine_sword", () -> new ItemModSword(RarityList.DIVINE, DivineToolMaterials.DIVINE_SWORD, DivineRPG.tabs.melee)),
        gray_divine_sword = registerItem("gray_divine_sword", () -> new ItemModSword(RarityList.DARK, DivineToolMaterials.DIVINE_SWORD, DivineRPG.tabs.melee)),
        green_divine_sword = registerItem("green_divine_sword", () -> new ItemModSword(RarityList.GREEN, DivineToolMaterials.DIVINE_SWORD, DivineRPG.tabs.melee)),
        red_divine_sword = registerItem("red_divine_sword", () -> new ItemModSword(RarityList.RED, DivineToolMaterials.DIVINE_SWORD, DivineRPG.tabs.melee)),
        yellow_divine_sword = registerItem("yellow_divine_sword", () -> new ItemModSword(RarityList.YELLOW, DivineToolMaterials.DIVINE_SWORD, DivineRPG.tabs.melee)),
        ...
        dual_claw = registerItem("dual_claw", () -> new ItemModSword(DivineToolMaterials.DUAL_CLAW, DivineRPG.tabs.melee)),
        eden_blade = registerItem("eden_blade", () -> new ItemModSword(RarityList.EDEN, DivineToolMaterials.EDEN_BLADE, DivineRPG.tabs.melee)),
        black_ender_sword = registerItem("black_ender_sword", () -> new ItemModSword(RarityList.DARK, DivineToolMaterials.ENDER_SWORD, DivineRPG.tabs.melee)),
        blue_ender_sword = registerItem("blue_ender_sword", () -> new ItemModSword(RarityList.BLUE, DivineToolMaterials.ENDER_SWORD, DivineRPG.tabs.melee)),
        ender_sword = registerItem("ender_sword", () -> new ItemModSword(RarityList.ENDER, DivineToolMaterials.ENDER_SWORD, DivineRPG.tabs.melee)),
        green_ender_sword = registerItem("green_ender_sword", () -> new ItemModSword(RarityList.GREEN, DivineToolMaterials.ENDER_SWORD, DivineRPG.tabs.melee)),
        red_ender_sword = registerItem("red_ender_sword", () -> new ItemModSword(RarityList.RED, DivineToolMaterials.ENDER_SWORD, DivineRPG.tabs.melee)),
        yellow_ender_sword = registerItem("yellow_ender_sword", () -> new ItemModSword(RarityList.YELLOW, DivineToolMaterials.ENDER_SWORD, DivineRPG.tabs.melee)),
        fury_maul = registerItem("fury_maul", () -> new ItemModSword(DivineToolMaterials.FURY_MAUL, DivineRPG.tabs.melee)),
        halite_blade = registerItem("halite_blade", () -> new ItemModSword(RarityList.HALITE, DivineToolMaterials.HALITE_BLADE, DivineRPG.tabs.melee)),
        livicia_sword = registerItem("livicia_sword", () -> new ItemModSword(DivineToolMaterials.LIVICIA_SWORD, DivineRPG.tabs.melee)),
        mortum_blade = registerItem("mortum_blade", () -> new ItemModSword(RarityList.MORTUM, DivineToolMaterials.MORTUM_BLADE, DivineRPG.tabs.melee)),
        ocean_knife = registerItem("ocean_knife", () -> new ItemModSword(DivineToolMaterials.OCEAN_KNIFE, DivineRPG.tabs.melee)),
        realmite_sword = registerItem("realmite_sword", () -> new ItemModSword(DivineToolMaterials.REALMITE_SWORD, DivineRPG.tabs.melee)),
        rupee_rapier = registerItem("rupee_rapier", () -> new ItemModSword(DivineToolMaterials.RUPEE_RAPIER, DivineRPG.tabs.melee)),
        sandslash = registerItem("sandslash", () -> new ItemModSword(DivineToolMaterials.SANDSLASH, DivineRPG.tabs.melee)),
        scorching_sword = registerItem("scorching_sword", () -> new ItemModSword(DivineToolMaterials.SCORCHING_SWORD, DivineRPG.tabs.melee)),
        shark_sword = registerItem("shark_sword", () -> new ItemModSword(DivineToolMaterials.SHARK_SWORD, DivineRPG.tabs.melee)),
        skythern_blade = registerItem("skythern_blade", () -> new ItemModSword(RarityList.SKYTHERN, DivineToolMaterials.SKYTHERN_BLADE, DivineRPG.tabs.melee)),
        slime_sword = registerItem("slime_sword", () -> new ItemModSword(DivineToolMaterials.SLIME_SWORD, DivineRPG.tabs.melee)),
        terran_dagger = registerItem("terran_dagger", () -> new ItemModSword(DivineToolMaterials.TERRAN_DAGGER, DivineRPG.tabs.melee)),
        terran_knife = registerItem("terran_knife", () -> new ItemModSword(DivineToolMaterials.TERRAN_KNIFE, DivineRPG.tabs.melee)),
        terran_maul = registerItem("terran_maul", () -> new ItemModSword(DivineToolMaterials.TERRAN_MAUL, DivineRPG.tabs.melee)),
        wildwood_blade = registerItem("wildwood_blade", () -> new ItemModSword(RarityList.WILDWOOD, DivineToolMaterials.WILDWOOD_BLADE, DivineRPG.tabs.melee)),
        apalachia_shickaxe = registerItem("apalachia_shickaxe", () -> new ItemShickaxe(RarityList.APALACHIA, DivineToolMaterials.APALACHIA_SHICKAXE)),
        arlemite_shickaxe = registerItem("arlemite_shickaxe", () -> new ItemShickaxe(DivineToolMaterials.ARLEMITE_SHICKAXE)),
        corrupted_shickaxe = registerItem("corrupted_shickaxe", () -> new ItemShickaxe(DivineToolMaterials.CORRUPTED_SHICKAXE)),
        divine_shickaxe = registerItem("divine_shickaxe", () -> new ItemShickaxe(RarityList.DIVINE, DivineToolMaterials.DIVINE_SHICKAXE)),
        eden_shickaxe = registerItem("eden_shickaxe", () -> new ItemShickaxe(RarityList.EDEN, DivineToolMaterials.EDEN_SHICKAXE)),
        halite_shickaxe = registerItem("halite_shickaxe", () -> new ItemShickaxe(RarityList.HALITE, DivineToolMaterials.HALITE_SHICKAXE)),
        mortum_shickaxe = registerItem("mortum_shickaxe", () -> new ItemShickaxe(RarityList.MORTUM, DivineToolMaterials.MORTUM_SHICKAXE)),
        rupee_shickaxe = registerItem("rupee_shickaxe", () -> new ItemShickaxe(DivineToolMaterials.RUPEE_SHICKAXE)),
        skythern_shickaxe = registerItem("skythern_shickaxe", () -> new ItemShickaxe(RarityList.SKYTHERN, DivineToolMaterials.SKYTHERN_SHICKAXE)),
		terran_shickaxe = registerItem("terran_shickaxe", () -> new ItemShickaxe(DivineToolMaterials.TERRAN_SHICKAXE)),
        wildwood_shickaxe = registerItem("wildwood_shickaxe", () -> new ItemShickaxe(RarityList.WILDWOOD, DivineToolMaterials.WILDWOOD_SHICKAXE)),
        ...
        aqua_torch = registerItem("aqua_torch", () -> new StandingAndWallBlockItem(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(DivineRPG.MODID, "aqua_torch")), ForgeRegistries.BLOCKS.getValue(new ResourceLocation(DivineRPG.MODID, "aqua_wall_torch")), (new Item.Properties()).tab(DivineRPG.tabs.blocks))),
        arcanium_torch = registerItem("arcanium_torch", () -> new StandingAndWallBlockItem(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(DivineRPG.MODID, "arcanium_torch")), ForgeRegistries.BLOCKS.getValue(new ResourceLocation(DivineRPG.MODID, "arcanium_wall_torch")), (new Item.Properties()).tab(DivineRPG.tabs.blocks))),
        eden_torch = registerItem("eden_torch", () -> new StandingAndWallBlockItem(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(DivineRPG.MODID, "eden_torch")), ForgeRegistries.BLOCKS.getValue(new ResourceLocation(DivineRPG.MODID, "eden_wall_torch")), (new Item.Properties()).tab(DivineRPG.tabs.blocks))),
        skeleton_torch = registerItem("skeleton_torch", () -> new StandingAndWallBlockItem(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(DivineRPG.MODID, "skeleton_torch")), ForgeRegistries.BLOCKS.getValue(new ResourceLocation(DivineRPG.MODID, "skeleton_wall_torch")), (new Item.Properties()).tab(DivineRPG.tabs.blocks)));
    ...
    public static final RegistryObject<Item>
        ...
        santa_helmet = registerItem("santa_helmet", () -> new ItemDivineArmor(ArmorStats.SANTA, EquipmentSlot.HEAD, santaInfo)),
        santa_chestplate = registerItem("santa_chestplate", () -> new ItemDivineArmor(ArmorStats.SANTA, EquipmentSlot.CHEST, santaInfo)),
        santa_leggings = registerItem("santa_leggings", () -> new ItemDivineArmor(ArmorStats.SANTA, EquipmentSlot.LEGS, santaInfo)),
        santa_boots = registerItem("santa_boots", () -> new ItemDivineArmor(ArmorStats.SANTA, EquipmentSlot.FEET, santaInfo)),
