...
public class ItemRegistry {
    ...
    public static void registerItems(final RegistryEvent.Register<Item> e) {
        ...
        register(e, new DivineShield("realmite_shield", RarityList.COMMON, DivineRPG.tabs.armor, realmiteIngot, 1200));
        register(e, new DivineShield("arlemite_shield", RarityList.COMMON, DivineRPG.tabs.armor, arlemiteIngot, 1200));
        register(e, new DivineShield("rupee_shield", RarityList.COMMON, DivineRPG.tabs.armor, rupeeIngot, 1200));
        register(e, new DivineShield("eden_shield", RarityList.EDEN, DivineRPG.tabs.armor, edenChunk, 1200));
        register(e, new DivineShield("wildwood_shield", RarityList.WILDWOOD, DivineRPG.tabs.armor, wildwoodChunk, 2400));
        register(e, new DivineShield("apalachia_shield", RarityList.APALACHIA, DivineRPG.tabs.armor, apalachiaChunk, 4800));
        register(e, new DivineShield("skythern_shield", RarityList.SKYTHERN, DivineRPG.tabs.armor, skythernChunk, 9600));
        register(e, new DivineShield("mortum_shield", RarityList.MORTUM, DivineRPG.tabs.armor, mortumChunk, 19200));
        register(e, new DivineShield("halite_shield", RarityList.HALITE, DivineRPG.tabs.armor, Item.byBlock(Blocks.AIR), 0));
