...
public class ItemRegistry {
        ...
        //Seeds
        tomato_seeds = registerItem("tomato_seeds", () -> new ItemNameBlockItem(BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "tomato_plant")), new Properties())),
                white_mushroom_seeds = registerItem("white_mushroom_seeds", () -> new ItemNameBlockItem(BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "white_mushroom_plant")), new Properties())),
                aquamarine_seeds = registerItem("aquamarine_seeds", () -> new ItemNameBlockItem(BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "aquamarine_plant")), new Properties())),
                eucalyptus_root_seeds = registerItem("eucalyptus_root_seeds", () -> new ItemNameBlockItem(BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "eucalyptus_plant")), new Properties())),
                firestock_seeds = registerItem("firestock_seeds", () -> new ItemNameBlockItem(BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "firestock_plant")), new Properties())),
                hitchak_seeds = registerItem("hitchak_seeds", () -> new ItemNameBlockItem(BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "hitchak_plant")), new Properties())),
                lamona_seeds = registerItem("lamona_seeds", () -> new ItemNameBlockItem(BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "lamona_plant")), new Properties())),
                marsine_seeds = registerItem("marsine_seeds", () -> new ItemNameBlockItem(BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "marsine_plant")), new Properties())),
                pinfly_seeds = registerItem("pinfly_seeds", () -> new ItemNameBlockItem(BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "pinfly_plant")), new Properties())),
                veilo_seeds = registerItem("veilo_seeds", () -> new ItemNameBlockItem(BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "veilo_plant")), new Properties())),
                moonbulb_seeds = registerItem("moonbulb_seeds", () -> new ItemNameBlockItem(BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "moonbulb_plant")), new Properties())),
                pink_glowbone_seeds = registerItem("pink_glowbone_seeds", () -> new ItemNameBlockItem(BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "pink_glowbone_plant")), new Properties())),
                purple_glowbone_seeds = registerItem("purple_glowbone_seeds", () -> new ItemNameBlockItem(BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "purple_glowbone_plant")), new Properties())),
                sky_plant_seeds = registerItem("sky_plant_seeds", () -> new ItemNameBlockItem(BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "sky_plant")), new Properties())),
        ...
        //Pets
        snapper_egg = registerItem("snapper_spawn_egg", () -> new DeferredSpawnEggItem(() -> EntityRegistry.SNAPPER.get(), 0xFFFFFF, 0xFFFFFF, new Properties())),
                ehu_egg = registerItem("ehu_spawn_egg", () -> new DeferredSpawnEggItem(() -> EntityRegistry.EHU.get(), 0xFFFFFF, 0xFFFFFF, new Properties())),
                husk_egg = registerItem("husk_spawn_egg", () -> new DeferredSpawnEggItem(() -> EntityRegistry.HUSK.get(), 0xFFFFFF, 0xFFFFFF, new Properties())),
                brown_grizzle_egg = registerItem("brown_grizzle_spawn_egg", () -> new DeferredSpawnEggItem(() -> EntityRegistry.BROWN_GRIZZLE.get(), 0xFFFFFF, 0xFFFFFF, new Properties())),
                white_grizzle_egg = registerItem("white_grizzle_spawn_egg", () -> new DeferredSpawnEggItem(() -> EntityRegistry.WHITE_GRIZZLE.get(), 0xFFFFFF, 0xFFFFFF, new Properties())),
                stone_golem_egg = registerItem("stone_golem_spawn_egg", () -> new DeferredSpawnEggItem(() -> EntityRegistry.STONE_GOLEM.get(), 0xFFFFFF, 0xFFFFFF, new Properties())),
                smelter_egg = registerItem("smelter_spawn_egg", () -> new DeferredSpawnEggItem(() -> EntityRegistry.SMELTER.get(), 0xFFFFFF, 0xFFFFFF, new Properties())),
                fyracryx_egg = registerItem("fyracryx_spawn_egg", () -> new DeferredSpawnEggItem(() -> EntityRegistry.FYRACRYX.get(), 0xFFFFFF, 0xFFFFFF, new Properties())),
                golem_of_rejuvenation_egg = registerItem("golem_of_rejuvenation_spawn_egg", () -> new DeferredSpawnEggItem(() -> EntityRegistry.GOLEM_OF_REJUVENATION.get(), 0xFFFFFF, 0xFFFFFF, new Properties())),
                paratiku_egg = registerItem("paratiku_spawn_egg", () -> new DeferredSpawnEggItem(() -> EntityRegistry.PARATIKU.get(), 0xFFFFFF, 0xFFFFFF, new Properties())),
                seimer_egg = registerItem("seimer_spawn_egg", () -> new DeferredSpawnEggItem(() -> EntityRegistry.SEIMER.get(), 0xFFFFFF, 0xFFFFFF, new Properties())),
        ...
        //Buckets
        gem_fin_bucket = registerItem("gem_fin_bucket", () -> new MobBucketItem(()-> BuiltInRegistries.ENTITY_TYPE.get(new ResourceLocation(MODID, "gem_fin")), ()-> Fluids.WATER, ()-> SoundEvents.BUCKET_EMPTY_FISH, (new Properties()).stacksTo(1))),
        ...
        nightmare_bed = registerItem("nightmare_bed", () -> new ItemNightmareBed()),
                aqua_torch = registerItem("aqua_torch", () -> new StandingAndWallBlockItem(BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "aqua_torch")), BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "aqua_wall_torch")), new Properties(), Direction.EAST)),
                skeleton_torch = registerItem("skeleton_torch", () -> new StandingAndWallBlockItem(BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "skeleton_torch")), BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "skeleton_wall_torch")), new Properties(), Direction.EAST)),
                arcanium_torch = registerItem("arcanium_torch", () -> new StandingAndWallBlockItem(BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "arcanium_torch")), BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "arcanium_wall_torch")), new Properties(), Direction.EAST)),
                eden_torch = registerItem("eden_torch", () -> new StandingAndWallBlockItem(BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "eden_torch")), BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "eden_wall_torch")), new Properties(), Direction.EAST));
