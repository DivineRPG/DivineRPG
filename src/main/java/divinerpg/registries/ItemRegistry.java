...
public class ItemRegistry {
    ...
    yellow_rupee_helmet = registerItem("yellow_rupee_helmet", () -> new ItemDivineArmor(Rarity.UNCOMMON, YELLOW_RUPEE, HELMET, 35, rupeeInfo, MELEE_PROTECTION.getDelegate())),
    ...
    yellow_ender_helmet = registerItem("yellow_ender_helmet", () -> new ItemDivineArmor(Rarity.UNCOMMON, YELLOW_ENDER, HELMET, 0, enderInfo, EXPLOSION_PROTECTION.getDelegate())),
