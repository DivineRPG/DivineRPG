...
public class ItemRegistry {
    ...
    //Tools, Weapons & Armor
            ...
            //Bows
            hunter_bow = registerItem("hunter_bow", () -> new ItemModBow(ArrowType.HUNTER_ARROW, 2500)),
            shadow_bow = registerItem("shadow_bow", () -> new ItemModBow(ArrowType.SHADOW_ARROW, 10000, 36000)),
            icicle_bow = registerItem("icicle_bow", () -> new ItemModBow(ArrowType.ICICLE_ARROW, 10000, 24000)),
            inferno_bow = registerItem("inferno_bow", () -> new ItemModBow(ArrowType.INFERNO_ARROW, ItemModBow.DEFAULT_MAX_USE_DURATION, new Properties().durability(10000).fireResistant())),
            ...
            eden_bow = registerItem("eden_bow", () -> new ItemModBow(RarityList.EDEN, ArrowType.EDEN_ARROW, 0)),
            wildwood_bow = registerItem("wildwood_bow", () -> new ItemModBow(RarityList.WILDWOOD, ArrowType.LESSER_WILDWOOD_ARROW, 0, 36000)),
            apalachia_bow = registerItem("apalachia_bow", () -> new ItemModBow(RarityList.APALACHIA, ArrowType.GREATER_WILDWOOD_ARROW, 0)),
            skythern_bow = registerItem("skythern_bow", () -> new ItemModBow(RarityList.SKYTHERN, ArrowType.GREATER_WILDWOOD_ARROW, 0, 36000)),
            mortum_bow = registerItem("mortum_bow", () -> new ItemModBow(RarityList.MORTUM, ArrowType.FURY_ARROW, 0)),
            halite_bow = registerItem("halite_bow", () -> new ItemModBow(RarityList.HALITE, ArrowType.FURY_ARROW, 0, 36000)),
    ...
    //Vethean Swords
            teaker_backsword = registerItemVethean("teaker_backsword", () -> new ItemVetheanSword(ToolStats.TEAKER_BACKSWORD)),
            amthirmis_backsword = registerItemVethean("amthirmis_backsword", () -> new ItemVetheanSword(ToolStats.AMTHIRMIS_BACKSWORD)),
            darven_backsword = registerItemVethean("darven_backsword", () -> new ItemVetheanSword(ToolStats.DARVEN_BACKSWORD)),
            cermile_backsword = registerItemVethean("cermile_backsword", () -> new ItemVetheanSword(ToolStats.CERMILE_BACKSWORD)),
            pardimal_backsword = registerItemVethean("pardimal_backsword", () -> new ItemVetheanSword(ToolStats.PARDIMAL_BACKSWORD)),
            quadrotic_backsword = registerItemVethean("quadrotic_backsword", () -> new ItemVetheanSword(ToolStats.QUADROTIC_BACKSWORD)),
            karos_backsword = registerItemVethean("karos_backsword", () -> new ItemVetheanSword(ToolStats.KAROS_BACKSWORD)),
            heliosis_backsword = registerItemVethean("heliosis_backsword", () -> new ItemVetheanSword(ToolStats.HELIOSIS_BACKSWORD)),
            arksiane_backsword = registerItemVethean("arksiane_backsword", () -> new ItemVetheanSword(ToolStats.ARKSIANE_BACKSWORD)),

            //Hammers
            teaker_hammer = registerItemVethean("teaker_hammer", () -> new ItemVetheanSword(ToolStats.TEAKER_HAMMER)),
            amthirmis_hammer = registerItemVethean("amthirmis_hammer", () -> new ItemVetheanSword(ToolStats.AMTHIRMIS_HAMMER)),
            darven_hammer = registerItemVethean("darven_hammer", () -> new ItemVetheanSword(ToolStats.DARVEN_HAMMER)),
            cermile_hammer = registerItemVethean("cermile_hammer", () -> new ItemVetheanSword(ToolStats.CERMILE_HAMMER)),
            pardimal_hammer = registerItemVethean("pardimal_hammer", () -> new ItemVetheanSword(ToolStats.PARDIMAL_HAMMER)),
            quadrotic_hammer = registerItemVethean("quadrotic_hammer", () -> new ItemVetheanSword(ToolStats.QUADROTIC_HAMMER)),
            karos_hammer = registerItemVethean("karos_hammer", () -> new ItemVetheanSword(ToolStats.KAROS_HAMMER)),
            heliosis_hammer = registerItemVethean("heliosis_hammer", () -> new ItemVetheanSword(ToolStats.HELIOSIS_HAMMER)),
            arksiane_hammer = registerItemVethean("arksiane_hammer", () -> new ItemVetheanSword(ToolStats.ARKSIANE_HAMMER)),
            everlight = registerItemVethean("everlight", () -> new ItemVetheanSword(ToolStats.EVERLIGHT)),
            karos_rockmaul = registerItemVethean("karos_rockmaul", () -> new ItemVetheanSword(ToolStats.KAROS_ROCKMAUL)),

            //Claws
            teaker_claw = registerItemVethean("teaker_claw", () -> new ItemVetheanSword(ToolStats.TEAKER_CLAW)),
            amthirmis_claw = registerItemVethean("amthirmis_claw", () -> new ItemVetheanSword(ToolStats.AMTHIRMIS_CLAW)),
            darven_claw = registerItemVethean("darven_claw", () -> new ItemVetheanSword(ToolStats.DARVEN_CLAW)),
            cermile_claw = registerItemVethean("cermile_claw", () -> new ItemVetheanSword(ToolStats.CERMILE_CLAW)),
            pardimal_claw = registerItemVethean("pardimal_claw", () -> new ItemVetheanSword(ToolStats.PARDIMAL_CLAW)),
            quadrotic_claw = registerItemVethean("quadrotic_claw", () -> new ItemVetheanSword(ToolStats.QUADROTIC_CLAW)),
            karos_claw = registerItemVethean("karos_claw", () -> new ItemVetheanSword(ToolStats.KAROS_CLAW)),
            heliosis_claw = registerItemVethean("heliosis_claw", () -> new ItemVetheanSword(ToolStats.HELIOSIS_CLAW)),
            arksiane_claw = registerItemVethean("arksiane_claw", () -> new ItemVetheanSword(ToolStats.ARKSIANE_CLAW)),
            everbright = registerItemVethean("everbright", () -> new ItemVetheanSword(ToolStats.EVERBRIGHT)),
    ...
    degraded_helmet = registerItemVethean("degraded_helmet", () -> new ItemDivineArmor(ArmorStats.DEGRADED, ArmorItem.Type.HELMET, basicHelmInfo, DEGRADED_HELMET.get())),
            degraded_hood = registerItemVethean("degraded_hood", () -> new ItemDivineArmor(ArmorStats.DEGRADED, ArmorItem.Type.HELMET, basicHoodInfo, DEGRADED_HOOD.get())),
            degraded_mask = registerItemVethean("degraded_mask", () -> new ItemDivineArmor(ArmorStats.DEGRADED, ArmorItem.Type.HELMET, basicMaskInfo, DEGRADED_MASK.get())),
    ...
    finished_helmet = registerItemVethean("finished_helmet", () -> new ItemDivineArmor(ArmorStats.FINISHED, ArmorItem.Type.HELMET, basicHelmInfo, FINISHED_HELMET.get())),
            finished_hood = registerItemVethean("finished_hood", () -> new ItemDivineArmor(ArmorStats.FINISHED, ArmorItem.Type.HELMET, basicHoodInfo, FINISHED_HOOD.get())),
            finished_mask = registerItemVethean("finished_mask", () -> new ItemDivineArmor(ArmorStats.FINISHED, ArmorItem.Type.HELMET, basicMaskInfo, FINISHED_MASK.get())),
    ...
    glistening_helmet = registerItemVethean("glistening_helmet", () -> new ItemDivineArmor(ArmorStats.GLISTENING, ArmorItem.Type.HELMET, glisteningHelmInfo, GLISTENING_HELMET.get())),
            glistening_hood = registerItemVethean("glistening_hood", () -> new ItemDivineArmor(ArmorStats.GLISTENING, ArmorItem.Type.HELMET, glisteningHoodInfo, PREVENT_FALL_DAMAGE.get(), MobEffects.JUMP, GLISTENING_HOOD.get())),
            glistening_mask = registerItemVethean("glistening_mask", () -> new ItemDivineArmor(ArmorStats.GLISTENING, ArmorItem.Type.HELMET, glisteningMaskInfo, MobEffects.MOVEMENT_SPEED, GLISTENING_MASK.get())),
    ...
    demonized_helmet = registerItemVethean("demonized_helmet", () -> new ItemDivineArmor(ArmorStats.DEMONIZED, ArmorItem.Type.HELMET, demonizedHelmInfo, DEMONIZED_HELMET.get())),
            demonized_hood = registerItemVethean("demonized_hood", () -> new ItemDivineArmor(ArmorStats.DEMONIZED, ArmorItem.Type.HELMET, demonizedHoodInfo, new int[]{0, 1, 0}, PREVENT_FALL_DAMAGE.get(), MobEffects.JUMP, DEMONIZED_HOOD.get())),
            demonized_mask = registerItemVethean("demonized_mask", () -> new ItemDivineArmor(ArmorStats.DEMONIZED, ArmorItem.Type.HELMET, demonizedMaskInfo, new int[]{1, 0}, MobEffects.MOVEMENT_SPEED, DEMONIZED_MASK.get())),
    ...
    tormented_helmet = registerItemVethean("tormented_helmet", () -> new ItemDivineArmor(ArmorStats.TORMENTED, ArmorItem.Type.HELMET, tormentedHelmInfo, TORMENTED_HELMET.get())),
            tormented_hood = registerItemVethean("tormented_hood", () -> new ItemDivineArmor(ArmorStats.TORMENTED, ArmorItem.Type.HELMET, tormentedHoodInfo, new int[]{0, 2, 0}, PREVENT_FALL_DAMAGE.get(), MobEffects.JUMP, TORMENTED_HOOD.get())),
            tormented_mask = registerItemVethean("tormented_mask", () -> new ItemDivineArmor(ArmorStats.TORMENTED, ArmorItem.Type.HELMET, tormentedMaskInfo, new int[]{2, 0}, MobEffects.MOVEMENT_SPEED, TORMENTED_MASK.get())),
