...
public class RecipeRegistry {
    ...
    public static class Trades {
        ...
        public interface TradeGetter {
            DivineTrades[] get(Level level, RandomSource random);}
        ...
        JACK_O_MAN = (level, random) -> new DivineTrades[] {
                ...
                DIAMOND_DAVE = (level, random) -> new DivineTrades[] {
                        new DivineTrades(new ItemStack(Items.DIAMOND, 16 + random.nextInt(8)), level == null || random.nextBoolean() ? realmite_pickaxe.toStack() : EnchantmentHelper.enchantItem(random, realmite_pickaxe.toStack(), random.nextInt(30), level.registryAccess(), level.registryAccess().lookupOrThrow(Registries.ENCHANTMENT).get(EnchantmentTags.ON_TRADED_EQUIPMENT)), random.nextInt(3), 5),
...
//                        new DivineTrades(olivine.toStack(2), PotionContents.createItemStack(Items.POTION, PotionRegistry.TEA), random.nextInt(7), 1),
                ...
                GRUZZORLUG_GENERAL = (level, random) -> new DivineTrades[]{
                        ...
                        new DivineMapTrades(olivine.toStack(20), raw_wolpertinger_meat.toStack(5), "filled_map.gruzzorlug_raid_target", TagRegistry.GRUZZORLUG_RAID, MapDecorationTypes.TARGET_X, 15),
...
//                        new DivineTrades(olivine.toStack(5), PotionContents.createItemStack(Items.POTION, PotionRegistry.TEA), random.nextInt(7), 1),
                ...
                LORD_VATTICUS = (level, random) -> new DivineTrades[]{
                        new DivineTrades(collector.toStack(), new ItemStack(Items.DYE.blue(), 8), random.nextInt(7), 5),
