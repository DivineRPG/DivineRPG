...
public class LightUp2 extends VetheaWorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		setBlock(world, i + 1, j + 0, k + 0, ModBlocks.darkEverstone);
		...
		setBlock(world, i + 3, j + 3, k + 4, ModBlocks.darkEverstone);
		setBlock(world, i + 4, j + 3, k + 4, ModBlocks.darkEverstone);
		setBlock(world, i + 4, j + 4, k + 5, ModBlocks.firelight);
		setBlock(world, i + 5, j + 3, k + 4, ModBlocks.darkEverstone);
		setBlock(world, i + 5, j + 4, k + 4, ModBlocks.darkEverstone);
		setBlock(world, i + 5, j + 4, k + 5, ModBlocks.darkEverstone);
		setBlock(world, i + 5, j + 4, k + 6, ModBlocks.firelight);
		setBlock(world, i + 5, j + 5, k + 5, ModBlocks.firelight);
		setBlock(world, i + 6, j + 4, k + 5, ModBlocks.firelight);
