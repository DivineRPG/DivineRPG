...
public class FloatingTree3 implements IVetheanStructure
{
	...
	public void generate(VetheaChunk chunk, int i, int j, int k) {
		...
		chunk.setBlock(i + 1, j + 2, k + 1, ModBlocks.firewood);
		chunk.setBlock(i + 1, j + 2, k + 2, ModBlocks.firewood);
		chunk.setBlock(i + 1, j + 2, k + 3, ModBlocks.firewoodLeaves);
		chunk.setBlock(i + 1, j + 3, k + 1, ModBlocks.firewood);
		chunk.setBlock(i + 1, j + 3, k + 2, ModBlocks.firewood);
		chunk.setBlock(i + 1, j + 3, k + 3, ModBlocks.firewoodLeaves);
		chunk.setBlock(i + 1, j + 4, k + 1, ModBlocks.firewood);
		chunk.setBlock(i + 1, j + 4, k + 2, ModBlocks.firewood);
		...
		chunk.setBlock(i + 2, j + 2, k + 1, ModBlocks.firewood);
		chunk.setBlock(i + 2, j + 2, k + 2, ModBlocks.firewood);
		chunk.setBlock(i + 2, j + 2, k + 3, ModBlocks.firewoodLeaves);
		chunk.setBlock(i + 2, j + 3, k + 1, ModBlocks.firewood);
		chunk.setBlock(i + 2, j + 3, k + 2, ModBlocks.firewood);
		chunk.setBlock(i + 2, j + 4, k + 1, ModBlocks.firewood);
		chunk.setBlock(i + 2, j + 4, k + 2, ModBlocks.firewood);
