...
public class FloatingTree1 implements IVetheanStructure {
	...
	public void generate(VetheaChunk chunk, int i, int j, int k) {
			...
			chunk.setBlock(i + 1, j + 1, k + 3, ModBlocks.firewood);
			chunk.setBlock(i + 1, j + 1, k + 4, ModBlocks.firewood);
			chunk.setBlock(i + 1, j + 1, k + 5, ModBlocks.firewood);
			chunk.setBlock(i + 1, j + 1, k + 6, ModBlocks.firewood);
			chunk.setBlock(i + 1, j + 2, k + 1, ModBlocks.dreamStone);
			chunk.setBlock(i + 1, j + 2, k + 2, ModBlocks.dreamStone);
			chunk.setBlock(i + 2, j + 1, k + 6, ModBlocks.firewood);
			chunk.setBlock(i + 2, j + 2, k + 1, ModBlocks.firewood);
			chunk.setBlock(i + 3, j + 1, k + 6, ModBlocks.firewood);
			chunk.setBlock(i + 3, j + 2, k + 1, ModBlocks.firewood);
