...
import divinerpg.dimensions.vethea.all.Bow;
import divinerpg.dimensions.vethea.all.FloatingTree1;
import divinerpg.dimensions.vethea.all.FloatingTree2;
import divinerpg.dimensions.vethea.all.FloatingTree3;
import divinerpg.dimensions.vethea.all.FloatingTree4;
import divinerpg.dimensions.vethea.all.FloatingTree5;
import divinerpg.dimensions.vethea.all.FloatingTree6;
import divinerpg.dimensions.vethea.all.FloatingTree7;
import divinerpg.dimensions.vethea.all.Hook;
import divinerpg.dimensions.vethea.all.InfusionOutpost;
import divinerpg.dimensions.vethea.all.Lamp1;
import divinerpg.dimensions.vethea.all.Lamp2;
import divinerpg.dimensions.vethea.all.Mushroom;
import divinerpg.dimensions.vethea.all.Pickaxe;
import divinerpg.dimensions.vethea.all.Pointedsquare;
import divinerpg.dimensions.vethea.all.Ring;
import divinerpg.dimensions.vethea.all.Sword;
import divinerpg.dimensions.vethea.all.Trident;
import divinerpg.dimensions.vethea.all.WorldGenVetheanPillar;
import divinerpg.dimensions.vethea.layer1.Tree4;
import divinerpg.dimensions.vethea.layer1.Tree5;
import divinerpg.dimensions.vethea.layer1.Tree6;
...
public class VetheanChunkBuilder {
	...
	public VetheanChunkBuilder(World world) {
		this.world = world;
	}

	public Chunk buildChunk(int chunkX, int chunkZ){

		VetheaChunk chunk = new VetheaChunk(new Chunk(world, chunkX, chunkZ));

		for(int x = 0; x < 16; x++){
			for(int y = 1; y < 17; y++){
				for(int z = 0; z < 16; z++){
					chunk.setBlock(x, y, z, ModBlocks.dreamStone);
					chunk.setBlock(x, y+48, z, ModBlocks.dreamStone);
					chunk.setBlock(x, y+96, z, ModBlocks.dreamStone);
					chunk.setBlock(x, y+144, z, ModBlocks.dreamStone);
					if(y == 16) {
						chunk.setBlock(x, y, z, ModBlocks.dreamGrass);
						chunk.setBlock(x, y-1, z, ModBlocks.dreamDirt);
						if(this.rand.nextInt(2) == 0) chunk.setBlock(x, y-2, z, ModBlocks.dreamDirt);
						chunk.setBlock(x, y+48, z, ModBlocks.dreamGrass);
						chunk.setBlock(x, y+47, z, ModBlocks.dreamDirt);
						if(this.rand.nextInt(2) == 0) chunk.setBlock(x, y+46, z, ModBlocks.dreamDirt);
						chunk.setBlock(x, y+96, z, ModBlocks.dreamGrass);
						chunk.setBlock(x, y+95, z, ModBlocks.dreamDirt);
						if(this.rand.nextInt(2) == 0) chunk.setBlock(x, y+94, z, ModBlocks.dreamDirt);
						chunk.setBlock(x, y+144, z, ModBlocks.dreamGrass);
						chunk.setBlock(x, y+143, z, ModBlocks.dreamDirt);
						if(this.rand.nextInt(2) == 0) chunk.setBlock(x, y+142, z, ModBlocks.dreamDirt);
					}
				}
			}
		}
