    ...
    public void populate(int chunkX, int chunkZ) {
        ...
        if(this.rand.nextInt(20) == 0) {
            ...
            if(this.world.getBlockState(new BlockPos(x, y - 1, z)).getBlock() == BlockRegistry.apalachiaGrass) {
                int listSize = StructureRegistry.APALACHIA_SMALL_STRUCTURES.size();
                DRPGStructureHandler structure = StructureRegistry.APALACHIA_SMALL_STRUCTURES.get(this.rand.nextInt(listSize));
