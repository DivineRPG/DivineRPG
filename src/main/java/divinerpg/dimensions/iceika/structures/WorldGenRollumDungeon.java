...
public class WorldGenRollumDungeon extends WorldGenerator {
    ...
    public boolean generate(World w, Random rand, BlockPos pos) {
		...
		WorldGenAPI.addBlock(w, x + 20, y, z - 1, ModBlocks.rollumSpawner);
		WorldGenAPI.addBlock(w, x + 23, y, z - 1, ModBlocks.rollumSpawner);
		WorldGenAPI.addBlock(w, x + 8, y, z + 1, ModBlocks.rollumSpawner);
