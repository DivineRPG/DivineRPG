...
import static divinerpg.registries.BlockRegistry.asphalt;
import static divinerpg.registries.FluidRegistry.SMOLDERING_TAR_FLUID;
...
public class FluidEvents {
    ...
    public static void register(FMLCommonSetupEvent event) {
        event.enqueueWork(() -> addInteraction(SMOLDERING_TAR_FLUID.get().getFluidType()));
    }
    private static void addInteraction(FluidType fluidType) {
        FluidInteractionRegistry.addInteraction(NeoForgeMod.WATER_TYPE.value(), new FluidInteractionRegistry.InteractionInformation(fluidType, fluidState -> asphalt.get().defaultBlockState()));
        ...
        FluidInteractionRegistry.addInteraction(fluidType, new FluidInteractionRegistry.InteractionInformation(NeoForgeMod.WATER_TYPE.value(), fluidState -> asphalt.get().defaultBlockState()));
