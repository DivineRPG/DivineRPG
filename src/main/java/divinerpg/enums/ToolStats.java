...
public enum ToolStats implements Tier {
    ...
    APALACHIA_BLADE(3, 2540, -2.4F, 25F, 22, "apalachia_gem"),
    AQUA_DAGGER(2, 535, -2.0F, 3.5F, 10, "aquatic_ingot"),
    ...
    ARCANITE_BLADE(3, 2048, -2.4F, 13F, 15),
    ARCANIUM_SABER(3, -1, -2.4F, 12F, 15),
    ARLEMITE_STABBER(2, 1335, -2.4F, 5F, 10, "arlemite_ingot"),
    BEDROCK_SWORD(3, -1, -2.4F, 8F, 0),
    BEDROCK_MAUL(3, -1, -2.7F, 11.5F, 0),
    BLOODGEM_SWORD(3, -1, -2.4F, 5.2F, 0),
    SOULFIRE_SWORD(3, 1623, -2.4F, 7F, 15, "soulfire_stone"),
    CORRUPTED_MAUL(3, 2948, -2.7F, 11.1F, 10, "corrupted_stone"),
    CRABCLAW_MAUL(2, 1025, -2.7F, 6.1F, 13, "crab_claw"),
    CYCLOPSIAN_SWORD(2, 300, -2.4F, 4F, 14, "cyclops_eye"),
    DEATH_BRINGER(3, 1545, -2.4F, 7.3F, 10, "corrupted_stone"),
    DIVINE_SWORD(3, -1, -2.4F, 13F, 0),
    DUAL_CLAW(2, 822, -2.3F, 5.2F, 10, "crab_claw"),
    EDEN_BLADE(3, 2124, -2.4F, 17F, 22, "eden_gem"),
    ENDER_SWORD(3, -1, -2.4F, 12F, 0),
    ENDERICE(3, -1, -2.4F, 13F, 0),
    FLAMING_FURY(3, 3025, -2.3F, 10F, 16, "molten_stone"),
    ...
    FROZEN_MAUL(3, -1, -2.7F, 12.5F, 0),
    FURY_MAUL(3, 3127, -2.8F, 14F, 15, "bedrock_chunk"),
    GLACIER_SWORD(3, 1021, -2.6F, 7F, 13, "snowflake"),
    GLACIAL_BLADE(3, 1232, -2.3F, 11F, 13, "snowflake"),
    HALITE_BLADE(3, 3187, -2.4F, 34F, 22, "mortum_gem"),
    ICICLE_BANE(3, 1622, -2.5F, 6F, 13),
    ICICLE_DAGGER(3, 4, -2.0F, 20F, 13),
    ICINE_SWORD(3, -1, -2.4F, 14F, 0),
    INFERNO_SWORD(2, -1, -2.4F, 5.2F, 0),
    JUNGLE_KNIFE(3, 1292, -2.4F, 5.2F, 10, "jungle_stone"),
    JUNGLE_RAPIER(3, 1425, -2.4F, 6F, 10, "jungle_stone"),
    LIVICIA_SWORD(3, 3223, -2.4F, 15.5F, 15, "shadow_stone"),
    MOLTEN_SWORD(3, 1297, -2.4F, 5.4F, 10, "molten_stone"),
    MORTUM_BLADE(3, 2922, -2.4F, 31F, 22, "mortum_gem"),
    ...
    SANDSLASH(3, 100, -2.4F, 16F, 15, "divine_stone"),
    SCORCHING_SWORD(3, 1212, -2.4F, 6.2F, 15, "purple_blaze"),
    SHADOW_SABER(3, -1, -2.2F, 10F, 0),
    SHARK_SWORD(2, 627, -2.4F, 5.5F, 10, "aquatic_ingot"),
    SKYTHERN_BLADE(3, 2783, -2.4F, 29F, 22, "skythern_gem"),
    SLIME_SWORD(2, 739, -2.6F, 6.5F, 10, Items.DIAMOND),
    SNOWSLASH(3, 150, -2.4F, 17F, 15, "snowflake"),
    ...
    WILDWOOD_BLADE(3, 2342, -2.4F, 21F, 22, "wildwood_gem"),
