...
public class EntityTheHunger extends EntityDivineRPGVillager {
    ...
    public void addRecipies(MerchantRecipeList recipes) {
        ...
        recipes.add(new MerchantRecipe(new ItemStack(ModItems.dirtyPearls, 1, 0), new ItemStack(BlockRegistry.lightDreamBricks, 16, 0)));
        recipes.add(new MerchantRecipe(new ItemStack(ModItems.dirtyPearls, 1, 0), new ItemStack(BlockRegistry.darkDreamBricks, 16, 0)));
        recipes.add(new MerchantRecipe(new ItemStack(ModItems.dirtyPearls, 1, 0), new ItemStack(BlockRegistry.redDreamBricks, 16, 0)));
        recipes.add(new MerchantRecipe(new ItemStack(ModItems.dirtyPearls, 2, 0), new ItemStack(BlockRegistry.dreamDirt, 64, 0)));
        recipes.add(new MerchantRecipe(new ItemStack(ModItems.dirtyPearls, 1, 0), new ItemStack(BlockRegistry.smoothGlass, 16, 0)));
        recipes.add(new MerchantRecipe(new ItemStack(ModItems.dirtyPearls, 4, 0), new ItemStack(BlockRegistry.firelight, 1, 0)));
