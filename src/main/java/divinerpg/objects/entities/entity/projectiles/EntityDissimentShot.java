...
public class EntityDissimentShot extends EntityThrowable {
    ...
    public EntityDissimentShot(World world, EntityLiving entity) {
        ...
        this.motionY = (double)(-MathHelper.sin((this.rotationPitch + this.getGravityVelocity()) / 180.0F * (float)Math.PI) * f);
        this.shoot(this.motionX, this.motionY, this.motionZ, 1.6F, 1.0F);
    }
