...
public class RenderSparkler extends Render<EntitySparkler> {

    public RenderSparkler(RenderManager manager) {
        super(manager);
    }

    ResourceLocation location = new ResourceLocation(DivineRPG.MODID, "textures/projectiles/sparkler.png");
