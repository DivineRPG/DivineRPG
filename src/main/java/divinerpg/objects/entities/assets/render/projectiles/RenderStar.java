...
public class RenderStar extends Render<EntityStar> {

    public RenderStar(RenderManager manager) {
        super(manager);
    }

    public void doRender(EntityStar entity, double x, double y, double z, float entityYaw,
            float partialTicks) {
	...
	protected ResourceLocation getEntityTexture(EntityStar entity) {
        return new ResourceLocation("divinerpg:textures/projectiles/starlight.png");
	}
