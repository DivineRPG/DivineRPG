...
public class RenderShooterBullet extends Render<EntityShooterBullet> {

    public RenderShooterBullet(RenderManager manager) {
        super(manager);
    }

    public void doRender(EntityShooterBullet entity, double x, double y, double z, float entityYaw,
            float partialTicks) {
