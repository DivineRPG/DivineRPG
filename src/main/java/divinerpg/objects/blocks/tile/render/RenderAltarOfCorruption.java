...
public class RenderAltarOfCorruption extends TileEntitySpecialRenderer<TileEntityAltarOfCorruption> {
    private static final ResourceLocation TEXTURE_BOOK = new ResourceLocation(
            "divinerpg:textures/model/altar_book.png");
    private final ModelBook modelBook = new ModelBook();

    public void render(TileEntityAltarOfCorruption te, double x, double y, double z, float partialTicks,
