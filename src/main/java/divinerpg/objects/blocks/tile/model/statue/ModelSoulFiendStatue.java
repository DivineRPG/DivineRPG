...
public class ModelSoulFiendStatue extends DivineModel {
    //fields
    ModelRenderer head;
    ModelRenderer body;
    ...
    public ModelSoulFiendStatue() {
        ...
        rightarmext = new DivineRenderer(this, 40, 16);
        ...
        leftarmext = new DivineRenderer(this, 40, 16);
        ...
        rightlegcap = new DivineRenderer(this, 0, 16);
        ...
        leftlegcap = new DivineRenderer(this, 0, 16);
