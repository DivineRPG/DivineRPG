...
public class ModelEternalArcherStatue extends DivineModel {
    ...
    public ModelEternalArcherStatue() {
        ...
        shoulder6 = new DivineRenderer(this, 41, 1);
        ...
        armsRight[0] = new DivineRenderer(this, 110, 16);
        ...
        armsLeft[2] = new DivineRenderer(this, 110, 16);
        ...
        armsRight[2] = new DivineRenderer(this, 71, 16);
        ...
        armsLeft[0] = new DivineRenderer(this, 71, 16);
        ...
        armsLeft[1] = new DivineRenderer(this, 91, 16);
        ...
        armsRight[1] = new DivineRenderer(this, 91, 16);
        ...
        body = new DivineRenderer(this, 46, 16);
        body.addBox(-4F, 0F, -2F, 8, 12, 4);
        body.setRotationPoint(0F, 0F, 0F);
        body.setTextureSize(128, 32);
        body.mirror = true;
        setRotation(body, 0F, 0F, 0F);
        shoulder1 = new DivineRenderer(this, 41, 1);
        ...
        shoulder4 = new DivineRenderer(this, 19, 24);
        ...
        shoulder3 = new DivineRenderer(this, 19, 24);
        ...
        shoulder2 = new DivineRenderer(this, 17, 16);
        ...
        shoulder5 = new DivineRenderer(this, 17, 16);
