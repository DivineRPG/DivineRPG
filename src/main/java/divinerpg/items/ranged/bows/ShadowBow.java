...
import static divinerpg.utils.RarityList.DARK_GRAY;
import static divinerpg.utils.ToolStats.SHADOW_BOW;
...
public class ShadowBow extends ItemBow {
    ...
    public ShadowBow(Properties properties) {
        super(SHADOW_BOW, properties.component(POTION_CONTENTS, PotionContents.EMPTY.withEffectAdded(new MobEffectInstance(BLINDNESS, 4 * 20, 0))), null, DARK_GRAY);
        effectSeconds = 4;
    }
