...
public class ItemSmithingTemplate {
	...
	public static SmithingTemplateItem createBedrockUpgrade() {
		return new SmithingTemplateItem(BEDROCK_UPGRADE_APPLIES_TO, BEDROCK_UPGRADE_INGREDIENTS, BEDROCK_UPGRADE, BEDROCK_UPGRADE_BASE_SLOT_DESCRIPTION, BEDROCK_UPGRADE_ADDITIONS_SLOT_DESCRIPTION, createArmorUpgradeIconList(), createArmorUpgradeMaterialList());
	}
	public static SmithingTemplateItem createAquaticCoating() {
		return new SmithingTemplateItem(AQUATIC_COATING_APPLIES_TO, AQUATIC_COATING_INGREDIENTS, AQUATIC_COATING, AQUATIC_COATING_BASE_SLOT_DESCRIPTION, AQUATIC_COATING_ADDITIONS_SLOT_DESCRIPTION, createArmorUpgradeIconList(), createArmorUpgradeMaterialList());
	}
	...
	public static List<ResourceLocation> createArmorUpgradeIconList() {
	...
	public static List<ResourceLocation> createArmorUpgradeMaterialList() {
