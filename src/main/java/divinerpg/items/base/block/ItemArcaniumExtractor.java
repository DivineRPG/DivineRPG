...
public class ItemArcaniumExtractor extends BlockItem {
    public ItemArcaniumExtractor(Block block, Properties properties) {super(block, properties);}
    @SuppressWarnings("removal")
    @Override public void initializeClient(Consumer<IClientItemExtensions> consumer) {consumer.accept(RenderArcaniumExtractor.INSTANCE);}
