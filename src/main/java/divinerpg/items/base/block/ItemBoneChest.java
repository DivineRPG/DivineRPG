...
public class ItemBoneChest extends BlockItem {
    public ItemBoneChest(Block block, Properties properties) {super(block, properties);}
    @SuppressWarnings("removal")
    @Override public void initializeClient(Consumer<IClientItemExtensions> consumer) {consumer.accept(RenderBoneChest.INSTANCE);}
