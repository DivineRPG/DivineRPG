...
public class ItemModAxe extends AxeItem {
    public ItemModAxe(Tier tier, float attackSpeed, Rarity rarity) {super(tier, 0, attackSpeed, new Item.Properties().rarity(rarity));}
    public ItemModAxe(Tier tier, float attackSpeed) {super(tier, 0, attackSpeed, new Item.Properties());}
