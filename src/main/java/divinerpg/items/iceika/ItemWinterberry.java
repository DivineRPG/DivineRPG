...
public class ItemWinterberry extends BlockItem {
    public ItemWinterberry(Item.Properties properties) {super(BlockRegistry.winterberryBush.get(), properties.food(FoodList.WINTERBERRY));}
