...
public class VetheaTeleporter implements ITeleporter {
		...
		if(entity instanceof ServerPlayer && !((ServerPlayer) entity).isOnPortalCooldown()) {
			...
			for(int currentChunkX = chunkX - 4; currentChunkX < chunkX + 4; currentChunkX++) for(int currentChunkZ = chunkZ - 4; currentChunkZ < chunkZ + 4; currentChunkZ++) {
				...
				for(int y = 0; y < 256; y++) for(int x = 0; x < 16; x++) for(int z = 0; z < 16; z++) {
					...
					if(searchState == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "vethea_portal")).defaultBlockState()
							|| searchState == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "nightmare_bed")).defaultBlockState()) {
			...
			destWorld.setBlock(new BlockPos(x + 1, y, z), BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "mortum_block")).defaultBlockState(), 0);
			destWorld.setBlock(new BlockPos(x, y, z), BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "mortum_block")).defaultBlockState(), 0);
			destWorld.setBlock(new BlockPos(x + 2, y, z), BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "mortum_block")).defaultBlockState(), 0);
			destWorld.setBlock(new BlockPos(x + 1, y + 1, z - 1), BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "mortum_block")).defaultBlockState(), 0);
			destWorld.setBlock(new BlockPos(x + 1, y + 1, z + 1), BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "mortum_block")).defaultBlockState(), 0);
			destWorld.setBlock(new BlockPos(x + 1, y + 2, z - 2), BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "mortum_block")).defaultBlockState(), 0);
			destWorld.setBlock(new BlockPos(x + 1, y + 2, z + 2), BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "mortum_block")).defaultBlockState(), 0);
			destWorld.setBlock(new BlockPos(x + 1, y + 3, z + 1), BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "mortum_block")).defaultBlockState(), 0);
			destWorld.setBlock(new BlockPos(x + 1, y + 3, z - 1), BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "mortum_block")).defaultBlockState(), 0);
			destWorld.setBlock(new BlockPos(x + 1, y + 4, z), BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "mortum_block")).defaultBlockState(), 0);
			destWorld.setBlock(new BlockPos(x + 1, y + 1, z), BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "vethea_portal")).defaultBlockState().setValue(BlockModPortal.AXIS, Direction.Axis.Z), 0);
			destWorld.setBlock(new BlockPos(x + 1, y + 2, z + 1), BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "vethea_portal")).defaultBlockState().setValue(BlockModPortal.AXIS, Direction.Axis.Z), 0);
			destWorld.setBlock(new BlockPos(x + 1, y + 2, z), BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "vethea_portal")).defaultBlockState().setValue(BlockModPortal.AXIS, Direction.Axis.Z), 0);
			destWorld.setBlock(new BlockPos(x + 1, y + 2, z - 1), BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "vethea_portal")).defaultBlockState().setValue(BlockModPortal.AXIS, Direction.Axis.Z), 0);
			destWorld.setBlock(new BlockPos(x + 1, y + 3, z), BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "vethea_portal")).defaultBlockState().setValue(BlockModPortal.AXIS, Direction.Axis.Z), 0);
	...
	public boolean isBlockPortal(ServerLevel var1, int var2, int var3, int var4) {
		return var1.getBlockState(new BlockPos(var2, var3, var4)).getBlock().defaultBlockState() == BuiltInRegistries.BLOCK.get(new ResourceLocation(DivineRPG.MODID, "vethea_portal")).defaultBlockState();
	}
}