...
public class FoodList {
    ...
    //Iceika
        EGG_NOG = new FoodProperties.Builder().usingConvertsTo(Items.BUCKET).nutrition(4).saturationModifier(.8F)
    ...
    //Skythern
        SKY_FLOWER = new FoodProperties.Builder().nutrition(3).saturationModifier(.2F)
            .effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 30 * 20, 0), 1)
            .effect(() -> new MobEffectInstance(MobEffects.WATER_BREATHING, 30 * 20, 0), 1).build(),
