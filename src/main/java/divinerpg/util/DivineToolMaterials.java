...
public enum DivineToolMaterials implements IItemTier {
    ...
    APALACHIA_BLADE(4, 2000, 4.0F, 25.0F, 22, () -> {
        return Ingredient.fromItems(ItemRegistry.apalachiaGem);
    }),
    AQUA_DAGGER(4, 2000, 4.0F, 6.0F, 15, () -> {
        return Ingredient.fromItems(ItemRegistry.aquaticIngot);
    }),
    ...
    AQUATOOTH_MAUL(4, 3500, 4.0F, 14.0F, 10, () -> {
        return Ingredient.fromItems(ItemRegistry.liopleurodonTeeth);
    }),
    ...
    ARLEMITE_STABBER(4, 4000, 4.0F, 8.0F, 10, () -> {
        return Ingredient.fromItems(ItemRegistry.arlemiteIngot);
    }),
    BEDROCK_SWORD(4, 14000, 4.0F, 10.0F, 2, () -> {
        return Ingredient.fromItems(ItemRegistry.bedrockChunk);
    }),
    ...
    BLUEFIRE_SWORD(4, 3000, 4.0F, 16.0F, 15, () -> {
        return Ingredient.fromItems(ItemRegistry.bluefireStone);
    }),
    CORRUPTED_MAUL(4, 6000, 4.0F, 9.0F, 15, () -> {
        return Ingredient.fromItems(ItemRegistry.corruptedStone);
    }),
    CRABCLAW_MAUL(4, 4000, 4.0F, 7.0F, 15, () -> {
        return Ingredient.fromItems(ItemRegistry.crabClaw);
    }),
    CYCLOPSIAN_SWORD(4, 1000, 4.0F, 2.0F, 10, () -> {
        return Ingredient.fromItems(ItemRegistry.cyclopsEye);
    }),
    ...
    EDEN_BLADE(4, 2000, 4.0F, 20.0F, 22, () -> {
        return Ingredient.fromItems(ItemRegistry.edenGem);
    }),
    ...
    FLAMING_FURY(4, 6000, 4.0F, 22.0F, 15, () -> {
        return Ingredient.fromItems(ItemRegistry.moltenStone);
    }),
    FROSSIVENCE(4, 270, 4.0F, -3.0F, 0, () -> {
        return Ingredient.fromItems(ItemRegistry.snowflake);
    }),
    FROST_SWORD(4, 5000, 4.0F, 6.0F, 15, () -> {
        return Ingredient.fromItems(ItemRegistry.iceStone);
    }),
    ...
    HALITE_BLADE(4, 2000, 4.0F, 32.0F, 22, () -> {
        return Ingredient.fromItems(ItemRegistry.mortumGem);
    }),
    ...
    JUNGLE_KNIFE(4, 2000, 4.0F, 8.0F, 10, () -> {
        return Ingredient.fromItems(ItemRegistry.jungleStone);
    }),
    JUNGLE_RAPIER(4, 1200, 4.0F, 12.0F, 10, () -> {
        return Ingredient.fromItems(ItemRegistry.jungleStone);
    }),
    LIVICIA_SWORD(4, 10000, 4.0F, 22.0F, 22, () -> {
        return Ingredient.fromItems(ItemRegistry.shadowStone);
    }),
    ...
    PALAVENCE(4, 60, 4.0F, -3.0F, 0, () -> {
        return Ingredient.fromItems(ItemRegistry.realmiteIngot);
    }),
    ...
    RUPEE_RAPIER(4, 2500, 4.0F, 8.0F, 15, () -> {
        return Ingredient.fromItems(ItemRegistry.rupeeIngot);
    }),
    SANDSLASH(4, 100, 4.0F, 17.0F, 22, () -> {
        return Ingredient.fromItems(ItemRegistry.shadowBar);
    }),
    SCORCHING_SWORD(4, 500, 4.0F, 16.0F, 15, () -> {
        return Ingredient.fromItems(ItemRegistry.purpleBlaze);
    }),
    ...
    SKYTHERN_BLADE(4, 2000, 4.0F, 27.0F, 22, () -> {
        return Ingredient.fromItems(ItemRegistry.skythernGem);
    }),
    ...
    TERRAN_DAGGER(4, 350, 4.0F, 7.0F, 10, () -> {
        return Ingredient.fromItems(ItemRegistry.terranStone);
    }),
    ...
    WILDWOOD_BLADE(4, 2000, 4.0F, 22.0F, 22, () -> {
        return Ingredient.fromItems(ItemRegistry.wildwoodGem);
    }),
    ...
    DIVINE_AXE(7, 35000, 20.0F, 8.0F, 10, () -> {
        return Ingredient.fromItems(ItemRegistry.divineStone);
    }),
