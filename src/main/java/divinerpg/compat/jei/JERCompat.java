...
public class JERCompat {
    public static void init() {
        ...
        if(worldGenRegistry != null) {
            ...
            //Twilight
            worldGenRegistry.register(new ItemStack(BlockRegistry.twilightEdenOre.get()), new DistributionSquare(6, 5, -64, 256), new Restriction(new DimensionRestriction(LevelRegistry.EDEN)), new LootDrop(new ItemStack(ItemRegistry.eden_fragments.get()), 1, 4, Conditional.affectedByFortune));
            worldGenRegistry.register(new ItemStack(BlockRegistry.scorchaltEdenOre.get()), new DistributionSquare(6, 5, -64, 256), new Restriction(new DimensionRestriction(LevelRegistry.EDEN)), new LootDrop(new ItemStack(ItemRegistry.eden_fragments.get()), 1, 4, Conditional.affectedByFortune));
