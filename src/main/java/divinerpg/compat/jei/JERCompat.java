...
public class JERCompat {
    public static void init() {
        ...
        if(dungeonRegistry != null) {
            ...
            //Overworld
            dungeonRegistry.registerChest("Diamond Dave's Chest", ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "chests/overworld/amethyst")));
            dungeonRegistry.registerChest("Ancient Tomb Chest", ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "chests/overworld/ancient_tomb")));
            dungeonRegistry.registerChest("Merchant's Hut Chest", ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "chests/overworld/livestock_chest")));
            //Iceika
            dungeonRegistry.registerChest("Iceika Chest", ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "chests/iceika/iceika_chest_dungeon")));
            dungeonRegistry.registerChest("Iceika Hut Chest", ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "chests/iceika/iceika_chest_hut")));
            dungeonRegistry.registerChest("Groglin Chest", ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "chests/iceika/groglin_chest")));
            dungeonRegistry.registerChest("Gruzzorlug Chest", ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "chests/iceika/gruzzorlug_chest")));
            //Arcana
            dungeonRegistry.registerChest("Banquet Hall Chest", ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "chests/arcana/banquet_hall_loot")));
            dungeonRegistry.registerChest("Utility Hallway Chest", ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "chests/arcana/utility_hallway_loot")));
            //Twilight
            dungeonRegistry.registerChest("Eden Hut Chest", ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "chests/twilight/eden/hut_chest")));
            dungeonRegistry.registerChest("Skythern Chest", ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "chests/twilight/skythern/chest")));
            dungeonRegistry.registerChest("Wildwood Chest", ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "chests/twilight/wildwood/chest")));
            //Vethea
            dungeonRegistry.registerChest("Crypt Chest", ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "chests/vethea/crypt_loot")));
            dungeonRegistry.registerChest("Karos Madhouse Chest", ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "chests/vethea/karos_madhouse_loot")));
            dungeonRegistry.registerChest("Quadrotic Post Chest", ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "chests/vethea/quadrotic_post_loot")));
            dungeonRegistry.registerChest("Raglok Chamber Chest", ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "chests/vethea/raglok_chamber_loot")));
            dungeonRegistry.registerChest("Temple Bottom Chest", ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "chests/vethea/temple_loot_bottom")));
