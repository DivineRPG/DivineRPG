...
public class JERCompat {
    public static void init() {
        ...
        if(worldGenRegistry != null) {
            ...
            worldGenRegistry.register(new ItemStack(BlockRegistry.oxdriteOre.get()), new DistributionSquare(8, 8, 64, 128), new Restriction(new DimensionRestriction(LevelRegistry.ICEIKA)), new LootDrop(new ItemStack(ItemRegistry.raw_oxdrite.get()), 2, 20, Conditional.affectedByFortune));
            worldGenRegistry.register(new ItemStack(BlockRegistry.oxdriteOre.get()), new DistributionSquare(16, 8, -64, 64), new Restriction(new DimensionRestriction(LevelRegistry.ICEIKA)), new LootDrop(new ItemStack(ItemRegistry.raw_oxdrite.get()), 2, 20, Conditional.affectedByFortune));
            //Twilight
            worldGenRegistry.register(new ItemStack(BlockRegistry.twilightEdenOre.get()), new DistributionSquare(12, 5, 0, 256), new Restriction(new DimensionRestriction(LevelRegistry.EDEN)), new LootDrop(new ItemStack(ItemRegistry.eden_fragments.get()), 1, 4, Conditional.affectedByFortune));
            worldGenRegistry.register(new ItemStack(BlockRegistry.scorchaltEdenOre.get()), new DistributionSquare(12, 5, 0, 256), new Restriction(new DimensionRestriction(LevelRegistry.EDEN)), new LootDrop(new ItemStack(ItemRegistry.eden_fragments.get()), 1, 4, Conditional.affectedByFortune));
