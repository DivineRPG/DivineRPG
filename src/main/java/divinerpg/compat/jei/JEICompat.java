...
public class JEICompat implements IModPlugin {
    ...
    @Override public void registerRecipes(IRecipeRegistration registration) {
        ...
        registration.addRecipes(RecipeTypes.BREWING, List.of(
                ...
                new PotionRecipe(Items.POTION, TEA, WARMTH, 2, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "brewing.warmth.regular"), ItemRegistry.olivine.toStack()),
                new PotionRecipe(Items.SPLASH_POTION, TEA, WARMTH, 3, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "brewing.warmth.splash"), ItemRegistry.olivine.toStack()),
                new PotionRecipe(Items.LINGERING_POTION, TEA, WARMTH, 4, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "brewing.warmth.lingering"), ItemRegistry.olivine.toStack()),
                new PotionRecipe(Items.POTION, Potions.WATER, TEA, 1, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "brewing.tea.regular"), ItemRegistry.winterberry.toStack(), Items.SWEET_BERRIES.getDefaultInstance()),
                new PotionRecipe(Items.SPLASH_POTION, Potions.WATER, TEA, 2, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "brewing.tea.splash"), ItemRegistry.winterberry.toStack(), Items.SWEET_BERRIES.getDefaultInstance()),
                new PotionRecipe(Items.LINGERING_POTION, Potions.WATER, TEA, 3, ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "brewing.tea.lingering"), ItemRegistry.winterberry.toStack(), Items.SWEET_BERRIES.getDefaultInstance())
        ));
    ...
    @Override public void registerGuiHandlers(IGuiHandlerRegistration registration) {
        registration.addRecipeClickArea(ArcaniumExtractorScreen.class, 79, 34, 24, 16, new RecipeType<>(ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "arcanium_extractor"), RecipeHolder.class));
        registration.addRecipeClickArea(InfusionTableScreen.class, 36, 47, 25, 18, new RecipeType<>(ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "infusion_table"), RecipeHolder.class));
    }
}