...
//
//        registration.addRecipeCatalyst(new ItemStack(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(DivineRPG.MODID, "arcanium_extractor"))), ARCANIUM_EXTRACTOR);
//        registration.addRecipeCatalyst(new ItemStack(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(DivineRPG.MODID, "infusion_table"))), INFUSION_TABLE);
//    }
//    @Override
...
//
//
//        registration.addRecipes(ARCANIUM_EXTRACTOR, arcaniumExtractorRecipes);
//        registration.addRecipes(INFUSION_TABLE, infusionTableRecipes);
//
//    }
