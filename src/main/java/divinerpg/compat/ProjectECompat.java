...
public class ProjectECompat {
	...
	public static void init() {
		...
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ModItems.edenHeart, 1, 0), 4096L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ModItems.wildwoodHeart, 1, 0), 16384L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ModItems.apalachiaHeart, 1, 0), 65536L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ModItems.skythernHeart, 1, 0), 262144L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ModItems.mortumHeart, 1, 0), 1048576L);
        }
