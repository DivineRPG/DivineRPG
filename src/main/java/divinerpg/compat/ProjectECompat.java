...
//        ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.torriditeIngot, 1, 0), 512L);
...
//        ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.infernoSword, 1, 0), 4740L);
