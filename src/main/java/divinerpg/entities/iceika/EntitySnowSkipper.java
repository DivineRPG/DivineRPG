...
public class EntitySnowSkipper extends PathfinderMob {
    public EntitySnowSkipper(EntityType<? extends EntitySnowSkipper> type, Level worldIn) {
        ...
        setPathfindingMalus(PathType.ON_TOP_OF_POWDER_SNOW, 0F);
    ...
    @Override public boolean isInvulnerableTo(ServerLevel level, DamageSource source) {
        return (source.is(DamageTypes.IN_WALL) && !isTravelMedium(getInBlockState())) || super.isInvulnerableTo(level, source);
    }
