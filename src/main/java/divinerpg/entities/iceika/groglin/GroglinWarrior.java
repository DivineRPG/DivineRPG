...
public class GroglinWarrior extends Groglin {
	public GroglinWarrior(EntityType<? extends Monster> type, Level worldIn) {
		super(type, worldIn);
	...
	protected String getTradesLocation() {
		return "trades/groglin_warrior";
	}
	@Override
	protected void registerGoals() {
		super.registerGoals();
		goalSelector.addGoal(4, new FollowLeaderGoal(this, GroglinChieftain.class, 1D, 4F, (float)getAttributeValue(Attributes.FOLLOW_RANGE)));
	}
}