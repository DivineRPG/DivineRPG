...
public class EntityBlubbertusk extends Animal {
	private static final Ingredient FOOD_ITEMS = Ingredient.of(FISHES);
	...
	@Override public boolean isInvulnerableTo(DamageSource source) {return super.isInvulnerableTo(source) || source.is(DROWN);}
