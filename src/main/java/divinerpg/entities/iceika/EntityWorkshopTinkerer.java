...
public class EntityWorkshopTinkerer extends EntityDivineMerchant {
    ...
    protected void updateTrades() {
        ...
        DivineTrades[] tradetrades = new DivineTrades[]{
                ...
                new EntityDivineMerchant.DivineTrades(new ItemStack(ItemRegistry.snowflake.get(), 30), new ItemStack(ItemRegistry.bluefire_bow.get(), 1), new ItemStack(ItemRegistry.snowstorm_bow.get(), 1), random.nextInt(7), 5),
