...
public class GruzzorlugCannoneer extends Gruzzorlug implements RangedAttackMob {
	...
	protected void registerGoals() {
		super.registerGoals();
        goalSelector.addGoal(0, new RangedAttackGoal(this, getAttribute(Attributes.MOVEMENT_SPEED).getBaseValue(), 15, (float)getAttribute(Attributes.FOLLOW_RANGE).getBaseValue()));
