...
public class EntitySkyreBullet extends DivineThrowable {
    ...
    protected void onHitEntity(EntityHitResult result) {
        if (tickCount != 1 || tickCount != 0) {
            ...
            level.explode(this, this.xo, this.yo, this.zo, 4.5F, false, Explosion.BlockInteraction.NONE);
    ...
    protected void onHit(HitResult result) {
        if (tickCount != 1 || tickCount != 0) {
            if (!this.level.isClientSide) {
                this.level.explode(this, this.xo, this.yo, this.zo, 2, false, Explosion.BlockInteraction.NONE);
                this.kill();
            }
        }
    }
