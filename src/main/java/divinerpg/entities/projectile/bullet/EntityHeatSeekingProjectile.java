...
public class EntityHeatSeekingProjectile extends ThrowableProjectile {
    ...
    public EntityHeatSeekingProjectile(EntityType<? extends ThrowableProjectile> type, LivingEntity entity, Level world) {super(type, entity.xo, entity.yo, entity.zo, world);}
