...
public abstract class EntityDivineFireballMob extends EntityDivineMonster implements RangedAttackMob {
	...
	@Override protected void registerGoals() {
        goalSelector.addGoal(0, new EscapeWaterGoal(this));
	...
	@Override protected void customServerAiStep() {
    	if(!onGround() && getDeltaMovement().y < 0) setDeltaMovement(getDeltaMovement().multiply(1, .6, 1));
	...
	protected @Nullable SoundEvent getShootSound() {return null;}
