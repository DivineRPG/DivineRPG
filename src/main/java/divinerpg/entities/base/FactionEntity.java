...
public interface FactionEntity {
    ...
    class Faction {
        public static LivingEntity getNearestEnemy(LivingEntity from, AABB searchArea, TargetingConditions conditions) {
            ...
            for(Entity enemy : enemies) if(conditions.test(from.level().getServer().getLevel(from.level().dimension()), from, (LivingEntity) enemy)) {
        ...
        static {
            ...
            iceikaNature.add(EntityTypes.COD);
            iceikaNature.add(EntityTypes.SALMON);
            iceikaNature.add(EntityTypes.TROPICAL_FISH);
            iceikaNature.add(EntityTypes.POLAR_BEAR);
            ...
            iceikaNature.remove(EntityTypes.COD);
