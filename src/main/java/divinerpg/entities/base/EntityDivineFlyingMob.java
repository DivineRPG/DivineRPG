...
public abstract class EntityDivineFlyingMob extends EntityDivineMonster {
    ...
    protected void customServerAiStep() {
        ...
        yRot = Mth.rotlerp(yRot, (float) (Mth.atan2(distanceZ, distanceX) * 180D / Math.PI) - 90F, 90F);
        xRot = Mth.rotlerp(xRot, (float) -(Mth.atan2(distanceY, Math.sqrt(distanceX * distanceX + distanceZ * distanceZ)) * 180D / Math.PI), 20F);
