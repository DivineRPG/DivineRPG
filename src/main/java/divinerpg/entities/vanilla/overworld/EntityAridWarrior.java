...
public class EntityAridWarrior extends EntityDivineMonster implements RangedAttackMob {
    ...
    @Override protected void registerGoals() {
        super.registerGoals();
        goalSelector.addGoal(1, new RangedBowAttackGoal<>(this, getAttribute(Attributes.MOVEMENT_SPEED).getBaseValue(), 5, (float)getAttribute(Attributes.FOLLOW_RANGE).getBaseValue()));
    }
