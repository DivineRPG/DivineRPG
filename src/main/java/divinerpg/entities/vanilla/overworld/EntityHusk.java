...
public class EntityHusk extends EntityDivineTameable {
    ...
    @Override public boolean isFood(ItemStack item) {return item.is(TagRegistry.PET_HUSK);}
    @Override protected boolean isTamingFood(ItemStack item) {return item.is(TagRegistry.TAMING_HUSK);}
