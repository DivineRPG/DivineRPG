...
public class EntityWhiteGrizzle extends Grizzle {
    ...
    @Override public boolean isFood(ItemStack item) {return item.is(TagRegistry.PET_WHITE_GRIZZLE);}
    @Override protected boolean isTamingFood(ItemStack item) {return item.is(TagRegistry.TAMING_WHITE_GRIZZLE);}
}