...
public class EntityBrownGrizzle extends Grizzle {
    ...
    @Override public boolean isFood(ItemStack item) {return item.is(TagRegistry.PET_BROWN_GRIZZLE);}
    @Override protected boolean isTamingFood(ItemStack item) {return item.is(TagRegistry.TAMING_BROWN_GRIZZLE);}
}