...
public class EntitySmelter extends EntityDivineTameable {
    ...
    @Override public boolean isFood(ItemStack item) {return item.is(TagRegistry.PET_SMELTER);}
    @Override protected boolean isTamingFood(ItemStack item) {return item.is(TagRegistry.TAMING_SMELTER);}
