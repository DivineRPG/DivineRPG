...
public record RiftVariant(BlockPos pos, byte variant) implements CustomPacketPayload {
    public static final CustomPacketPayload.Type<RiftVariant> TYPE = new CustomPacketPayload.Type<>(ResourceLocation.fromNamespaceAndPath(DivineRPG.MODID, "rift_variant"));
