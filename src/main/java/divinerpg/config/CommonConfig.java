...
public class CommonConfig {
    ...
    static {
        ...
        kitraProtected = BUILDER.comment("Entities that count towards Kitra spawning").define("kitraProtected", ImmutableList.of("minecraft:salmon", "minecraft:cod", "minecraft:pufferfish", "minecraft:squid", "minecraft:tadpole", "minecraft:turtle", "divinerpg:shark", "divinerpg:aequorea", "divinerpg:whale", "divinerpg:liopleurodon", "minecraft:glow_squid", "divinerpg:robbin", "divinerpg:pink_ghost_glider"));
