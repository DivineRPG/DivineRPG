...
public class CommonConfig {
    ...
    static {
        ...
        ghostWhaleProtected = BUILDER.comment("Entities that count towards ghost whale spawning").define("ghostWhaleProtected", ImmutableList.of("minecraft:salmon", "minecraft:cod", "minecraft:pufferfish", "minecraft:squid", "minecraft:tadpole", "minecraft:turtle", "divinerpg:shark", "divinerpg:aequorea", "divinerpg:whale", "divinerpg:liopleurodon", "minecraft:glow_squid", "divinerpg:robin"));
        BUILDER.pop();
        SPEC = BUILDER.build();
    }
