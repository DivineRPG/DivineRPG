...
public class ToolMaterialMod {
    ...
    // Shickaxes
    public static final ToolMaterial ARLEMITE_SHICKAXE = EnumHelper.addToolMaterial("drpg_arlemite_shickaxe", 4, 12000, 13.0F, 8.0F, 15).setRepairItem(makeRepairStack("arlemite_ingot"));
    ...
    // Axes
    public static final ToolMaterial APALACHIA_AXE = EnumHelper.addToolMaterial("drpg_apalachia_axe", 9, 6000, 40.0F, 9.0F, 22).setRepairItem(makeRepairStack("apalachia_gem"));
    public static final ToolMaterial ARLEMITE_AXE = EnumHelper.addToolMaterial("drpg_arlemite_axe", 3, 3000, 13.0F, 7.0F, 10).setRepairItem(makeRepairStack("arlemite_ingot"));
    ...
    public static final ToolMaterial DIVINE_AXE = EnumHelper.addToolMaterial("drpg_divine_axe", 8, 35000, 20.0F, 8.0F, 10).setRepairItem(makeRepairStack("divine_stone"));
    public static final ToolMaterial EDEN_AXE = EnumHelper.addToolMaterial("drpg_eden_axe", 9, 6000, 20.0F, 7.0F, 22).setRepairItem(makeRepairStack("eden_chunk"));
    public static final ToolMaterial MORTUM_AXE = EnumHelper.addToolMaterial("drpg_mortum_axe", 9, 6000, 55.0F, 11.0F, 22).setRepairItem(makeRepairStack("mortum_chunk"));
    ...
    public static final ToolMaterial RUPEE_AXE = EnumHelper.addToolMaterial("drpg_rupee_axe", 6, 2500, 16.0F, 7.0F, 10).setRepairItem(makeRepairStack("rupee_ingot"));
    ...
    public static final ToolMaterial WILDWOOD_AXE = EnumHelper.addToolMaterial("drpg_wildwood_axe", 9, 6000, 28.0F, 8.0F, 22).setRepairItem(makeRepairStack("wildwood_gem"));

    // Pickaxes
    public static final ToolMaterial APALACHIA_PICKAXE = EnumHelper.addToolMaterial("drpg_apalachia_pickaxe", 9, 6000, 40.0F, 7.0F, 22).setRepairItem(makeRepairStack("apalachia_gem"));
    public static final ToolMaterial ARLEMITE_PICKAXE = EnumHelper.addToolMaterial("drpg_arlemite_pickaxe", 3, 3000, 13.0F, 5.0F, 10).setRepairItem(makeRepairStack("arlemite_ingot"));
    ...
    public static final ToolMaterial DIVINE_PICKAXE = EnumHelper.addToolMaterial("drpg_divine_pickaxe", 8, 35000, 20.0F, 6.0F, 10).setRepairItem(makeRepairStack("divine_stone"));
    public static final ToolMaterial EDEN_PICKAXE = EnumHelper.addToolMaterial("drpg_eden_pickaxe", 9, 6000, 20.0F, 5.0F, 22).setRepairItem(makeRepairStack("eden_chunk"));
    public static final ToolMaterial MORTUM_PICKAXE = EnumHelper.addToolMaterial("drpg_mortum_pickaxe", 9, 6000, 55.0F, 9.0F, 22).setRepairItem(makeRepairStack("mortum_chunk"));
    ...
    public static final ToolMaterial RUPEE_PICKAXE = EnumHelper.addToolMaterial("drpg_rupee_pickaxe", 6, 2500, 16.0F, 5.0F, 22).setRepairItem(makeRepairStack("rupee_ingot"));
    ...
    public static final ToolMaterial WILDWOOD_PICKAXE = EnumHelper.addToolMaterial("drpg_wildwood_pickaxe", 9, 6000, 28.0F, 6.0F, 22).setRepairItem(makeRepairStack("wildwood_gem"));

    // Shovels
    public static final ToolMaterial APALACHIA_SHOVEL = EnumHelper.addToolMaterial("drpg_apalachia_shovel", 9, 6000, 40.0F, 7.0F, 22).setRepairItem(makeRepairStack("apalachia_gem"));
    public static final ToolMaterial ARLEMITE_SHOVEL = EnumHelper.addToolMaterial("drpg_arlemite_shovel", 3, 3000, 13.0F, 5.0F, 10).setRepairItem(makeRepairStack("arlemite_ingot"));
    ...
    public static final ToolMaterial DIVINE_SHOVEL = EnumHelper.addToolMaterial("drpg_divine_shovel", 8, 35000, 20.0F, 6.0F, 10).setRepairItem(makeRepairStack("divine_stone"));
    public static final ToolMaterial EDEN_SHOVEL = EnumHelper.addToolMaterial("drpg_eden_shovel", 9, 6000, 20.0F, 5.0F, 22).setRepairItem(makeRepairStack("eden_chunk"));
    public static final ToolMaterial MORTUM_SHOVEL = EnumHelper.addToolMaterial("drpg_mortum_shovel", 9, 6000, 55.0F, 9.0F, 22).setRepairItem(makeRepairStack("mortum_chunk"));
    ...
    public static final ToolMaterial RUPEE_SHOVEL = EnumHelper.addToolMaterial("drpg_rupee_shovel", 6, 2500, 16.0F, 5.0F, 22).setRepairItem(makeRepairStack("rupee_ingot"));
    ...
    public static final ToolMaterial WILDWOOD_SHOVEL = EnumHelper.addToolMaterial("drpg_wildwood_shovel", 9, 6000, 28.0F, 6.0F, 22).setRepairItem(makeRepairStack("wildwood_gem"));
