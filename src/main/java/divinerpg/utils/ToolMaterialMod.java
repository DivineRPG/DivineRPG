...
public class ToolMaterialMod {
    ...
    //Armor materials
    public static final ArmorMaterial ANGELIC_ARMOR = EnumHelper.addArmorMaterial("drpg_angelic_armor", Reference.MODID + ":angelic", 18, new int[] {3, 4, 4, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0F);
    public static final ArmorMaterial APALACHIA_ARMOR = EnumHelper.addArmorMaterial("drpg_apalachia_armor", Reference.MODID + ":apalachia", 36, new int[] {5, 5, 7, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F);
    public static final ArmorMaterial AQUASTRIVE_ARMOR = EnumHelper.addArmorMaterial("drpg_aquastrive_armor", Reference.MODID + ":aquastrive", 28, new int[] {4, 5, 6, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial ARLEMITE_ARMOR = EnumHelper.addArmorMaterial("drpg_arlemite_armor", Reference.MODID + ":arlemite", 30, new int[] {3, 5, 7, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4F);
    public static final ArmorMaterial BEDROCK_ARMOR = EnumHelper.addArmorMaterial("drpg_bedrock_armor", Reference.MODID + ":bedrock", 45, new int[] {5, 6, 8, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 5F);
    public static final ArmorMaterial CORRUPTED_ARMOR = EnumHelper.addArmorMaterial("drpg_corrupted_armor", Reference.MODID + ":corrupted", 40, new int[] {4, 6, 8, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F);
    public static final ArmorMaterial DIVINE_ARMOR = EnumHelper.addArmorMaterial("drpg_divine_armor", Reference.MODID + ":divine", 40, new int[] {5, 6, 8, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4F);
    public static final ArmorMaterial EDEN_ARMOR = EnumHelper.addArmorMaterial("drpg_eden_armor", Reference.MODID + ":eden", 32, new int[] {3, 5, 7, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F);
    public static final ArmorMaterial ELITE_REALMITE_ARMOR = EnumHelper.addArmorMaterial("drpg_elite_realmite_armor", Reference.MODID + ":elite_realmite", 38, new int[] {4, 6, 7, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F);
    public static final ArmorMaterial ENDER_ARMOR = EnumHelper.addArmorMaterial("drpg_ender_armor", Reference.MODID + ":ender", 36, new int[] {5, 6, 7, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial RED_ENDER_ARMOR = EnumHelper.addArmorMaterial("drpg_red_ender_armor", Reference.MODID + ":red_ender", 36, new int[] {5, 6, 7, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial YELLOW_ENDER_ARMOR = EnumHelper.addArmorMaterial("drpg_yellow_ender_armor", Reference.MODID + ":yellow_ender", 36, new int[] {5, 6, 7, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial GREEN_ENDER_ARMOR = EnumHelper.addArmorMaterial("drpg_green_ender_armor", Reference.MODID + ":green_ender", 36, new int[] {5, 6, 7, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial GRAY_ENDER_ARMOR = EnumHelper.addArmorMaterial("drpg_gray_ender_armor", Reference.MODID + ":gray_ender", 36, new int[] {5, 6, 7, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial BLUE_ENDER_ARMOR = EnumHelper.addArmorMaterial("drpg_blue_ender_armor", Reference.MODID + ":blue_ender", 36, new int[] {5, 6, 7, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial FROZEN_ARMOR = EnumHelper.addArmorMaterial("drpg_frozen_armor", Reference.MODID + ":frozen", 29, new int[] {3, 5, 7, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1F);
    public static final ArmorMaterial HALITE_ARMOR = EnumHelper.addArmorMaterial("drpg_halite_armor", Reference.MODID + ":halite", 42, new int[] {5, 7, 8, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4F);
    public static final ArmorMaterial INFERNO_ARMOR = EnumHelper.addArmorMaterial("drpg_inferno_armor", Reference.MODID + ":inferno", 20, new int[] {4, 7, 7, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1F);
    public static final ArmorMaterial JACK_O_MAN_ARMOR = EnumHelper.addArmorMaterial("drpg_jack_o_man_armor", Reference.MODID + ":jack_o_man", 24, new int[] {3, 6, 8, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial JUNGLE_ARMOR = EnumHelper.addArmorMaterial("drpg_jungle_armor", Reference.MODID + ":jungle", 29, new int[] {3, 5, 7, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1F);
    public static final ArmorMaterial KORMA_ARMOR = EnumHelper.addArmorMaterial("drpg_korma_armor", Reference.MODID + ":korma", 36, new int[] {4, 7, 8, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4F);
    public static final ArmorMaterial KRAKEN_ARMOR = EnumHelper.addArmorMaterial("drpg_kraken_armor", Reference.MODID + ":kraken", 26, new int[] {3, 5, 6, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1F);
    public static final ArmorMaterial MORTUM_ARMOR = EnumHelper.addArmorMaterial("drpg_mortum_armor", Reference.MODID + ":mortum", 38, new int[] {4, 6, 9, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4F);
    public static final ArmorMaterial NETHERITE_ARMOR = EnumHelper.addArmorMaterial("drpg_netherite_armor", Reference.MODID + ":netherite", 34, new int[] {4, 5, 6, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F);
    public static final ArmorMaterial REALMITE_ARMOR = EnumHelper.addArmorMaterial("drpg_realmite_armor", Reference.MODID + ":realmite", 23, new int[] {2, 5, 6, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0F);
    public static final ArmorMaterial RUPEE_ARMOR = EnumHelper.addArmorMaterial("drpg_rupee_armor", Reference.MODID + ":rupee", 35, new int[] {4, 6, 8, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial RED_RUPEE_ARMOR = EnumHelper.addArmorMaterial("drpg_red_rupee_armor", Reference.MODID + ":red_rupee", 35, new int[] {4, 6, 8, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial YELLOW_RUPEE_ARMOR = EnumHelper.addArmorMaterial("drpg_yellow_rupee_armor", Reference.MODID + ":yellow_rupee", 35, new int[] {4, 6, 8, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial GREEN_RUPEE_ARMOR = EnumHelper.addArmorMaterial("drpg_green_rupee_armor", Reference.MODID + ":green_rupee", 35, new int[] {4, 6, 8, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial GRAY_RUPEE_ARMOR = EnumHelper.addArmorMaterial("drpg_gray_rupee_armor", Reference.MODID + ":gray_rupee", 35, new int[] {4, 6, 8, 4}, 1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial BLUE_RUPEE_ARMOR = EnumHelper.addArmorMaterial("drpg_blue_rupee_armor", Reference.MODID + ":blue_rupee", 35, new int[] {4, 6, 8, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial SANTA_ARMOR = EnumHelper.addArmorMaterial("drpg_santa_armor", Reference.MODID + ":santa", 18, new int[] {3, 4, 5, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0F);
    public static final ArmorMaterial SHADOW_ARMOR = EnumHelper.addArmorMaterial("drpg_shadow_armor", Reference.MODID + ":shadow", 27, new int[] {4, 6, 8, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F);
    public static final ArmorMaterial SKELEMAN_ARMOR = EnumHelper.addArmorMaterial("drpg_skeleman_armor", Reference.MODID + ":skeleman", 24, new int[] {3, 5, 7, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1F);
    public static final ArmorMaterial SKYTHERN_ARMOR = EnumHelper.addArmorMaterial("drpg_skythern_armor", Reference.MODID + ":skythern", 36, new int[] {4, 6, 8, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F);
    public static final ArmorMaterial TERRAN_ARMOR = EnumHelper.addArmorMaterial("drpg_terran_armor", Reference.MODID + ":terran", 29, new int[] {3, 5, 7, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1F);
    public static final ArmorMaterial VEMOS_ARMOR = EnumHelper.addArmorMaterial("drpg_vemos_armor", Reference.MODID + ":vemos", 28, new int[] {4, 5, 6, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F);
    public static final ArmorMaterial WILDWOOD_ARMOR = EnumHelper.addArmorMaterial("drpg_wildwood_armor", Reference.MODID + ":wildwood", 34, new int[] {4, 5, 7, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F);
    public static final ArmorMaterial WITHER_REAPER_ARMOR = EnumHelper.addArmorMaterial("drpg_wither_reaper_armor", Reference.MODID + ":wither_reaper", 34, new int[] {3, 6, 8, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
