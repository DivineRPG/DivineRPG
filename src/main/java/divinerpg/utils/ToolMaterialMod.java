...
public class ToolMaterialMod {
    ...
    public static final ToolMaterial AQUATON = EnumHelper.addToolMaterial("drpg_aquaton", 4, 5000, 4.0F, 12.0F, 15);
    public static final ToolMaterial AQUATOOTH_MAUL = EnumHelper.addToolMaterial("drpg_aquatooth_maul", 4, 3500, 4.0F, 14.0F, 10);
    public static final ToolMaterial AQUATOOTH_SWORD = EnumHelper.addToolMaterial("drpg_aquatooth_sword", 4, 3500, 4.0F, 11.0F, 10);
    ...
    public static final ToolMaterial ARLEMITE_STABBER = EnumHelper.addToolMaterial("drpg_arlemite_stabber", 4, 4000, 4.0F, 8.0F, 10);
    public static final ToolMaterial BEDROCK_SWORD = EnumHelper.addToolMaterial("drpg_bedrock_sword", 4, 14000, 4.0F, 10.0F, 2);
    ...
    public static final ToolMaterial BLUEFIRE_SWORD = EnumHelper.addToolMaterial("drpg_bluefire_sword", 4, 3000, 4.0F, 16, 15);
    public static final ToolMaterial CORRUPTED_MAUL = EnumHelper.addToolMaterial("drpg_corrupted_maul", 4, 6000, 4.0F, 9.0F, 15);
    public static final ToolMaterial CRABCLAW_MAUL = EnumHelper.addToolMaterial("drpg_crabclaw_maul", 4, 4000, 4.0F, 7.0F, 15);
    public static final ToolMaterial CYCLOPSIAN_SWORD = EnumHelper.addToolMaterial("drpg_cyclopsian_sword", 4, 1000, 4.0F, 2.0F, 10);
    public static final ToolMaterial DEATH_BRINGER = EnumHelper.addToolMaterial("drpg_death_bringer", 4, 6000, 4.0F, 8.0F, 15);
    public static final ToolMaterial DIVINE_SWORD = EnumHelper.addToolMaterial("drpg_divine_sword", 4, -1, 4.0F, 15.0F, 22);
    public static final ToolMaterial DUAL_CLAW = EnumHelper.addToolMaterial("drpg_dual_claw", 4, 4000, 4.0F, 8.0F, 15);
    public static final ToolMaterial EDEN_BLADE = EnumHelper.addToolMaterial("drpg_eden_blade", 4, 2000, 4.0F, 20.0F, 22);
    ...
    public static final ToolMaterial FLAMING_FURY = EnumHelper.addToolMaterial("drpg_flaming_fury", 4, 6000, 4.0F, 22.0F, 15);
    public static final ToolMaterial FROSSIVENCE = EnumHelper.addToolMaterial("drpg_frossivence", 4, 270, 4.0F, -3.0F, 0);
    public static final ToolMaterial FROST_SWORD = EnumHelper.addToolMaterial("drpg_frost_sword", 4, 5000, 4.0F, 6.0F, 15);
    public static final ToolMaterial FROSTKING_SWORD = EnumHelper.addToolMaterial("drpg_frossivence", 4, 6000, 4.0F, 12.0F, 15);
    public static final ToolMaterial FROZEN_MAUL = EnumHelper.addToolMaterial("drpg_frossivence", 4, -1, 4.0F, 13.0F, 15);
    public static final ToolMaterial FURY_MAUL = EnumHelper.addToolMaterial("drpg_fury_maul", 4, 4000, 4.0F, 14.0F, 15);
    public static final ToolMaterial GLACIER_SWORD = EnumHelper.addToolMaterial("drpg_glacier_sword", 4, 1000, 4.0F, 14.0F, 15);
    public static final ToolMaterial HALITE_BLADE = EnumHelper.addToolMaterial("drpg_halite_blade", 4, 2000, 4.0F, 32.0F, 22);
    ...
    public static final ToolMaterial JUNGLE_KNIFE = EnumHelper.addToolMaterial("drpg_jungle_knife", 4, 2000, 4.0F, 8.0F, 10);
    public static final ToolMaterial JUNGLE_RAPIER = EnumHelper.addToolMaterial("drpg_jungle_rapier", 4, 1200, 4.0F, 12.0F, 10);
    public static final ToolMaterial LIVICIA_SWORD = EnumHelper.addToolMaterial("drpg_livicia_sword", 4, 10000, 4.0F, 22.0F, 22);
    public static final ToolMaterial MOLTEN_SWORD = EnumHelper.addToolMaterial("drpg_molten_sword", 4, 5000, 4.0F, 6.0F, 15);
    public static final ToolMaterial MORTUM_BLADE = EnumHelper.addToolMaterial("drpg_mortum_blade", 4, 2000, 4.0F, 29.0F, 22);
    public static final ToolMaterial OCEAN_KNIFE = EnumHelper.addToolMaterial("drpg_ocean_knife", 4, 2000, 4.0F, 10.0F, 10);
    public static final ToolMaterial PALAVENCE = EnumHelper.addToolMaterial("drpg_palavence", 4, 60, 4.0F, -3.0F, 0);
    public static final ToolMaterial POISON_SABER = EnumHelper.addToolMaterial("drpg_poison_saber", 4, 5000, 4.0F, 12.0F, 15);
    public static final ToolMaterial REALMITE_SWORD = EnumHelper.addToolMaterial("drpg_realmite_sword", 4, 4000, 4.0F, 2.0F, 10);
    public static final ToolMaterial RUPEE_RAPIER = EnumHelper.addToolMaterial("drpg_rupee_rapier", 4, 2500, 4.0F, 8.0F, 15);
    public static final ToolMaterial SANDSLASH = EnumHelper.addToolMaterial("drpg_sandslash", 4, 100, 4.0F, 17.0F, 22);
    public static final ToolMaterial SCORCHING_SWORD = EnumHelper.addToolMaterial("drpg_scorching_sword", 4, 500, 4.0F, 16.0F, 15);
    public static final ToolMaterial SHARK_SWORD = EnumHelper.addToolMaterial("drpg_shark_sword",4, 2000, 4.0F, 10.0F, 15);
    public static final ToolMaterial SHADOW_SABER = EnumHelper.addToolMaterial("drpg_shadow_saber", 4, -1, 4.0F, 16.0F, 22);
    public static final ToolMaterial SKYTHERN_BLADE = EnumHelper.addToolMaterial("drpg_skythern_blade", 4, 2000, 4.0F, 27.0F, 22);
    public static final ToolMaterial SLIME_SWORD = EnumHelper.addToolMaterial("drpg_slime_sword", 4, 1000, 4.0F, 7.0F, 22);
    public static final ToolMaterial SNOWSLASH = EnumHelper.addToolMaterial("drpg_snowslash", 4, 150, 4.0F, 21.0F, 15);
    public static final ToolMaterial STORM_SWORD = EnumHelper.addToolMaterial("drpg_storm_sword", 4, -1, 4.0F, 1.0F, 22);
    public static final ToolMaterial TERRAN_DAGGER = EnumHelper.addToolMaterial("drpg_terran_dagger", 4, 350, 4.0F, 9.0F, 10);
    public static final ToolMaterial TERRAN_KNIFE = EnumHelper.addToolMaterial("drpg_terran_knife", 4, 750, 4.0F, 8.0F, 10);
    public static final ToolMaterial TERRAN_MAUL = EnumHelper.addToolMaterial("drpg_terran_maul", 4, 1200, 4.0F, 11.0F, 10);
    public static final ToolMaterial WILDWOOD_BLADE = EnumHelper.addToolMaterial("drpg_wildwood_blade", 4, 2000, 4.0F, 22.0F, 22);
