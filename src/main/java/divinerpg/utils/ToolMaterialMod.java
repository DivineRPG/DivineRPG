...
public class ToolMaterialMod {
    ...
    //Armor materials
    public static final ArmorMaterial ANGELIC_ARMOR = EnumHelper.addArmorMaterial("drpg_angelic_armor", Reference.MODID + ":angelic", 500, new int[] {3, 4, 4, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0F);
    public static final ArmorMaterial APALACHIA_ARMOR = EnumHelper.addArmorMaterial("drpg_apalachia_armor", Reference.MODID + ":apalachia", 500, new int[] {5, 5, 7, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F);
    public static final ArmorMaterial AQUASTRIVE_ARMOR = EnumHelper.addArmorMaterial("drpg_aquastrive_armor", Reference.MODID + ":aquastrive", 500, new int[] {4, 5, 6, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial ARLEMITE_ARMOR = EnumHelper.addArmorMaterial("drpg_arlemite_armor", Reference.MODID + ":arlemite", 500, new int[] {3, 5, 7, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4F);
    ...
    public static final ArmorMaterial EDEN_ARMOR = EnumHelper.addArmorMaterial("drpg_eden_armor", Reference.MODID + ":eden", 500, new int[] {3, 5, 7, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F);
    public static final ArmorMaterial ELITE_REALMITE_ARMOR = EnumHelper.addArmorMaterial("drpg_elite_realmite_armor", Reference.MODID + ":elite_realmite", 500, new int[] {4, 6, 7, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F);
    public static final ArmorMaterial ENDER_ARMOR = EnumHelper.addArmorMaterial("drpg_ender_armor", Reference.MODID + ":ender", 500, new int[] {5, 6, 7, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial RED_ENDER_ARMOR = EnumHelper.addArmorMaterial("drpg_red_ender_armor", Reference.MODID + ":red_ender", 500, new int[] {5, 6, 7, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial YELLOW_ENDER_ARMOR = EnumHelper.addArmorMaterial("drpg_yellow_ender_armor", Reference.MODID + ":yellow_ender", 500, new int[] {5, 6, 7, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial GREEN_ENDER_ARMOR = EnumHelper.addArmorMaterial("drpg_green_ender_armor", Reference.MODID + ":green_ender", 500, new int[] {5, 6, 7, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial GRAY_ENDER_ARMOR = EnumHelper.addArmorMaterial("drpg_gray_ender_armor", Reference.MODID + ":gray_ender", 500, new int[] {5, 6, 7, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial BLUE_ENDER_ARMOR = EnumHelper.addArmorMaterial("drpg_blue_ender_armor", Reference.MODID + ":blue_ender", 500, new int[] {5, 6, 7, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial FROZEN_ARMOR = EnumHelper.addArmorMaterial("drpg_frozen_armor", Reference.MODID + ":frozen", 500, new int[] {3, 5, 7, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1F);
    ...
    public static final ArmorMaterial INFERNO_ARMOR = EnumHelper.addArmorMaterial("drpg_inferno_armor", Reference.MODID + ":inferno", 500, new int[] {4, 7, 7, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1F);
    public static final ArmorMaterial JACK_O_MAN_ARMOR = EnumHelper.addArmorMaterial("drpg_jack_o_man_armor", Reference.MODID + ":jack_o_man", 500, new int[] {3, 6, 8, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial JUNGLE_ARMOR = EnumHelper.addArmorMaterial("drpg_jungle_armor", Reference.MODID + ":jungle", 500, new int[] {3, 5, 7, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1F);
    ...
    public static final ArmorMaterial KRAKEN_ARMOR = EnumHelper.addArmorMaterial("drpg_kraken_armor", Reference.MODID + ":kraken", 500, new int[] {3, 5, 6, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1F);
    ...
    public static final ArmorMaterial NETHERITE_ARMOR = EnumHelper.addArmorMaterial("drpg_netherite_armor", Reference.MODID + ":netherite", 500, new int[] {4, 5, 6, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F);
    public static final ArmorMaterial REALMITE_ARMOR = EnumHelper.addArmorMaterial("drpg_realmite_armor", Reference.MODID + ":realmite", 500, new int[] {2, 5, 6, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0F);
    ...
    public static final ArmorMaterial RED_RUPEE_ARMOR = EnumHelper.addArmorMaterial("drpg_red_rupee_armor", Reference.MODID + ":red_rupee", 500, new int[] {4, 6, 8, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial YELLOW_RUPEE_ARMOR = EnumHelper.addArmorMaterial("drpg_yellow_rupee_armor", Reference.MODID + ":yellow_rupee", 500, new int[] {4, 6, 8, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial GREEN_RUPEE_ARMOR = EnumHelper.addArmorMaterial("drpg_green_rupee_armor", Reference.MODID + ":green_rupee", 500, new int[] {4, 6, 8, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial GRAY_RUPEE_ARMOR = EnumHelper.addArmorMaterial("drpg_gray_rupee_armor", Reference.MODID + ":gray_rupee", 500, new int[] {4, 6, 8, 4}, 1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial BLUE_RUPEE_ARMOR = EnumHelper.addArmorMaterial("drpg_blue_rupee_armor", Reference.MODID + ":blue_rupee", 500, new int[] {4, 6, 8, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
    public static final ArmorMaterial SANTA_ARMOR = EnumHelper.addArmorMaterial("drpg_santa_armor", Reference.MODID + ":santa", 500, new int[] {3, 4, 5, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0F);
    ...
    public static final ArmorMaterial SKELEMAN_ARMOR = EnumHelper.addArmorMaterial("drpg_skeleman_armor", Reference.MODID + ":skeleman", 500, new int[] {3, 5, 7, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1F);
    ...
    public static final ArmorMaterial TERRAN_ARMOR = EnumHelper.addArmorMaterial("drpg_terran_armor", Reference.MODID + ":terran", 500, new int[] {3, 5, 7, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1F);
    public static final ArmorMaterial VEMOS_ARMOR = EnumHelper.addArmorMaterial("drpg_vemos_armor", Reference.MODID + ":vemos", 500, new int[] {4, 5, 6, 5},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F);
    public static final ArmorMaterial WILDWOOD_ARMOR = EnumHelper.addArmorMaterial("drpg_wildwood_armor", Reference.MODID + ":wildwood", 500, new int[] {4, 5, 7, 4},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 3F);
    public static final ArmorMaterial WITHER_REAPER_ARMOR = EnumHelper.addArmorMaterial("drpg_wither_reaper_armor", Reference.MODID + ":wither_reaper", 500, new int[] {3, 6, 8, 3},  1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 2F);
