...
public class HiveStart extends DivineStructureStart {
    ...
    public HiveStart(ResourceLocation location, TemplateManager manager, Rotation rotation, int chunkX, int y, int chunkZ) {
    ...
    protected StructureComponentTemplate getComponent(TemplateManager manager, ResourceLocation location, Rotation rotation, BlockPos pos) {
        return new HiveComponent(manager, location, rotation, pos);
    }
}
