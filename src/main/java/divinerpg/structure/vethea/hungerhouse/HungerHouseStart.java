...
public class HungerHouseStart extends DivineStructureStart {
    ...
    public HungerHouseStart(ResourceLocation location, TemplateManager manager, Rotation rotation, int chunkX, int y, int chunkZ) {
        super(location, manager, rotation, chunkX, y, chunkZ, 1, 1);
    }
    ...
    protected StructureComponentTemplate getComponent(TemplateManager manager, ResourceLocation location, Rotation rotation, BlockPos pos) {
        return new HungerHouseComponent(manager, location, rotation, pos);
    }
}
