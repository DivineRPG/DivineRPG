...
public class HutPiece {
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        private void loadTemplate(TemplateManager p_204754_1_) {
            Template template = p_204754_1_.get(STRUCTURE);
            PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation).setMirror(this.mirror).setRotationPivot(HutPiece.STRUCTURE_OFFSET).addProcessor(BlockIgnoreStructureProcessor.STRUCTURE_BLOCK);
