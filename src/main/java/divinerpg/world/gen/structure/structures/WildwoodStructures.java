...
public class WildwoodStructures extends Structure<NoFeatureConfig> {
    public WildwoodStructures(Codec<NoFeatureConfig> codec) {
        super(codec);
    }
    ...
    public  IStartFactory<NoFeatureConfig> getStartFactory() {
        return WildwoodStructures.Start::new;
    }
