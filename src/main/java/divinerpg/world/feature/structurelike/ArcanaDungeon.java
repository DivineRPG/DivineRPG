...
public class ArcanaDungeon extends Feature<NoneFeatureConfiguration> {
	...
	public boolean place(NoneFeatureConfiguration c, WorldGenLevel level, ChunkGenerator g, RandomSource random, BlockPos pos) {
		if(doorway == null) {
			...
			doorway = manager.getOrCreate(Identifier.fromNamespaceAndPath(DivineRPG.MODID, "arcana/doors/doorway"));
			entranceRoom = manager.getOrCreate(Identifier.fromNamespaceAndPath(DivineRPG.MODID, "arcana/entrance_room"));
			stairs = manager.getOrCreate(Identifier.fromNamespaceAndPath(DivineRPG.MODID, "arcana/stairs"));
			stairsTop = manager.getOrCreate(Identifier.fromNamespaceAndPath(DivineRPG.MODID, "arcana/stairs_top"));
			doors = new StructureTemplate[] {
					manager.getOrCreate(Identifier.fromNamespaceAndPath(DivineRPG.MODID, "arcana/doors/ancient_brick")),
					manager.getOrCreate(Identifier.fromNamespaceAndPath(DivineRPG.MODID, "arcana/doors/degraded_brick")),
					manager.getOrCreate(Identifier.fromNamespaceAndPath(DivineRPG.MODID, "arcana/doors/soul_sludge")),
					manager.getOrCreate(Identifier.fromNamespaceAndPath(DivineRPG.MODID, "arcana/doors/soul_stone"))
			};
	...
	class Room {
		...
		public Room(StructureTemplateManager manager, String location, @Nullable BlockState wallBlock) {
			room = manager.getOrCreate(Identifier.fromNamespaceAndPath(DivineRPG.MODID, location));
	...
	class BigRoom {
		...
		public BigRoom(StructureTemplateManager manager, String room) {
			this.room = manager.getOrCreate(Identifier.fromNamespaceAndPath(DivineRPG.MODID, room));
		}
