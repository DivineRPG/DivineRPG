...
public final class ConfiguredFeatureKeys {
	...
	public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
		...
		//Vethea
		register(context, DREAM_ASTEROID, FeatureRegistry.ELLIPSOID.get(), new EllipsoidConfig(BlockStateProvider.simple(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(DivineRPG.MODID, "dream_stone"))), 2, 7, ImmutableList.of()));
		register(context, DREAM_ASTEROID_SMALL, FeatureRegistry.ELLIPSOID.get(), new EllipsoidConfig(BlockStateProvider.simple(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(DivineRPG.MODID, "dream_stone"))), 1, 2, ImmutableList.of()));
