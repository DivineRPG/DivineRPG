...
public class ItemVanillaArmor extends net.minecraft.item.ItemArmor implements ISpecialArmor, IHasModel {
	...
	public ItemVanillaArmor(EnumArmor armorMaterial, EntityEquipmentSlot slot) {
		this(armorMaterial, slot, armorMaterial.getType());
	}

	public ItemVanillaArmor(EnumArmor armorMaterial, EntityEquipmentSlot slot, boolean vethean) {
		this(armorMaterial, slot, armorMaterial.getType(), vethean);
	}

	public ItemVanillaArmor(EnumArmor armorMaterial, EntityEquipmentSlot slot, int dR) {
		this(armorMaterial, slot, dR, armorMaterial.getType(), new Object[] { "null", "null" }, false, null);
	}

	public ItemVanillaArmor(EnumArmor armorMaterial, EntityEquipmentSlot slot, int dR, Object[] info) {
		this(armorMaterial, slot, dR, armorMaterial.getType(), info, false, null);
	}

	public ItemVanillaArmor(EnumArmor armorMaterial, EntityEquipmentSlot slot, int dR, String name) {
		this(armorMaterial, slot, dR, name, new Object[] { "null", "null" }, false, null);
	}

	public ItemVanillaArmor(EnumArmor armorMaterial, EntityEquipmentSlot slot, int dR, String name, Object[] info,
	...
	public ItemVanillaArmor(EnumArmor armorMaterial, EntityEquipmentSlot slot, Object[] info) {
		this(armorMaterial, slot, armorMaterial.getType(), info);
	}

	public ItemVanillaArmor(EnumArmor armorMaterial, EntityEquipmentSlot slot, Object[] info, boolean vethean,
	        String helmType) {
		this(armorMaterial, slot, armorMaterial.getType(), info, vethean, helmType);
	}

	public ItemVanillaArmor(EnumArmor armorMaterial, EntityEquipmentSlot slot, String name) {
		this(armorMaterial, slot, armorMaterial.getDamageReduction(), name, new Object[] { "null", "null" }, false,
		        null);
	}

	public ItemVanillaArmor(EnumArmor armorMaterial, EntityEquipmentSlot slot, String name, boolean vethean) {
		this(armorMaterial, slot, armorMaterial.getDamageReduction(), name, new Object[] { "null", "null" }, vethean,
		        null);
	}

	public ItemVanillaArmor(EnumArmor armorMaterial, EntityEquipmentSlot slot, String name, Object[] info) {
	...
	public ItemVanillaArmor(EnumArmor armorMaterial, EntityEquipmentSlot slot, String name, Object[] info, boolean vethean,
	        String helmType) {
