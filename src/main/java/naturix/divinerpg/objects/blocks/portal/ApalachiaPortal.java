...
public class ApalachiaPortal extends BlockBreakable {
	...
	public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entity) {
		if ((entity.getRidingEntity() == null) && ((entity instanceof EntityPlayerMP))) {
			...
			int dimensionID = Config.apalachiaDimensionId;
			Block blockFrame = ModBlocks.blockWildWood;
			
			if(thePlayer.timeUntilPortal > 0) 
				thePlayer.timeUntilPortal = 10;
			else if(thePlayer.dimension != dimensionID) {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getPlayerList().transferPlayerToDimension(thePlayer, dimensionID, new ModTeleporterApalachia(thePlayer.mcServer.getWorld(dimensionID), dimensionID, this));
			} else {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getPlayerList().transferPlayerToDimension(thePlayer, 0, new ModTeleporterApalachia(thePlayer.mcServer.getWorld(0), 0, this));
			}
		}
	}
