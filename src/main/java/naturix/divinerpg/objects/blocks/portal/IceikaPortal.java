...
public class IceikaPortal extends BlockBreakable implements IHasModel {
    ...
    public static class Size {
        ...
        protected int calculatePortalHeight() {
            ...
            for (this.height = 0; this.height < 21; ++this.height) {
                for (int i = 0; i < this.width; ++i) {
                    ...
                    if (block == ModBlocks.iceikaPortal) {
        ...
        protected boolean isEmptyBlock(Block blockIn) {
            return blockIn.getMaterial(blockIn.getDefaultState()) == Material.AIR || blockIn == ModBlocks.iceikaFire || blockIn == ModBlocks.iceikaPortal;
        }
        ...
        public void placePortalBlocks() {
            for (int i = 0; i < this.width; ++i) {
                ...
                for (int j = 0; j < this.height; ++j) {
                    this.world.setBlockState(blockpos.up(j), ModBlocks.iceikaPortal.getDefaultState().withProperty(IceikaPortal.AXIS, this.axis), 2);
                }
            }
        }
    }
    ...
    public boolean makePortal(World worldIn, BlockPos p) {
        ...
        IceikaPortal.Size size = new IceikaPortal.Size(worldIn, p, EnumFacing.Axis.X);
        if (size.isValid() && size.portalBlockCount == 0) {
            ...
            IceikaPortal.Size size1 = new IceikaPortal.Size(worldIn, p, EnumFacing.Axis.Z);
    ...
    public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) {
        ...
        if (enumfacing$axis == EnumFacing.Axis.X) {
            ...
            if (!IceikaPortal$size.isValid() || IceikaPortal$size.portalBlockCount < IceikaPortal$size.width * IceikaPortal$size.height) {
                worldIn.setBlockState(pos, Blocks.AIR.getDefaultState());
            }
        } else if (enumfacing$axis == EnumFacing.Axis.Z) {
            IceikaPortal.Size IceikaPortal$size1 = new IceikaPortal.Size(worldIn, pos, EnumFacing.Axis.Z);

            if (!IceikaPortal$size1.isValid() || IceikaPortal$size1.portalBlockCount < IceikaPortal$size1.width * IceikaPortal$size1.height) {
                worldIn.setBlockState(pos, Blocks.AIR.getDefaultState());
            }
        }
    }
    ...
    public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entity) {
        if ((entity.getRidingEntity() == null) && ((entity instanceof EntityPlayerMP))) {
            ...
            if (thePlayer.timeUntilPortal > 0) {
                ...
                thePlayer.timeUntilPortal = 10;
                thePlayer.mcServer.getPlayerList().transferPlayerToDimension(thePlayer, dimensionID, new DivineTeleporter(thePlayer.mcServer.getWorld(dimensionID), this, Blocks.SNOW.getDefaultState()));
            } else {
                thePlayer.timeUntilPortal = 10;
                thePlayer.mcServer.getPlayerList().transferPlayerToDimension(thePlayer, 0, new DivineTeleporter(thePlayer.mcServer.getWorld(0), this, Blocks.SNOW.getDefaultState()));
            }
        }
    }
