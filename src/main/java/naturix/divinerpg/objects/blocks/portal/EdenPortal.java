...
public class EdenPortal extends BlockBreakable implements IHasModel {
    ...
    public static class Size {
        ...
        protected int calculatePortalHeight() {
            ...
            for (int j = 0; j < this.width; ++j) {
                if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != ModBlocks.divineRock) {
                    this.height = 0;
                    break;
                }
            }
        ...
        protected int getDistanceUntilEdge(BlockPos pos, EnumFacing facing) {
            ...
            for (i = 0; i < 22; ++i) {
                ...
                if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock()) || this.world.getBlockState(blockpos.down()).getBlock() != ModBlocks.divineRock) {
                    break;
                }
            }

            Block block = this.world.getBlockState(pos.offset(facing, i)).getBlock();
            return block == ModBlocks.divineRock ? i : 0;
        }
        ...
        protected boolean isEmptyBlock(Block blockIn) {
            return blockIn.getMaterial(blockIn.getDefaultState()) == Material.AIR || blockIn == ModBlocks.blueFire || blockIn == ModBlocks.edenPortal;
        }
        ...
        public void placePortalBlocks() {
            for (int i = 0; i < this.width; ++i) {
                ...
                for (int j = 0; j < this.height; ++j) {
                    this.world.setBlockState(blockpos.up(j), ModBlocks.edenPortal.getDefaultState().withProperty(EdenPortal.AXIS, this.axis), 2);
                }
            }
        }
    }
    ...
    public EdenPortal(String name, Block fireBlock) {
    ...
    public boolean makePortal(World worldIn, BlockPos p) {
        ...
        EdenPortal.Size size = new EdenPortal.Size(worldIn, p, EnumFacing.Axis.X);
        if (size.isValid() && size.portalBlockCount == 0) {
            ...
            EdenPortal.Size size1 = new EdenPortal.Size(worldIn, p, EnumFacing.Axis.Z);
    ...
    public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) {
        ...
        if (enumfacing$axis == EnumFacing.Axis.X) {
            EdenPortal.Size WildWoodPortal$size = new EdenPortal.Size(worldIn, pos, EnumFacing.Axis.X);
            ...
            EdenPortal.Size WildWoodPortal$size1 = new EdenPortal.Size(worldIn, pos, EnumFacing.Axis.Z);
    ...
    public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entity) {
        if ((entity.getRidingEntity() == null) && ((entity instanceof EntityPlayerMP))) {
            ...
            int dimensionID = ModDimensions.edenDimension.getId();
            if (thePlayer.timeUntilPortal > 0) {
                thePlayer.timeUntilPortal = 10;
            } else if (thePlayer.dimension != dimensionID) {
                thePlayer.timeUntilPortal = 10;
                thePlayer.mcServer.getPlayerList().transferPlayerToDimension(thePlayer, dimensionID, new DivineTeleporter(thePlayer.mcServer.getWorld(dimensionID), this, ModBlocks.divineRock.getDefaultState()));
            } else {
                thePlayer.timeUntilPortal = 10;
                thePlayer.mcServer.getPlayerList().transferPlayerToDimension(thePlayer, 0, new DivineTeleporter(thePlayer.mcServer.getWorld(0), this, ModBlocks.divineRock.getDefaultState()));
            }
        }
    }
