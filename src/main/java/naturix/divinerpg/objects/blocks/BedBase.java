...
public class BedBase extends BlockHorizontal implements ITileEntityProvider
{
    ...
    /**
     * Called before the Block is set to air in the worldgen. Called regardless of if the player's tool can actually
     * collect this block
     */
    ...
    /**
     * Spawns the block's drops in the worldgen. By the time this is called the Block has possibly been set to air via
