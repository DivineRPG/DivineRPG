...
public class BlockModLeaves extends BlockLeaves implements IShearable, IHasModel {
    ...
    //    if (Minecraft.getMinecraft().gameSettings.fancyGraphics || world.getBlock(x, y, z) == VetheaBlocks.firewoodLeaves || world.getBlock(x, y, z) == VetheaBlocks.hyrewoodLeaves || world.getBlock(x, y, z) == VetheaBlocks.dreamWoodLeaves || world.getBlock(x, y, z) == VetheaBlocks.mintwoodLeaves)
    //        return true;
    //    return false;
    //}
