...
public class ContainerPresentBox extends Container {
    ...
    private final TileEntityPresentBox chestInventory;
    public ContainerPresentBox(InventoryPlayer playerInventory, TileEntityPresentBox chestInventory, EntityPlayer player) {
    ...
    public TileEntityPresentBox getChestInventory(){
