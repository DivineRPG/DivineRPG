...
import naturix.divinerpg.objects.blocks.tile.model.ModelDramixAltar;
import net.minecraft.client.renderer.GlStateManager;
import net.minecraft.client.renderer.tileentity.TileEntitySpecialRenderer;
import net.minecraft.util.ResourceLocation;

public class RenderDramixAltar extends TileEntitySpecialRenderer<TileEntityDramixAltar> {
    private static ResourceLocation TEXTURE = new ResourceLocation("divinerpg:textures/model/dramix_altar.png");
