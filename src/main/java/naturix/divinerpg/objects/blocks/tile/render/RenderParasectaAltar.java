...
import naturix.divinerpg.objects.blocks.tile.model.ModelParasectaAltar;
...
public class RenderParasectaAltar extends TileEntitySpecialRenderer<TileEntityParasectaAltar> {
    private static ResourceLocation TEXTURE = new ResourceLocation("divinerpg:textures/model/parasecta_altar.png");
