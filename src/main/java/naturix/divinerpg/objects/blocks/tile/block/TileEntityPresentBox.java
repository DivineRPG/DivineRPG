 ...
 * /01/2019
 */
public class TileEntityPresentBox extends TileEntityLockableLoot implements ITickable {
    ...
    public String getName() {
        return this.hasCustomName()? this.customName : "Present Box";
    }
    ...
    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
        return new ContainerPresentBox(playerInventory, this, playerIn);
    }

    @Override
    public String getGuiID() {
        return Reference.MODID + ":present_box";
    }
    ...
    public void update()
    {
        if (!this.world.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + pos.getX() + pos.getY() + pos.getZ()) % 200 == 0)
        {
            ...
            {
                if (entityplayer.openContainer instanceof ContainerPresentBox)
                {
                    if (((ContainerPresentBox)entityplayer.openContainer).getChestInventory() == this)
                    {
