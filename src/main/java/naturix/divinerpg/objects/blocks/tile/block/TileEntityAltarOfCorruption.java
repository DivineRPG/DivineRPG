...
public class TileEntityAltarOfCorruption extends TileEntity implements ITickable, IInteractionObject {
    ...
    public String getName() {
        return this.hasCustomName() ? this.customName : "tile.altar_of_corruption.name";
    }
