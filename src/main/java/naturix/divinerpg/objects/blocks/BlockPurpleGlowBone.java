...
//
//	@Override
//    public void updateTick(World worldgen, BlockPos pos, IBlockState state, Random rand) {
//    int	i=pos.getX();
//	int j=pos.getY();
//	int k=pos.getZ();
//	BlockPos pos2 = new BlockPos(i, j+1, k);
//	BlockPos pos3 = new BlockPos(i, j-1, k);
//		if(worldgen.isAirBlock(pos2) && worldgen.getBlockState(pos) == Blocks.AIR && worldgen.getBlockState(pos3) == Blocks.GRASS) {
...
//			if(worldgen.getBlockMetadata(i, j, k) == 2)this.dropBlockAsItemWithChance(worldgen, i, j, k, worldgen.getBlockMetadata(i, j, k), 1f, 0);
//			else if(worldgen.getBlockMetadata(i, j, k) == 0)this.dropBlockAsItem(worldgen, i, j, k, new ItemStack(TwilightItemsCrops.purpleGlowboneSeeds));
//			worldgen.breakBlock(i, j, k, false);
//		}else if(worldgen.getBlockMetadata(i, j, k) != 0 && worldgen.getBlock(i, j+1, k) != this){
...
//
//	@Override
//	public ArrayList<ItemStack> getDrops(World worldgen, int x, int y, int z, int meta, int fortune)
//    {
