...
//        this.dataWatcher.addObject(16, Byte.valueOf((byte)0));
    ...
    public void onUpdate() {
        ...
        if(this.courseChangeCooldown-- <= 0) {
            ...
            //FIXME - causing crashes but works without this
...
//            }
        ...
        if(this.targetedEntity != null && this.targetedEntity.getDistanceSq(this) < d4 * d4) {
            ...
            if(this.canEntityBeSeen(this.targetedEntity)) {
                ++this.attackCounter;
                    //FIXME - CoriShot needs adding
//                if(this.attackCounter == 20) {
//                    this.world.playSound(this.targetedEntity, ModSounds.CORI_SHOOT, 1.0F, 1.0F);
//                    CoriShot shot = new CoriShot(this.world, this, 30);
...
//            }
    ...
    private boolean isCourseTraversable(double par1, double par3, double par5, double par7) {
        ...
        AxisAlignedBB var15 = this.getCollisionBoundingBox();
