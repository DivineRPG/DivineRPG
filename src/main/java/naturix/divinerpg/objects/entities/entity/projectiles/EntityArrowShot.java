...
public class EntityArrowShot extends EntityArrow {
    ...
    private static final DataParameter<Byte> ARROW_ID = EntityDataManager.<Byte>createKey(EntityArrowShot.class,
            DataSerializers.BYTE);
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public EntityArrowShot(World world) {
        super(world);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    public EntityArrowShot(World worldIn, ArrowType arrowType, double x, double y, double z) {
        this(worldIn);
    ...
    public EntityArrowShot(World worldIn, ArrowType arrowType, EntityLivingBase shooter) {
    ...
    public static void renderMe() {
        RenderingRegistry.registerEntityRenderingHandler(EntityArrowShot.class,
                manager -> new RenderArrowShot(manager));
    }
