...
//        List<EntityLivingBase> mobs = this.world.getEntitiesWithinAABB(EntityLivingBase.class, this.getCollisionBoundingBox().expand(50, 50, 50));
...
//                if(findNewTarget && (target == null || (target != null && this.getDistance(e) < this.getDistance(target)))) target = e;
//            }
//        }
        if(target == null) {}
        if(target != null) {
            Vec3d dir = new Vec3d(target.posX-this.posX, target.posY-this.posY, target.posZ-this.posZ).normalize();
