...
public class RenderVileStorm extends Render<EntityVileStorm> {
	 ...
	 */
	@Override
	public void doRender(EntityVileStorm entity, double x, double y, double z, float entityYaw, float partialTicks) {
