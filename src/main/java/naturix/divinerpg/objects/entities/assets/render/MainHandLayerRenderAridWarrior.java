...
public class MainHandLayerRenderAridWarrior implements LayerRenderer<AridWarrior> {
    ...
    public MainHandLayerRenderAridWarrior(RenderAridWarrior renderAridWarriorIn) {
        renderAridWarrior = renderAridWarriorIn;
    }

    @Override
    public void doRenderLayer(AridWarrior entitylivingbaseIn, float limbSwing, float limbSwingAmount,
        ...
        Minecraft.getMinecraft().getItemRenderer().renderItem(entitylivingbaseIn, new ItemStack(ModItems.shadowBow),
