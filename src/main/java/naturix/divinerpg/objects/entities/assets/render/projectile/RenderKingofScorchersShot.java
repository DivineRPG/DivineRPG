...
public class RenderKingofScorchersShot extends Render<EntityKingOfScorchersShot> {
    ...
    public void doRender(EntityKingOfScorchersShot entity, double x, double y, double z, float entityYaw,
            float partialTicks) {
