package naturix.divinerpg.objects.entities.assets.render.projectiles;
...
public class RenderStaff extends Render<EntityGeneralsStaff> {

    public RenderStaff(RenderManager manager) {
        super(manager);
    }
