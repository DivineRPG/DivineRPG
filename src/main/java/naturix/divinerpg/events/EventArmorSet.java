...
public class EventArmorSet {
    ...
    public void playerTick(PlayerTickEvent event) {
        ...
        //		}
        /**
         * if(helmet == ModItems.aquastriveHelmet && body ==
         * ModItems.aquastriveChestplate && legs == ModItems.aquastriveLeggings && boots
         * == ModItems.aquastriveBoots) {
         * 
         * event.player.addPotionEffect(new
         * PotionEffect(Potion.getPotionFromResourceLocation("water_breathing"), 2, 5));
         * } if(helmet == ModItems.krakenHelmet && body == ModItems.krakenChestplate &&
         * legs == ModItems.krakenLeggings && boots == ModItems.krakenBoots) {
         * 
         * event.player.addPotionEffect(new
         * PotionEffect(Potion.getPotionFromResourceLocation("water_breathing"), 2, 5));
         * } if(helmet == ModItems.eliteRealmiteHelmet && body ==
         * ModItems.eliteRealmiteChestplate && legs == ModItems.eliteRealmiteLeggings &&
         * boots == ModItems.eliteRealmiteBoots) {
         * 
         ...
         * }
         * 
         * @SubscribeEvent public void onJump(LivingJumpEvent event) {
         * 
         *                 }
         * 
         * @SubscribeEvent public void onLivingHurtEvent(LivingHurtEvent e) {
         */
