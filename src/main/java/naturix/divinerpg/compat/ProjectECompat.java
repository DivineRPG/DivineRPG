...
public class ProjectECompat {
	...
	public static void init() {
		...
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ModItems.shardDivine, 1, 0), (int) 640);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ModItems.shardCorrupted, 1, 0), (int) 640);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ModItems.shardEnder, 1, 0), (int) 640);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ModItems.shardJungle, 1, 0), (int) 640);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ModItems.shardMolten, 1, 0), (int) 640);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ModItems.shardTerran, 1, 0), (int) 640);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ModItems.shardIce, 1, 0), (int) 640);
