...
public class PreInitLog {
	public static void init() {
		...
		DivineRPG.logger.info("RadioactiveStud, Eternaldoom1, BossLetsPlays, Xolova, sheenrox82, The_SlayerMC, insanity414all, deathman12e3, Fire_Sight, krwminer and NicosaurusRex99 are the DivineRPG dev team!");
