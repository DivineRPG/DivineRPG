...
public class ModEntities {
	public static void init() {
		...
		EntityRegistry.addSpawn(JungleStegosaurus.class, 100, 3, 5, EnumCreatureType.MONSTER, Biomes.JUNGLE, Biomes.JUNGLE_EDGE, Biomes.JUNGLE_HILLS, Biomes.MUTATED_JUNGLE, Biomes.MUTATED_JUNGLE_EDGE);
