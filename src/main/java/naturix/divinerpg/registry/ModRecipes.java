...
public class ModRecipes {
    public ModRecipes() {
        ...
        addOredictRecipe(ModItems.infernoSword, "BOB", "BOB", "BSB", 'B', Items.BLAZE_POWDER, 'O', Blocks.REDSTONE_ORE, 'S', "stickWood");
        addOredictRecipe(ModItems.moltenSword, " I ", " I ", " S ", 'I', ModItems.moltenStone, 'S', "stickWood");
        addRecipe(ModItems.scorchingSword, " I ", " I ", " S ", 'I', ModItems.purpleBlaze, 'S', ModItems.netheriteIngot);
        addRecipe(ModItems.bluefireSword, " I ", " I ", " S ", 'I', ModItems.bluefireStone, 'S', ModItems.shadowBar);
        addRecipe(ModItems.flamingFury, "XIX", "XIX", "XOX", 'I', ModItems.furyFire, 'X', ModItems.infernoSword, 'O', ModItems.shadowBar);
        addOredictRecipe(ModItems.poisonSaber, " R ", "BRB", "BSB", 'R', ModItems.jungleStone, 'B', ModItems.shadowBar, 'S', "stickWood");
        ...
        addRecipe(new ItemStack(ModItems.dualClaw), " C ", "AAA", " C ", 'C', ModItems.crabClaw, 'A', ModItems.aquaticIngot);
        ...
        addOredictRecipe(ModItems.aquatoothSword, " T ", "TKT", " S ", 'T', ModItems.liopleurodonTeeth, 'K', ModItems.liopleurodonSkull, 'S', "stickWood");
        addOredictRecipe(ModItems.aquatoothMaul, "TKT", "TKT", "KSK", 'T', ModItems.liopleurodonTeeth, 'K', ModItems.liopleurodonSkull, 'S', "stickWood");
        addRecipe(new ItemStack(ModItems.jungleRapier), "S S", "SBS", " B ", 'S', ModItems.jungleStone, 'B', ModItems.shadowBar);

        //ranged weapons
        addRecipe(ModItems.shuriken, " I ", "III", " I ", 'I', Items.IRON_INGOT);
        addRecipe(new ItemStack(ModItems.vileStorm, 8), "SSS", "SJS", "SSS", 'J', ModItems.jungleShards, 'S', ModItems.shuriken);
        ...
        addRecipe(ModItems.liopleurodonAnchor, "SIS", "IXI", " X ", 'I', ModItems.liopleurodonTeeth, 'X', ModItems.aquaticIngot, 'S', ModItems.liopleurodonSkull);
        ...
        addRecipe(ModItems.enderBow, " IX", "E X", " IX", 'I', ModItems.enderStone, 'X', Items.STRING, 'E', ModItems.watchingEye);
        addRecipe(ModItems.bluefireBow, " IX", "I X", " IX", 'I', ModItems.aquaticBlazeRod, 'X', ModItems.bluefireStone);
        ...
        addOredictRecipe(ModItems.corruptedPickaxe, "III", " S ", " S ", 'I', ModItems.corruptedStone, 'S', "stickWood");
        ...
        addShapelessRecipe(ModItems.arlemiteShickaxe, ModItems.arlemitePickaxe, ModItems.arlemiteShovel, ModItems.arlemiteAxe, ModItems.arlemiteHoe);
        ...
        addShapelessRecipe(ModItems.rupeeShickaxe, ModItems.rupeePickaxe, ModItems.rupeeShovel, ModItems.rupeeAxe, ModItems.rupeeHoe);
        ...
        // FIXME - Remove Vanilla DIAMOND, GOLDEN and IRON armor and put the replacement in
        ...
        // FIXME - Need to add
        //addRecipe(new ItemStack(ModBlocks.arcanaPortalFrame, 12), " c ", "iii", " c ", 'c', ModItems.bluefireStone, 'i', Blocks.IRON_BLOCK);

        addRecipe(ModItems.twilightClock, "CCC", "CCC", "CCC", 'C', Items.CLOCK);
        addRecipe(ModItems.snowGlobe, " G ", "GSG", "DBD", 'G', Blocks.GLASS, 'S', Blocks.SNOW, 'D', Items.DIAMOND, 'B', ModItems.shadowBar);

        addRecipe(ModItems.mysteriousClock, " H ", "SCS", " S ", 'C', Items.CLOCK, 'S', ModItems.corruptedStone, 'H', ModItems.hellstoneIngot);
        addRecipe(ModItems.callOfTheWatcher, " H ", "SES", " S ", 'E', ModItems.watchingEye, 'S', ModItems.moltenStone, 'H', ModItems.hellstoneIngot);
        addRecipe(ModItems.hordeHorn, " H ", "SES", " S ", 'E', Items.ENDER_EYE, 'S', ModItems.enderStone, 'H', ModItems.hellstoneIngot);
        ...
        addRecipe(ModBlocks.purpleSteel, "xxx", "xyx", "xxx", 'x', Items.IRON_INGOT, 'y', new ItemStack(Items.DYE, 1, 5));
        addRecipe(ModBlocks.greenSteel, "xxx", "xyx", "xxx", 'x', Items.IRON_INGOT, 'y', new ItemStack(Items.DYE, 1, 2));
        addRecipe(ModBlocks.yellowSteel, "xxx", "xyx", "xxx", 'x', Items.IRON_INGOT, 'y', new ItemStack(Items.DYE, 1, 11));
        addRecipe(ModBlocks.blueSteel, "xxx", "xyx", "xxx", 'x', Items.IRON_INGOT, 'y', new ItemStack(Items.DYE, 1, 4));
        addRecipe(ModBlocks.whiteSteel, "xxx", "xyx", "xxx", 'x', Items.IRON_INGOT, 'y', new ItemStack(Items.DYE, 1, 15));
        addRecipe(ModBlocks.blackSteel, "xxx", "xyx", "xxx", 'x', Items.IRON_INGOT, 'y', new ItemStack(Items.DYE, 1, 0));
        addRecipe(ModBlocks.orangeSteel, "xxx", "xyx", "xxx", 'x', Items.IRON_INGOT, 'y', new ItemStack(Items.DYE, 1, 14));
        addRecipe(ModBlocks.brightRedSteel, "xxx", "xyx", "xxx", 'x', Items.IRON_INGOT, 'y', new ItemStack(Items.DYE, 1, 13));

        addShapelessRecipe(new ItemStack(ModBlocks.milkStone, 4), Blocks.STONE, Blocks.STONE, Blocks.STONE, Items.MILK_BUCKET);

        addShapelessRecipe(ModBlocks.aquatonicBricks, ModItems.aquaBall, Blocks.STONEBRICK, Blocks.STONEBRICK, Blocks.STONEBRICK);
        addRecipe(ModBlocks.arlemiteBricks, "xyx", "yxy", "xyx", 'x', ModItems.arlemiteIngot, 'y', Blocks.STONEBRICK);
        addShapelessRecipe(ModBlocks.darkstoneBricks, Blocks.STONEBRICK, Blocks.STONEBRICK, Blocks.STONEBRICK, new ItemStack(Items.DYE, 1, 0));
        addShapelessRecipe(ModBlocks.diamondBricks, Blocks.STONEBRICK, Blocks.STONEBRICK, Blocks.STONEBRICK, Items.DIAMOND);
        addShapelessRecipe(ModBlocks.goldBricks, Blocks.STONEBRICK, Blocks.STONEBRICK, Blocks.STONEBRICK, Items.GOLD_INGOT);
        addShapelessRecipe(ModBlocks.greenBricks, Blocks.STONEBRICK, Blocks.STONEBRICK, Blocks.STONEBRICK, new ItemStack(Items.DYE, 1, 2));
        addShapelessRecipe(ModBlocks.ironBricks, Blocks.STONEBRICK, Blocks.STONEBRICK, Blocks.STONEBRICK, Items.IRON_INGOT);
        addShapelessRecipe(ModBlocks.lapisLazuliBricks, Blocks.STONEBRICK, Blocks.STONEBRICK, Blocks.STONEBRICK, new ItemStack(Items.DYE, 1, 4));
        addShapelessRecipe(ModBlocks.lavaBricks, Blocks.STONEBRICK, Blocks.STONEBRICK, Blocks.STONEBRICK, Items.LAVA_BUCKET);
        addShapelessRecipe(ModBlocks.netheriteBricks, ModItems.netheriteIngot);
        addShapelessRecipe(ModBlocks.pinkBricks, Blocks.STONEBRICK, Blocks.STONEBRICK, Blocks.STONEBRICK, new ItemStack(Items.DYE, 1, 9));
        addShapelessRecipe(ModBlocks.purpleBricks, Blocks.STONEBRICK, Blocks.STONEBRICK, Blocks.STONEBRICK, new ItemStack(Items.DYE, 1, 5));
        addShapelessRecipe(ModBlocks.realmiteBricks, ModItems.realmiteIngot, ModItems.realmiteIngot, ModItems.realmiteIngot, ModItems.realmiteIngot, ModItems.realmiteIngot);
        addShapelessRecipe(ModBlocks.redstoneBricks, Blocks.STONEBRICK, Blocks.STONEBRICK, Blocks.STONEBRICK, Items.REDSTONE);
        addShapelessRecipe(ModBlocks.milkStoneBricks, ModBlocks.milkStone, ModBlocks.milkStone, ModBlocks.milkStone, ModBlocks.milkStone);

        addRecipe(ModBlocks.rupeeMinibricks, "XXX", "XCX", "XXX", 'X', ModBlocks.minibricks, 'C', ModItems.rupeeIngot);
        addRecipe(ModBlocks.realmiteMinibricks, "XXX", "XCX", "XXX", 'X', ModBlocks.minibricks, 'C', ModItems.realmiteIngot);
        addRecipe(ModBlocks.arlemiteMinibricks, "XXX", "XCX", "XXX", 'X', ModBlocks.minibricks, 'C', ModItems.arlemiteIngot);
        ...
        addRecipe(ModBlocks.netheriteMinibricks, "XXX", "XCX", "XXX", 'X', ModBlocks.minibricks, 'C', ModItems.netheriteIngot);
        ...
        addRecipe(ModBlocks.arlemiteLamp, "xxx", "xyx", "xzx", 'x', Items.IRON_INGOT, 'y', ModItems.arlemiteIngot, 'z', Blocks.GLOWSTONE);
        ...
        addRecipe(ModBlocks.diamondLamp, "xxx", "xyx", "xzx", 'x', Items.IRON_INGOT, 'y', Items.DIAMOND, 'z', Blocks.GLOWSTONE);
        addShapelessRecipe(ModBlocks.divineLamp, Blocks.GLOWSTONE, ModItems.divineStone);
        addRecipe(ModBlocks.drakenLamp, "xxx", "zyz", "xxx", 'x', Items.IRON_INGOT, 'y', Items.LAVA_BUCKET, 'z', Blocks.GOLD_BLOCK);
        ...
        addRecipe(ModBlocks.goldLamp, "xxx", "xyx", "xzx", 'x', Items.IRON_INGOT, 'y', Items.GOLD_INGOT, 'z', Blocks.GLOWSTONE);
        ...
        addRecipe(ModBlocks.lapisLazuliLamp, "xxx", "xyx", "xzx", 'x', Items.IRON_INGOT, 'y', new ItemStack(Items.DYE, 1, 4), 'z', Blocks.GLOWSTONE);
        ...
        addRecipe(ModBlocks.netheriteLamp, "xxx", "xyx", "xzx", 'x', Items.IRON_INGOT, 'y', ModItems.netheriteIngot, 'z', Blocks.GLOWSTONE);
        addRecipe(ModBlocks.realmiteLamp, "xxx", "xyx", "xzx", 'x', Items.IRON_INGOT, 'y', ModItems.realmiteIngot, 'z', Blocks.GLOWSTONE);
        addRecipe(ModBlocks.redstoneOrekLamp, "xxx", "xyx", "xzx", 'x', Items.IRON_INGOT, 'y', Items.REDSTONE, 'z', Blocks.GLOWSTONE);
        addRecipe(ModBlocks.rupeeLamp, "xxx", "xyx", "xzx", 'x', Items.IRON_INGOT, 'y', ModItems.rupeeIngot, 'z', Blocks.GLOWSTONE);
        addShapelessRecipe(ModBlocks.terranLamp, Blocks.GLOWSTONE, ModItems.terranStone);

        addRecipe(new ItemStack(ModBlocks.stainedGlass, 1), "y  ", " x ", "   ", 'x', Blocks.GLASS, 'y', ModItems.marsine);
        addRecipe(new ItemStack(ModBlocks.stainedGlass2, 1), " y ", " x ", "   ", 'x', Blocks.GLASS, 'y', ModItems.marsine);
        addRecipe(new ItemStack(ModBlocks.stainedGlass3, 1), "  y", " x ", "   ", 'x', Blocks.GLASS, 'y', ModItems.marsine);
        addRecipe(new ItemStack(ModBlocks.stainedGlass4, 1), "   ", "yx ", "   ", 'x', Blocks.GLASS, 'y', ModItems.marsine);
        addRecipe(new ItemStack(ModBlocks.stainedGlass5, 1), "   ", " xy", "   ", 'x', Blocks.GLASS, 'y', ModItems.marsine);
        addRecipe(new ItemStack(ModBlocks.stainedGlass6, 1), "   ", " x ", "y  ", 'x', Blocks.GLASS, 'y', ModItems.marsine);
        addRecipe(new ItemStack(ModBlocks.stainedGlass7, 1), "   ", " x ", " y ", 'x', Blocks.GLASS, 'y', ModItems.marsine);
        addRecipe(new ItemStack(ModBlocks.stainedGlass8, 1), "   ", " x ", "  y", 'x', Blocks.GLASS, 'y', ModItems.marsine);

        // FIXME - Need to add
        //addRecipe(ModBlocks.boneChest, "bbb", "b b", "bbb", 'b', Items.BONE);

        addRecipe(new ItemStack(Blocks.BEDROCK, 3), "OOO", "OBO", " OO", 'O', Blocks.OBSIDIAN, 'B', ModBlocks.rupeeBlock);
        ...
        addRecipe(ModItems.aquaBall, "wsw", "wkw", "wsw", 'w', Items.WATER_BUCKET, 's', Items.SLIME_BALL, 'k', ModItems.krakenSkin);
        ...
        addShapelessRecipe(new ItemStack(ModBlocks.rainbowWool, 4), new ItemStack(Blocks.WOOL, 1, 1), new ItemStack(Blocks.WOOL, 1, 14), new ItemStack(Blocks.WOOL, 1, 4), new ItemStack(Blocks.WOOL, 1, 5), new ItemStack(Blocks.WOOL, 1, 9), new ItemStack(Blocks.WOOL, 1, 11), new ItemStack(Blocks.WOOL, 1, 10));
        addRecipe(new ItemStack(ModBlocks.checker, 3), "xyx", "yxy", "xyx", 'x', new ItemStack(Blocks.WOOL, 1, 0), 'y', new ItemStack(Blocks.WOOL, 1, 15));
        addRecipe(new ItemStack(ModBlocks.blueStone, 8), "GGG", "GLG", "GGG", 'G', Blocks.GLOWSTONE, 'L', new ItemStack(Items.DYE, 1, 4));
        addOredictRecipe(new ItemStack(ModBlocks.crate, 4), "xxx", "y y", "xxx", 'x', "plankWood", 'y', "logWood");
        addRecipe(new ItemStack(ModBlocks.plankDesign, 4), "xyx", "yxy", "xyx", 'x', new ItemStack(Blocks.PLANKS, 1, 0), 'y', new ItemStack(Blocks.PLANKS, 1, 1));

        addRecipe(new ItemStack(ModBlocks.skeletonTorch, 4), "x", "y", 'y', Items.BONE, 'x', Items.COAL);
        addOredictRecipe(new ItemStack(ModBlocks.aquaTorch, 4), "x", "y", 'y', "stickWood", 'x', ModItems.aquaticBlazeRod);
        // FIXME - Need to add
        ...
        // FIXME - Need to add
        //addShapelessRecipe(new ItemStack(ModBlocks.eucalyptusPlank, 4), ModBlocks.eucalyptusWood);
        ...
        addRecipe(new ItemStack(ModBlocks.blueVane, 4), "CCC", "COC", "CCC", 'C', new ItemStack(Items.DYE, 4), 'O', Blocks.OBSIDIAN);
        addRecipe(new ItemStack(ModBlocks.redVane, 4), "CCC", "COC", "CCC", 'C', new ItemStack(Items.DYE, 1, 1), 'O', Blocks.OBSIDIAN);
        addRecipe(new ItemStack(ModBlocks.cyanVane, 4), "CCC", "COC", "CCC", 'C', new ItemStack(Items.DYE, 1, 6), 'O', Blocks.OBSIDIAN);
        addRecipe(new ItemStack(ModBlocks.purpleVane, 4), "CCC", "COC", "CCC", 'C', new ItemStack(Items.DYE, 1, 5), 'O', Blocks.OBSIDIAN);
        addRecipe(new ItemStack(ModBlocks.yellowVane, 4), "CCC", "COC", "CCC", 'C', new ItemStack(Items.DYE, 1, 11), 'O', Blocks.OBSIDIAN);
