...
import naturix.divinerpg.events.advancementtriggers.AdvancementArrowKnee;
...
public static final AdvancementArrowKnee ARROW_KNEE = new AdvancementArrowKnee("arrow_knee");
...
public static final AdvancementArrowKnee[] TRIGGER_ARRAY3 = new AdvancementArrowKnee[] { ARROW_KNEE };
...
public static void registerTriggers() {
	...
	for (int i = 0; i < TRIGGER_ARRAY3.length; i++) {
		try {
			method.invoke(null, TRIGGER_ARRAY2[i]);
		} catch (IllegalAccessException | IllegalArgumentException | InvocationTargetException e) {
			e.printStackTrace();
