...
public final class ModSounds {
	...
	public static final SoundEvent LHEVIA_HURT = createEvent("lhevia_hurt");
	...
	public static final SoundEvent LORGA_FLIGHT = createEvent("lorga_flight");
	public static final SoundEvent LORGA_FLIGHT_HURT = createEvent("lorga_flight_hurt");
	...
	public static void registerSounds(RegistryEvent.Register<SoundEvent> evt) {
		evt.getRegistry().register(ACID_HAG);
		evt.getRegistry().register(ACID_HAG_HURT);
		...
		evt.getRegistry().register(BIPHRON);
		evt.getRegistry().register(BIPHRON_HURT);
		evt.getRegistry().register(BLITZ);
		evt.getRegistry().register(BOHEMITE);
		evt.getRegistry().register(BOHEMITE_HURT);
		evt.getRegistry().register(BUNNY);
		evt.getRegistry().register(BUNNY_HURT);
		evt.getRegistry().register(CADILLION);
		evt.getRegistry().register(CEILING_EXPLOSIONS);
		...
		evt.getRegistry().register(CYMESOID);
		evt.getRegistry().register(CYMESOID_HURT);
		...
		evt.getRegistry().register(DISSIMENT);
		evt.getRegistry().register(DISSIMENT_HURT);
		...
		evt.getRegistry().register(DREAM_WRECKER);
		evt.getRegistry().register(DREAM_WRECKER_HURT);
		...
		evt.getRegistry().register(DUO);
		evt.getRegistry().register(DUO_HURT);
		evt.getRegistry().register(END);
		evt.getRegistry().register(ENDIKU);
		evt.getRegistry().register(ENDIKU_HURT);
		evt.getRegistry().register(ENT);
		evt.getRegistry().register(ENT_HURT);
		evt.getRegistry().register(EXPLOSIONS);
		evt.getRegistry().register(FEEL_SOUL_ARKSIANE);
		...
		evt.getRegistry().register(GALROID);
		evt.getRegistry().register(GALROID_HURT);
		...
		evt.getRegistry().register(GORGOSION);
		evt.getRegistry().register(GORGOSION_HURT);
		...
		evt.getRegistry().register(HELIO);
		evt.getRegistry().register(HELIO_HURT);
		...
		evt.getRegistry().register(HIVE_QUEEN);
		evt.getRegistry().register(HIVE_QUEEN_HURT);
		evt.getRegistry().register(HOVER_STINGER);
		evt.getRegistry().register(HOVER_STINGER_HURT);
		...
		evt.getRegistry().register(JUNGLE);
		evt.getRegistry().register(JUNGLE_SPIDER);
		evt.getRegistry().register(KAROS_INTRO);
		evt.getRegistry().register(KAROS_LAUGH);
		evt.getRegistry().register(KAZROTIC);
		evt.getRegistry().register(KAZROTIC_HURT);
		...
		evt.getRegistry().register(LHEVIA_HURT);
		...
		evt.getRegistry().register(LORGA);
		evt.getRegistry().register(LORGA_FLIGHT);
		evt.getRegistry().register(LORGA_FLIGHT_HURT);
		evt.getRegistry().register(LORGA_HURT);
		evt.getRegistry().register(MADIVEL);
		evt.getRegistry().register(MADIVEL_HURT);
		evt.getRegistry().register(MAGE_FIRE);
		evt.getRegistry().register(MANDRAGORA);
		evt.getRegistry().register(MEET_DOOM);
		...
		evt.getRegistry().register(NOBODY_CAN_DEFEAT);
		...
		evt.getRegistry().register(QUADRO_DIE_BEFORE);
		evt.getRegistry().register(QUADRO_ENOUGH);
		evt.getRegistry().register(QUADRO_INCOMING_PUNCH);
		evt.getRegistry().register(QUADRO_IS_NEXT);
		evt.getRegistry().register(QUADRO_KILL_MINE);
		evt.getRegistry().register(QUADRO_MY_KILL);
		evt.getRegistry().register(QUADRO_NO_DIE);
		evt.getRegistry().register(QUADRO_SIT_DOWN);
		evt.getRegistry().register(QUADRO_TASTE_FIST);
		evt.getRegistry().register(RAGLOK_AVENGE);
		evt.getRegistry().register(RAGLOK_AWAKEN);
		evt.getRegistry().register(RAGLOK_DARK);
		evt.getRegistry().register(RAGLOK_GUARDIAN);
		evt.getRegistry().register(RAGLOK_NOTHING);
		evt.getRegistry().register(RAGLOK_RAIN);
		...
		evt.getRegistry().register(SHADAHIER);
		evt.getRegistry().register(SHADAHIER_HURT);
		...
		evt.getRegistry().register(STOP_AT_ONCE);
		evt.getRegistry().register(THE_EYE);
		evt.getRegistry().register(THE_EYE_HURT);
		evt.getRegistry().register(TOCAXIN);
		evt.getRegistry().register(TOCAXIN_HURT);
		evt.getRegistry().register(TRY_YOUR_BEST);
		evt.getRegistry().register(VARAAK);
		evt.getRegistry().register(VARAAK_HURT);
		evt.getRegistry().register(VEREK);
		evt.getRegistry().register(VEREK_HURT);
		evt.getRegistry().register(VERMENOUS);
		evt.getRegistry().register(VERMENOUS_HURT);
		evt.getRegistry().register(VETHEA_BOW);
		...
		evt.getRegistry().register(WRECK_INTRO);
		evt.getRegistry().register(WRECK_SPEED);
		evt.getRegistry().register(WRECK_STRENGTH);
		evt.getRegistry().register(YOU_CANT_KILL_ME);
		evt.getRegistry().register(ZONE);
