...
public static Item degradedHelmet = new ItemArmorBase(EnumArmor.DEGRADED, EntityEquipmentSlot.HEAD, basicHelmInfo, true,
        "helmet");
public static Item degradedMask = new ItemArmorBase(EnumArmor.DEGRADED, EntityEquipmentSlot.HEAD, basicMaskInfo, true,
        "mask");
public static Item degradedHood = new ItemArmorBase(EnumArmor.DEGRADED, EntityEquipmentSlot.HEAD, basicHoodInfo, true,
        "hood");
...
public static Item finishedHelmet = new ItemArmorBase(EnumArmor.FINISHED, EntityEquipmentSlot.HEAD, basicHelmInfo, true,
        "helmet");
public static Item finishedMask = new ItemArmorBase(EnumArmor.FINISHED, EntityEquipmentSlot.HEAD, basicMaskInfo, true,
        "mask");
public static Item finishedHood = new ItemArmorBase(EnumArmor.FINISHED, EntityEquipmentSlot.HEAD, basicHoodInfo, true,
        "hood");
...
public static Item demonizedHelmet = new ItemArmorBase(EnumArmor.DEMONIZED, EntityEquipmentSlot.HEAD, demonizedHelmInfo,
        true, "helmet");
public static Item demonizedMask = new ItemArmorBase(EnumArmor.DEMONIZED, EntityEquipmentSlot.HEAD, demonizedMaskInfo,
        true, "mask");
public static Item demonizedHood = new ItemArmorBase(EnumArmor.DEMONIZED, EntityEquipmentSlot.HEAD, demonizedHoodInfo,
        true, "hood");
...
public static Item tormentedHelmet = new ItemArmorBase(EnumArmor.TORMENTED, EntityEquipmentSlot.HEAD, tormentedHelmInfo,
        true, "helmet");
public static Item tormentedMask = new ItemArmorBase(EnumArmor.TORMENTED, EntityEquipmentSlot.HEAD, tormentedMaskInfo,
        true, "mask");
public static Item tormentedHood = new ItemArmorBase(EnumArmor.TORMENTED, EntityEquipmentSlot.HEAD, tormentedHoodInfo,
        true, "hood");
