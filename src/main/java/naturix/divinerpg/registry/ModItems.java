...
public class ModItems {
    ...
    public static Item shuriken = new ItemNotReady("shuriken", DivineRPG.CombatTab);
    public static Item vileStorm = new ItemNotReady("vile_storm", DivineRPG.CombatTab);
    //public static Item scythe = new ItemScythe();
    public static Item scythe = new ItemNotReady("scythe", DivineRPG.CombatTab);
    //public static Item frostCannon = new ItemProjectileShooter("frost_cannon", 6F, Sounds.frostCannon.getPrefixedName(),
    //        Items.SNOWBALL, EntityResourceLocation.frostCannon.toString(), 15000, 0);
    public static Item frostCannon = new ItemNotReady("frost_cannon", DivineRPG.CombatTab);
    //public static Item cyclopsianStaff = new ItemProjectileShooter("cyclopsian_staff", 7F,
    //        Sounds.staff.getPrefixedName(), ModItems.cyclopsEyeShards, 3000, 0);
    public static Item cyclopsianStaff = new ItemNotReady("cyclopsian_staff", DivineRPG.CombatTab);
    //public static Item maelstrom = new ItemProjectileShooter("maelstrom", 12F, Sounds.ghastCannon.getPrefixedName(),
    //        x.maelstrom.toString(), 100, 0);
    public static Item maelstrom = new ItemNotReady("maelstrom", DivineRPG.CombatTab);
    //public static Item crabAnchor = new ItemAnchor("crab_anchor", x.crabAnchor.toString(), 3);
    public static Item crabAnchor = new ItemNotReady("crab_anchor", DivineRPG.CombatTab);
    //public static Item sharkAnchor = new ItemAnchor("shark_anchor", x.bowheadAnchor.toString(), 4);
    public static Item sharkAnchor = new ItemNotReady("shark_anchor", DivineRPG.CombatTab);
    //public static Item bowheadAnchor = new ItemAnchor("bowhead_anchor", x.bowheadAnchor.toString(), 5);
    public static Item bowheadAnchor = new ItemNotReady("bowhead_anchor", DivineRPG.CombatTab);
    //public static Item liopleurodonAnchor = new ItemAnchor("liopleurodon_anchor", x.liopleurodonAnchor.toString(), 6);
    public static Item liopleurodonAnchor = new ItemNotReady("liopleurodon_anchor", DivineRPG.CombatTab);
    //public static Item goldenFury = new ItemProjectileShooter("golden_fury", 30F, Sounds.blitz.getPrefixedName(),
    //        Items.GOLD_NUGGET, -1, 0);
    public static Item goldenFury = new ItemNotReady("golden_fury", DivineRPG.CombatTab);
    //public static Item corruptedCannon = new ItemCorruptedCannon("corrupted_cannon");
    public static Item corruptedCannon = new ItemNotReady("corrupted_cannon", DivineRPG.CombatTab);
    //public static Item ghastCannon = new ItemProjectileShooter("ghast_cannon", 16F,
    //        Sounds.ghastCannon.getPrefixedName(), x.ghastCannon.toString(), 100, 5);
    public static Item ghastCannon = new ItemNotReady("ghast_cannon", DivineRPG.CombatTab);
    //public static Item crabclawCannon = new ItemProjectileShooter("crabclaw_cannon", 12F,
    //        Sounds.ghastCannon.getPrefixedName(), Util.toItem(Blocks.cactus), x.crabAnchor.toString(), 1000, 3);
    public static Item crabclawCannon = new ItemNotReady("crabclaw_cannon", DivineRPG.CombatTab);
    //public static Item bowheadCannon = new ItemProjectileShooter("bowhead_cannon", 12F,
    //        Sounds.ghastCannon.getPrefixedName(), Util.toItem(Blocks.cactus), x.bowheadAnchor.toString(), 1000, 3);
    public static Item bowheadCannon = new ItemNotReady("bowhead_cannon", DivineRPG.CombatTab);

    //public static Item serenadeOfHealth = new ItemSerenadeOfHealth("serenade_of_health");
    public static Item serenadeOfHealth = new ItemNotReady("serenade_of_health", DivineRPG.ItemsTab);
    //public static Item serenadeStriker = new ItemSerenadeStriker("serenade_striker");
    public static Item serenadeStriker = new ItemNotReady("serenade_striker", DivineRPG.CombatTab);
    //public static Item serenadeOfDeath = new ItemSerenadeOfDeath("serenade_of_death");
    public static Item serenadeOfDeath = new ItemNotReady("serenade_of_death", DivineRPG.CombatTab);
    //public static Item serenadeOfInfusion = new ItemSerenadeOfInfusion("serenade_of_infusion");
    public static Item serenadeOfInfusion = new ItemNotReady("serenade_of_infusion", DivineRPG.ItemsTab);
    ...
    public static Item eliteRealmiteHelmet = new ItemArmorBase(EnumArmor.ELITE_REALMITE, EntityEquipmentSlot.HEAD, eliteRealmiteInfo);
    public static Item eliteRealmiteBody = new ItemArmorBase(EnumArmor.ELITE_REALMITE, EntityEquipmentSlot.CHEST, eliteRealmiteInfo);
    public static Item eliteRealmiteLegs = new ItemArmorBase(EnumArmor.ELITE_REALMITE, EntityEquipmentSlot.LEGS, eliteRealmiteInfo);
    public static Item eliteRealmiteBoots = new ItemArmorBase(EnumArmor.ELITE_REALMITE, EntityEquipmentSlot.FEET, eliteRealmiteInfo);
    ...
    public static Item yellowRupeeHelmet = new ItemArmorBase(EnumArmor.RUPEE_YELLOW, EntityEquipmentSlot.HEAD, rupeeInfo);
    public static Item yellowRupeeBody = new ItemArmorBase(EnumArmor.RUPEE_YELLOW, EntityEquipmentSlot.CHEST, rupeeInfo);
    public static Item yellowRupeeLegs = new ItemArmorBase(EnumArmor.RUPEE_YELLOW, EntityEquipmentSlot.LEGS, rupeeInfo);
    public static Item yellowRupeeBoots = new ItemArmorBase(EnumArmor.RUPEE_YELLOW, EntityEquipmentSlot.FEET, rupeeInfo);
    ...
    public static Item jackOManHelmet = new ItemArmorBase(EnumArmor.JACKOMAN, EntityEquipmentSlot.HEAD, "jackOMan", jackomanInfo);
    public static Item jackOManBody = new ItemArmorBase(EnumArmor.JACKOMAN, EntityEquipmentSlot.CHEST, "jackOMan", jackomanInfo);
    public static Item jackOManLegs = new ItemArmorBase(EnumArmor.JACKOMAN, EntityEquipmentSlot.LEGS, "jackOMan", jackomanInfo);
    public static Item jackOManBoots = new ItemArmorBase(EnumArmor.JACKOMAN, EntityEquipmentSlot.FEET, "jackOMan", jackomanInfo);
    ...
    public static Item aquastriveHelmet = new ItemArmorBase(EnumArmor.AQUATIC, EntityEquipmentSlot.HEAD, aquastriveInfo);
    ...
    public static Item netheriteHelmet = new ItemArmorBase(EnumArmor.NETHERITE, EntityEquipmentSlot.HEAD, netheriteInfo);
    ...
    public static Item witherReaperHelmet = new ItemArmorBase(EnumArmor.WITHER_REAPER, EntityEquipmentSlot.HEAD, witherReaperInfo);
    public static Item witherReaperBody = new ItemArmorBase(EnumArmor.WITHER_REAPER, EntityEquipmentSlot.CHEST, witherReaperInfo);
    public static Item witherReaperLegs = new ItemArmorBase(EnumArmor.WITHER_REAPER, EntityEquipmentSlot.LEGS, witherReaperInfo);
    public static Item witherReaperBoots = new ItemArmorBase(EnumArmor.WITHER_REAPER, EntityEquipmentSlot.FEET, witherReaperInfo);
    ...
    public static Item yellowEnderHelmet = new ItemArmorBase(EnumArmor.ENDER_YELLOW, EntityEquipmentSlot.HEAD, enderInfo);
    public static Item yellowEnderBody = new ItemArmorBase(EnumArmor.ENDER_YELLOW, EntityEquipmentSlot.CHEST, enderInfo);
    public static Item yellowEnderLegs = new ItemArmorBase(EnumArmor.ENDER_YELLOW, EntityEquipmentSlot.LEGS, enderInfo);
    public static Item yellowEnderBoots = new ItemArmorBase(EnumArmor.ENDER_YELLOW, EntityEquipmentSlot.FEET, enderInfo);
    ...
    public static Item corruptedHelmet = new ItemArmorBase(EnumArmor.CORRUPTED, EntityEquipmentSlot.HEAD, corruptedInfo);
    ...
    //public static Item tarBucket = new ItemModBucket(VanillaBlocks.tar, "bucket_of_tar");
    public static Item tarBucket = new ItemNotReady("bucket_of_tar", DivineRPG.ItemsTab);

    //public static Item mysteriousClock = new ItemMysteriousClock("mysterious_clock");
    public static Item mysteriousClock = new ItemNotReady("mysterious_clock", DivineRPG.ItemsTab);
    ...
    public static Item infernalFlame = new ItemNotReady("infernal_flame", DivineRPG.CombatTab);
    public static Item hordeHorn = new ItemHordeHorn("horde_horn");

    //public static Item mushroomSeeds = new ItemModSeeds("white_mushroom_seeds", (BlockModCrop) VanillaBlocks.mushroom);
    public static Item whiteMushroomSeeds = new ItemNotReady("white_mushroom_seeds", DivineRPG.ItemsTab);
    //public static Item tomatoSeeds = new ItemModSeeds("tomato_seeds", (BlockModCrop) VanillaBlocks.tomato);
    public static Item tomatoSeeds = new ItemNotReady("tomato_seeds", DivineRPG.ItemsTab);
    ...
    public static Item teleportationCrystal = new ItemNotReady("teleportation_crystal", DivineRPG.ItemsTab);
    ...
    public static Item soundOfCarols = new ItemNotReady("sound_of_carols", DivineRPG.CombatTab);
    //public static Item soundOfMusic = new ItemMusicShooter("sound_of_music").setCreativeTab(DivineRPGTabs.ranged);
    public static Item soundOfMusic = new ItemNotReady("sound_of_music", DivineRPG.CombatTab);
    //public static Item frostclawCannon = new ItemProjectileShooter("frostclaw_cannon", 16F,
    //        Sounds.frostclawCannon.getPrefixedName(), Item.getItemFromBlock(Blocks.cactus),
    //       EntityResourceLocation.frostclawCannon.toString(), 10000, 0);
    public static Item frostclawCannon = new ItemNotReady("frostclaw_cannon", DivineRPG.CombatTab);
    //public static Item fractiteCannon = new ItemProjectileShooter("fractite_cannon", 14F,
    //        Sounds.fractiteCannon.getPrefixedName(), iceShards, EntityResourceLocation.fractiteCannon.toString(), 10000,
    //        0);
    public static Item fractiteCannon = new ItemNotReady("fractite_cannon", DivineRPG.CombatTab);
    //public static Item snowflakeShuriken = new ItemSnowflakeShuriken("snowflake_shuriken", 7);
    public static Item snowflakeShuriken = new ItemNotReady("snowflake_shuriken", DivineRPG.CombatTab);
    //public static Item serenadeOfIce = new ItemSerenadeOfIce("serenade_of_ice");
    public static Item serenadeOfIce = new ItemNotReady("serenade_of_ice", DivineRPG.CombatTab);

    //public static Item eggNog = new ItemEggNog("egg_nog");
    public static Item eggNog = new ItemNotReady("egg_nog", DivineRPG.ItemsTab);
    ...
    //public static Item apalachiaSlicer = new ItemThrowable("apalachia_slicer", 12);
    ...
    public static Item edenSlicer = new ItemNotReady("eden_slicer", DivineRPG.CombatTab);
    public static Item wildwoodSlicer = new ItemNotReady("wildwood_slicer", DivineRPG.CombatTab);
    public static Item apalachiaSlicer = new ItemNotReady("apalachia_slicer", DivineRPG.CombatTab);
    public static Item skythernSlicer = new ItemNotReady("skythern_slicer", DivineRPG.CombatTab);
    public static Item mortumSlicer = new ItemNotReady("mortum_slicer", DivineRPG.CombatTab);
    public static Item haliteSlicer = new ItemNotReady("halite_slicer", DivineRPG.CombatTab);

    //public static Item edenBlitz = new ItemTwilightBlitz("eden_blitz", x.blitzEden.toString(), TwilightItemsOther.edenDust, 10F).setHasParticle("eden");
    //public static Item wildwoodBlitz = new ItemTwilightBlitz("wildwood_blitz", x.blitzWild.toString(), TwilightItemsOther.wildwoodDust, 12F).setHasParticle("wildwood");
    //public static Item apalachiaBlitz = new ItemTwilightBlitz("apalachia_blitz", x.blitzApalachia.toString(), TwilightItemsOther.apalachiaDust, 14F).setHasParticle("apalachia");
    //public static Item skythernBlitz = new ItemTwilightBlitz("skythern_blitz", x.blitzSkythern.toString(), TwilightItemsOther.skythernDust, 16F).setHasParticle("skythern");
    //public static Item mortumBlitz = new ItemTwilightBlitz("mortum_blitz", x.blitzMortum.toString(), TwilightItemsOther.mortumDust, 18F).setHasParticle("mortum");
    //public static Item haliteBlitz = new ItemTwilightBlitz("halite_blitz", x.blitzHalite.toString(), TwilightItemsOther.mortumDust, 20F).setHasParticle("halite");
    public static Item edenBlitz = new ItemNotReady("eden_blitz", DivineRPG.CombatTab);
    public static Item wildwoodBlitz = new ItemNotReady("wildwood_blitz", DivineRPG.CombatTab);
    public static Item apalachiaBlitz = new ItemNotReady("apalachia_blitz", DivineRPG.CombatTab);
    public static Item skythernBlitz = new ItemNotReady("skythern_blitz", DivineRPG.CombatTab);
    public static Item mortumBlitz = new ItemNotReady("mortum_blitz", DivineRPG.CombatTab);
    public static Item haliteBlitz = new ItemNotReady("halite_blitz", DivineRPG.CombatTab);

    //public static Item edenPhaser = new ItemProjectileShooter("eden_phaser", 14F, Sounds.phaser.getPrefixedName(), x.phaserEden.toString(), 3000, 3).setHasParticle("eden");
    //public static Item wildwoodPhaser = new ItemProjectileShooter("wildwood_phaser", 17F, Sounds.phaser.getPrefixedName(), x.phaserWild.toString(), 3000, 3).setHasParticle("wildwood");
    //public static Item apalachiaPhaser = new ItemProjectileShooter("apalachia_phaser", 20F, Sounds.phaser.getPrefixedName(), x.phaserApalachia.toString(), 3000, 3).setHasParticle("apalachia");
    //public static Item skythernPhaser = new ItemProjectileShooter("skythern_phaser", 23F, Sounds.phaser.getPrefixedName(), x.phaserSkythern.toString(), 3000, 3).setHasParticle("skythern");
    //public static Item mortumPhaser = new ItemProjectileShooter("mortum_phaser", 26F, Sounds.phaser.getPrefixedName(), x.phaserMortum.toString(), 3000, 3).setHasParticle("mortum");
    //public static Item halitePhaser = new ItemProjectileShooter("halite_phaser", 29F, Sounds.phaser.getPrefixedName(), x.phaserHalite.toString(), 3000, 3).setHasParticle("halite");
    public static Item edenPhaser = new ItemNotReady("eden_phaser", DivineRPG.CombatTab);
    public static Item wildwoodPhaser = new ItemNotReady("wildwood_phaser", DivineRPG.CombatTab);
    public static Item apalachiaPhaser = new ItemNotReady("apalachia_phaser", DivineRPG.CombatTab);
    public static Item skythernPhaser = new ItemNotReady("skythern_phaser", DivineRPG.CombatTab);
    public static Item mortumPhaser = new ItemNotReady("mortum_phaser", DivineRPG.CombatTab);
    public static Item halitePhaser = new ItemNotReady("halite_phaser", DivineRPG.CombatTab);

    public static Item edenArrow = new ItemBase("eden_arrow").setCreativeTab(DivineRPG.CombatTab);
    public static Item wildwoodArrow = new ItemBase("wildwood_arrow").setCreativeTab(DivineRPG.CombatTab);
    public static Item furyArrow = new ItemBase("fury_arrow").setCreativeTab(DivineRPG.CombatTab);
    ...
    public static Item moonbulbSeeds = new ItemNotReady("moonbulb_seeds", DivineRPG.ItemsTab);
    ...
    public static Item purpleGlowboneSeeds = new ItemNotReady("purple_glowbone_seeds", DivineRPG.ItemsTab);
    ...
    public static Item pinkGlowboneSeeds = new ItemNotReady("pink_glowbone_seeds", DivineRPG.ItemsTab);
    //public static Item skyFlower = new ItemSkyFlower();
    public static Item skyFlower = new ItemNotReady("sky_flower", DivineRPG.ItemsTab);
    //public static Item skyPlantSeeds = new ItemTwilightSeeds("sky_plant_seeds", ModBlocks.skyPlant, Blocks.GRASS);
    public static Item skyPlantSeeds = new ItemNotReady("sky_plant_seeds", DivineRPG.ItemsTab);
    ...
    public static Item twilightClock = new ItemNotReady("twilight_clock", DivineRPG.ItemsTab);
    ...
    public static Item densosCrystal = new ItemNotReady("densos_crystal", DivineRPG.ItemsTab);
    public static Item karotCrystal = new ItemNotReady("karot_crystal", DivineRPG.ItemsTab);
    public static Item reyvorCrystal = new ItemNotReady("reyvor_crystal", DivineRPG.ItemsTab);
    public static Item soulFiendCrystal = new ItemNotReady("soul_fiend_crystal", DivineRPG.ItemsTab);
    public static Item twilightDemonCrystal = new ItemNotReady("twilight_demon_crystal", DivineRPG.ItemsTab);
    public static Item vamacheronCrystal = new ItemNotReady("vamacheron_crystal", DivineRPG.ItemsTab);
    public static Item eternalArcherCrystal = new ItemNotReady("eternal_archer_crystal", DivineRPG.ItemsTab);
    ...
    public static Item staffStarlight = new ItemNotReady("staff_of_starlight", DivineRPG.ItemsTab);
    public static Item starlight = new ItemNotReady("starlight", DivineRPG.ItemsTab);
    public static Item stormSword = new ItemNotReady("storm_sword", DivineRPG.CombatTab);
    //public static Item captainsSparkler = new ItemCaptainsSparkler("captains_sparkler");
    public static Item captainsSparkler = new ItemNotReady("captains_sparkler", DivineRPG.CombatTab);
    ...
    public static Item strongArcanaPotion = new ItemNotReady("strong_arcana_potion", DivineRPG.ItemsTab);
    public static Item weakArcanaPotion = new ItemNotReady("weak_arcana_potion", DivineRPG.ItemsTab);
    ...
    public static Item chargedCollector = new ItemNotReady("charged_collector", DivineRPG.ItemsTab);
    public static Item wizardBook = new ItemNotReady("wizards_book", DivineRPG.ItemsTab);
    public static Item staffOfEnrichment = new ItemNotReady("staff_of_enrichment", DivineRPG.ToolsTab);
    public static Item orbOfLight = new ItemNotReady("orb_of_light", DivineRPG.ItemsTab);
    public static Item meriksMissile = new ItemNotReady("meriks_missile", DivineRPG.CombatTab);
    public static Item grenade = new ItemNotReady("grenade", DivineRPG.CombatTab);
    public static Item firefly = new ItemNotReady("firefly", DivineRPG.CombatTab);
    public static Item laVekor = new ItemNotReady("la_vekor", DivineRPG.CombatTab);
    public static Item enderScepter = new ItemNotReady("ender_scepter", DivineRPG.ItemsTab);
    public static Item arcaniumSaber = new ItemNotReady("arcanium_saber", DivineRPG.CombatTab);
    public static Item ghostbane = new ItemNotReady("ghostbane", DivineRPG.CombatTab);
    public static Item arcaniumReflector = new ItemNotReady("arcanium_reflector", DivineRPG.CombatTab);
    public static Item shadowSword = new ItemNotReady("shadow_saber", DivineRPG.CombatTab);
    public static Item liviciaSword = new ItemNotReady("livicia_sword", DivineRPG.CombatTab);
    public static Item meteorMash = new ItemNotReady("meteor_mash", DivineRPG.CombatTab);
    public static Item divineAccumulator = new ItemNotReady("divine_accumulator", DivineRPG.CombatTab);
    public static Item arcaniteBlaster = new ItemNotReady("arcanite_blaster", DivineRPG.CombatTab);
    public static Item arcaniteBlade = new ItemNotReady("arcanite_blade", DivineRPG.CombatTab);
    public static Item generalsStaff = new ItemNotReady("generals_staff", DivineRPG.CombatTab);
    public static Item arcaniumAttractor = new ItemNotReady("arcanium_attractor", DivineRPG.CombatTab);
    ...
    public static Item sludgeKey = new ItemNotReady("sludge_key", DivineRPG.ItemsTab);
    public static Item ancientKey = new ItemNotReady("ancient_key", DivineRPG.ItemsTab);
    public static Item soulKey = new ItemNotReady("soul_key", DivineRPG.ItemsTab);
    public static Item degradedKey = new ItemNotReady("degraded_key", DivineRPG.ItemsTab);
    ...
    public static Item golemSpawner = new ItemNotReady("golem_egg", DivineRPG.ItemsTab);
    public static Item seimerSpawner = new ItemNotReady("seimer_egg", DivineRPG.ItemsTab);
    public static Item paratikuSpawner = new ItemNotReady("paratiku_egg", DivineRPG.ItemsTab);
    public static Item fyracryxSpawner = new ItemNotReady("fyracryx_egg", DivineRPG.ItemsTab);
    ...
    public static Item hitchakSeeds = new ItemNotReady("hitchak_seeds", DivineRPG.ItemsTab);
    ...
    public static Item veiloSeeds = new ItemNotReady("veilo_seeds", DivineRPG.ItemsTab);
    ...
    public static Item marsineSeeds = new ItemNotReady("marsine_seeds", DivineRPG.ItemsTab);
    public static Item lamona = new ItemNotReady("lamona", DivineRPG.ItemsTab);
    public static Item lamonaSeeds = new ItemNotReady("lamona_seeds", DivineRPG.ItemsTab);
    ...
    public static Item firestockSeeds = new ItemNotReady("firestock_seeds", DivineRPG.ItemsTab);
    public static Item pinfly = new ItemFoodBase(2, 0.3F, false, "pinfly").setPotionEffect(new PotionEffect(MobEffects.SPEED, 10, 2), 1.0F);
    ...
    public static Item pinflySeeds = new ItemNotReady("pinfly_seeds", DivineRPG.ItemsTab);
    public static Item aquamarine = new ItemNotReady("aquamarine", DivineRPG.ItemsTab);
    public static Item aquamarineSeeds = new ItemNotReady("aquamarine_seeds", DivineRPG.ItemsTab);
    public static Item eucalyptusSeeds = new ItemNotReady("eucalyptus_root_seeds", DivineRPG.ItemsTab);
    ...
    //public static Item barredDoor = new ItemNotReady("barred_door", DivineRPG.ItemsTab);
    ...
    public static Item teakerDisk = new ItemNotReady("teaker_disk", DivineRPG.CombatTab);
    public static Item amthrimisDisk = new ItemNotReady("amthirmis_disk", DivineRPG.CombatTab);
    public static Item darvenDisk = new ItemNotReady("darven_disk", DivineRPG.CombatTab);
    public static Item cermileDisk = new ItemNotReady("cermile_disk", DivineRPG.CombatTab);
    public static Item pardimalDisk = new ItemNotReady("pardimal_disk", DivineRPG.CombatTab);
    public static Item quadroticDisk = new ItemNotReady("quadrotic_wardisk", DivineRPG.CombatTab);
    public static Item karosDisk = new ItemNotReady("karos_wardisk", DivineRPG.CombatTab);
    public static Item heliosisDisk = new ItemNotReady("heliosis_wrathdisk", DivineRPG.CombatTab);
    public static Item arksianeDisk = new ItemNotReady("arksiane_wrathdisk", DivineRPG.CombatTab);
    ...
    public static Item teakerStaff = new ItemNotReady("teaker_staff", DivineRPG.CombatTab);
    public static Item amthrimisStaff = new ItemNotReady("amthirmis_staff", DivineRPG.CombatTab);
    public static Item darvenStaff = new ItemNotReady("darven_staff", DivineRPG.CombatTab);
    public static Item cermileStaff = new ItemNotReady("cermile_staff", DivineRPG.CombatTab);
    public static Item pardimalStaff = new ItemNotReady("pardimal_staff", DivineRPG.CombatTab);
    public static Item quadroticStaff = new ItemNotReady("quadrotic_warstaff", DivineRPG.CombatTab);
    public static Item karosStaff = new ItemNotReady("karos_warstaff", DivineRPG.CombatTab);
    public static Item heliosisStaff = new ItemNotReady("heliosis_wrathstaff", DivineRPG.CombatTab);
    public static Item arksianeStaff = new ItemNotReady("arksiane_wrathstaff", DivineRPG.CombatTab);
    ...
    public static Item honeysuckle = new ItemNotReady("honeysuckle", DivineRPG.ItemsTab);
    public static Item honeychunk = new ItemNotReady("honeychunk", DivineRPG.ItemsTab);
    public static Item dreamCarrot = new ItemNotReady("dream_carrot", DivineRPG.ItemsTab);
    public static Item dreamMelon = new ItemNotReady("dream_melon", DivineRPG.ItemsTab);
    public static Item dreamPie = new ItemNotReady("dream_pie", DivineRPG.ItemsTab);
    public static Item dreamCake = new ItemNotReady("dream_cake", DivineRPG.ItemsTab);
    public static Item dreamSweets = new ItemNotReady("dream_sweets", DivineRPG.ItemsTab);
    public static Item dreamSours = new ItemNotReady("dream_sours", DivineRPG.ItemsTab);
    ...
    //public static Item amthrimisCannon = new ItemVetheanCannon("amthirmis_cannon", 5);
    //public static Item darvenCannon = new ItemVetheanCannon("darven_cannon", 8);
    //public static Item cermileCannon = new ItemVetheanCannon("cermile_cannon", 12);
    //public static Item pardimalCannon = new ItemVetheanCannon("pardimal_cannon", 15);
    //public static Item quadroticCannon = new ItemVetheanCannon("quadrotic_warcannon", 19);
    ...
    public static Item teakerCannon = new ItemNotReady("teaker_cannon", DivineRPG.CombatTab);
    public static Item amthrimisCannon = new ItemNotReady("amthirmis_cannon", DivineRPG.CombatTab);
    public static Item darvenCannon = new ItemNotReady("darven_cannon", DivineRPG.CombatTab);
    public static Item cermileCannon = new ItemNotReady("cermile_cannon", DivineRPG.CombatTab);
    public static Item pardimalCannon = new ItemNotReady("pardimal_cannon", DivineRPG.CombatTab);
    public static Item quadroticCannon = new ItemNotReady("quadrotic_warcannon", DivineRPG.CombatTab);
    public static Item karosCannon = new ItemNotReady("karos_warcannon", DivineRPG.CombatTab);
    public static Item heliosisCannon = new ItemNotReady("heliosis_wrathcannon", DivineRPG.CombatTab);
    public static Item arksianeCannon = new ItemNotReady("arksiane_wrathcannon", DivineRPG.CombatTab);
    ...
    //public static Item darvenHammer = new ItemVetheanSword("darven_hammer", Util.addHammerMaterial(12));
    //public static Item cermileHammer = new ItemVetheanSword("cermile_hammer", Util.addHammerMaterial(15));
    //public static Item pardimalHammer = new ItemVetheanSword("pardimal_hammer", Util.addHammerMaterial(19));
    //public static Item quadroticHammer = new ItemVetheanSword("quadrotic_warhammer", Util.addHammerMaterial(24));
    ...
    public static Item teakerHammer = new ItemNotReady("teaker_hammer", DivineRPG.CombatTab);
    public static Item amthrimisHammer = new ItemNotReady("amthirmis_hammer", DivineRPG.CombatTab);
    public static Item darvenHammer = new ItemNotReady("darven_hammer", DivineRPG.CombatTab);
    public static Item cermileHammer = new ItemNotReady("cermile_hammer", DivineRPG.CombatTab);
    public static Item pardimalHammer = new ItemNotReady("pardimal_hammer", DivineRPG.CombatTab);
    public static Item quadroticHammer = new ItemNotReady("quadrotic_warhammer", DivineRPG.CombatTab);
    public static Item karosHammer = new ItemNotReady("karos_warhammer", DivineRPG.CombatTab);
    public static Item heliosisHammer = new ItemNotReady("heliosis_wrathhammer", DivineRPG.CombatTab);
    public static Item arksianeHammer = new ItemNotReady("arksiane_wrathhammer", DivineRPG.CombatTab);
    ...
    //public static Item darvenSword = new ItemVetheanSword("darven_backsword", Util.addHammerMaterial(9));
    //public static Item cermileSword = new ItemVetheanSword("cermile_backsword", Util.addHammerMaterial(13));
    //public static Item pardimalSword = new ItemVetheanSword("pardimal_backsword", Util.addHammerMaterial(16));
    //public static Item quadroticSword = new ItemVetheanSword("quadrotic_warsword", Util.addHammerMaterial(20));
    ...
    public static Item teakerSword = new ItemNotReady("teaker_backsword", DivineRPG.CombatTab);
    public static Item amthrimisSword = new ItemNotReady("amthirmis_backsword", DivineRPG.CombatTab);
    public static Item darvenSword = new ItemNotReady("darven_backsword", DivineRPG.CombatTab);
    public static Item cermileSword = new ItemNotReady("cermile_backsword", DivineRPG.CombatTab);
    public static Item pardimalSword = new ItemNotReady("pardimal_backsword", DivineRPG.CombatTab);
    public static Item quadroticSword = new ItemNotReady("quadrotic_warsword", DivineRPG.CombatTab);
    public static Item karosSword = new ItemNotReady("karos_warsword", DivineRPG.CombatTab);
    public static Item heliosisSword = new ItemNotReady("heliosis_wrathsword", DivineRPG.CombatTab);
    public static Item arksianeSword = new ItemNotReady("arksiane_wrathsword", DivineRPG.CombatTab);
    ...
    public static Item teakerClaw = new ItemNotReady("teaker_claw", DivineRPG.CombatTab);
    public static Item amthrimisClaw = new ItemNotReady("amthirmis_claw", DivineRPG.CombatTab);
    public static Item darvenClaw = new ItemNotReady("darven_claw", DivineRPG.CombatTab);
    public static Item cermileClaw = new ItemNotReady("cermile_claw", DivineRPG.CombatTab);
    public static Item pardimalClaw = new ItemNotReady("pardimal_claw", DivineRPG.CombatTab);
    public static Item quadroticClaw = new ItemNotReady("quadrotic_warclaw", DivineRPG.CombatTab);
    public static Item karosClaw = new ItemNotReady("karos_warclaw", DivineRPG.CombatTab);
    public static Item heliosisClaw = new ItemNotReady("heliosis_wrathclaw", DivineRPG.CombatTab);
    public static Item arksianeClaw = new ItemNotReady("arksiane_wrathclaw", DivineRPG.CombatTab);
    ...
    public static Item eversight = new ItemNotReady("eversight", DivineRPG.CombatTab);
    public static Item everlight = new ItemNotReady("everlight", DivineRPG.CombatTab);
    public static Item everbright = new ItemNotReady("everbright", DivineRPG.CombatTab);
    public static Item everArrow = new ItemBase("ever_arrow").setCreativeTab(DivineRPG.CombatTab);
    ...
    public static Item everfrightBow = new ItemNotReady("everfright_bow", DivineRPG.CombatTab);
    public static Item evernight = new ItemNotReady("evernight", DivineRPG.CombatTab);

    //public static Item karosRockmaul = new ItemVetheanSword("karos_rockmaul", Util.addHammerMaterial(46));
    public static Item karosRockmaul = new ItemNotReady("karos_rockmaul", DivineRPG.CombatTab);

    public static Item teakerArrow = new ItemBase("teaker_arrow").setCreativeTab(DivineRPG.CombatTab);;
    public static Item darvenArrow = new ItemBase("darven_arrow").setCreativeTab(DivineRPG.CombatTab);;
    public static Item pardimalArrow = new ItemBase("pardimal_arrow").setCreativeTab(DivineRPG.CombatTab);;
    public static Item karosArrow = new ItemBase("karos_arrow").setCreativeTab(DivineRPG.CombatTab);;

    //public static Item teakerBow = new ItemModBow("teaker_bow", -1, 2, 5, teakerArrow).setSound(Sounds.vetheaBow.getPrefixedName()).setVethean();
    //public static Item amthrimisBow = new ItemModBow("amthirmis_bow", -1, 2, 7, teakerArrow).setSound(Sounds.vetheaBow.getPrefixedName()).setVethean();
    //public static Item darvenBow = new ItemModBow("darven_bow", -1, 3, 11, darvenArrow).setSound(Sounds.vetheaBow.getPrefixedName()).setVethean();
    //public static Item cermileBow = new ItemModBow("cermile_bow", -1, 4, 14, darvenArrow).setSound(Sounds.vetheaBow.getPrefixedName()).setVethean();
    //public static Item pardimalBow = new ItemModBow("pardimal_bow", -1, 5, 18, pardimalArrow).setSound(Sounds.vetheaBow.getPrefixedName()).setVethean();
    //public static Item quadroticBow = new ItemModBow("quadrotic_warbow", -1, 6, 21, pardimalArrow).setSound(Sounds.vetheaBow.getPrefixedName()).setVethean();
    //public static Item karosBow = new ItemModBow("karos_warbow", -1, 7, 23, karosArrow).setSound(Sounds.vetheaBow.getPrefixedName()).setVethean();
    //public static Item heliosisBow = new ItemModBow("heliosis_wrathbow", -1, 8, 28, karosArrow).setSound(Sounds.vetheaBow.getPrefixedName()).setVethean();
    //public static Item arksianeBow = new ItemModBow("arksiane_wrathbow", -1, 12, 36, karosArrow).setSound(Sounds.vetheaBow.getPrefixedName()).setVethean();
    public static Item teakerBow = new ItemNotReady("teaker_bow", DivineRPG.CombatTab);
    public static Item amthrimisBow = new ItemNotReady("amthirmis_bow", DivineRPG.CombatTab);
    public static Item darvenBow = new ItemNotReady("darven_bow", DivineRPG.CombatTab);
    public static Item cermileBow = new ItemNotReady("cermile_bow", DivineRPG.CombatTab);
    public static Item pardimalBow = new ItemNotReady("pardimal_bow", DivineRPG.CombatTab);
    public static Item quadroticBow = new ItemNotReady("quadrotic_warbow", DivineRPG.CombatTab);
    public static Item karosBow = new ItemNotReady("karos_warbow", DivineRPG.CombatTab);
    public static Item heliosisBow = new ItemNotReady("heliosis_wrathbow", DivineRPG.CombatTab);
    public static Item arksianeBow = new ItemNotReady("arksiane_wrathbow", DivineRPG.CombatTab);

    //public static Item dreamFlint = new ItemDreamFlint();
    //public static Item moonClock = new ItemMoonClock();
    public static Item dreamFlint = new ItemNotReady("dream_flint", DivineRPG.ItemsTab);
    public static Item moonClock = new ItemNotReady("moon_clock", DivineRPG.ItemsTab);
    public static Item rockChunks = new ItemBase("rock_chunks");
    //public static Item nightmareBed = new ItemNightmareBed();
    public static Item nightmareBed = new ItemNotReady("nightmare_bed", DivineRPG.ItemsTab);
    ...
    public static Item degradedHelmet = new ItemArmorBase(EnumArmor.DEGRADED, EntityEquipmentSlot.HEAD, basicHelmInfo, true, "helmet");
    public static Item degradedMask = new ItemArmorBase(EnumArmor.DEGRADED, EntityEquipmentSlot.HEAD, basicMaskInfo, true, "mask");
    public static Item degradedHood = new ItemArmorBase(EnumArmor.DEGRADED, EntityEquipmentSlot.HEAD, basicHoodInfo, true, "hood");
    ...
    public static Item finishedHelmet = new ItemArmorBase(EnumArmor.FINISHED, EntityEquipmentSlot.HEAD, basicHelmInfo, true, "helmet");
    public static Item finishedMask = new ItemArmorBase(EnumArmor.FINISHED, EntityEquipmentSlot.HEAD, basicMaskInfo, true, "mask");
    public static Item finishedHood = new ItemArmorBase(EnumArmor.FINISHED, EntityEquipmentSlot.HEAD, basicHoodInfo, true, "hood");
    ...
    public static Item glisteningHelmet = new ItemArmorBase(EnumArmor.GLISTENING, EntityEquipmentSlot.HEAD, glisteningHelmInfo, true, "helmet");
    public static Item glisteningMask = new ItemArmorBase(EnumArmor.GLISTENING, EntityEquipmentSlot.HEAD, glisteningMaskInfo, true, "mask");
    public static Item glisteningHood = new ItemArmorBase(EnumArmor.GLISTENING, EntityEquipmentSlot.HEAD, glisteningHoodInfo, true, "hood");
    ...
    public static Item demonizedHelmet = new ItemArmorBase(EnumArmor.DEMONIZED, EntityEquipmentSlot.HEAD, demonizedHelmInfo, true, "helmet");
    public static Item demonizedMask = new ItemArmorBase(EnumArmor.DEMONIZED, EntityEquipmentSlot.HEAD, demonizedMaskInfo, true, "mask");
    public static Item demonizedHood = new ItemArmorBase(EnumArmor.DEMONIZED, EntityEquipmentSlot.HEAD, demonizedHoodInfo, true, "hood");
    ...
    public static Item tormentedHelmet = new ItemArmorBase(EnumArmor.TORMENTED, EntityEquipmentSlot.HEAD, tormentedHelmInfo, true, "helmet");
    public static Item tormentedMask = new ItemArmorBase(EnumArmor.TORMENTED, EntityEquipmentSlot.HEAD, tormentedMaskInfo, true, "mask");
    public static Item tormentedHood = new ItemArmorBase(EnumArmor.TORMENTED, EntityEquipmentSlot.HEAD, tormentedHoodInfo, true, "hood");
