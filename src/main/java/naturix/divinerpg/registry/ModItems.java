...
public static Item cyclopsianStaff = new ItemProjectileShooter("cyclopsian_staff", ProjectileType.CYCLOPSIAN_STAFF_SHOT,
...
public static Item liopleurodonAnchor = new ItemAnchor("liopleurodon_anchor", ProjectileType.LIOPLEURODON_ANCHOR_SHOT);
...
public static Item crabclawCannon = new ItemProjectileShooter("crabclaw_cannon", ProjectileType.CRABCLAW_CANNON_SHOT,
...
public static Item yellowRupeeHelmet = new ItemDivineArmor(EnumArmor.RUPEE_YELLOW, EntityEquipmentSlot.HEAD, rupeeInfo);
public static Item yellowRupeeBody = new ItemDivineArmor(EnumArmor.RUPEE_YELLOW, EntityEquipmentSlot.CHEST, rupeeInfo);
public static Item yellowRupeeLegs = new ItemDivineArmor(EnumArmor.RUPEE_YELLOW, EntityEquipmentSlot.LEGS, rupeeInfo);
public static Item yellowRupeeBoots = new ItemDivineArmor(EnumArmor.RUPEE_YELLOW, EntityEquipmentSlot.FEET, rupeeInfo);
...
public static Item aquastriveHelmet = new ItemDivineArmor(EnumArmor.AQUATIC, EntityEquipmentSlot.HEAD, aquastriveInfo);
...
public static Item netheriteHelmet = new ItemDivineArmor(EnumArmor.NETHERITE, EntityEquipmentSlot.HEAD, netheriteInfo);
...
public static Item yellowEnderHelmet = new ItemDivineArmor(EnumArmor.ENDER_YELLOW, EntityEquipmentSlot.HEAD, enderInfo);
public static Item yellowEnderBody = new ItemDivineArmor(EnumArmor.ENDER_YELLOW, EntityEquipmentSlot.CHEST, enderInfo);
public static Item yellowEnderLegs = new ItemDivineArmor(EnumArmor.ENDER_YELLOW, EntityEquipmentSlot.LEGS, enderInfo);
public static Item yellowEnderBoots = new ItemDivineArmor(EnumArmor.ENDER_YELLOW, EntityEquipmentSlot.FEET, enderInfo);
...
public static Item corruptedHelmet = new ItemDivineArmor(EnumArmor.CORRUPTED, EntityEquipmentSlot.HEAD, corruptedInfo);
...
public static Item frostclawCannon = new ItemProjectileShooter("frostclaw_cannon", ProjectileType.FROSTCLAW_CANNON_SHOT,
...
public static Item skythernBlitz = new ItemTwilightBlitz("skythern_blitz", ProjectileType.SKYTHERN_BLITZ_SHOT,
        skythernDust);
public static Item mortumBlitz = new ItemTwilightBlitz("mortum_blitz", ProjectileType.MORTUM_BLITZ_SHOT, mortumDust);
public static Item haliteBlitz = new ItemTwilightBlitz("halite_blitz", ProjectileType.HALITE_BLITZ_SHOT, mortumDust);
...
public static Item wildwoodPhaser = new ItemProjectileShooter("wildwood_phaser", ProjectileType.WILDWOOD_PHASER_SHOT,
        ModSounds.PHASER, 3000, 3);
public static Item apalachiaPhaser = new ItemProjectileShooter("apalachia_phaser", ProjectileType.APALACHIA_PHASER_SHOT,
        ModSounds.PHASER, 3000, 3);
public static Item skythernPhaser = new ItemProjectileShooter("skythern_phaser", ProjectileType.SKYTHERN_PHASER_SHOT,
        ModSounds.PHASER, 3000, 3);
...
public static Item degradedHelmet = new ItemDivineArmor(EnumArmor.DEGRADED, EntityEquipmentSlot.HEAD, basicHelmInfo,
        true, "helmet");
public static Item degradedMask = new ItemDivineArmor(EnumArmor.DEGRADED, EntityEquipmentSlot.HEAD, basicMaskInfo, true,
        "mask");
public static Item degradedHood = new ItemDivineArmor(EnumArmor.DEGRADED, EntityEquipmentSlot.HEAD, basicHoodInfo, true,
        "hood");
...
public static Item finishedHelmet = new ItemDivineArmor(EnumArmor.FINISHED, EntityEquipmentSlot.HEAD, basicHelmInfo,
        true, "helmet");
public static Item finishedMask = new ItemDivineArmor(EnumArmor.FINISHED, EntityEquipmentSlot.HEAD, basicMaskInfo, true,
        "mask");
public static Item finishedHood = new ItemDivineArmor(EnumArmor.FINISHED, EntityEquipmentSlot.HEAD, basicHoodInfo, true,
        "hood");
...
public static Item demonizedMask = new ItemDivineArmor(EnumArmor.DEMONIZED, EntityEquipmentSlot.HEAD, demonizedMaskInfo,
        true, "mask");
public static Item demonizedHood = new ItemDivineArmor(EnumArmor.DEMONIZED, EntityEquipmentSlot.HEAD, demonizedHoodInfo,
        true, "hood");
...
public static Item tormentedMask = new ItemDivineArmor(EnumArmor.TORMENTED, EntityEquipmentSlot.HEAD, tormentedMaskInfo,
        true, "mask");
public static Item tormentedHood = new ItemDivineArmor(EnumArmor.TORMENTED, EntityEquipmentSlot.HEAD, tormentedHoodInfo,
        true, "hood");
