...
public class ModBlocks {
    ...
    public static Block divinePlanks = new BlockMod(EnumBlockType.WOOD, "divine_planks", 2, DivineRPG.BlocksTab).setResistance(5);
    ...
    //public static Block winterberryBushRipe = new BlockWinterberryBush(true, "ripe_winterberry_bush").setHardness(0.2F);
    ...
    public static Block frostArcherSpawner = new BlockModSpawner("frost_archer_spawner", "FrostArcher").setHardness(5.0F);
    ...
    //public static Block workshopBookcase = new BlockModBook(EnumBlockType.ROCK, "workshop_bookcase").setHardness(1.5F);
    public static Block workshopLamp = new BlockMod(EnumBlockType.GLASS, "workshop_lamp", 0.3F).setLightLevel(1);
    //public static Block steelDoorBlock = new BlockModDoor(EnumBlockType.IRON, "steel_door_block", 7.0F, true);
    ...
    //public static Block iceikaPortal = new BlockModPortal("iceika_portal", ConfigurationHelper.iceika, iceikaFire, Blocks.SNOW);
    ...
    //public static Block edenPortal = new BlockModPortal("eden_portal", ConfigurationHelper.eden, blueFire, divineRock);
    //public static Block wildwoodPortal = new BlockModPortal("wildwood_portal", ConfigurationHelper.wildwood, blueFire, edenBlock);
    //public static Block apalachiaPortal = new BlockModPortal("apalachia_portal", ConfigurationHelper.apalachia, blueFire, wildwoodBlock);
    //public static Block skythernPortal = new BlockModPortal("skythern_portal", ConfigurationHelper.skythern, blueFire, apalachiaBlock);
    //public static Block mortumPortal = new BlockModPortal("mortum_portal", ConfigurationHelper.mortum, blueFire, skythernBlock);
