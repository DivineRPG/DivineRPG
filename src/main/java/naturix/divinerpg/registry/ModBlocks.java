...
public class ModBlocks {
	...
	public static BlockModPortal wildwoodPortal = new BlockModPortal("wildwood_portal", blueFire,
	        ModDimensions.wildWoodDimension.getId(), edenBlock);
	public static BlockModPortal apalachiaPortal = new BlockModPortal("apalachia_portal", blueFire,
	        ModDimensions.apalachiaDimension.getId(), wildwoodBlock);
	public static BlockModPortal skythernPortal = new BlockModPortal("skythern_portal", blueFire,
	        ModDimensions.skythernDimension.getId(), apalachiaBlock);
	public static BlockModPortal mortumPortal = new BlockModPortal("mortum_portal", blueFire,
	        ModDimensions.mortumDimension.getId(), skythernBlock);
