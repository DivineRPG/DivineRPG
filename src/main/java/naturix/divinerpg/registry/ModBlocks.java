...
import naturix.divinerpg.bases.blocks.CoalstoneFurnace;
...
import naturix.divinerpg.bases.blocks.IceikaChest;
...
import naturix.divinerpg.bases.blocks.SteelDoor;
...
public class ModBlocks {
	...
	// public static BlockBase frozenLeaves = new BlockBase(Material.LEAVES,
	// "leaves_frozen");
	...
	// public static SaplingApalachia divineSapling = new
	// SaplingApalachia("sapling_divine");
	// public static SaplingApalachia dreamSapling = new
	// SaplingApalachia("sapling_dream");
	// public static SaplingApalachia frozenSapling = new
	// SaplingApalachia("sapling_frozen");
	// public static SaplingApalachia hyreSapling = new
	// SaplingApalachia("sapling_hyre");
	// public static SaplingApalachia mintSapling = new
	// SaplingApalachia("sapling_mint");
	public static SaplingEden edenSapling = new SaplingEden("sapling_eden");
	// public static SaplingApalachia fireSapling = new
	// SaplingApalachia("sapling_fire");
