...
public class EnderTriplets extends EntityMob {
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(7, new EnderTriplets.AIFireballAttack(this));
        this.applyEntityAI();
    }
    ...
    {
        private final EnderTriplets parentEntity;
        public int attackTimer;

        public AIFireballAttack(EnderTriplets enderTriplets)
        {
            this.parentEntity = enderTriplets;
        }
