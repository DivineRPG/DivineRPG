...
public abstract class ECustomArrow extends Entity implements IProjectile
{
    ...
    private static final DataParameter<Byte> CRITICAL = EntityDataManager.<Byte>createKey(ECustomArrow.class, DataSerializers.BYTE);
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public ECustomArrow.PickupStatus pickupStatus;
    ...
    public ECustomArrow(World worldIn)
    {
        super(worldIn);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
        this.pickupStatus = ECustomArrow.PickupStatus.DISALLOWED;
        this.damage = 2.0D;
        this.setSize(0.5F, 0.5F);
    }

    public ECustomArrow(World worldIn, double x, double y, double z)
    {
        this(worldIn);
    ...
    public ECustomArrow(World worldIn, EntityLivingBase shooter)
    {
        ...
        {
            this.pickupStatus = ECustomArrow.PickupStatus.ALLOWED;
        }
    }
    ...
    protected void onHit(RayTraceResult raytraceResultIn)
    {
        ...
        if (entity != null)
        {
            ...
            else
            {
                ...
                {
                    if (this.pickupStatus == ECustomArrow.PickupStatus.ALLOWED)
                    {
    ...
    public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        {
            this.pickupStatus = ECustomArrow.PickupStatus.getByOrdinal(compound.getByte("pickup"));
        }
        else if (compound.hasKey("player", 99))
        {
            this.pickupStatus = compound.getBoolean("player") ? ECustomArrow.PickupStatus.ALLOWED : ECustomArrow.PickupStatus.DISALLOWED;
        }
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn)
    {
        ...
        {
            boolean flag = this.pickupStatus == ECustomArrow.PickupStatus.ALLOWED || this.pickupStatus == ECustomArrow.PickupStatus.CREATIVE_ONLY && entityIn.capabilities.isCreativeMode;

            if (this.pickupStatus == ECustomArrow.PickupStatus.ALLOWED && !entityIn.inventory.addItemStackToInventory(this.getArrowStack()))
            {
                flag = false;
            }
    ...
    public static enum PickupStatus
    {
        ...
        public static ECustomArrow.PickupStatus getByOrdinal(int ordinal)
        {
