...
public class ModTeleporterApalachia extends Teleporter {
    ...
    protected final Long2ObjectMap<ModTeleporterApalachia.PortalPosition> destinationCoordinateCache = new Long2ObjectOpenHashMap<ModTeleporterApalachia.PortalPosition>(
            4096);
                ...
                for (int i1 = -2; i1 <= 2; ++i1) {
                    for (int j1 = -1; j1 < 3; ++j1) {
                        ...
                        this.myWorld.setBlockState(new BlockPos(k1, l1, i2),
                                flag ? ModBlocks.apalachiaPortal.getDefaultState() : Blocks.AIR.getDefaultState());
                    }
                }
            }
    ...
    public boolean placeInExistingPortal(Entity entityIn, float par2) {
        ...
        if (this.destinationCoordinateCache.containsKey(k)) {
            ModTeleporterApalachia.PortalPosition portalposition = (ModTeleporterApalachia.PortalPosition) this.destinationCoordinateCache
                    .get(k);
            d0 = 0.0D;
        ...
        if (d0 >= 0.0D) {
            if (flag1) {
                this.destinationCoordinateCache.put(k,
                        new ModTeleporterApalachia.PortalPosition(object, this.myWorld.getTotalWorldTime()));
            }
                ...
                for (j3 = 1; j3 < 3; ++j3) {
                    for (k3 = -1; k3 < 3; ++k3) {
                        ...
                        this.myWorld.setBlockState(new BlockPos(l3, i4, j4),
                                flag ? ModBlocks.wildwoodBlock.getDefaultState() : Blocks.AIR.getDefaultState());
                    }
                }
            }
        }
            ...
            for (k3 = 0; k3 < 4; ++k3) {
                for (l3 = -1; l3 < 4; ++l3) {
                    ...
                    this.myWorld.setBlockState(new BlockPos(i4, j4, k4),
                            flag1 ? ModBlocks.wildwoodBlock.getDefaultState() : iblockstate, 2);
                }
            }
