package naturix.divinerpg.dimensions.skythern.worldgen.trees;
...
public class SkythernTree extends WorldGenAbstractTree {
    ...
    public SkythernTree(boolean notify, int minTreeHeightIn) {
        super(notify);
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        boolean isSoil = ((BlockModSapling) ModBlocks.skythernSapling).canPlaceBlockAt(worldIn, position);
