package naturix.divinerpg.dimensions.mortum.chunk;
...
public class ChunkGeneratorMortum implements  IChunkGenerator
{
	...
	public ChunkGeneratorMortum(World world, long seed)
	{
		this.worldObj = world;
	...
	public void buildSurfaces(int i, int j, ChunkPrimer chunkPrimer)
    {
        for(int k = 0; k < 16; k++)
        {
            for(int l = 0; l < 16; l++)
            {
        		...
        		IBlockState top = ModBlocks.grassMortum.getDefaultState();
        		IBlockState filler = ModBlocks.dirtMortum.getDefaultState();
