...
public class ModTeleporterEden extends Teleporter {
	...
	protected final Long2ObjectMap<ModTeleporterEden.PortalPosition> destinationCoordinateCache = new Long2ObjectOpenHashMap<ModTeleporterEden.PortalPosition>(
	        4096);
	...
	public boolean makePortal(Entity p_85188_1_) {
		...
		portal.getDefaultState().withProperty(BlockPortal.AXIS, l5 == 0 ? EnumFacing.Axis.Z : EnumFacing.Axis.X);
	...
	public boolean placeInExistingPortal(Entity entityIn, float par2) {
		...
		if (this.destinationCoordinateCache.containsKey(k)) {
			ModTeleporterEden.PortalPosition portalposition = this.destinationCoordinateCache.get(k);
			d0 = 0.0D;
		...
		if (d0 >= 0.0D) {
			if (flag1) {
				this.destinationCoordinateCache.put(k,
				        new ModTeleporterEden.PortalPosition(object, this.myWorld.getTotalWorldTime()));
			}
