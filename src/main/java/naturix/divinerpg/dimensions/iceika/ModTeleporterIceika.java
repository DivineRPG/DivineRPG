...
public class ModTeleporterIceika extends Teleporter {
    ...
    protected final Long2ObjectMap<ModTeleporterIceika.PortalPosition> destinationCoordinateCache = new Long2ObjectOpenHashMap<ModTeleporterIceika.PortalPosition>(
            4096);
                ...
                for (int i1 = -2; i1 <= 2; ++i1) {
                    for (int j1 = -1; j1 < 3; ++j1) {
                        ...
                        this.myWorld.setBlockState(new BlockPos(k1, l1, i2),
                                flag ? ModBlocks.iceikaPortal.getDefaultState() : Blocks.AIR.getDefaultState());
                    }
                }
            }
    ...
    public boolean placeInExistingPortal(Entity entityIn, float par2) {
        ...
        if (this.destinationCoordinateCache.containsKey(k)) {
            ModTeleporterIceika.PortalPosition portalposition = (ModTeleporterIceika.PortalPosition) this.destinationCoordinateCache
                    .get(k);
            d0 = 0.0D;
        ...
        if (d0 >= 0.0D) {
            if (flag1) {
                this.destinationCoordinateCache.put(k,
                        new ModTeleporterIceika.PortalPosition(object, this.myWorld.getTotalWorldTime()));
            }
            ...
            for (k3 = 0; k3 < 4; ++k3) {
                for (l3 = -1; l3 < 4; ++l3) {
                    ...
                    this.myWorld.setBlockState(new BlockPos(i4, j4, k4),
                            flag1 ? Blocks.SNOW.getDefaultState() : iblockstate, 2);
                }
            }
