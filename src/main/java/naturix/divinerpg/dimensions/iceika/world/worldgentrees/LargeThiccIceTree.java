package naturix.divinerpg.dimensions.iceika.world.worldgentrees;
 ...
 * /24/2019
 */
public class LargeThiccIceTree extends WorldGenAbstractTree {
    ...
    public LargeThiccIceTree(boolean notify, int minTrunkHeight) {
        super(notify);
    ...
    public boolean generate(World worldIn, Random rand, BlockPos blockPos) {
        ...
        int branchSectionNum = rand.nextInt(7) + 8;
        int treeHeight = trunkHeight + (branchSectionNum * 3);
    ...
    private void generateBranchLayer(World worldIn, BlockPos blockPos, int branchSectionNum, int trunkHeight) {
        for (int y = 0; y <= branchSectionNum*3; y++) {
            if (y % 3 == 0) {
                for (int x = -3; x <= 4; x++) {
                    for (int z = -4; z <= 5; z++) {
        ...
        for (int x = -2; x <= 3; x++) {
            for (int z = -3; z <= 4; z++) {
                setBlockAndNotifyAdequately(worldIn, blockPos.add(x, (branchSectionNum*3) + trunkHeight + 1, z), leaves);
            }
        }
        for (int x = -3; x <= 4; x++) {
            for (int z = -2; z <= 3; z++) {
        ...
        for (int x = -1; x <= 2; x++) {
            for (int z = -2; z <= 3; z++) {
                setBlockAndNotifyAdequately(worldIn, blockPos.add(x, (branchSectionNum*3) + trunkHeight + 2, z), leaves);
            }
        }
        for (int x = -2; x <= 3; x++) {
            for (int z = -1; z <= 2; z++) {
        ...
        for (int x = 0; x <= 1; x++) {
            for (int z = -1; z <= 2; z++) {
                setBlockAndNotifyAdequately(worldIn, blockPos.add(x, (branchSectionNum*3) + trunkHeight + 3, z), leaves);
            }
        }
        for (int x = -1; x <= 2; x++) {
            for (int z = 0; z <= 1; z++) {
        ...
        for (int x = -2; x <= 3; x++) {
            for (int z = -3; z <= 4; z++) {
                setBlockAndNotifyAdequately(worldIn, blockPos.add(x, (branchSectionNum*3) + trunkHeight + 4, z), leaves);
            }
        }
        for (int x = -3; x <= 4; x++) {
            for (int z = -2; z <= 3; z++) {
        ...
        for (int x = -1; x <= 2; x++) {
            for (int z = -2; z <= 3; z++) {
                setBlockAndNotifyAdequately(worldIn, blockPos.add(x, (branchSectionNum*3) + trunkHeight + 5, z), leaves);
            }
        }
        for (int x = -2; x <= 3; x++) {
            for (int z = -1; z <= 2; z++) {
        ...
        for (int x = 0; x <= 1; x++) {
            for (int z = -1; z <= 2; z++) {
                setBlockAndNotifyAdequately(worldIn, blockPos.add(x, (branchSectionNum*3) + trunkHeight + 6, z), leaves);
            }
        }
        for (int x = -1; x <= 2; x++) {
            for (int z = 0; z <= 1; z++) {
        ...
        for (int x = 0; x <= 1; x++) {
            for (int z = 0; z <= 1; z++) {
                setBlockAndNotifyAdequately(worldIn, blockPos.add(x, (branchSectionNum*3) + trunkHeight + 7, z), leaves);
            }
        }
        for (int x = 0; x <= 1; x++) {
            for (int z = -1; z <= 2; z++) {
                setBlockAndNotifyAdequately(worldIn, blockPos.add(x, (branchSectionNum*3) + trunkHeight + 8, z), leaves);
            }
        }
        for (int x = -1; x <= 2; x++) {
            for (int z = 0; z <= 1; z++) {
        ...
        for (int y = (branchSectionNum*3) + trunkHeight + 1; y <= (branchSectionNum*3) + trunkHeight + 6; y++) {
            setBlockAndNotifyAdequately(worldIn, blockPos.up(y), log);
            setBlockAndNotifyAdequately(worldIn, blockPos.add(1, y, 0), log);
            setBlockAndNotifyAdequately(worldIn, blockPos.add(1, y, 1), log);
            setBlockAndNotifyAdequately(worldIn, blockPos.add(0, y, 1), log);
