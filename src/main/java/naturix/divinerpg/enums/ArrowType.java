...
public enum ArrowType {
    ...
    AMTHRIMIS_ARROW(2, 7, ProjectileLoc("teaker_arrow")),
    DARVEN_ARROW(3, 11, ProjectileLoc("darven_arrow")),
    CERMIL_ARROW(4, 14, ProjectileLoc("darven_arrow")),
    PARDINAL_ARROW(5, 18, ProjectileLoc("pardimal_arrow")),
    ...
    ARKSIAN_ARROW(12, 36, ProjectileLoc("karos_arrow")),
