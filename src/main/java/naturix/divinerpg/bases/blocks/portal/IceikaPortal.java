	...
	public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entity) {
		if ((entity.getRidingEntity() == null) && ((entity instanceof EntityPlayerMP))) {
			...
			if(thePlayer.timeUntilPortal > 0) 
				...
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getPlayerList().transferPlayerToDimension(thePlayer, dimensionID, new ModTeleporterIceika(thePlayer.mcServer.getWorld(dimensionID), dimensionID, this, Blocks.SNOW));
			} else {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getPlayerList().transferPlayerToDimension(thePlayer, 0, new ModTeleporterIceika(thePlayer.mcServer.getWorld(0), 0, this, Blocks.SNOW));
			}
		}
	}
...
//			EntityIceikaPortalFX var20 = new EntityIceikaPortalFX(worldIn, d0, d1, d2, d3, d4, d5);
