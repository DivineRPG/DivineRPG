...
public final class LowestCeilingType extends Structure {
    ...
    public LowestCeilingType(Structure.StructureSettings config,
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        Optional<Structure.GenerationStub> structurePiecesGenerator =
                JigsawPlacement.addPieces(
                        ...
                        false,
                        Optional.empty(),
                        new JigsawStructure.MaxDistance(this.maxDistanceFromCenter), PoolAliasLookup.EMPTY, DimensionPadding.ZERO, LiquidSettings.APPLY_WATERLOGGING);
