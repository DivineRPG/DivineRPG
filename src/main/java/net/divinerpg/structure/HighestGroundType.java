package net.divinerpg.structure;

import com.mojang.serialization.Codec;
import com.mojang.serialization.MapCodec;
import com.mojang.serialization.codecs.RecordCodecBuilder;
import net.divinerpg.registries.StructureRegistry;
...
public final class HighestGroundType extends Structure {
    public static final MapCodec<HighestGroundType> CODEC = RecordCodecBuilder.<HighestGroundType>mapCodec(instance ->
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        Optional<Structure.GenerationStub> structurePiecesGenerator = JigsawPlacement.addPieces(context, this.startPool, this.startJigsawName, this.size, new BlockPos(x, y, z), false, Optional.empty(), new JigsawStructure.MaxDistance(this.maxDistanceFromCenter), PoolAliasLookup.EMPTY, DimensionPadding.ZERO, LiquidSettings.APPLY_WATERLOGGING);
