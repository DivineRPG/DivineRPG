...
public class ModItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
            ...
            tag(commonTag("ingots")).addTags(commonTag("ingots/arlemite"), commonTag("ingots/rupee"), commonTag("ingots/aquatic"), commonTag("ingots/hellstone"), commonTag("ingots/oxdrite"), commonTag("ingots/realmite"), commonTag("ingots/torridite"));
