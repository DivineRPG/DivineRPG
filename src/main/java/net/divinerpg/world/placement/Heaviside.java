package net.divinerpg.world.placement;
...
public record Heaviside(DensityFunction argument) implements DensityFunction {
    public static final MapCodec<Heaviside> DATA_CODEC = DensityFunction.CODEC.fieldOf("argument").xmap(Heaviside::new, Heaviside::argument);
