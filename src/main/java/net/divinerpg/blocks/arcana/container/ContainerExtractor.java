...
public class ContainerExtractor extends Container {
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int slotNumber) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            {
                if (itemstack1 != null && itemstack1.getItem() == Item.getItemFromBlock(ArcanaBlocks.arcaniumOre))
                {
                ...
                else if (itemstack1 != null && itemstack1.getItem() == ArcanaItems.chargedCollector)
                {
