...
public class EntityMystic extends EntityDivineRPGMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(net.divinerpg.entities.base.EntityStats.mysticHealth);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(net.divinerpg.entities.base.EntityStats.mysticDamage);
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(net.divinerpg.entities.base.EntityStats.mysticSpeed);
        this.getEntityAttribute(SharedMonsterAttributes.followRange).setBaseValue(net.divinerpg.entities.base.EntityStats.mysticFollowRange);
    }
    ...
    public void onUpdate() {
        ...
        if (this.ticksExisted % 10 == 0) {
            ...
            if (this.entityToAttack != null && !this.worldObj.isRemote) {
                ...
                EntityTwilightMageShot e = new EntityTwilightMageShot(this.worldObj, this, 234, 223, 228);
