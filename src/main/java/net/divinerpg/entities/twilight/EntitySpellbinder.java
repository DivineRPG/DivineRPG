...
public class EntitySpellbinder extends EntityDivineRPGMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(net.divinerpg.entities.base.EntityStats.spellbinderHealth);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(net.divinerpg.entities.base.EntityStats.spellbinderDamage);
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(net.divinerpg.entities.base.EntityStats.spellbinderSpeed);
        this.getEntityAttribute(SharedMonsterAttributes.followRange).setBaseValue(net.divinerpg.entities.base.EntityStats.spellbinderFollowRange);
    }
    ...
    public void onUpdate() {
        ...
        if (this.ticksExisted % 10 == 0) {
            ...
            if (this.entityToAttack != null && !this.worldObj.isRemote) {
                ...
                EntityTwilightMageShot e = new EntityTwilightMageShot(this.worldObj, this, 234, 158, 253);
