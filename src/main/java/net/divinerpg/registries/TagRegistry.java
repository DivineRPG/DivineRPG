...
public class TagRegistry {
    ...
    private static TagKey<DamageType> damageType(String path) { return TagKey.create(Registries.DAMAGE_TYPE, Identifier.fromNamespaceAndPath(DivineRPG.MODID, path)); }
    private static TagKey<Structure> structure(String path) { return TagKey.create(Registries.STRUCTURE, Identifier.fromNamespaceAndPath(DivineRPG.MODID, path)); }
}