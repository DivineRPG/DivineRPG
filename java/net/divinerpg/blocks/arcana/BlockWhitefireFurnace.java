...
public class BlockWhitefireFurnace extends BlockModFurnace {
	...
	public static void updateFurnaceBlockState(boolean act, World par1World, int par2, int par3, int par4) {
		...
		keepInventory = true;
		if(act) par1World.setBlock(par2, par3, par4, ArcanaBlocks.whitefireFurnaceOn);
		else par1World.setBlock(par2, par3, par4, ArcanaBlocks.whitefireFurnace);
		keepInventory = false;
