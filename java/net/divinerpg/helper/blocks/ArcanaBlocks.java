...
public class ArcanaBlocks {
    ...
    public static final Block arcaniumMetal         = new BlockMod("arcaniumMetal", -1F);
    ...
    public static final Block dungenLamp            = new BlockMod("dungeonLamp", -1F).setLightLevel(1.0F);
    ...
    public static final Block soulStone             = new BlockMod("soulStone", -1F);
    public static final Block soulSludge            = new BlockMod("soulSludge", -1F);
    public static final Block degradedBrick         = new BlockMod("degradedBrick", -1F);
    public static final Block darkDegradedBrick     = new BlockMod("darkDegradedBrick", -1F);
    public static final Block ancientBrick          = new BlockMod("ancientBrick", -1F);
    public static final Block ancientStone          = new BlockMod("ancientStone", -1F);
    public static final Block lightDegradedBrick    = new BlockMod("lightDegradedBrick", -1F);
    ...
    public static final Block ancientTile           = new BlockMod("ancientTile", -1F);
