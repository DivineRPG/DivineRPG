...
public class ArcanaEntityRenderer {
	...
	public static void init(){
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityReflector.class, new RenderSpecialProjectile(x.blank, 1));
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityGolemOfRejuv.class, new RenderDivineMob(new ModelRejuvGolem(), 0.5f, 1.5f, x.golem_rejuv));
