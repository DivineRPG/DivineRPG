...
public class VetheaEntityRenderer {
	...
	public static void init(){
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityMandragoraProjectile.class, new RenderSpecialProjectile(x.blank));
		RenderingRegistry.registerEntityRenderingHandler(EntityLadyLunaSparkler.class, new RenderSpecialProjectile(x.blank));
