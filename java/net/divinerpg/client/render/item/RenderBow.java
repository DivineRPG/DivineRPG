...
/*
 * 
 * This class was originally part of The Mists of RioV by sheenrox82. sheenrox82 has given the DivineRPG team permission to use it.
 * 
 */
...
public class RenderBow implements IItemRenderer
{
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        if(e instanceof EntityPlayer && ((EntityPlayer)e).getCommandSenderName().equals(Minecraft.getMinecraft().thePlayer.getCommandSenderName()) && Minecraft.getMinecraft().gameSettings.thirdPersonView == 0) renderFirstPerson = true;
