...
public class DevHatEvent {
	...
	public static boolean isDeveloperName(String name) {
		return name.equals("Doomturd") || name.equals("XolovA") || name.equals("geekclb") || name.equals("sheenrox82") || name.equals("The_SlayerMC") || name.equals("insanity414all") || name.equals("deathman12e3");
	}
}