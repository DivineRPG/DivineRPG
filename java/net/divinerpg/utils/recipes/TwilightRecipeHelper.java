...
public class TwilightRecipeHelper extends DivineRPG {
	...
	public static void init() {
		...
		addRecipe(IS.edenSlicer, "", "X", "", "X", TwilightItemsOther.edenGem);
		...
		addRecipe(IS.wildwoodSlicer, "", "X", "", "X", TwilightItemsOther.wildwoodGem);
		...
		addRecipe(IS.apalchiaPhaser, " X ", "XXX", " X ", "X", TwilightItemsOther.apalachiaChunk);
		addRecipe(IS.apalachiaBlitz, "X X", "X X", "XXX", "X", TwilightItemsOther.apalachiaChunk);
		addRecipe(IS.apalachiaSlicer, "", "X", "", "X", TwilightItemsOther.apalachiaGem);
		...
		addRecipe(IS.skythernSlicer, "", "X", "", "X", TwilightItemsOther.skythernGem);
		...
		addRecipe(IS.mortumSlicer, "", "X", "", "X", TwilightItemsOther.mortumGem);
