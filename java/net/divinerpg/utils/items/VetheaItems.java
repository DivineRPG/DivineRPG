...
public class VetheaItems {
    ...
    public static Item quadroticDisk      = new ItemDisk(20, "quadroticDisk");
    public static Item karosDisk          = new ItemDisk(22, "karosDisk");
    public static Item heliosisDisk       = new ItemDisk(29, "heliosisDisk");
    public static Item arksianeDisk       = new ItemDisk(37, "arksianeDisk");
    ...
    public static Item quadroticStaff     = new ItemStaff(19, 10, "quadroticStaff");
    public static Item karosStaff         = new ItemStaff(21, 10, "karosStaff");
    public static Item heliosisStaff      = new ItemStaff(28, 10, "heliosisStaff");
    public static Item arksianeStaff      = new ItemStaff(36, 10, "arksianeStaff");
    ...
    public static Item heivaBelt          = new ItemMod("heivaBelt").setCreativeTab(DivineRPGTabs.vethea);
    ...
    public static Item pardimalCannon     = new ItemVetheanCannon("pardimalWarcannon", 15);
    ...
    public static Item quadroticHammer    = new ItemVetheanSword("quadroticHammer", Util.addHammerMaterial(24));
    public static Item karosHammer        = new ItemVetheanSword("karosHammer", Util.addHammerMaterial(26));
    public static Item heliosisHammer     = new ItemVetheanSword("heliosisHammer", Util.addHammerMaterial(33));
    public static Item arksianeHammer     = new ItemVetheanSword("arksianeHammer", Util.addHammerMaterial(39));
    ...
    public static Item quadroticSword     = new ItemVetheanSword("quadroticBacksword", Util.addHammerMaterial(20));
    public static Item karosSword         = new ItemVetheanSword("karosBacksword", Util.addHammerMaterial(22));
    public static Item heliosisSword      = new ItemVetheanSword("heliosisBacksword", Util.addHammerMaterial(29));
    public static Item arksianeSword      = new ItemVetheanSword("arksianeBacksword", Util.addHammerMaterial(37));
    ...
    public static Item quadroticClaw      = new ItemVetheanClaw(14, "quadroticClaw");
    public static Item karosClaw          = new ItemVetheanClaw(19, "karosClaw");
    public static Item heliosisClaw       = new ItemVetheanClaw(26, "heliosisClaw");
    public static Item arksianeClaw       = new ItemVetheanClaw(35, "arksianeClaw");
    ...
    public static Item everfright		    = new ItemModBow("everfright", -1, 25, 46, everArrow);
    public static Item evernight          = new ItemStaff(115, 200, "evernight");
    ...
    public static Item pardimalBow      = new ItemModBow("pardimalWarbow", -1, 5, 18, pardimalArrow).setSound(Sounds.vetheaBow.getPrefixedName()).setVethean();
    ...
    private static final Object[] basicHelmInfo = {15, ArmorInfo.MELEE_PROTECTION};
    private static final Object[] basicMaskInfo = {15, ArmorInfo.RANGED_PROTECTION};
    private static final Object[] basicHoodInfo = {15, ArmorInfo.ARCANA_PROTECTION};
    private static final Object[] glisteningHelmInfo = {15, ArmorInfo.MELEE_PROTECTION, 3, ArmorInfo.MELEE_DAMAGE};
    private static final Object[] glisteningMaskInfo = {15, ArmorInfo.RANGED_PROTECTION, 1.4, ArmorInfo.SPEED};
    private static final Object[] glisteningHoodInfo = {15, ArmorInfo.ARCANA_PROTECTION, 2, ArmorInfo.JUMP_HEIGHT};
    private static final Object[] demonizedHelmInfo = {15, ArmorInfo.MELEE_PROTECTION, 6, ArmorInfo.MELEE_DAMAGE};
    private static final Object[] demonizedMaskInfo = {15, ArmorInfo.RANGED_PROTECTION, 1.8, ArmorInfo.SPEED};
    private static final Object[] demonizedHoodInfo = {15, ArmorInfo.ARCANA_PROTECTION, 3, ArmorInfo.JUMP_HEIGHT};
    private static final Object[] tormentedHelmInfo = {15, ArmorInfo.MELEE_PROTECTION, 9, ArmorInfo.MELEE_DAMAGE};
    private static final Object[] tormentedMaskInfo = {15, ArmorInfo.RANGED_PROTECTION, 2.2, ArmorInfo.SPEED};
    private static final Object[] tormentedHoodInfo = {15, ArmorInfo.ARCANA_PROTECTION, 4, ArmorInfo.JUMP_HEIGHT};
