...
public class ArcanaBlocks {
	...
	public static void init(){
		...
		dungenSpawnerPrisoner = new BlockStupidSpawner("dungeonPrisonerSpawner", "DungeonPrisoner", "arcanaSpawner").setBlockUnbreakable().setResistance(6000000F);
		razorbackSpawner      = new BlockStupidSpawner("razorbackSpawner", "Razorback", "arcanaSpawner").setBlockUnbreakable().setResistance(6000000F);
		deathHoundSpawner     = new BlockStupidSpawner("deathHoundSpawner", "DeathHound", "arcanaSpawner").setBlockUnbreakable().setResistance(6000000F);
		deathcryxSpawner      = new BlockStupidSpawner("deathcryxSpawner", "Deathcryx", "arcanaSpawner").setBlockUnbreakable().setResistance(6000000F);
		livingStatueSpawner   = new BlockStupidSpawner("livingStatueSpawner", "LivingStatue", "arcanaSpawner").setBlockUnbreakable().setResistance(6000000F);
		roamerSpawner         = new BlockStupidSpawner("roamerSpawner", "Roamer", "arcanaSpawner").setBlockUnbreakable().setResistance(6000000F);
