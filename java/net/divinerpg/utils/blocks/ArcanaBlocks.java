...
public class ArcanaBlocks {
	...
	public static void init(){
		...
		dungenSpawnerPrisoner = new BlockStupidSpawner("dungeonPrisonerSpawner", "DungeonPrisoner", "arcanaSpawner");
		razorbackSpawner      = new BlockStupidSpawner("razorbackSpawner", "Razorback", "arcanaSpawner");
		deathHoundSpawner     = new BlockStupidSpawner("deathHoundSpawner", "DeathHound", "arcanaSpawner");
		deathcryxSpawner      = new BlockStupidSpawner("deathcryxSpawner", "Deathcryx", "arcanaSpawner");
		livingStatueSpawner   = new BlockStupidSpawner("livingStatueSpawner", "LivingStatue", "arcanaSpawner");
		roamerSpawner         = new BlockStupidSpawner("roamerSpawner", "Roamer", "arcanaSpawner");
