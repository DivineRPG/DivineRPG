...
public class ArcanaBlocks {
	...
	public static void init(){
		...
		stainedGlass          = new BlockModGlass("stainedGlass", 0.3F).setBlockName("stainedGlass");
		stainedGlass2         = new BlockModGlass("stainedGlass2", 0.3F).setBlockName("stainedGlass");
		stainedGlass3         = new BlockModGlass("stainedGlass3", 0.3F).setBlockName("stainedGlass");
		stainedGlass4         = new BlockModGlass("stainedGlass4", 0.3F).setBlockName("stainedGlass");
		stainedGlass5         = new BlockModGlass("stainedGlass5", 0.3F).setBlockName("stainedGlass");
		stainedGlass6         = new BlockModGlass("stainedGlass6", 0.3F).setBlockName("stainedGlass");
		stainedGlass7         = new BlockModGlass("stainedGlass7", 0.3F).setBlockName("stainedGlass");
		stainedGlass8         = new BlockModGlass("stainedGlass8", 0.3F).setBlockName("stainedGlass");
