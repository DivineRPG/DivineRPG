...
public class VetheaBlocks {
    ...
    public static final BlockModPortal    vetheaPortal           = (BlockModPortal) new BlockModPortal("vetheaPortal", ConfigurationHelper.vethea, TwilightBlocks.blueFire, TwilightBlocks.mortumBlock);
