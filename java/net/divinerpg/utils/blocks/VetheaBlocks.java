...
public class VetheaBlocks {
	...
	public static Block vetheaPortal = new BlockVetheaPortal().setCreativeTab(DivineRPGTabs.vethea);
	...
	public static Block dreamGrass = new BlockModGrass((BlockMod) dreamDirt, "dreamGrass", "dreamDirt", 0.6F).setCreativeTab(DivineRPGTabs.vethea);
	...
	public static Block dreamWoodLeaves = new BlockModLeaves("dreamwoodLeaves", 0.2F).setCreativeTab(DivineRPGTabs.vethea);
	...
	public static Block cryptWall = new BlockMod("cryptWall", false, DivineRPGTabs.vethea);
	public static Block smoothGlass = new BlockModGlass("smoothGlass", 0.3F).setCreativeTab(DivineRPGTabs.vethea);
	public static Block villageLamp = new BlockMod(EnumBlockType.GLASS, "villageLamp", false, DivineRPGTabs.vethea).setLightLevel(1);
	public static Block cellLamp = new BlockMod(EnumBlockType.GLASS, "cellLamp", false, DivineRPGTabs.vethea).setLightLevel(1);
	...
	public static Block mintwoodLeaves = new BlockModLeaves("mintwoodLeaves", 0.2F).setCreativeTab(DivineRPGTabs.vethea);
	...
	public static Block everstone = new BlockMod("greenEverstone", false, DivineRPGTabs.vethea);
	public static Block lunicAcid = new BlockAcid("lunicAcid", true, true);
	public static Block firewoodLeaves = new BlockModLeaves("firewoodLeaves", 0.2F).setCreativeTab(DivineRPGTabs.vethea);
	public static Block hyrewoodLeaves = new BlockModLeaves("hyrewoodLeaves", 0.2F).setCreativeTab(DivineRPGTabs.vethea);
