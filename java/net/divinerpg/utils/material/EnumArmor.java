...
public enum EnumArmor {
    ...
    ENDER_YELLOW(Util.addArmorMaterial("Ender", 0, 10), "yellowEnder", true, 65),
    ENDER_RED(Util.addArmorMaterial("Ender", 0, 10), "redEnder", true, 65),
    ENDER_GREEN(Util.addArmorMaterial("Ender", 0, 10), "greenEnder", true, 65),
    ENDER_GRAY(Util.addArmorMaterial("Ender", 0, 10), "grayEnder", true, 65),
    ENDER_BLUE(Util.addArmorMaterial("Ender", 0, 10), "blueEnder", true, 65),
