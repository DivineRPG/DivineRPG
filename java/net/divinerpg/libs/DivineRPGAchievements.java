...
public class DivineRPGAchievements {
    ...
    public static final Achievement whatLiesWithin 		    = addAchievement("whatLiesWithin"		, 0, 5, ArcanaBlocks.arcanaPortalFrame, null, false);					//DONE
    ...
    public static final Achievement allHellLoose 			= addAchievement("allHellLoose"			, 3, 10, ArcanaItems.stormSword, whatLiesWithin, false);					//DONE
    public static final Achievement enrichment 				= addAchievement("enrichment"			, 3, 7, ArcanaItems.staffOfEnrichment, whatLiesWithin, false);				//DONE
