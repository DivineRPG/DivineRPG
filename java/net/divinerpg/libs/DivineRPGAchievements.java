...
public class DivineRPGAchievements {
    ...
    public static final Achievement divineInervention 		= addAchievement("divineIntervention"	, 0, 3, VanillaItemsOther.callWatcher, null, true);					
    ...
    public static final Achievement tripleDanger 			= addAchievement("tripleDanger"			, 3, 0, VanillaItemsOther.enderShard, null, false);						
    public static final Achievement	possibilities 			= addAchievement("possibilities"		, 2, 3, VanillaBlocks.divineRock, divineInervention, true);			
    ...
    public static final Achievement whenPigsFly 			= addAchievement("whenPigsFly"			, 3, 2, VanillaItemsArmor.angelicHelmet, divineInervention, true);		
