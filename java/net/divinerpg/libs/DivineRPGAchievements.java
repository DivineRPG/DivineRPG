...
public class DivineRPGAchievements {
    ...
    public static final Achievement tripleDanger 			= addAchievement("tripleTheDanger"		, 3, 0, VanillaItemsOther.enderShard, null, false);						
    ...
    public static AchievementPage page = new AchievementPage("DivineRPG", divinePlan, divineIntervention, whatLiesWithin, friendOrFoe,
			...
			lilTinkerin, lilGift, skyHigh, whenPigsFly, offKey, allHellLoose, darkAnotherDay, arrowToTheKnee, dramcryxDeath, oneLampTwoLampRedLampBlueLamp);
