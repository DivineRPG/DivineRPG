package net.divinerpg.dimension.gen.twilight.apalachia;
...
public class WorldGenApalachiaTree extends WorldGenerator {
    ...
    public int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger) {
        ...
        if (var3[var5] == 0) {
            ...
            for (var15 = var3[var5] + var8; var14 != var15; var14 += var8) {
                ...
                if (var16 != Blocks.air && var16 != TwilightBlocks.apalachiaLeaves) {
                    break;
                }
            }
