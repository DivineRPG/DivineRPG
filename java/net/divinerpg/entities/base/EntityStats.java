...
public class EntityStats {
	...
	public static double rollumHealth 			= 200.0D, rollumDamage = 5.0D, rollumSpeed = normalSpeed, rollumFollowRange = follow;
	...
	public static double apalachiaGolemHealth 	= 350.0D, apalachiaGolemDamage = 21.0D, apalachiaGolemSpeed = normalSpeed, apalachiaGolemFollowRange = follow;
	...
	public static double skythernGolemHealth 	= 400.0D, skythernGolemDamage = 23.0D, skythernGolemSpeed = normalSpeed, skythernGolemFollowRange = follow;
	public static double verekHealth 			= 50.0D, verekDamage = 15.0D, verekSpeed = normalSpeed, verekFollowRange = follow;
	...
	public static double wildwoodGolemHealth 	= 350.0D, wildwoodGolemDamage = 21.0D, wildwoodGolemSpeed = normalSpeed, wildwoodGolemFollowRange = follow;
	...
	public static double corruptedDramcryxHealth= 80.0D, corruptedDramcryxDamage = 9.0D, corruptedDramcryxSpeed = normalSpeed, corruptedDramcryxFollowRange = follow;
	public static double caveclopsHealth 		= 60.0D, caveclopsDamage = 6.0D, caveclopsSpeed = normalSpeed, caveclopsFollowRange = follow;
	public static double caveCrawlerHealth 		= 30.0D, caveCrawlerDamage = 6.0D, caveCrawlerSpeed = normalSpeed, caveCrawlerFollowRange = follow;
	public static double crabHealth 			= 45.0D, crabDamage = 8.0D, crabSpeed = normalSpeed, crabFollowRange = follow;
	public static double cyclopsHealth 			= 35.0D, cyclopsDamage = 6.0D, cyclopsSpeed = normalSpeed, cyclopsFollowRange = follow;
	public static double desertCrawlerHealth 	= 40.0D, desertCrawlerDamage = 12.0D, desertCrawlerSpeed = normalSpeed, desertCrawlerFollowRange = follow;
	public static double enderSpiderHealth 		= 35.0D, enderSpiderDamage = 10.0D, enderSpiderSpeed = normalSpeed, enderSpiderFollowRange = follow;
	...
	public static double glaconHealth 			= 60.0D, glaconDamage = 12.0D, glaconSpeed = normalSpeed, glaconFollowRange = follow;
	...
	public static double jungleBatHealth 		= 20.0D, jungleBatDamage = 10.0D, jungleBatSpeed = normalSpeed, jungleBatFollowRange = follow;
	public static double jungleSpiderHealth		= 45.0D, jungleSpiderDamage = 9.0D, jungleSpiderSpeed = normalSpeed, jungleSpiderFollowRange = follow;
	...
	public static double kingCrabHealth 		= 100.0D, kingCrabDamage = 12.0D, kingCrabSpeed = normalSpeed, kingCrabFollowRange = follow;
	...
	public static double rotatickHealth 		= 40.0D, rotatickDamage = 8.0D, rotatickSpeed = normalSpeed, rotatickFollowRange = follow;
	public static double scorcherHealth 		= 75.0D, scorcherDamage = 7.0D, scorcherSpeed = normalSpeed, scorcherFollowRange = follow;
	public static double sharkHealth 			= 80.0D, sharkDamage = 10.0D, sharkSpeed = normalSpeed, sharkFollowRange = follow;
	public static double theEyeHealth 			= 40.0D, theEyeDamage = 13.0D, theEyeSpeed = normalSpeed, theEyeFollowRange = follow;
