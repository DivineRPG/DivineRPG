...
public class WorldGenGlacideDungeon extends WorldGenerator {
    ...
    public boolean generate(World w, Random rand, int x, int y, int z) {
		...
		WorldGenAPI.addRectangle(6, 4, 5, w, x, y, z, IceikaBlocks.snowBricks);
		WorldGenAPI.addRectangle(8, 8, 5, w, x + 5, y, z - 2, IceikaBlocks.snowBricks);
		...
		WorldGenAPI.addRectangle(1, 4, 4, w, x + 12, y, z - 1, IceikaBlocks.snowBricks);
		WorldGenAPI.addRectangle(4, 4, 5, w, x + 13, y, z + 2, IceikaBlocks.snowBricks);
		WorldGenAPI.addRectangle(4, 6, 5, w, x + 13, y, z + 3, IceikaBlocks.snowBricks);
		...
		WorldGenAPI.addRectangle(8, 4, 5, w, x + 16, y, z + 5, IceikaBlocks.snowBricks);
		...
		WorldGenAPI.addRectangle(4, 3, 5, w, x + 20, y, z + 3, IceikaBlocks.snowBricks);
		WorldGenAPI.addRectangle(8, 8, 5, w, x + 18, y, z - 5, IceikaBlocks.snowBricks);
