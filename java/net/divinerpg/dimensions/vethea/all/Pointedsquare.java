...
public class Pointedsquare extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 2, j + 1, k + 0, VetheaBlocks.everstone);
		...
		world.setBlock(i + 3, j + 3, k + 0, VetheaBlocks.everstone);
		...
		world.setBlock(i + 4, j + 2, k + 0, VetheaBlocks.darkEverstone);
		...
		world.setBlock(i + 7, j + 1, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 7, j + 2, k + 0, VetheaBlocks.darkEverstone);
		world.setBlock(i + 7, j + 5, k + 0, VetheaBlocks.darkEverstone);
		world.setBlock(i + 7, j + 6, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 7, j + 7, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 7, j + 8, k + 0, VetheaBlocks.darkEverstone);
		world.setBlock(i + 8, j + 0, k + 0, VetheaBlocks.darkEverstone);
		world.setBlock(i + 8, j + 1, k + 0, VetheaBlocks.everstone);
		...
		world.setBlock(i + 8, j + 6, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 8, j + 7, k + 0, VetheaBlocks.darkEverstone);
		...
		world.setBlock(i + 9, j + 6, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 9, j + 7, k + 0, VetheaBlocks.darkEverstone);
		world.setBlock(i + 10, j + 0, k + 0, VetheaBlocks.darkEverstone);
		world.setBlock(i + 10, j + 1, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 10, j + 2, k + 0, VetheaBlocks.darkEverstone);
		world.setBlock(i + 10, j + 3, k + 0, VetheaBlocks.darkEverstone);
		world.setBlock(i + 10, j + 4, k + 0, VetheaBlocks.darkEverstone);
		world.setBlock(i + 10, j + 5, k + 0, VetheaBlocks.darkEverstone);
		world.setBlock(i + 10, j + 6, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 10, j + 7, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 10, j + 8, k + 0, VetheaBlocks.darkEverstone);
		...
		world.setBlock(i + 11, j + 3, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 11, j + 4, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 11, j + 5, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 11, j + 6, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 11, j + 7, k + 0, VetheaBlocks.darkEverstone);
		world.setBlock(i + 12, j + 0, k + 0, VetheaBlocks.darkEverstone);
		world.setBlock(i + 12, j + 1, k + 0, VetheaBlocks.darkEverstone);
		world.setBlock(i + 12, j + 2, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 12, j + 3, k + 0, VetheaBlocks.darkEverstone);
		world.setBlock(i + 12, j + 4, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 12, j + 5, k + 0, VetheaBlocks.darkEverstone);
		world.setBlock(i + 12, j + 6, k + 0, VetheaBlocks.darkEverstone);
		world.setBlock(i + 12, j + 7, k + 0, VetheaBlocks.darkEverstone);
		world.setBlock(i + 13, j + 2, k + 0, VetheaBlocks.darkEverstone);
		world.setBlock(i + 13, j + 4, k + 0, VetheaBlocks.darkEverstone);
