...
public class Mushroom extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 2, j + 7, k + 0, VetheaBlocks.everstone);
		...
		world.setBlock(i + 3, j + 7, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 3, j + 8, k + 0, VetheaBlocks.whiteEverstone);
		...
		world.setBlock(i + 4, j + 3, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 4, j + 4, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 4, j + 5, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 4, j + 6, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 4, j + 7, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 4, j + 8, k + 0, VetheaBlocks.whiteEverstone);
		world.setBlock(i + 4, j + 9, k + 0, VetheaBlocks.whiteEverstone);
		...
		world.setBlock(i + 6, j + 6, k + 0, VetheaBlocks.darkEverstone);
		world.setBlock(i + 6, j + 7, k + 0, VetheaBlocks.everstone);
		world.setBlock(i + 6, j + 8, k + 0, VetheaBlocks.whiteEverstone);
		world.setBlock(i + 6, j + 9, k + 0, VetheaBlocks.whiteEverstone);
		world.setBlock(i + 6, j + 10, k + 0, VetheaBlocks.darkEverstone);
		...
		world.setBlock(i + 8, j + 7, k + 0, VetheaBlocks.everstone);
